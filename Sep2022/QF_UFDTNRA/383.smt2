...
(declare-datatypes ((x1134 0)) (((x1341 (x1581 x1134) (x1468 Real)) (x1584 (x1379 Real)) (x1388 (x840 x1134) (x195 x1134) (x485 Real)))))
...
(declare-fun x854 (Real Real) Real)
...
(declare-fun x478 (Real Real Real Real) Real)
(declare-fun x159 () Real)
(declare-fun x1727 (Real Real) Real)
(declare-fun x367 () Bool)
(declare-fun x1063 () Real)
(declare-fun x1212 (x1134) Real)
...
(declare-fun x849 (Real Real) Real)
...
(declare-fun x1316 (Real Real Real Real Real Real Real Real Real) Real)
...
(declare-fun x1487 (x1134) Real)
(declare-fun x636 () Real)
(declare-fun x326 () Real)
(declare-fun x1147 (x1134) Real)
(declare-fun x5 () Real)
...
(declare-fun x1236 (x1134) Real)
(declare-fun x1000 (x1134) Real)
...
(declare-fun x726 (x1134) Real)
(declare-fun x117 () x1134)
(declare-fun x1043 () Bool)
(declare-fun x686 () Real)
(declare-fun x810 (x1134) Real)
...
(define-fun x1592 ((x1134 x1134) (x213 Real)) x1134 (ite ((_ is x1341) x1134) (x1341 (x1581 x1134) (+ (x1468 x1134) x213)) (ite ((_ is x1388) x1134) (x1388 (x840 x1134) (x195 x1134) (+ (x485 x1134) x213)) (x1584 (+ x213 (x1379 x1134))))))
(define-fun x1101 ((x631 Real)) Real (ite (and (<= 0 x631) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 x631)) x631 (- x631 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x557 ((x631 Real)) Real (ite (and (>= x631 (- 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (< x631 0)) (+ 115792089237316195423570985008687907853269984665640564039457584007913129639936 x631) x631))
(define-fun x550 ((x620 Real)) Bool (and (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 x620) (>= x620 0)))
(define-fun x1181 ((x620 Real)) Bool (and (= (x259 115792089237316195423570985008687907853269984665640564039457584007913129639935 x620) x620) (= x620 (x259 x620 115792089237316195423570985008687907853269984665640564039457584007913129639935))))
(define-fun x821 ((x620 Real)) Bool (and (= (x259 0 x620) 0) (= (x259 x620 0) 0)))
(define-fun x1538 ((x620 Real)) Bool (= x620 (x259 x620 x620)))
(define-fun x571 ((x620 Real)) Bool (and (x821 x620) (x1538 x620) (x1181 x620)))
(define-fun x886 ((x620 Real)) Bool (= (x259 115792089237316195423570985008687907853269984665640564039457584007913129639904 x620) (x259 115792089237316195423570985008687907853269984665640564039457584007913129639904 (x259 115792089237316195423570985008687907853269984665640564039457584007913129639904 x620))))
(define-fun x1307 ((x620 Real)) Bool (=> (and (<= 0 x620) (< x620 32)) (= (x259 115792089237316195423570985008687907853269984665640564039457584007913129639904 x620) 0)))
(define-fun x731 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (= (x259 115792089237316195423570985008687907853269984665640564039457584007913129639904 x620) (* 32 x1385)) (= x620 (+ (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x820) (* 32 x1385) x1616)) (> 3618502788666131106986593281521497120414687020801267626233049500247285301248 x1385) (< x820 1) (<= 0 x1616) (> 32 x1616) (<= 0 x1385) (<= 0 x820)))
(define-fun x8 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x1307 x620) (x886 x620) (x731 x620 x530 x1298 x611)))
(define-fun x1094 ((x620 Real) (x1616 Real)) Bool (= (x259 x620 x1616) (x259 x1616 x620)))
(define-fun x6 ((x620 Real) (x1616 Real)) Bool (and (=> (>= x1616 0) (<= (x259 x620 x1616) x1616)) (<= 0 (x259 x620 x1616)) (=> (<= 0 x620) (>= x620 (x259 x620 x1616)))))
(define-fun x1186 ((x620 Real) (x1616 Real)) Bool (and (x6 x620 x1616) (x1094 x620 x1616)))
(define-fun x1315 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x8 x620 x530 x1298 x611) (x1186 x620 115792089237316195423570985008687907853269984665640564039457584007913129639904)))
(define-fun x622 ((x620 Real)) Bool (= (x259 255 (x259 255 x620)) (x259 255 x620)))
(define-fun x1042 ((x620 Real)) Bool (=> (and (> 256 x620) (>= x620 0)) (= x620 (x259 255 x620))))
(define-fun x81 ((x620 Real)) Bool (=> (= x620 (x259 255 x620)) (and (< x620 256) (>= x620 0))))
(define-fun x1587 ((x620 Real)) Bool (=> (and (>= x620 256) (< x620 512)) (= (x259 255 x620) (- x620 256))))
(define-fun x1166 ((x620 Real) (x1616 Real)) Bool (and (>= x1616 0) (= x620 (+ (* 256 x1616) (x259 255 x620)))))
(define-fun x887 ((x620 Real) (x548 Real)) Bool (and (x1166 x620 x548) (x622 x620) (x1042 x620) (x81 x620) (x1587 x620)))
(define-fun x1401 ((x620 Real) (x548 Real)) Bool (and (x1186 x620 255) (x887 x620 x548)))
(define-fun x1128 ((x620 Real)) Bool (= (x259 18446744073709551615 x620) (x259 18446744073709551615 (x259 18446744073709551615 x620))))
(define-fun x1046 ((x620 Real)) Bool (=> (and (> 18446744073709551616 x620) (>= x620 0)) (= (x259 18446744073709551615 x620) x620)))
(define-fun x1474 ((x620 Real)) Bool (=> (= x620 (x259 18446744073709551615 x620)) (and (> 18446744073709551616 x620) (<= 0 x620))))
(define-fun x761 ((x620 Real)) Bool (=> (and (>= x620 18446744073709551616) (> 36893488147419103232 x620)) (= (x259 18446744073709551615 x620) (- x620 18446744073709551616))))
(define-fun x575 ((x620 Real) (x1616 Real)) Bool (and (>= x1616 0) (= x620 (+ (* x1616 18446744073709551616) (x259 18446744073709551615 x620)))))
(define-fun x1279 ((x620 Real) (x548 Real)) Bool (and (x761 x620) (x575 x620 x548) (x1046 x620) (x1128 x620) (x1474 x620)))
(define-fun x1470 ((x620 Real) (x548 Real)) Bool (and (x1186 x620 18446744073709551615) (x1279 x620 x548)))
(define-fun x1021 ((x620 Real)) Bool (= (x259 4294967295 x620) (x259 4294967295 (x259 4294967295 x620))))
(define-fun x1486 ((x620 Real)) Bool (=> (and (> 4294967296 x620) (>= x620 0)) (= x620 (x259 4294967295 x620))))
(define-fun x141 ((x620 Real)) Bool (=> (= (x259 4294967295 x620) x620) (and (> 4294967296 x620) (<= 0 x620))))
(define-fun x536 ((x620 Real)) Bool (=> (and (<= 4294967296 x620) (> 8589934592 x620)) (= (- x620 4294967296) (x259 4294967295 x620))))
(define-fun x1729 ((x620 Real) (x1616 Real)) Bool (and (>= x1616 0) (= x620 (+ (x259 4294967295 x620) (* 4294967296 x1616)))))
(define-fun x1492 ((x620 Real) (x548 Real)) Bool (and (x536 x620) (x1486 x620) (x1729 x620 x548) (x1021 x620) (x141 x620)))
(define-fun x1040 ((x620 Real) (x548 Real)) Bool (and (x1492 x620 x548) (x1186 x620 4294967295)))
(define-fun x733 ((x620 Real)) Bool (= (x259 115792089237316195423570985008687907853269984665640564039457584007913129639680 x620) (x259 115792089237316195423570985008687907853269984665640564039457584007913129639680 (x259 115792089237316195423570985008687907853269984665640564039457584007913129639680 x620))))
(define-fun x1334 ((x620 Real)) Bool (=> (and (< x620 256) (>= x620 0)) (= 0 (x259 115792089237316195423570985008687907853269984665640564039457584007913129639680 x620))))
(define-fun x742 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (= x620 (+ (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x820) x1616 (* x1385 256))) (> 1 x820) (> 452312848583266388373324160190187140051835877600158453279131187530910662656 x1385) (<= 0 x1385) (<= 0 x1616) (= (* 256 x1385) (x259 115792089237316195423570985008687907853269984665640564039457584007913129639680 x620)) (< x1616 256) (>= x820 0)))
(define-fun x450 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x742 x620 x530 x1298 x611) (x1334 x620) (x733 x620)))
(define-fun x1547 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x450 x620 x530 x1298 x611) (x1186 x620 115792089237316195423570985008687907853269984665640564039457584007913129639680)))
(define-fun x1696 ((x620 Real)) Bool (= (x259 1461501637330902918203684832716283019655932542975 x620) (x259 1461501637330902918203684832716283019655932542975 (x259 1461501637330902918203684832716283019655932542975 x620))))
(define-fun x164 ((x620 Real)) Bool (=> (and (<= 0 x620) (> 1461501637330902918203684832716283019655932542976 x620)) (= x620 (x259 1461501637330902918203684832716283019655932542975 x620))))
(define-fun x817 ((x620 Real)) Bool (=> (= x620 (x259 1461501637330902918203684832716283019655932542975 x620)) (and (>= x620 0) (> 1461501637330902918203684832716283019655932542976 x620))))
(define-fun x1015 ((x620 Real)) Bool (=> (and (>= x620 1461501637330902918203684832716283019655932542976) (< x620 2923003274661805836407369665432566039311865085952)) (= (- x620 1461501637330902918203684832716283019655932542976) (x259 1461501637330902918203684832716283019655932542975 x620))))
(define-fun x1087 ((x620 Real) (x1616 Real)) Bool (and (= (+ (x259 1461501637330902918203684832716283019655932542975 x620) (* 1461501637330902918203684832716283019655932542976 x1616)) x620) (<= 0 x1616)))
(define-fun x1317 ((x620 Real) (x548 Real)) Bool (and (x1015 x620) (x1696 x620) (x1087 x620 x548) (x817 x620) (x164 x620)))
(define-fun x1017 ((x620 Real) (x548 Real)) Bool (and (x1186 x620 1461501637330902918203684832716283019655932542975) (x1317 x620 x548)))
(define-fun x1425 ((x620 Real)) Bool (= (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 x620)) (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 x620)))
(define-fun x26 ((x620 Real)) Bool (=> (and (> 57896044618658097711785492504343953926634992332820282019728792003956564819968 x620) (<= 0 x620)) (= x620 (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 x620))))
(define-fun x1563 ((x620 Real)) Bool (=> (= (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 x620) x620) (and (<= 0 x620) (< x620 57896044618658097711785492504343953926634992332820282019728792003956564819968))))
(define-fun x1158 ((x620 Real)) Bool (=> (and (<= 57896044618658097711785492504343953926634992332820282019728792003956564819968 x620) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 x620)) (= (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 x620) (- x620 57896044618658097711785492504343953926634992332820282019728792003956564819968))))
(define-fun x788 ((x620 Real) (x1616 Real)) Bool (and (= x620 (+ (x259 57896044618658097711785492504343953926634992332820282019728792003956564819967 x620) (* x1616 57896044618658097711785492504343953926634992332820282019728792003956564819968))) (<= 0 x1616)))
(define-fun x1071 ((x620 Real) (x548 Real)) Bool (and (x26 x620) (x1425 x620) (x1563 x620) (x788 x620 x548) (x1158 x620)))
(define-fun x427 ((x620 Real) (x548 Real)) Bool (and (x1186 x620 57896044618658097711785492504343953926634992332820282019728792003956564819967) (x1071 x620 x548)))
(define-fun x760 ((x620 Real)) Bool (= (x259 115792089237316195423570985007226406215939081747436879206741300988257197096960 x620) (x259 115792089237316195423570985007226406215939081747436879206741300988257197096960 (x259 115792089237316195423570985007226406215939081747436879206741300988257197096960 x620))))
(define-fun x275 ((x620 Real)) Bool (=> (and (> 1461501637330902918203684832716283019655932542976 x620) (<= 0 x620)) (= 0 (x259 115792089237316195423570985007226406215939081747436879206741300988257197096960 x620))))
(define-fun x499 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (= x620 (+ x1616 (* x1385 1461501637330902918203684832716283019655932542976) (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x820))) (<= 0 x820) (= (x259 115792089237316195423570985007226406215939081747436879206741300988257197096960 x620) (* 1461501637330902918203684832716283019655932542976 x1385)) (<= 0 x1616) (< x820 1) (> 1461501637330902918203684832716283019655932542976 x1616) (>= x1385 0) (> 79228162514264337593543950336 x1385)))
(define-fun x560 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x499 x620 x530 x1298 x611) (x275 x620) (x760 x620)))
(define-fun x66 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x1186 x620 115792089237316195423570985007226406215939081747436879206741300988257197096960) (x560 x620 x530 x1298 x611)))
(define-fun x123 ((x620 Real)) Bool (= (x259 115792089210356248756420345215482394403581256910207104449633294546465451933695 (x259 115792089210356248756420345215482394403581256910207104449633294546465451933695 x620)) (x259 115792089210356248756420345215482394403581256910207104449633294546465451933695 x620)))
(define-fun x140 ((x620 Real)) Bool (=> (and (<= 0 x620) (< x620 1461501637330902918203684832716283019655932542976)) (= (x259 115792089210356248756420345215482394403581256910207104449633294546465451933695 x620) x620)))
(define-fun x1610 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (< x1616 1461501637330902918203684832716283019655932542976) (<= 0 x820) (= (+ (* 1461501637330902918203684832716283019655932542976 x1385) x1616 (* 26959946667150639794667015087019630673637144422540572481103610249216 x820)) x620) (>= x1616 0) (>= x1385 0) (< x1385 18446744073709551616) (> 4294967296 x820) (= (+ (* x820 26959946667150639794667015087019630673637144422540572481103610249216) x1616) (x259 115792089210356248756420345215482394403581256910207104449633294546465451933695 x620))))
(define-fun x961 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x140 x620) (x1610 x620 x530 x1298 x611) (x123 x620)))
(define-fun x135 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x961 x620 x530 x1298 x611) (x1186 x620 115792089210356248756420345215482394403581256910207104449633294546465451933695)))
(define-fun x1206 ((x620 Real)) Bool (= (x259 26959946667150639793205513449688727755433459589824289461447677706240 x620) (x259 26959946667150639793205513449688727755433459589824289461447677706240 (x259 26959946667150639793205513449688727755433459589824289461447677706240 x620))))
(define-fun x1472 ((x620 Real)) Bool (=> (and (> 1461501637330902918203684832716283019655932542976 x620) (>= x620 0)) (= 0 (x259 26959946667150639793205513449688727755433459589824289461447677706240 x620))))
(define-fun x186 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (= x620 (+ (* x820 26959946667150639794667015087019630673637144422540572481103610249216) x1616 (* 1461501637330902918203684832716283019655932542976 x1385))) (>= x1385 0) (>= x820 0) (> 18446744073709551616 x1385) (< x1616 1461501637330902918203684832716283019655932542976) (> 4294967296 x820) (= (* x1385 1461501637330902918203684832716283019655932542976) (x259 26959946667150639793205513449688727755433459589824289461447677706240 x620)) (<= 0 x1616)))
(define-fun x1242 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x1206 x620) (x1472 x620) (x186 x620 x530 x1298 x611)))
(define-fun x383 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x1186 x620 26959946667150639793205513449688727755433459589824289461447677706240) (x1242 x620 x530 x1298 x611)))
(define-fun x838 ((x620 Real)) Bool (= (x259 26959946667150639794667015087019630673637144422540572481103610249215 (x259 26959946667150639794667015087019630673637144422540572481103610249215 x620)) (x259 26959946667150639794667015087019630673637144422540572481103610249215 x620)))
(define-fun x1312 ((x620 Real)) Bool (=> (and (> 26959946667150639794667015087019630673637144422540572481103610249216 x620) (>= x620 0)) (= (x259 26959946667150639794667015087019630673637144422540572481103610249215 x620) x620)))
(define-fun x534 ((x620 Real)) Bool (=> (= (x259 26959946667150639794667015087019630673637144422540572481103610249215 x620) x620) (and (< x620 26959946667150639794667015087019630673637144422540572481103610249216) (>= x620 0))))
(define-fun x861 ((x620 Real)) Bool (=> (and (< x620 53919893334301279589334030174039261347274288845081144962207220498432) (>= x620 26959946667150639794667015087019630673637144422540572481103610249216)) (= (- x620 26959946667150639794667015087019630673637144422540572481103610249216) (x259 26959946667150639794667015087019630673637144422540572481103610249215 x620))))
(define-fun x1676 ((x620 Real) (x1616 Real)) Bool (and (= (+ (x259 26959946667150639794667015087019630673637144422540572481103610249215 x620) (* x1616 26959946667150639794667015087019630673637144422540572481103610249216)) x620) (<= 0 x1616)))
(define-fun x1638 ((x620 Real) (x548 Real)) Bool (and (x1676 x620 x548) (x861 x620) (x838 x620) (x1312 x620) (x534 x620)))
(define-fun x1241 ((x620 Real) (x548 Real)) Bool (and (x1186 x620 26959946667150639794667015087019630673637144422540572481103610249215) (x1638 x620 x548)))
(define-fun x586 ((x620 Real)) Bool (= (x259 115792089237316195423570984636004990333889740523700931696805413995650331181055 (x259 115792089237316195423570984636004990333889740523700931696805413995650331181055 x620)) (x259 115792089237316195423570984636004990333889740523700931696805413995650331181055 x620)))
(define-fun x1069 ((x620 Real)) Bool (=> (and (>= x620 0) (< x620 1461501637330902918203684832716283019655932542976)) (= (x259 115792089237316195423570984636004990333889740523700931696805413995650331181055 x620) x620)))
(define-fun x344 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (= (+ x1616 (* 374144419156711147060143317175368453031918731001856 x820) (* x1385 1461501637330902918203684832716283019655932542976)) x620) (> 256 x1385) (>= x820 0) (<= 0 x1385) (> 309485009821345068724781056 x820) (<= 0 x1616) (> 1461501637330902918203684832716283019655932542976 x1616) (= (x259 115792089237316195423570984636004990333889740523700931696805413995650331181055 x620) (+ x1616 (* 374144419156711147060143317175368453031918731001856 x820)))))
(define-fun x458 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x586 x620) (x1069 x620) (x344 x620 x530 x1298 x611)))
(define-fun x1231 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x458 x620 x530 x1298 x611) (x1186 x620 115792089237316195423570984636004990333889740523700931696805413995650331181055)))
(define-fun x378 ((x620 Real)) Bool (= (x259 372682917519380244141939632342652170012262798458880 x620) (x259 372682917519380244141939632342652170012262798458880 (x259 372682917519380244141939632342652170012262798458880 x620))))
(define-fun x1335 ((x620 Real)) Bool (=> (and (> 1461501637330902918203684832716283019655932542976 x620) (>= x620 0)) (= 0 (x259 372682917519380244141939632342652170012262798458880 x620))))
(define-fun x1694 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (> 1461501637330902918203684832716283019655932542976 x1616) (= x620 (+ (* 374144419156711147060143317175368453031918731001856 x820) (* 1461501637330902918203684832716283019655932542976 x1385) x1616)) (>= x1616 0) (< x820 309485009821345068724781056) (= (* 1461501637330902918203684832716283019655932542976 x1385) (x259 372682917519380244141939632342652170012262798458880 x620)) (<= 0 x820) (< x1385 256) (>= x1385 0)))
(define-fun x1078 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x378 x620) (x1694 x620 x530 x1298 x611) (x1335 x620)))
(define-fun x449 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x1078 x620 x530 x1298 x611) (x1186 x620 372682917519380244141939632342652170012262798458880)))
(define-fun x243 ((x620 Real)) Bool (= (x259 115792089210356248756420345214020892766250353992003419616917011526809519390720 x620) (x259 115792089210356248756420345214020892766250353992003419616917011526809519390720 (x259 115792089210356248756420345214020892766250353992003419616917011526809519390720 x620))))
(define-fun x25 ((x620 Real)) Bool (=> (and (<= 0 x620) (< x620 26959946667150639794667015087019630673637144422540572481103610249216)) (= 0 (x259 115792089210356248756420345214020892766250353992003419616917011526809519390720 x620))))
(define-fun x364 ((x620 Real) (x1616 Real) (x1385 Real) (x820 Real)) Bool (and (< x1616 26959946667150639794667015087019630673637144422540572481103610249216) (>= x1616 0) (<= 0 x820) (<= 0 x1385) (> 1 x820) (< x1385 4294967296) (= (* 26959946667150639794667015087019630673637144422540572481103610249216 x1385) (x259 115792089210356248756420345214020892766250353992003419616917011526809519390720 x620)) (= x620 (+ (* x820 115792089237316195423570985008687907853269984665640564039457584007913129639936) (* 26959946667150639794667015087019630673637144422540572481103610249216 x1385) x1616))))
(define-fun x1052 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x25 x620) (x364 x620 x530 x1298 x611) (x243 x620)))
(define-fun x796 ((x620 Real) (x530 Real) (x1298 Real) (x611 Real)) Bool (and (x1052 x620 x530 x1298 x611) (x1186 x620 115792089210356248756420345214020892766250353992003419616917011526809519390720)))
(define-fun x948 ((x1163 Real)) Real (x542 x1163))
(define-fun x1455 ((x1163 x1134)) Real (ite (= (x428 x1003) x1163) x148 (x1261 x1163)))
(define-fun x565 ((x1163 x1134)) Real (ite (= (x428 274184521717934524641157099916833587240) x1163) x18 (x1455 x1163)))
(define-fun x1062 ((x1163 Real)) Real (ite (= x1163 128) x921 (x476 x1163)))
(define-fun x696 ((x1163 Real)) Real (ite (and (>= x1163 160) (< x1163 (+ x921 160))) (x542 (+ (- x1163 160) x1663)) (x1062 x1163)))
(define-fun x569 ((x1163 Real)) Real (ite (= x1163 x267) 0 (x696 x1163)))
(define-fun x424 ((x1163 Real)) Real (ite (= x1107 x1163) x405 (x569 x1163)))
(define-fun x899 ((x1163 Real)) Real (ite (= x1036 x1163) x1428 (x424 x1163)))
(define-fun x1503 ((x1163 Real)) Real (ite (= x1163 x825) x260 (x899 x1163)))
(define-fun x1167 ((x1163 Real)) Real (ite (= x1163 x1395) x650 (x1503 x1163)))
(define-fun x758 ((x1163 Real)) Real (ite (= x57 x1163) x871 (x1167 x1163)))
(define-fun x724 ((x1163 Real)) Real (ite (= x1163 x674) x105 (x758 x1163)))
(define-fun x1006 ((x1163 Real)) Real (ite (= x824 x1163) x686 (x724 x1163)))
(define-fun x628 ((x1163 Real)) Real (ite (= x1163 x1329) x52 (x1006 x1163)))
(define-fun x176 ((x1163 Real)) Real (ite (= x1163 x614) x1438 (x628 x1163)))
(define-fun x903 ((x1163 Real)) Real (ite (= x1163 x1392) x795 (x176 x1163)))
(define-fun x35 ((x1163 Real)) Real (ite (= x1163 x559) (ite true 1 0) (x903 x1163)))
(define-fun x567 ((x1163 x1134)) Real (ite (= x1163 x1525) x433 (x810 x1163)))
(define-fun x774 ((x1163 Real)) Real (ite (= x1068 x1163) x405 (x35 x1163)))
(define-fun x22 ((x1163 Real)) Real (ite (= x1611 x1163) x1428 (x774 x1163)))
(define-fun x791 ((x1163 Real)) Real (ite (= x309 x1163) x1215 (x22 x1163)))
(define-fun x456 ((x1163 Real)) Real (ite (= x1163 x1413) x1609 (x791 x1163)))
(define-fun x826 ((x1163 Real)) Real (ite (= x206 x1163) x1576 (x456 x1163)))
(define-fun x1734 ((x1163 Real)) Real (ite (= x1163 x1632) x1111 (x826 x1163)))
(define-fun x801 ((x1163 Real)) Real (ite (= x1163 x1327) x764 (x1734 x1163)))
(define-fun x967 ((x1163 Real)) Real (ite (= x1161 x1163) x1588 (x801 x1163)))
(define-fun x827 ((x1163 Real)) Real (ite (= x1163 x1160) x1442 (x967 x1163)))
(define-fun x121 ((x1163 Real)) Real (ite (= x1163 x1687) x387 (x827 x1163)))
(define-fun x1625 ((x1163 Real)) Real (ite (= x480 x1163) 11430537079145650693387304458692941425836787954612963690241153482819318579200 (x121 x1163)))
(define-fun x1722 ((x1163 Real)) Real (ite (= x1163 x1297) x108 (x1625 x1163)))
(define-fun x828 ((x1163 Real)) Real (ite (= x1163 x328) 0 (x212 x1163)))
(define-fun x681 ((x1163 Real)) Real (ite (= x1624 x1163) x507 (x828 x1163)))
(define-fun x1211 ((x1163 Real)) Real (ite (= x1163 x640) x1551 (x681 x1163)))
(define-fun x740 ((x1163 Real)) Real (ite (= x692 x1163) x1028 (x1211 x1163)))
(define-fun x169 ((x1163 Real)) Real (ite (= x1155 x1163) x1595 (x740 x1163)))
(define-fun x1723 ((x1163 Real)) Real (ite (= 0 x1163) x553 (x1259 x1163)))
(define-fun x779 ((x1163 Real)) Real (ite (= x1453 x1163) x553 (x169 x1163)))
(define-fun x118 ((x1163 Real)) Real (ite (= x1163 x328) 0 (x212 x1163)))
(define-fun x1195 ((x1163 Real)) Real (ite (= x850 x1163) x507 (x118 x1163)))
(define-fun x1072 ((x1163 Real)) Real (ite (= x1600 x1163) x182 (x1195 x1163)))
(define-fun x1682 ((x1163 Real)) Real (ite (= x1163 x1549) x502 (x1072 x1163)))
(define-fun x1517 ((x1163 Real)) Real (ite (= x1163 x1657) x892 (x1682 x1163)))
(define-fun x964 ((x1163 Real)) Real (ite (= x1163 0) x615 (x698 x1163)))
(define-fun x314 ((x1163 Real)) Real (ite (= x197 x1163) x615 (x1517 x1163)))
(define-fun x1251 ((x1163 Real)) Real (ite (and (not x1622) x1718 x1146) (ite (and (not x1113) x1146 (not x1575) (not x192) x1718 (not x1622)) (x779 x1163) (ite (and x1718 (not x1113) x1146 (not x1575) (not x1622) x192) (x779 x1163) (x212 x1163))) (ite (and x1718 x55 (not x1622) (not x1146)) (ite (and (not x1622) (not x385) (not x941) x1718 x55 (not x618) (not x1146)) (x314 x1163) (ite (and (not x941) x1718 (not x1146) (not x1622) (not x618) x385 x55) (x314 x1163) (x212 x1163))) (x212 x1163))))
(define-fun x240 ((x1163 x1134)) Real (ite (= x1163 x544) x922 (x567 x1163)))
(define-fun x94 ((x1163 x1134)) Real (ite (= x1163 x1417) x884 (x240 x1163)))
(define-fun x1399 ((x1163 x1134)) Real (ite (= x1118 x1163) x800 (x94 x1163)))
(define-fun x1684 ((x1163 x1134)) Real (ite (= x1163 x1032) x1570 (x1399 x1163)))
(define-fun x1264 ((x1163 x1134)) Real (ite (= x1163 x923) x29 (x1684 x1163)))
(define-fun x990 ((x1163 x1134)) Real (ite (= x923 x1163) x1683 (x1264 x1163)))
(define-fun x564 ((x1163 x1134)) Real (ite (= x1163 x1044) x619 (x990 x1163)))
(define-fun x290 ((x1163 x1134)) Real (ite (= x1163 x1044) x563 (x564 x1163)))
(define-fun x1381 ((x1163 x1134)) Real (ite (= x1163 x1044) x989 (x290 x1163)))
(define-fun x578 ((x1163 x1134)) Real (ite (= x49 x1163) x1667 (x1381 x1163)))
(define-fun x1012 ((x1163 x1134)) Real (ite (= x1163 x49) x958 (x578 x1163)))
(define-fun x666 ((x1163 Real)) Real (ite (= x600 x1163) 904250603428552709895185118199468575982109441609966099573332780532423983104 (x1251 x1163)))
(define-fun x1286 ((x1163 Real)) Real (ite (and (>= x1163 x600) (< x1163 (+ x600 32))) (x165 (+ 0 (- x1163 x600))) (x274 x1163)))
(define-fun x1243 ((x1163 x1134)) Real (ite (= x1163 x496) x541 (x1176 x1163)))
(define-fun x1598 ((x1163 x1134)) Real (ite (= x1163 x221) x1238 (x1243 x1163)))
(define-fun x1208 ((x1163 x1134)) Real (ite (= x310 x1163) x171 (x1598 x1163)))
(define-fun x395 ((x1163 x1134)) Real (ite (= x1049 x1163) x73 (x1208 x1163)))
(define-fun x1585 ((x1163 x1134)) Real (ite x68 (ite (and x831 x285) (x395 x1163) (x1176 x1163)) (x1176 x1163)))
(define-fun x988 ((x1163 x1134)) Real (ite (= x1163 x1041) x511 (x1585 x1163)))
(define-fun x175 ((x1163 x1134)) Real (ite (= x1282 x1163) x204 (x1025 x1163)))
(define-fun x284 ((x1163 x1134)) Real (ite (= x1163 x1629) x962 (x175 x1163)))
(define-fun x31 ((x1163 x1134)) Real (ite (= x1163 x1511) x1543 (x284 x1163)))
(define-fun x1240 ((x1163 x1134)) Real (ite (= x1639 x1163) x584 (x31 x1163)))
(define-fun x337 ((x1163 x1134)) Real (ite (and x384 x1618) (x1240 x1163) (x1025 x1163)))
(define-fun x875 ((x1163 x1134)) Real (ite x479 (ite x124 (x337 x1163) (x1025 x1163)) (x1025 x1163)))
(define-fun x493 ((x1163 x1134)) Real (ite x1339 (x875 x1163) (x810 x1163)))
(define-fun x1065 ((x1163 Real)) Real (ite (= x1343 x1163) 16156842317565293874272834530371880720966471053262404558597773956279093428224 (x859 x1163)))
(define-fun x955 ((x1163 Real)) Real (ite (= x1163 x1301) x415 (x1065 x1163)))
(define-fun x1347 ((x1163 Real)) Real (ite (= x716 x1163) 274184521717934524641157099916833587240 (x955 x1163)))
(define-fun x822 ((x1163 Real)) Real (ite (= x1343 x1163) x306 (x669 x1163)))
(define-fun x414 ((x1163 Real)) Real (ite (= x1163 x1343) x1033 (x669 x1163)))
(define-fun x242 ((x1163 Real)) Real (ite (= x1163 x1343) 109576784812748834340197573905731726730118698833493337707389013487240318287872 (x859 x1163)))
(define-fun x1182 ((x1163 Real)) Real (ite (= x1668 x1163) x244 (x242 x1163)))
(define-fun x1512 ((x1163 Real)) Real (ite (= x1603 x1163) 274184521717934524641157099916833587240 (x1182 x1163)))
(define-fun x226 ((x1163 Real)) Real (ite (= x1163 x1606) x1004 (x1512 x1163)))
(define-fun x1709 ((x1163 Real)) Real (ite (= x1163 x1558) x1265 (x226 x1163)))
(define-fun x17 ((x1163 Real)) Real (ite (= x1491 x1163) 160 (x1709 x1163)))
(define-fun x735 ((x1163 Real)) Real (ite (and (> (+ x1343 0) x1163) (<= x1343 x1163)) (x725 (+ (- x1163 x1343) 0)) (x1352 x1163)))
(define-fun x1057 ((x1163 Real)) Real (ite x68 (ite (and x285 x831) (x669 x1163) (ite (and x1247 x723) (x822 x1163) (x414 x1163))) (ite (and (not x570) x1514 x1739) (x735 x1163) (x1352 x1163))))
(define-fun x609 ((x1163 x1134)) Real (ite (= x965 x1163) x412 (x13 x1163)))
(define-fun x1199 ((x1163 x1134)) Real (ite (= x1163 x329) x311 (x609 x1163)))
(define-fun x492 ((x1163 x1134)) Real (ite x68 (ite (and x285 x831) (x13 x1163) (ite (and x1247 x723) (x13 x1163) (x1199 x1163))) (ite (and (not x570) x1514 x1739) (x1212 x1163) (x13 x1163))))
(define-fun x785 ((x1163 x1134)) Real (ite (= x1163 x1224) x819 (x879 x1163)))
(define-fun x1013 ((x1163 x1134)) Real (ite x68 (ite (and x831 x285) (x879 x1163) (ite (and x1247 x723) (x879 x1163) (x785 x1163))) (ite (and x1514 (not x570) x1739) (x1119 x1163) (x879 x1163))))
(define-fun x1177 ((x1163 x1134)) Real (ite (= x1163 x379) x637 (x1336 x1163)))
(define-fun x217 ((x1163 x1134)) Real (ite (= x1163 x1328) x1117 (x1177 x1163)))
(define-fun x1662 ((x1163 x1134)) Real (ite x68 (ite (and x831 x285) (x1336 x1163) (ite (and x723 x1247) (x217 x1163) (x1336 x1163))) (ite (and x1739 (not x570) x1514) (x95 x1163) (x1336 x1163))))
(define-fun x305 ((x1163 x1134)) Real (ite (= x1524 x1163) x1019 (x1487 x1163)))
(define-fun x759 ((x1163 x1134)) Real (ite x68 (ite (and x285 x831) (x1487 x1163) (ite (and x723 x1247) (x305 x1163) (x1487 x1163))) (ite (and (not x570) x1739 x1514) (x1405 x1163) (x1487 x1163))))
(define-fun x1507 ((x1163 x1134)) Real (ite x68 (x565 x1163) (ite (and x1739 (not x570) x1514) (x1 x1163) (x565 x1163))))
(define-fun x93 ((x1163 Real)) Real (ite (= x1163 x915) 9518847204935358166548570266051330015907116135037852959641967396525866745856 (x904 x1163)))
(define-fun x1707 ((x1163 Real)) Real (ite (= x1163 x1097) x64 (x93 x1163)))
(define-fun x775 ((x1163 Real)) Real (ite (= x191 x1163) 0 (x1707 x1163)))
(define-fun x504 ((x1163 Real)) Real (ite (= x294 x1163) x256 (x775 x1163)))
(define-fun x1110 ((x1163 Real)) Real (ite (= x295 x1163) 128 (x504 x1163)))
(define-fun x714 ((x1163 Real)) Real (ite (= x1163 x1590) x1700 (x40 x1163)))
(define-fun x654 ((x1163 Real)) Real (ite (= x1276 x1163) 0 (x288 x1163)))
(define-fun x1702 ((x1163 Real)) Real (ite (and (> (+ 32 x915) x1163) (>= x1163 x915)) (x1411 (+ 0 (- x1163 x915))) (x1256 x1163)))
(define-fun x1058 ((x1163 Real)) Real (ite (and x906 x1104 x10) (x1702 x1163) (x1256 x1163)))
(define-fun x469 ((x1163 Real)) Real (ite (= x1612 x1163) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x1077 x1163)))
(define-fun x1066 ((x1163 Real)) Real (ite (= 0 x1163) x1704 (x1103 x1163)))
(define-fun x1169 ((x1163 Real)) Real (ite (= x1163 x1612) x1704 (x652 x1163)))
(define-fun x1204 ((x1163 Real)) Real (ite (= x1612 x1163) x1164 (x652 x1163)))
(define-fun x780 ((x1163 Real)) Real (ite (= x1612 x1163) x162 (x652 x1163)))
(define-fun x1175 ((x1163 Real)) Real (ite (and x1669 x1649) (x1169 x1163) (ite (and x1011 x1325) (x1204 x1163) (x780 x1163))))
(define-fun x361 ((x1163 Real)) Real (ite x347 (x1175 x1163) (x1077 x1163)))
(define-fun x1257 ((x1163 Real)) Real (ite (= x1163 x881) 34167655436598589418538772692774877509225721125679165766806516059628562808832 (x361 x1163)))
(define-fun x581 ((x1163 Real)) Real (ite (= x1163 x517) x59 (x1257 x1163)))
(define-fun x646 ((x1163 Real)) Real (ite (and (<= x881 x1163) (> (+ x881 0) x1163)) (x996 (+ (- x1163 x881) 0)) (x473 x1163)))
(define-fun x745 ((x1163 Real)) Real (ite (= x881 x1163) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x1448 x1163)))
(define-fun x1271 ((x1163 Real)) Real (ite (= 0 x1163) x1443 (x209 x1163)))
(define-fun x157 ((x1163 Real)) Real (ite (= x1163 x881) x1443 (x200 x1163)))
(define-fun x1061 ((x1163 Real)) Real (ite (= x1593 x1163) x370 (x1077 x1163)))
(define-fun x1555 ((x1163 Real)) Real (ite (= x1163 x1621) 274184521717934524641157099916833587240 (x1061 x1163)))
(define-fun x149 ((x1163 Real)) Real (ite (= x1163 x255) x326 (x1555 x1163)))
(define-fun x695 ((x1163 Real)) Real (ite (= x1612 x1163) x891 (x149 x1163)))
(define-fun x1424 ((x1163 Real)) Real (ite (= x1163 x266) x455 (x695 x1163)))
(define-fun x335 ((x1163 Real)) Real (ite (= x807 x1163) 32 (x1424 x1163)))
(define-fun x1400 ((x1163 Real)) Real (ite (= x1163 x546) x1690 (x1605 x1163)))
(define-fun x778 ((x1163 Real)) Real (ite (= x783 x1163) 0 (x1360 x1163)))
(define-fun x325 ((x1163 x1134)) Real (ite (= (x428 274184521717934524641157099916833587240) x1163) x750 (x153 x1163)))
(define-fun x1132 ((x1163 x1134)) Real (ite (= x1163 (x428 x1658)) x782 (x325 x1163)))
(define-fun x333 ((x1163 x1134)) Real (ite (= (x428 x1658) x1163) x1314 (x1132 x1163)))
(define-fun x719 ((x1163 x1134)) Real (ite (= (x428 274184521717934524641157099916833587240) x1163) x855 (x333 x1163)))
(define-fun x1216 ((x1163 x1134)) Real (ite (and x751 x481) (x1000 x1163) (x153 x1163)))
(define-fun x1067 ((x1163 Real)) Real (ite (= x1163 x1088) x1361 (x287 x1163)))
(define-fun x597 ((x1163 Real)) Real (ite (= x1088 x1163) x231 (x287 x1163)))
(define-fun x170 ((x1163 Real)) Real (ite (= x1163 0) 1 (x589 x1163)))
(define-fun x1705 ((x1163 Real)) Real (ite (= 0 x1163) 1 (x589 x1163)))
(define-fun x872 ((x1163 Real)) Real (ite (and x384 x1618) (x589 x1163) (ite (and x1364 x1389) (x170 x1163) (x1705 x1163))))
(define-fun x120 ((x1163 Real)) Real (ite (= x1163 x1088) x1577 (x949 x1163)))
(define-fun x303 ((x1163 Real)) Real (ite (and (> (+ x1726 x1577) x1163) (<= x1726 x1163)) (x872 (+ 0 (- x1163 x1726))) (x120 x1163)))
(define-fun x1200 ((x1163 Real)) Real (ite (and x124 x1451) (x949 x1163) (x303 x1163)))
(define-fun x430 ((x1163 Real)) Real (ite (= x881 x1163) x158 (x200 x1163)))
(define-fun x3 ((x1163 Real)) Real (ite (= x1163 x881) x418 (x200 x1163)))
(define-fun x770 ((x1163 Real)) Real (ite (and x1533 x763) (x157 x1163) (ite (and x1304 x173) (x430 x1163) (x3 x1163))))
(define-fun x389 ((x1163 Real)) Real (ite x479 (ite x124 (x1200 x1163) (x1077 x1163)) (ite x994 (x770 x1163) (x1448 x1163))))
(define-fun x1340 ((x1163 x1134)) Real (ite (= x1163 x1220) x1154 (x1597 x1163)))
(define-fun x1552 ((x1163 x1134)) Real (ite (= x1163 x1628) x1123 (x1340 x1163)))
(define-fun x257 ((x1163 x1134)) Real (ite (and x384 x1618) (x1597 x1163) (ite (and x1364 x1389) (x1597 x1163) (x1552 x1163))))
(define-fun x552 ((x1163 x1134)) Real (ite (and x751 x481) (x1236 x1163) (x1597 x1163)))
(define-fun x1619 ((x1163 x1134)) Real (ite x479 (ite x124 (x257 x1163) (x1597 x1163)) (x552 x1163)))
(define-fun x950 ((x1163 x1134)) Real (ite (= x876 x1163) x180 (x951 x1163)))
(define-fun x848 ((x1163 x1134)) Real (ite (= x813 x1163) x92 (x950 x1163)))
(define-fun x1459 ((x1163 x1134)) Real (ite (and x384 x1618) (x951 x1163) (ite (and x1389 x1364) (x848 x1163) (x951 x1163))))
(define-fun x1198 ((x1163 x1134)) Real (ite (and x481 x751) (x713 x1163) (x951 x1163)))
(define-fun x533 ((x1163 x1134)) Real (ite x479 (ite x124 (x1459 x1163) (x951 x1163)) (x1198 x1163)))
(define-fun x48 ((x1163 x1134)) Real (ite (= x1163 (x428 274184521717934524641157099916833587240)) x743 (x65 x1163)))
(define-fun x521 ((x1163 x1134)) Real (ite (= (x428 x1090) x1163) x771 (x48 x1163)))
(define-fun x1654 ((x1163 x1134)) Real (ite (and (not x219) x1513 x439 x1741) (x726 x1163) (x521 x1163)))
(define-fun x1441 ((x1163 x1134)) Real (ite (= x1163 (x428 x1090)) x1116 (x1654 x1163)))
(define-fun x1496 ((x1163 Real)) Real (ite (= x1387 x1163) x270 (x389 x1163)))
(define-fun x1096 ((x1163 Real)) Real (ite (= x1163 x1350) x607 (x1496 x1163)))
(define-fun x997 ((x1163 Real)) Real (ite (= x214 x1163) x1162 (x1096 x1163)))
(define-fun x1217 ((x1163 Real)) Real (ite (= x1163 x463) x1311 (x997 x1163)))
(define-fun x1685 ((x1163 Real)) Real (ite (= x487 x1163) 32 (x1217 x1163)))
(define-fun x298 ((x1163 Real)) Real (ite (= x1163 x393) x319 (x1476 x1163)))
(define-fun x593 ((x1163 Real)) Real (ite (= x1163 x1290) 0 (x436 x1163)))
(define-fun x229 ((x1163 x1134)) Real (ite (and x906 x10) (ite (and x1104 x10 x906) (x936 x1163) (x759 x1163)) (x759 x1163)))
(define-fun x777 ((x1163 x1134)) Real (ite (and x906 x10) (ite (and x10 x1104 x906) (x1080 x1163) (x1013 x1163)) (x1013 x1163)))
(define-fun x913 ((x1163 x1134)) Real (ite (= (x428 274184521717934524641157099916833587240) x1163) x163 (x65 x1163)))
(define-fun x1295 ((x1163 x1134)) Real (ite (= x1163 (x428 x297)) x1509 (x913 x1163)))
(define-fun x447 ((x1163 x1134)) Real (ite (= x1332 x1163) x959 (x533 x1163)))
(define-fun x687 ((x1163 Real)) Real (ite (= x1163 0) 1 (x925 x1163)))
(define-fun x703 ((x1163 Real)) Real (ite (= x1522 x1163) x1124 (x562 x1163)))
(define-fun x1149 ((x1163 Real)) Real (ite (= x1163 0) 1 (x488 x1163)))
(define-fun x1060 ((x1163 Real)) Real (ite (= x1163 0) 1 (x488 x1163)))
(define-fun x721 ((x1163 Real)) Real (ite (= x1163 0) x162 (x1103 x1163)))
(define-fun x63 ((x1163 Real)) Real (ite (= 0 x1163) x1164 (x1103 x1163)))
(define-fun x1712 ((x1163 Real)) Real (ite (= 0 x1163) x418 (x209 x1163)))
(define-fun x823 ((x1163 Real)) Real (ite (= x1163 0) x158 (x209 x1163)))
(define-fun x675 ((x1163 x1134)) Real (ite (= x1163 x128) x1689 (x1619 x1163)))
(define-fun x1354 ((x1163 Real)) Real (ite (= x1163 0) 1 (x925 x1163)))
(define-fun x1022 ((x1163 Real)) Real (ite (= x1522 x1163) x694 (x562 x1163)))
(define-fun x1355 ((x1163 Real)) Real (ite (and x1391 x1406) (x687 x1163) (x1354 x1163)))
(define-fun x1568 ((x1163 x1134)) Real (ite (= x1163 (x428 x297)) x684 (x1295 x1163)))
(define-fun x1407 ((x1163 Real)) Real (ite (= x1163 x1522) x880 (x901 x1163)))
(define-fun x1127 ((x1163 Real)) Real (ite (and (< x1163 (+ x691 x880)) (>= x1163 x691)) (x1355 (+ (- x1163 x691) 0)) (x1407 x1163)))
(define-fun x354 ((x1163 Real)) Real (ite (and x1369 x484) (x901 x1163) (x1127 x1163)))
(define-fun x852 ((x620 Real)) Bool (=> (and (not (= 599290589 x620)) (not (= 1889567281 x620)) (not (= 274184521717934524641157099916833587206 x620)) (not (= x620 274184521717934524641157099916833587202)) (not (= x620 57896044618658097711785492504343953926418782139537452191302581570759080747168)) (not (= 76450787359836037641860180984291677749980919077056822294353438043884394381312 x620)) (not (= x620 2311529814)) (not (= 904250603428552709895185118199468575982109441609966099573332780532423983104 x620)) (not (= x620 115792089237316195423570985007226406215939081747436879206741300988257197096960)) (not (= x620 115792089210356248756420345214020892766250353992003419616917011526809519390720)) (not (= x620 2835717307)) (not (= 404098525 x620)) (not (= 3155786881 x620)) (not (= x620 57896044618658097711785492504343953926634992332820282019728792003956564819967)) (not (= 1845821197 x620)) (not (= x620 5192296858534827628530496329220096)) (not (= 1858285468 x620)) (not (= 1461501637330902918203684832716283019655932542976 x620)) (not (= 26959946667150639794667015087019630673637144422540572481103610249216 x620)) (not (= 117300739 x620)) (not (= 2514000705 x620)) (not (= x620 455944412)) (not (= 115792089237316195423570984636004990333889740523700931696805413995650331181055 x620)) (not (= 1461501637330902918203684832716283019655932542975 x620)) (not (= x620 115792089237316195423570985008687907853269984665640564039457584007913129639908)) (not (= x620 115792089210356248756420345215482394403581256910207104449633294546465451933695)) (not (= x620 11430537079145650693387304458692941425836787954612963690241153482819318579200)) (not (= 115792089237316195423570985008687907853269984665640564039457584007913129639935 x620)) (not (= x620 2650021976)) (not (= 115792089237316195423570985008687907853269984665640564039457584007913129639680 x620)) (not (= x620 157198259)) (not (= 50942633119752846454219349998365661925608737367104304655302372697894809501696 x620)) (not (= 9518847204935358166548570266051330015907116135037852959641967396525866745856 x620)) (not (= x620 115792089237316195423570985008687907853269984665640564039457584007913129639934)) (not (= x620 98474297345890754025501882143967591664980152141971839855651084132735363579904)) (not (= x620 4294967296)) (not (= x620 109576784812748834340197573905731726730118698833493337707389013487240318287872)) (not (= x620 115792089237316195423570985008687907853269984665640564039457584007913129639904)) (not (= 274184521717934524641157099916833587240 x620)) (not (= 18446744073709551615 x620)) (not (= 826074471 x620)) (> x620 10000) (not (= 34167655436598589418538772692774877509225721125679165766806516059628562808832 x620)) (not (= 1166402363 x620)) (not (= 37714057306076988483118529490347679105585116642029194716945419020321082336612 x620)) (not (= x620 4294967295)) (not (= 2335792882 x620)) (not (= 26959946667150639794667015087019630673637144422540572481103610249215 x620)) (not (= x620 16156842317565293874272834530371880720966471053262404558597773956279093428224)) (not (= 511946350 x620)) (not (= x620 18446744073709551616)) (not (= x620 1722255204))) (not ((_ is x1584) (x428 x620)))))
(assert (axiom_frac_bound (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x37) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* 1461501637330902918203684832716283019655932542976 x851) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* x1215 x1428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* x710 26959946667150639794667015087019630673637144422540572481103610249216) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (ite x264 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (ite x38 1 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (x1455 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (x333 (x428 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 79228162514264337593543950336 x795 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x110 x514 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1215 x1428 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1265 x365 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x365 x1265 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x514 x110 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x686 79228162514264337593543950336 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x871 79228162514264337593543950336 (uninterp_frac (x48 (x428 x1090)) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 79228162514264337593543950336 x795 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x110 x514 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x1215 x1428 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x1265 x365 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x365 x1265 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x514 x110 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x686 79228162514264337593543950336 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_zero 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428 x871 79228162514264337593543950336 (uninterp_frac 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1428)))
(assert (axiom_frac_bound x1188 5192296858534827628530496329220096))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 79228162514264337593543950336 x795 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x110 x514 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x1215 x1428 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x1265 x365 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x365 x1265 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x514 x110 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x686 79228162514264337593543950336 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_zero x1188 5192296858534827628530496329220096 x871 79228162514264337593543950336 (uninterp_frac x1188 5192296858534827628530496329220096)))
(assert (axiom_frac_bound x446 100))
(assert (axiom_frac_zero x446 100 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 79228162514264337593543950336 x795 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x110 x514 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x1215 x1428 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x1265 x365 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x365 x1265 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x514 x110 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x686 79228162514264337593543950336 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac x446 100)))
(assert (axiom_frac_zero x446 100 x871 79228162514264337593543950336 (uninterp_frac x446 100)))
(assert (axiom_frac_bound x490 57896044618658097711785492504343953926634992332820282019728792003956564819968))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 79228162514264337593543950336 x795 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x110 x514 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x1215 x1428 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x1265 x365 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x365 x1265 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x514 x110 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x686 79228162514264337593543950336 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_zero x490 57896044618658097711785492504343953926634992332820282019728792003956564819968 x871 79228162514264337593543950336 (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)))
(assert (axiom_frac_bound x583 18446744073709551616))
(assert (axiom_frac_zero x583 18446744073709551616 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 79228162514264337593543950336 x795 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x110 x514 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x1215 x1428 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x1265 x365 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x365 x1265 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x514 x110 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x686 79228162514264337593543950336 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_zero x583 18446744073709551616 x871 79228162514264337593543950336 (uninterp_frac x583 18446744073709551616)))
(assert (axiom_frac_bound x942 452312848583266388373324160190187140051835877600158453279131187530910662656))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 1461501637330902918203684832716283019655932542976 x37 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 1461501637330902918203684832716283019655932542976 x851 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 79228162514264337593543950336 x795 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x110 x514 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x1215 x1428 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x1265 x365 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x365 x1265 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x514 x110 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x686 79228162514264337593543950336 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x710 26959946667150639794667015087019630673637144422540572481103610249216 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
(assert (axiom_frac_zero x942 452312848583266388373324160190187140051835877600158453279131187530910662656 x871 79228162514264337593543950336 (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)))
...
(assert (x550 x392))
(assert (=> (> (+ 10000 1) x518) (= (x1584 x518) (x428 x518))))
...
(assert (=> (< (- x909 1) 10000) (= (x1584 x909) (x428 x909))))
(assert (x550 x463))
(assert (x550 x756))
...
(assert (x550 x1327))
(assert (x550 x227))
(assert (=> (> (+ 10000 1) x1059) (= (x1584 x1059) (x428 x1059))))
...
(assert (x550 x112))
(assert (= 0 (x476 x491)))
(assert (=> (< (- x1434 1) 10000) (= (x1584 x1434) (x428 x1434))))
...
(assert (= (uninterp_mod (* x871 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (x1727 x871 96)))
(assert (x550 x1443))
...
(assert (=> (> (+ 10000 1) x437) (= (x428 x437) (x1584 x437))))
...
(assert (x571 x582))
(assert (=> (> (+ 10000 1) x1102) (= (x428 x1102) (x1584 x1102))))
...
(assert (=> (> (+ 10000 1) x1561) (= (x1584 x1561) (x428 x1561))))
(assert (x550 x196))
(assert (x550 x1383))
...
(assert (=> (> (+ 10000 1) x1090) (= (x428 x1090) (x1584 x1090))))
(assert (x550 x109))
(assert (x550 x1090))
(assert (= (x1727 x795 96) (uninterp_mod (* 79228162514264337593543950336 x795) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (x852 x656))
(assert (= (ite (= x805 x1580) 37714057306076988483118529490347679105585116642029194716945419020321082336612 (x335 x805)) (x82 x805)))
(assert (x550 x710))
(assert (x550 x268))
(assert (=> (> (+ 10000 1) x1008) (= (x428 x1008) (x1584 x1008))))
...
(assert (x550 x1102))
(assert (=> (> (+ 10000 1) x709) (= (x428 x709) (x1584 x709))))
...
(assert (x550 x1225))
(assert (x550 x1521))
(assert (=> (> (+ 10000 1) x256) (= (x1584 x256) (x428 x256))))
(assert (x571 x104))
(assert (x550 x1237))
...
(assert (x550 x995))
(assert (x550 x1490))
(assert (=> (> (+ 10000 1) x1027) (= (x1584 x1027) (x428 x1027))))
(assert (x571 x1337))
(assert (x550 x397))
(assert (x550 x1008))
(assert (x550 x388))
...
(assert (x550 x1192))
(assert (x550 x1500))
(assert (=> (< (- x871 1) 10000) (= (x1584 x871) (x428 x871))))
(assert (x550 x807))
...
(assert (x550 x174))
(assert (x550 x769))
(assert (=> (< (- x1415 1) 10000) (= (x1584 x1415) (x428 x1415))))
...
(assert (=> (> (+ 10000 1) x685) (= (x1584 x685) (x428 x685))))
...
(assert (x550 x1491))
(assert (x550 x1726))
(assert (=> (> (+ 10000 1) x262) (= (x428 x262) (x1584 x262))))
...
(assert (x550 x656))
(assert (x550 x159))
(assert (=> (> (+ 10000 1) x766) (= (x428 x766) (x1584 x766))))
...
(assert (=> (< (- x349 1) 10000) (= (x428 x349) (x1584 x349))))
...
(assert (x550 x472))
(assert (x550 x311))
(assert (=> (> (+ 10000 1) x656) (= (x428 x656) (x1584 x656))))
(assert (= (ite (= x76 x491) x706 (x772 x491)) (x1476 x491)))
(assert (=> (> (+ 10000 1) x547) (= (x1584 x547) (x428 x547))))
...
(assert (x550 x1736))
(assert (=> (> (+ 10000 1) x1658) (= (x428 x1658) (x1584 x1658))))
(assert (x550 x596))
...
(assert (=> (> (+ 10000 1) x1233) (= (x428 x1233) (x1584 x1233))))
...
(assert (x852 x547))
(assert (x550 x1291))
(assert (= (uninterp_mod (* x686 79228162514264337593543950336) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (x1727 x686 96)))
(assert (x550 x1183))
(assert (x550 x1033))
(assert (x550 x514))
(assert (x550 x1688))
...
(assert (=> (> (+ 10000 1) x841) (= (x1584 x841) (x428 x841))))
(assert (x550 x1438))
(assert (x550 x841))
...
(assert (x550 x975))
(assert (=> (< (- x799 1) 10000) (= (x1584 x799) (x428 x799))))
(assert (x550 x356))
...
(assert (=> (> (+ 10000 1) x1003) (= (x428 x1003) (x1584 x1003))))
...
(assert (x550 x563))
(assert (x550 x29))
(assert (=> (< (- x952 1) 10000) (= (x1584 x952) (x428 x952))))
...
(assert (x550 x881))
(assert (x550 x43))
(assert (= (- (/ x490 57896044618658097711785492504343953926634992332820282019728792003956564819968) (uninterp_frac x490 57896044618658097711785492504343953926634992332820282019728792003956564819968)) (x789 x490 255)))
(assert (= (ite (= x1374 x1343) 0 (x1057 x1374)) (x904 x1374)))
(assert (x550 x992))
(assert (= (ite (= x621 x143) x1226 (x82 x143)) (x1281 x143)))
(assert (=> (< (- x1180 1) 10000) (= (x1584 x1180) (x428 x1180))))
(assert (x550 x494))
(assert (x550 x156))
(assert (x571 x382))
...
(assert (x550 x197))
(assert (x550 x512))
(assert (=> (> (+ 10000 1) x16) (= (x428 x16) (x1584 x16))))
...
(assert (=> (< (- x107 1) 10000) (= (x428 x107) (x1584 x107))))
...
(assert (x550 x107))
(assert (=> (> (+ 10000 1) x795) (= (x1584 x795) (x428 x795))))
(assert (x550 x942))
(assert (=> (< (- x376 1) 10000) (= (x428 x376) (x1584 x376))))
(assert (x550 x368))
(assert (x550 x1530))
...
(assert (=> (< (- x1187 1) 10000) (= (x428 x1187) (x1584 x1187))))
(assert (x571 x798))
(assert (x550 x51))
...
(assert (=> (< (- x297 1) 10000) (= (x428 x297) (x1584 x297))))
...
(assert (=> (< (- x1725 1) 10000) (= (x1584 x1725) (x428 x1725))))
(assert (x852 x1232))
(assert (x550 x1442))
(assert (x550 x782))
(assert (= x1465 (and x1274 x291)))
(assert (x550 x340))
(assert (=> (< (- x1232 1) 10000) (= (x428 x1232) (x1584 x1232))))
...
(assert (= (- (/ x942 452312848583266388373324160190187140051835877600158453279131187530910662656) (uninterp_frac x942 452312848583266388373324160190187140051835877600158453279131187530910662656)) (x789 x942 248)))
...
(assert (=> (< (- x1594 1) 10000) (= (x428 x1594) (x1584 x1594))))
