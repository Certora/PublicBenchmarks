...
(declare-datatypes ((x199 0)) (((x1177 (x1279 x199) (x1452 x199) (x201 Real)) (x511 (x754 Real)) (x45 (x100 x199) (x605 Real)))))
...
(declare-fun x937 (x199) Real)
(declare-fun x1102 (x199) Real)
...
(declare-fun x317 (Real Real) Real)
...
(declare-fun x475 (Real Real) Real)
...
(define-fun x904 ((x199 x199) (x882 Real)) x199 (ite ((_ is x45) x199) (x45 (x100 x199) (+ (x605 x199) x882)) (ite ((_ is x1177) x199) (x1177 (x1279 x199) (x1452 x199) (+ x882 (x201 x199))) (x511 (+ (x754 x199) x882)))))
(define-fun x808 ((x448 Real)) Real (ite (and (>= x448 0) (< x448 115792089237316195423570985008687907853269984665640564039457584007913129639936)) x448 (- x448 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x212 ((x448 Real)) Real (ite (and (< x448 0) (>= x448 (- 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (+ x448 115792089237316195423570985008687907853269984665640564039457584007913129639936) x448))
(define-fun x891 ((x643 Real)) Bool (and (>= x643 0) (< x643 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x1527 ((x643 Real)) Bool (and (= x643 (x317 x643 115792089237316195423570985008687907853269984665640564039457584007913129639935)) (= x643 (x317 115792089237316195423570985008687907853269984665640564039457584007913129639935 x643))))
(define-fun x527 ((x643 Real)) Bool (and (= (x317 0 x643) 0) (= 0 (x317 x643 0))))
(define-fun x478 ((x643 Real)) Bool (= x643 (x317 x643 x643)))
(define-fun x1003 ((x643 Real)) Bool (and (x527 x643) (x478 x643) (x1527 x643)))
(define-fun x1107 ((x643 Real)) Bool (= (x317 1461501637330902918203684832716283019655932542975 x643) (x317 1461501637330902918203684832716283019655932542975 (x317 1461501637330902918203684832716283019655932542975 x643))))
(define-fun x460 ((x643 Real)) Bool (=> (and (< x643 1461501637330902918203684832716283019655932542976) (>= x643 0)) (= (x317 1461501637330902918203684832716283019655932542975 x643) x643)))
(define-fun x308 ((x643 Real)) Bool (=> (= (x317 1461501637330902918203684832716283019655932542975 x643) x643) (and (<= 0 x643) (> 1461501637330902918203684832716283019655932542976 x643))))
(define-fun x224 ((x643 Real)) Bool (=> (and (< x643 2923003274661805836407369665432566039311865085952) (>= x643 1461501637330902918203684832716283019655932542976)) (= (- x643 1461501637330902918203684832716283019655932542976) (x317 1461501637330902918203684832716283019655932542975 x643))))
(define-fun x1356 ((x643 Real) (x1329 Real)) Bool (and (= x643 (+ (* x1329 1461501637330902918203684832716283019655932542976) (x317 1461501637330902918203684832716283019655932542975 x643))) (<= 0 x1329)))
(define-fun x1531 ((x643 Real) (x604 Real)) Bool (and (x460 x643) (x1356 x643 x604) (x224 x643) (x1107 x643) (x308 x643)))
(define-fun x488 ((x643 Real) (x1329 Real)) Bool (= (x317 x643 x1329) (x317 x1329 x643)))
(define-fun x167 ((x643 Real) (x1329 Real)) Bool (and (=> (<= 0 x643) (<= (x317 x643 x1329) x643)) (>= (x317 x643 x1329) 0) (=> (>= x1329 0) (<= (x317 x643 x1329) x1329))))
(define-fun x360 ((x643 Real) (x1329 Real)) Bool (and (x167 x643 x1329) (x488 x643 x1329)))
(define-fun x705 ((x643 Real) (x604 Real)) Bool (and (x360 x643 1461501637330902918203684832716283019655932542975) (x1531 x643 x604)))
(define-fun x1591 ((x643 Real)) Bool (= (x317 26959946667150639794667015087019630673637144422540572481103610249215 x643) (x317 26959946667150639794667015087019630673637144422540572481103610249215 (x317 26959946667150639794667015087019630673637144422540572481103610249215 x643))))
(define-fun x1062 ((x643 Real)) Bool (=> (and (> 26959946667150639794667015087019630673637144422540572481103610249216 x643) (>= x643 0)) (= x643 (x317 26959946667150639794667015087019630673637144422540572481103610249215 x643))))
(define-fun x94 ((x643 Real)) Bool (=> (= (x317 26959946667150639794667015087019630673637144422540572481103610249215 x643) x643) (and (>= x643 0) (> 26959946667150639794667015087019630673637144422540572481103610249216 x643))))
(define-fun x303 ((x643 Real)) Bool (=> (and (< x643 53919893334301279589334030174039261347274288845081144962207220498432) (<= 26959946667150639794667015087019630673637144422540572481103610249216 x643)) (= (- x643 26959946667150639794667015087019630673637144422540572481103610249216) (x317 26959946667150639794667015087019630673637144422540572481103610249215 x643))))
(define-fun x115 ((x643 Real) (x1329 Real)) Bool (and (<= 0 x1329) (= x643 (+ (* x1329 26959946667150639794667015087019630673637144422540572481103610249216) (x317 26959946667150639794667015087019630673637144422540572481103610249215 x643)))))
(define-fun x1445 ((x643 Real) (x604 Real)) Bool (and (x1591 x643) (x115 x643 x604) (x1062 x643) (x303 x643) (x94 x643)))
(define-fun x1011 ((x643 Real) (x604 Real)) Bool (and (x1445 x643 x604) (x360 x643 26959946667150639794667015087019630673637144422540572481103610249215)))
(define-fun x598 ((x643 Real)) Bool (= (x317 115792089237316195423570985008687907853269984665640564039457584007913129639904 x643) (x317 115792089237316195423570985008687907853269984665640564039457584007913129639904 (x317 115792089237316195423570985008687907853269984665640564039457584007913129639904 x643))))
(define-fun x1333 ((x643 Real)) Bool (=> (and (<= 0 x643) (> 32 x643)) (= (x317 115792089237316195423570985008687907853269984665640564039457584007913129639904 x643) 0)))
(define-fun x682 ((x643 Real) (x1329 Real) (x601 Real) (x1209 Real)) Bool (and (<= 0 x1209) (< x1209 1) (= (* x601 32) (x317 115792089237316195423570985008687907853269984665640564039457584007913129639904 x643)) (= (+ (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1209) x1329 (* 32 x601)) x643) (< x1329 32) (>= x601 0) (< x601 3618502788666131106986593281521497120414687020801267626233049500247285301248) (>= x1329 0)))
(define-fun x1431 ((x643 Real) (x1058 Real) (x658 Real) (x667 Real)) Bool (and (x598 x643) (x1333 x643) (x682 x643 x1058 x658 x667)))
(define-fun x699 ((x643 Real) (x1058 Real) (x658 Real) (x667 Real)) Bool (and (x360 x643 115792089237316195423570985008687907853269984665640564039457584007913129639904) (x1431 x643 x1058 x658 x667)))
(define-fun x1084 ((x272 Real)) Real (x652 x272))
(define-fun x1009 ((x272 Real)) Real (ite (= x272 128) x526 (x984 x272)))
(define-fun x1301 ((x272 Real)) Real (ite (and (<= 160 x272) (< x272 (+ x1118 160))) (x652 (+ (- x272 160) x668)) (x1009 x272)))
(define-fun x1455 ((x272 Real)) Real (ite (= x463 x272) 0 (x1301 x272)))
(define-fun x873 ((x272 Real)) Real (ite (and (>= x272 x979) (> (+ x88 x979) x272)) (x652 (+ (- x272 x979) x1187)) (x219 x272)))
(define-fun x1426 ((x272 x199)) Real (ite (= x636 x272) x966 (x987 x272)))
(define-fun x174 ((x272 x199)) Real (ite (= x500 x272) x966 (x987 x272)))
(define-fun x1604 ((x272 x199)) Real (ite (= x1110 x272) x966 (x1063 x272)))
(define-fun x1217 ((x272 x199)) Real (ite (= x143 x272) x966 (x1063 x272)))
(define-fun x75 ((x272 x199)) Real (ite (and x398 x860) (x1063 x272) (ite (and x583 x592) (x987 x272) (ite (and (not x447) x344) (x1604 x272) (x1217 x272)))))
(define-fun x989 ((x272 x199)) Real (ite (= x272 x881) x966 (x1278 x272)))
(define-fun x994 ((x272 x199)) Real (ite (= x1498 x272) x966 (x1278 x272)))
(define-fun x1210 ((x272 x199)) Real (ite (= x272 x685) x966 (x1278 x272)))
(define-fun x684 ((x272 x199)) Real (ite (= x272 x6) x966 (x1387 x272)))
(define-fun x793 ((x272 x199)) Real (ite (= x272 x1215) x966 (x1387 x272)))
(define-fun x1500 ((x272 x199)) Real (ite (= x272 x1326) x966 (x1387 x272)))
(define-fun x279 ((x272 x199)) Real (ite (and x398 x860) (x1387 x272) (ite (and x583 x592) (x1278 x272) (ite (and (not x309) (not x378) x431) (x684 x272) (ite (and x431 (not x378) x309) (x793 x272) (x1500 x272))))))
(define-fun x1304 ((x272 x199)) Real (ite (= x272 x557) x405 (x125 x272)))
(define-fun x712 ((x272 x199)) Real (ite (= x272 x1231) x614 (x1167 x272)))
(define-fun x1467 ((x272 x199)) Real (ite (and (not x447) x344) (x712 x272) (x1167 x272)))
(define-fun x139 ((x272 x199)) Real (ite (and x860 x398) (x1167 x272) (ite (and x583 x592) (x125 x272) (x1467 x272))))
(define-fun x1020 ((x272 x199)) Real (ite (= x1263 x272) x144 (x1102 x272)))
(define-fun x282 ((x272 x199)) Real (ite (= x545 x272) x1260 (x121 x272)))
(define-fun x1295 ((x272 x199)) Real (ite (and (not x378) (not x309) x431) (x282 x272) (x121 x272)))
(define-fun x1023 ((x272 x199)) Real (ite (and x398 x860) (x121 x272) (ite (and x583 x592) (x1102 x272) (x1295 x272))))
(define-fun x1564 ((x272 x199)) Real (ite (= x272 x250) x902 (x1032 x272)))
(define-fun x1505 ((x272 x199)) Real (ite (= x795 x272) x759 (x99 x272)))
(define-fun x1332 ((x272 x199)) Real (ite (and x860 x398) (x1313 x272) (ite (and x592 x583) (x937 x272) (ite (and x1380 (not x822) x344 (not x141)) (x99 x272) (ite (and x344 (not x822) (not x1380)) (x1313 x272) (ite (and x822 x344) (x1313 x272) (x1505 x272)))))))
(define-fun x1512 ((x272 Real)) Real (ite (= x272 x975) x266 (x711 x272)))
(define-fun x34 ((x272 Real)) Real (ite (= x272 x706) x645 (x1512 x272)))
(define-fun x1143 ((x272 Real)) Real (ite (and x539 x171) (x711 x272) (x34 x272)))
(define-fun x241 ((x272 Real)) Real (ite (= x272 x290) x1470 (x1143 x272)))
(define-fun x595 ((x272 Real)) Real (ite (= x1270 x272) x1534 (x1159 x272)))
(define-fun x1360 ((x272 Real)) Real (ite (= x64 x272) x887 (x886 x272)))
(define-fun x359 ((x272 Real)) Real (ite (= x272 x82) x469 (x1360 x272)))
(define-fun x722 ((x272 Real)) Real (ite (and (not x309) x431 (not x378)) (x359 x272) (ite (and x431 (not x378) x309) (x359 x272) (x886 x272))))
(define-fun x481 ((x272 x199)) Real (ite (= x272 x629) x518 (x566 x272)))
(define-fun x1575 ((x272 x199)) Real (ite (and x151 x521) (x566 x272) (x481 x272)))
(define-fun x688 ((x272 x199)) Real (ite (= x272 x95) x486 (x200 x272)))
(define-fun x681 ((x272 x199)) Real (ite (and x539 x92) (x200 x272) (x688 x272)))
(define-fun x80 ((x272 Real)) Real (ite (= x853 x272) x1410 (x722 x272)))
(define-fun x1039 ((x272 Real)) Real (ite (= x84 x272) x927 (x504 x272)))
(define-fun x1241 ((x272 Real)) Real (ite (and x860 x398) (x886 x272) (ite (and x592 x583) (x711 x272) (ite (and x1380 x344 (not x141) (not x822)) (x504 x272) (ite (and (not x822) x344 (not x1380)) (x1610 x272) (ite (and x822 x344) (x1610 x272) (x1039 x272)))))))
(define-fun x1447 ((x272 Real)) Real (ite (= x272 x1570) x1014 (x1241 x272)))
(define-fun x726 ((x272 Real)) Real (ite (= x272 x102) x1567 (x1447 x272)))
(define-fun x117 ((x272 Real)) Real (ite (= x272 x948) x498 (x726 x272)))
(define-fun x1538 ((x272 Real)) Real (ite (= x220 x272) x1484 (x117 x272)))
(define-fun x1155 ((x272 Real)) Real (ite (= x272 x1482) 32 (x1538 x272)))
(define-fun x391 ((x272 Real)) Real (ite (= x272 x1598) x1147 (x957 x272)))
(define-fun x1059 ((x272 Real)) Real (ite (= x272 x406) 0 (x49 x272)))
(define-fun x1563 ((x272 Real)) Real (ite (= x272 0) 1 (x1012 x272)))
(define-fun x1529 ((x272 Real)) Real (ite (= 0 x272) 1 (x1012 x272)))
(define-fun x529 ((x272 Real)) Real (ite (and x1030 x194) (x1563 x272) (x1529 x272)))
(define-fun x813 ((x272 Real)) Real (ite (= x1075 x272) x1269 (x404 x272)))
(define-fun x709 ((x272 Real)) Real (ite (= x272 x1075) x1460 (x404 x272)))
(define-fun x1497 ((x272 Real)) Real (ite (= x1075 x272) x552 (x1180 x272)))
(define-fun x715 ((x272 Real)) Real (ite (and (>= x272 x862) (< x272 (+ x862 x552))) (x529 (+ 0 (- x272 x862))) (x1497 x272)))
(define-fun x569 ((x272 Real)) Real (ite (and (not x1106) x985) (x715 x272) (x1180 x272)))
(define-fun x864 ((x272 Real)) Real (ite (= x433 x272) x170 (x569 x272)))
(define-fun x616 ((x272 Real)) Real (ite (= x272 x1493) x1546 (x864 x272)))
(define-fun x181 ((x272 Real)) Real (ite (= x1392 x272) x826 (x616 x272)))
(define-fun x1520 ((x272 Real)) Real (ite (= x272 x766) x925 (x181 x272)))
(define-fun x1021 ((x272 Real)) Real (ite (= x1456 x272) 32 (x1520 x272)))
(define-fun x717 ((x272 Real)) Real (ite (= x272 x267) x730 (x327 x272)))
(define-fun x1254 ((x272 Real)) Real (ite (= x272 x551) 0 (x131 x272)))
(define-fun x560 ((x272 x199)) Real (ite (= x272 (x582 274184521717934524641157099916833587206)) x941 (x176 x272)))
(define-fun x379 ((x272 x199)) Real (ite (= (x582 x1166) x272) x1195 (x560 x272)))
(define-fun x1028 ((x272 x199)) Real (ite (= (x582 x1166) x272) x228 (x379 x272)))
(define-fun x1233 ((x272 x199)) Real (ite (= (x582 274184521717934524641157099916833587206) x272) x1343 (x1028 x272)))
(define-fun x1357 ((x272 x199)) Real (ite (= (x582 274184521717934524641157099916833587206) x272) x298 (x1233 x272)))
(define-fun x386 ((x272 x199)) Real (ite (= x272 (x582 x731)) x414 (x1357 x272)))
(define-fun x1342 ((x272 x199)) Real (ite (= x272 x644) x586 (x1371 x272)))
(define-fun x11 ((x272 x199)) Real (ite (= x272 x1321) x1179 (x1342 x272)))
(define-fun x1605 ((x272 x199)) Real (ite (and x1030 x194) (x11 x272) (x1371 x272)))
(define-fun x723 ((x272 x199)) Real (ite (= x272 x1031) x436 (x1605 x272)))
(define-fun x809 ((x272 Real)) Real (ite (= 0 x272) 1 (x1061 x272)))
(define-fun x301 ((x272 Real)) Real (ite (= x767 x272) x1533 (x884 x272)))
(define-fun x191 ((x272 x199)) Real (ite (= x272 x369) x1589 (x1255 x272)))
(define-fun x1355 ((x272 x199)) Real (ite (= x953 x272) x611 (x191 x272)))
(define-fun x1378 ((x272 x199)) Real (ite (and x1030 x194) (x1255 x272) (x1355 x272)))
(define-fun x1258 ((x272 x199)) Real (ite (= x650 x272) x330 (x1378 x272)))
(define-fun x1350 ((x272 Real)) Real (ite (= 0 x272) 1 (x1061 x272)))
(define-fun x758 ((x272 Real)) Real (ite (= x767 x272) x1249 (x884 x272)))
(define-fun x1435 ((x272 Real)) Real (ite (and x832 x833) (x809 x272) (x1350 x272)))
(define-fun x8 ((x272 x199)) Real (ite (= (x582 x731) x272) x364 (x386 x272)))
(define-fun x657 ((x272 Real)) Real (ite (= x767 x272) x1049 (x423 x272)))
(define-fun x1108 ((x272 Real)) Real (ite (and (<= x354 x272) (> (+ x354 x1049) x272)) (x1435 (+ (- x272 x354) 0)) (x657 x272)))
(define-fun x1294 ((x272 Real)) Real (ite (and x312 x1211) (x423 x272) (x1108 x272)))
(define-fun x751 ((x643 Real)) Bool (=> (and (not (= 18446744073709551615 x643)) (not (= x643 2835717307)) (not (= x643 2690754053)) (not (= x643 2743102681)) (not (= 649617121 x643)) (not (= x643 1889567281)) (not (= 69947311 x643)) (not (= x643 115792089237316195423570985008687907853269984665640564039457)) (not (= 142201243 x643)) (not (= 26959946667150639794667015087019630673637144422540572481103610249215 x643)) (not (= 2293535753 x643)) (not (= 826074471 x643)) (not (= x643 87118632)) (not (= x643 2532887486)) (not (= 274184521717934524641157099916833587206 x643)) (not (= 2061678023 x643)) (not (= x643 2512682246)) (not (= 2418364589 x643)) (not (= x643 468353030)) (not (= 1968616202 x643)) (not (= 2939843472 x643)) (not (= 2211524764 x643)) (not (= 37714057306076988483118529490347679105585116642029194716945419020321082336612 x643)) (not (= 274184521717934524641157099916833587218 x643)) (not (= 2764855426 x643)) (not (= 2258409472 x643)) (not (= x643 115792089237316195423570985008687907853269984665640564039457584007913129639935)) (not (= 2514000705 x643)) (not (= 115792089237316195423570985008687907853269984665640564039457584007913129639904 x643)) (not (= x643 759532456)) (not (= 1000000000000000000 x643)) (not (= x643 274184521717934524641157099916833587214)) (not (= 635128645 x643)) (not (= 604800 x643)) (not (= 76450787359836037641860180984291677749980919077056822294353438043884394381312 x643)) (not (= 2960351575 x643)) (not (= 2868243304 x643)) (not (= x643 2798343961)) (> x643 10000) (not (= 911411945 x643)) (not (= x643 1986467848)) (not (= x643 1461501637330902918203684832716283019655932542975))) (not ((_ is x511) (x582 x643)))))
(assert (axiom_frac_bound (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1000000000000000000 x339 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 32 x526 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1181 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1579 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1181 x1152 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1257 x815 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1579 x1152 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x269 x245 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x486 x145 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x51 x996 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x526 32 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x591 1000000000000000000 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x672 x518 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x815 x1257 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x967 x996 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x51 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x967 (uninterp_frac (* 1000000000000000000 x339) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1000000000000000000 x339 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 32 x526 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1181 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1579 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1181 x1152 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1257 x815 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1579 x1152 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x269 x245 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x486 x145 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x51 x996 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x526 32 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x591 1000000000000000000 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x672 x518 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x815 x1257 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x967 x996 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x51 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x967 (uninterp_frac (* 32 x526) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1000000000000000000 x339 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 32 x526 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1181 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1579 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1181 x1152 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1257 x815 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1579 x1152 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x269 x245 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x486 x145 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x51 x996 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x526 32 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x591 1000000000000000000 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x672 x518 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x815 x1257 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x967 x996 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x51 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x967 (uninterp_frac (* x526 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 1000000000000000000 x339 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 32 x526 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1181 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152 x1579 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1181 x1152 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1257 x815 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1579 x1152 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x269 x245 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x486 x145 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x51 x996 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x526 32 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x591 1000000000000000000 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x672 x518 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x815 x1257 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x967 x996 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x51 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_zero (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936 x996 x967 (uninterp_frac (* x591 1000000000000000000) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(assert (axiom_frac_bound x1141 1000000000000000000))
(assert (axiom_frac_zero x1141 1000000000000000000 1000000000000000000 x339 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 32 x526 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x1152 x1181 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x1152 x1579 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x1181 x1152 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x1257 x815 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x1579 x1152 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x269 x245 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x486 x145 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x51 x996 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x526 32 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x591 1000000000000000000 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x672 x518 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x815 x1257 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x967 x996 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x996 x51 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_zero x1141 1000000000000000000 x996 x967 (uninterp_frac x1141 1000000000000000000)))
(assert (axiom_frac_bound x184 1000000000000000000))
(assert (axiom_frac_zero x184 1000000000000000000 1000000000000000000 x339 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 32 x526 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x1152 x1181 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x1152 x1579 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x1181 x1152 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x1257 x815 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x1579 x1152 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x269 x245 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x486 x145 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x51 x996 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x526 32 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x591 1000000000000000000 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x672 x518 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x815 x1257 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x967 x996 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x996 x51 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_zero x184 1000000000000000000 x996 x967 (uninterp_frac x184 1000000000000000000)))
(assert (axiom_frac_bound x410 1000000000000000000))
(assert (axiom_frac_zero x410 1000000000000000000 1000000000000000000 x339 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 32 x526 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x1152 x1181 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x1152 x1579 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x1181 x1152 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x1257 x815 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x1579 x1152 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x269 x245 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x486 x145 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x51 x996 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x526 32 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x591 1000000000000000000 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x672 x518 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x815 x1257 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x967 x996 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x996 x51 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_zero x410 1000000000000000000 x996 x967 (uninterp_frac x410 1000000000000000000)))
(assert (axiom_frac_bound x543 x236))
(assert (axiom_frac_zero x543 x236 1000000000000000000 x339 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 32 x526 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x1152 x1181 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x1152 x1579 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x1181 x1152 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x1257 x815 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x1579 x1152 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x269 x245 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x486 x145 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x51 x996 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x526 32 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x591 1000000000000000000 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x672 x518 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x815 x1257 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x967 x996 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x996 x51 (uninterp_frac x543 x236)))
(assert (axiom_frac_zero x543 x236 x996 x967 (uninterp_frac x543 x236)))
(assert (axiom_frac_bound x655 x696))
(assert (axiom_frac_zero x655 x696 1000000000000000000 x339 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 32 x526 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x1152 x1181 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x1152 x1579 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x1181 x1152 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x1257 x815 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x1579 x1152 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x269 x245 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x486 x145 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x51 x996 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x526 32 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x591 1000000000000000000 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x672 x518 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x815 x1257 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x967 x996 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x996 x51 (uninterp_frac x655 x696)))
(assert (axiom_frac_zero x655 x696 x996 x967 (uninterp_frac x655 x696)))
(assert (axiom_frac_bound x773 1000000000000000000))
(assert (axiom_frac_zero x773 1000000000000000000 1000000000000000000 x339 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 32 x526 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x1152 x1181 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x1152 x1579 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x1181 x1152 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x1257 x815 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x1579 x1152 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x269 x245 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x486 x145 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x51 x996 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x526 32 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x591 1000000000000000000 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x672 x518 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x815 x1257 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x967 x996 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x996 x51 (uninterp_frac x773 1000000000000000000)))
(assert (axiom_frac_zero x773 1000000000000000000 x996 x967 (uninterp_frac x773 1000000000000000000)))
...
(assert (x891 x900))
(assert (=> (> (+ 10000 1) x830) (= (x511 x830) (x582 x830))))
(assert (= (ite (= x442 x1270) x526 (x1455 x1270)) (x219 x1270)))
(assert (= x177 (x465 (x582 x177))))
(assert (=> (> (+ 10000 1) x1486) (= (x511 x1486) (x582 x1486))))
(assert (= x840 (or x1549 x1476)))
(assert (=> (> (+ 10000 1) x157) (= (x582 x157) (x511 x157))))
...
(assert (x891 x1166))
(assert (= (x984 x1414) 0))
(assert (=> (> (+ 10000 1) x761) (= (x582 x761) (x511 x761))))
(assert (= 826074471 (x465 (x511 826074471))))
(assert (x891 x535))
(assert (x891 x676))
(assert (x891 x908))
(assert (=> (< (- x1303 1) 10000) (= (x582 x1303) (x511 x1303))))
(assert (x891 x1377))
(assert (x751 x830))
(assert (x891 x1140))
...
(assert (x891 x1185))
(assert (=> (> (+ 10000 1) x293) (= (x511 x293) (x582 x293))))
(assert (= (x511 2514000705) (x582 2514000705)))
(assert (=> (< (- x1093 1) 10000) (= (x511 x1093) (x582 x1093))))
(assert (x751 x900))
(assert (x891 x1290))
(assert (x891 x731))
(assert (x891 x1214))
...
(assert (=> (> (+ 10000 1) x638) (= (x582 x638) (x511 x638))))
(assert (x891 x1480))
(assert (x751 x1395))
...
(assert (x891 x189))
(assert (=> (> (+ 10000 1) x535) (= (x511 x535) (x582 x535))))
(assert (=> (< (- x1430 1) 10000) (= (x511 x1430) (x582 x1430))))
(assert (=> (< (- x926 1) 10000) (= (x582 x926) (x511 x926))))
(assert (x751 x790))
...
(assert (=> (> (+ 10000 1) x978) (= (x511 x978) (x582 x978))))
...
(assert (x1003 x620))
(assert (=> (< (- x1555 1) 10000) (= (x511 x1555) (x582 x1555))))
(assert (x751 x549))
(assert (x891 x293))
(assert (=> (< (- x575 1) 10000) (= (x511 x575) (x582 x575))))
(assert (x891 x498))
...
(assert (x891 x296))
(assert (x891 x960))
(assert (=> (> (+ 10000 1) x855) (= (x582 x855) (x511 x855))))
...
(assert (=> (> (+ 10000 1) x209) (= (x582 x209) (x511 x209))))
...
(assert (x891 x185))
(assert (x751 x1588))
(assert (=> (> (+ 10000 1) x1264) (= (x511 x1264) (x582 x1264))))
(assert (x891 x1234))
(assert (x891 x1114))
(assert (=> (> (+ 10000 1) x694) (= (x582 x694) (x511 x694))))
(assert (x891 x614))
(assert (= x553 (=> (= x1338 x863) x1248)))
(assert (= (ite (and x151 x951) (x1426 x916) (x174 x916)) (x1063 x916)))
(assert (= x571 (x465 (x582 x571))))
(assert (=> (> (+ 10000 1) x607) (= (x511 x607) (x582 x607))))
(assert (x891 x432))
...
(assert (=> (> (+ 10000 1) x261) (= (x582 x261) (x511 x261))))
(assert (x891 x868))
(assert (x751 x323))
...
(assert (=> (< (- x1339 1) 10000) (= (x511 x1339) (x582 x1339))))
(assert (x891 x1533))
(assert (x891 x1075))
...
(assert (=> (> (+ 10000 1) x1390) (= (x582 x1390) (x511 x1390))))
(assert (x891 x925))
(assert (x891 x1473))
(assert (x891 x1589))
(assert (x891 x531))
(assert (=> (> (+ 10000 1) x1429) (= (x582 x1429) (x511 x1429))))
(assert (= (x419 x1408) (ite (= x1064 x1408) x1349 (x384 x1408))))
(assert (x891 x1545))
(assert (= (x511 2418364589) (x582 2418364589)))
(assert (=> (< (- x14 1) 10000) (= (x511 x14) (x582 x14))))
(assert (x891 x967))
...
(assert (x891 x1268))
(assert (=> (< (- x1590 1) 10000) (= (x511 x1590) (x582 x1590))))
(assert (x751 x638))
(assert (x891 x446))
...
(assert (x891 x790))
(assert (x891 x571))
(assert (=> (> (+ 10000 1) x40) (= (x511 x40) (x582 x40))))
(assert (= (x984 x134) 0))
(assert true)
...
(assert (x891 x695))
(assert (x891 x163))
(assert (=> (< (- x326 1) 10000) (= (x511 x326) (x582 x326))))
(assert (x891 x1038))
...
(assert (=> (> (+ 10000 1) x1103) (= (x511 x1103) (x582 x1103))))
(assert (x891 x825))
(assert (x891 x383))
(assert (= x172 x1344))
(assert (x891 x396))
...
(assert (=> (> (+ 10000 1) x177) (= (x582 x177) (x511 x177))))
(assert (x751 x883))
(assert (x891 x1593))
(assert (= x986 x1481))
...
(assert (x891 x661))
(assert (x891 x226))
(assert (=> (> (+ 10000 1) x731) (= (x511 x731) (x582 x731))))
...
(assert (x891 x518))
(assert (x751 x1376))
(assert (=> (> (+ 10000 1) x893) (= (x511 x893) (x582 x893))))
(assert (=> (> (+ 10000 1) x1114) (= (x511 x1114) (x582 x1114))))
...
(assert (=> (> (+ 10000 1) x580) (= (x511 x580) (x582 x580))))
(assert (=> (> (+ 10000 1) x1182) (= (x582 x1182) (x511 x1182))))
...
(assert (x891 x874))
(assert (=> (> (+ 10000 1) x1369) (= (x582 x1369) (x511 x1369))))
(assert (x1003 x1368))
...
(assert (x751 x5))
(assert (=> (> (+ 10000 1) x451) (= (x582 x451) (x511 x451))))
(assert (x751 x1544))
(assert (=> (< (- x5 1) 10000) (= (x582 x5) (x511 x5))))
...
(assert (= x1082 x1537))
(assert (x891 x145))
(assert (=> (> (+ 10000 1) x1293) (= (x511 x1293) (x582 x1293))))
...
(assert (x891 x5))
(assert (x891 x885))
(assert (=> (< (- x399 1) 10000) (= (x511 x399) (x582 x399))))
(assert (x891 x375))
...
(assert (x891 x274))
(assert (=> (> (+ 10000 1) x863) (= (x582 x863) (x511 x863))))
(assert (=> (> (+ 10000 1) x38) (= (x511 x38) (x582 x38))))
(assert (x891 x1546))
...
(assert (=> (< (- x1365 1) 10000) (= (x582 x1365) (x511 x1365))))
(assert (x891 x1427))
(assert (x891 x357))
(assert (x891 x129))
(assert (=> (< (- x1418 1) 10000) (= (x511 x1418) (x582 x1418))))
(assert (x751 x1275))
(assert (= (x582 274184521717934524641157099916833587206) (x511 274184521717934524641157099916833587206)))
(assert (x891 x1402))
(assert (= (x984 x1270) 0))
(assert (=> (< (- x733 1) 10000) (= (x511 x733) (x582 x733))))
(assert (x751 x43))
(assert (x891 x829))
(assert (=> (> (+ 10000 1) x1434) (= (x582 x1434) (x511 x1434))))
(assert (=> (> (+ 10000 1) x1186) (= (x511 x1186) (x582 x1186))))
(assert (x891 x1262))
(assert (x751 x863))
...
(assert (=> (< (- x33 1) 10000) (= (x582 x33) (x511 x33))))
(assert (=> (< (- x85 1) 10000) (= (x582 x85) (x511 x85))))
...
(assert (x891 x1283))
(assert (x891 x495))
(assert (=> (> (+ 10000 1) x1454) (= (x582 x1454) (x511 x1454))))
...
(assert (=> (> (+ 10000 1) x509) (= (x582 x509) (x511 x509))))
(assert (x891 x295))
...
(assert (=> (> (+ 10000 1) x1290) (= (x582 x1290) (x511 x1290))))
(assert (x891 x1026))
(assert (x891 x870))
(assert (x891 x455))
...
(assert (=> (> (+ 10000 1) x1433) (= (x511 x1433) (x582 x1433))))
(assert (x891 x1486))
...
(assert (x751 x261))
(assert (=> (< (- x1166 1) 10000) (= (x511 x1166) (x582 x1166))))
...
(assert (x751 x1427))
(assert (=> (< (- x942 1) 10000) (= (x582 x942) (x511 x942))))
(assert (x891 x972))
(assert (x891 x1448))
...
(assert (x891 x83))
(assert (x751 x1442))
(assert (=> (> (+ 10000 1) x1145) (= (x511 x1145) (x582 x1145))))
(assert (x891 x894))
(assert (= (ite (= x442 x153) x159 (x1610 x442)) (x504 x442)))
(assert (=> (< (- x2 1) 10000) (= (x582 x2) (x511 x2))))
(assert (= (x465 (x582 x1572)) x1572))
(assert (x891 x1221))
(assert (=> (> (+ 10000 1) x874) (= (x582 x874) (x511 x874))))
(assert (= x1376 (x465 (x582 x1376))))
(assert (=> (> (+ 10000 1) x59) (= (x582 x59) (x511 x59))))
(assert (x891 x1411))
...
(assert (x891 x1005))
(assert (x891 x2))
(assert (=> (< (- x945 1) 10000) (= (x511 x945) (x582 x945))))
(assert (x891 x456))
(assert (x891 x462))
(assert (x891 x926))
(assert (x891 x352))
...
(assert (=> (< (- x347 1) 10000) (= (x582 x347) (x511 x347))))
(assert (x891 x1403))
...
(assert (=> (> (+ 10000 1) x1008) (= (x511 x1008) (x582 x1008))))
...
(assert (=> (> (+ 10000 1) x381) (= (x511 x381) (x582 x381))))
...
(assert (=> (< (- x1438 1) 10000) (= (x511 x1438) (x582 x1438))))
(assert (x751 x874))
(assert (=> (> (+ 10000 1) x1078) (= (x582 x1078) (x511 x1078))))
...
(assert (=> (< (- x28 1) 10000) (= (x582 x28) (x511 x28))))
(assert (x891 x290))
(assert (x891 x1134))
...
(assert (x891 x1116))
(assert (= x1128 x1345))
(assert (=> (> (+ 10000 1) x1489) (= (x582 x1489) (x511 x1489))))
(assert (x891 x642))
(assert (x891 x197))
...
(assert (x891 x1562))
(assert (=> (> (+ 10000 1) x790) (= (x582 x790) (x511 x790))))
(assert (x751 x1116))
...
(assert (=> (< (- x648 1) 10000) (= (x511 x648) (x582 x648))))
(assert (=> (> (+ 10000 1) x147) (= (x511 x147) (x582 x147))))
(assert (x891 x861))
(assert (x891 x389))
(assert (= (=> (and (= x931 x1182) (= x1400 x1465)) x1518) x739))
(assert (= 0 (x984 x220)))
(assert (=> (< (- x264 1) 10000) (= (x511 x264) (x582 x264))))
(assert (x751 x824))
(assert (x891 x1260))
...
(assert (x891 x53))
(assert (x891 x244))
(assert (=> (> (+ 10000 1) x1292) (= (x582 x1292) (x511 x1292))))
...
(assert (x751 x15))
(assert (=> (< (- x1175 1) 10000) (= (x511 x1175) (x582 x1175))))
...
(assert (x891 x1430))
(assert (x751 x1292))
(assert (=> (< (- x757 1) 10000) (= (x511 x757) (x582 x757))))
(assert (x891 x438))
...
(assert (=> (< (- x18 1) 10000) (= (x582 x18) (x511 x18))))
(assert (= (x465 (x582 x59)) x59))
(assert (=> (> (+ 10000 1) x900) (= (x582 x900) (x511 x900))))
(assert (x751 x1390))
...
(assert (x891 x672))
(assert (=> (> (+ 10000 1) x770) (= (x582 x770) (x511 x770))))
(assert (x891 x1145))
(assert (x891 x677))
(assert (= x18 (x465 (x582 x18))))
(assert (x891 x1571))
(assert (=> (> (+ 10000 1) x300) (= (x511 x300) (x582 x300))))
(assert (= x738 (and x1474 x971)))
(assert (x891 x948))
(assert (=> (> (+ 10000 1) x695) (= (x511 x695) (x582 x695))))
...
(assert (=> (> (+ 10000 1) x274) (= (x511 x274) (x582 x274))))
...
(assert (=> (< (- x1087 1) 10000) (= (x511 x1087) (x582 x1087))))
(assert (x891 x556))
...
(assert (x891 x18))
(assert (=> (> (+ 10000 1) x686) (= (x582 x686) (x511 x686))))
(assert (= x985 x1457))
(assert (x751 x1454))
(assert (x891 x1264))
...
(assert (=> (> (+ 10000 1) x78) (= (x582 x78) (x511 x78))))
...
(assert (x751 x209))
(assert (x891 x1043))
(assert (=> (> (+ 10000 1) x226) (= (x511 x226) (x582 x226))))
(assert (x751 x908))
...
(assert (x891 x418))
(assert (x891 x1179))
(assert (=> (> (+ 10000 1) x1083) (= (x582 x1083) (x511 x1083))))
(assert (x891 x609))
...
(assert (=> (> (+ 10000 1) x393) (= (x511 x393) (x582 x393))))
(assert (x891 x1041))
(assert (x891 x621))
...
(assert (x751 x104))
(assert (x751 x451))
(assert (=> (< (- x1490 1) 10000) (= (x511 x1490) (x582 x1490))))
(assert (=> (> (+ 10000 1) x1280) (= (x511 x1280) (x582 x1280))))
(assert (= (x465 (x582 x1391)) x1391))
(assert (x891 x339))
(assert (= (x465 (x582 x156)) x156))
(assert (=> (< (- x692 1) 10000) (= (x582 x692) (x511 x692))))
(assert (x891 x406))
...
(assert (x751 x1093))
(assert (x891 x680))
(assert (=> (< (- x1544 1) 10000) (= (x511 x1544) (x582 x1544))))
(assert (x891 x905))
(assert (x891 x1317))
(assert (=> (> (+ 10000 1) x234) (= (x511 x234) (x582 x234))))
(assert (x751 x2))
...
(assert (=> (< (- x456 1) 10000) (= (x511 x456) (x582 x456))))
(assert (x891 x119))
(assert (x891 x79))
...
(assert (x891 x134))
(assert (=> (> (+ 10000 1) x190) (= (x511 x190) (x582 x190))))
...
(assert (x891 x764))
(assert (= (x984 x248) 0))
(assert (=> (> (+ 10000 1) x156) (= (x511 x156) (x582 x156))))
(assert (=> (> (+ 10000 1) x825) (= (x511 x825) (x582 x825))))
(assert (x891 x789))
(assert (x751 x991))
(assert (x751 x1365))
(assert (x751 x205))
...
(assert (x891 x1000))
(assert (x751 x687))
(assert (=> (> (+ 10000 1) x716) (= (x511 x716) (x582 x716))))
(assert (x751 x244))
(assert (x891 x824))
(assert (x891 x638))
...
(assert (x751 x535))
(assert (=> (> (+ 10000 1) x252) (= (x582 x252) (x511 x252))))
(assert (x751 x247))
(assert (x891 x347))
(assert (x891 x901))
(assert (=> (< (- x15 1) 10000) (= (x511 x15) (x582 x15))))
(assert (x891 x856))
(assert (=> (< (- x104 1) 10000) (= (x582 x104) (x511 x104))))
(assert (= 0 (x984 224)))
(assert (=> (< (- x1442 1) 10000) (= (x511 x1442) (x582 x1442))))
(assert (x1003 x779))
...
(assert (x891 x1163))
(assert (x891 x1603))
(assert (=> (> (+ 10000 1) x799) (= (x582 x799) (x511 x799))))
(assert (x891 x1390))
(assert (x891 x1396))
...
(assert (=> (< (- x1116 1) 10000) (= (x582 x1116) (x511 x1116))))
...
(assert (x891 x469))
(assert (x891 x1433))
(assert (=> (< (- x1130 1) 10000) (= (x511 x1130) (x582 x1130))))
...
(assert (=> (> (+ 10000 1) x1005) (= (x582 x1005) (x511 x1005))))
(assert (x891 x1299))
(assert (x891 x326))
...
(assert (=> (< (- x810 1) 10000) (= (x582 x810) (x511 x810))))
...
(assert (x891 x463))
(assert (x891 x810))
(assert (=> (< (- x1000 1) 10000) (= (x582 x1000) (x511 x1000))))
(assert (x891 x1507))
...
(assert (=> (> (+ 10000 1) x1275) (= (x511 x1275) (x582 x1275))))
...
(assert (=> (> (+ 10000 1) x1042) (= (x582 x1042) (x511 x1042))))
(assert (x751 x315))
(assert (x751 x1576))
(assert (x891 x552))
(assert (x891 x1228))
...
(assert (x891 x1207))
(assert (x751 x1489))
(assert (=> (< (- x1169 1) 10000) (= (x582 x1169) (x511 x1169))))
(assert (x891 x563))
(assert (=> (< (- x205 1) 10000) (= (x582 x205) (x511 x205))))
...
(assert (x891 x157))
(assert (x891 x1442))
(assert (=> (> (+ 10000 1) x534) (= (x582 x534) (x511 x534))))
...
(assert (x891 x1022))
(assert (x891 x1318))
(assert (=> (< (- x1576 1) 10000) (= (x511 x1576) (x582 x1576))))
(assert (= x748 x523))
(assert (x891 x4))
(assert (x751 x707))
...
(assert (=> (< (- x1413 1) 10000) (= (x511 x1413) (x582 x1413))))
...
(assert (x1003 x701))
(assert (x891 x209))
(assert (=> (< (- x230 1) 10000) (= (x582 x230) (x511 x230))))
(assert (=> (> (+ 10000 1) x920) (= (x511 x920) (x582 x920))))
...
(assert (x891 x807))
(assert (=> (< (- x1256 1) 10000) (= (x511 x1256) (x582 x1256))))
...
(assert (=> (> (+ 10000 1) x778) (= (x582 x778) (x511 x778))))
(assert (x891 x1488))
(assert (x891 x382))
(assert (=> (< (- x1265 1) 10000) (= (x582 x1265) (x511 x1265))))
...
(assert (=> (> (+ 10000 1) x1379) (= (x511 x1379) (x582 x1379))))
(assert (= x431 (or x840 (and x671 x1001))))
(assert (x891 x630))
(assert (= x24 (and x1554 x62)))
(assert (x751 x14))
(assert (=> (> (+ 10000 1) x37) (= (x511 x37) (x582 x37))))
(assert (x891 x620))
(assert (= (x219 x1414) (ite (= x442 x1414) x526 (x1455 x1414))))
(assert (= x1339 (x465 (x582 x1339))))
(assert (=> (< (- x244 1) 10000) (= (x582 x244) (x511 x244))))
(assert (x891 x505))
(assert (= (ite (= x153 x442) x526 (x1455 x153)) (x219 x153)))
(assert (= (x459 x1414) (ite (= x1414 x430) x907 (x241 x1414))))
(assert (=> (< (- x594 1) 10000) (= (x511 x594) (x582 x594))))
(assert (=> (> (+ 10000 1) x1395) (= (x511 x1395) (x582 x1395))))
(assert (x891 x321))
(assert (x751 x1046))
(assert (= (x504 x1377) (ite (= x153 x1377) x159 (x1610 x1377))))
(assert (=> (> (+ 10000 1) x1048) (= (x582 x1048) (x511 x1048))))
(assert (x891 x633))
(assert (x751 x761))
(assert (=> (< (- x468 1) 10000) (= (x582 x468) (x511 x468))))
(assert (x891 x678))
(assert (x751 x1264))
(assert (x891 x701))
...
(assert (x891 x1265))
(assert (=> (> (+ 10000 1) x237) (= (x511 x237) (x582 x237))))
(assert (=> (> (+ 10000 1) x1366) (= (x582 x1366) (x511 x1366))))
...
(assert (x891 x159))
(assert (x891 x381))
(assert (=> (< (- x1307 1) 10000) (= (x582 x1307) (x511 x1307))))
(assert (x891 x1093))
...
(assert (x891 x778))
(assert (x891 x400))
(assert (=> (> (+ 10000 1) x1372) (= (x582 x1372) (x511 x1372))))
...
(assert (x891 x1338))
(assert (=> (> (+ 10000 1) x193) (= (x511 x193) (x582 x193))))
(assert (x891 x1534))
(assert (x891 x257))
(assert (x891 x961))
(assert (= 0 (x984 x1142)))
...
(assert (x891 x541))
(assert (x751 x1490))
(assert (=> (< (- x571 1) 10000) (= (x511 x571) (x582 x571))))
(assert (=> (< (- x366 1) 10000) (= (x511 x366) (x582 x366))))
(assert (x751 x1339))
(assert (x751 x193))
(assert (= x1184 x1128))
(assert (x891 x1606))
...
(assert (=> (> (+ 10000 1) x861) (= (x511 x861) (x582 x861))))
(assert (=> (> (+ 10000 1) x912) (= (x582 x912) (x511 x912))))
(assert (x751 x399))
(assert (x751 x534))
...
(assert (=> (< (- x918 1) 10000) (= (x511 x918) (x582 x918))))
(assert (x751 x960))
(assert (x891 x1424))
(assert (x751 x1186))
(assert (=> (< (- x883 1) 10000) (= (x582 x883) (x511 x883))))
(assert (x891 x1111))
(assert (x891 x1343))
(assert (x891 x311))
(assert (x891 x476))
...
(assert (=> (< (- x41 1) 10000) (= (x511 x41) (x582 x41))))
(assert (x891 x138))
(assert (x891 x710))
(assert (x891 x413))
(assert (x891 x1349))
...
(assert (=> (> (+ 10000 1) x1046) (= (x511 x1046) (x582 x1046))))
(assert (x891 x787))
(assert (= x209 (x465 (x582 x209))))
(assert (= (x459 x1077) (ite (= x1077 x430) x907 (x241 x1077))))
(assert (x891 x1256))
(assert (=> (> (+ 10000 1) x97) (= (x511 x97) (x582 x97))))
(assert (x891 x442))
...
(assert (=> (< (- x676 1) 10000) (= (x511 x676) (x582 x676))))
(assert (x891 x912))
(assert (x891 x264))
(assert (= x1537 x140))
...
(assert (=> (< (- x43 1) 10000) (= (x511 x43) (x582 x43))))
(assert (x705 x1507 x208))
(assert (=> (< (- x1400 1) 10000) (= (x582 x1400) (x511 x1400))))
(assert (x891 x436))
(assert (x891 x1369))
(assert (x891 x848))
(assert (x891 x1225))
...
(assert (x891 x1581))
(assert (x891 x1152))
(assert (=> (< (- x960 1) 10000) (= (x511 x960) (x582 x960))))
...
(assert (= 0 (x984 160)))
(assert (x751 x97))
(assert (=> (> (+ 10000 1) x385) (= (x511 x385) (x582 x385))))
(assert (x891 x1351))
(assert (x891 x878))
(assert (x891 x1269))
(assert (=> (< (- x707 1) 10000) (= (x511 x707) (x582 x707))))
(assert (= (x582 2868243304) (x511 2868243304)))
(assert (= (x465 (x511 2532887486)) 2532887486))
(assert (x891 x1129))
(assert (=> (> (+ 10000 1) x991) (= (x511 x991) (x582 x991))))
...
(assert (=> (> (+ 10000 1) x1286) (= (x582 x1286) (x511 x1286))))
(assert (=> (< (- x908 1) 10000) (= (x582 x908) (x511 x908))))
(assert (x751 x48))
...
(assert (x751 x661))
(assert (=> (< (- x661 1) 10000) (= (x511 x661) (x582 x661))))
...
(assert (=> (< (- x1183 1) 10000) (= (x511 x1183) (x582 x1183))))
(assert (= (x465 (x582 x78)) x78))
(assert (x891 x148))
(assert (x891 x1286))
(assert (=> (> (+ 10000 1) x703) (= (x511 x703) (x582 x703))))
(assert (x891 x1122))
(assert (x891 x525))
(assert (x751 x1175))
(assert (x891 x366))
...
(assert (x891 x103))
(assert (=> (< (- x389 1) 10000) (= (x582 x389) (x511 x389))))
(assert (x891 x962))
(assert (=> (> (+ 10000 1) x1054) (= (x582 x1054) (x511 x1054))))
(assert (x891 x979))
(assert (x891 x1213))
...
(assert (x1003 x454))
(assert (x891 x37))
(assert (=> (> (+ 10000 1) x1374) (= (x582 x1374) (x511 x1374))))
(assert (x891 x694))
(assert (x751 x918))
(assert (x751 x945))
(assert (x751 x37))
...
(assert (x891 x716))
(assert (=> (> (+ 10000 1) x1391) (= (x582 x1391) (x511 x1391))))
...
(assert (=> (< (- x824 1) 10000) (= (x582 x824) (x511 x824))))
(assert (x891 x424))
(assert (=> (< (- x179 1) 10000) (= (x511 x179) (x582 x179))))
(assert (=> (< (- x1572 1) 10000) (= (x511 x1572) (x582 x1572))))
...
(assert (x751 x1234))
(assert (x1003 x798))
(assert (=> (< (- x1427 1) 10000) (= (x511 x1427) (x582 x1427))))
...
(assert (=> (> (+ 10000 1) x315) (= (x582 x315) (x511 x315))))
(assert (= (ite (= x1142 x1402) x720 (x626 x1142)) (x957 x1142)))
(assert (= (x465 (x582 x900)) x900))
(assert (x891 x815))
(assert (= x1264 (x465 (x582 x1264))))
(assert (=> (> (+ 10000 1) x1496) (= (x582 x1496) (x511 x1496))))
(assert (x891 x1583))
(assert (x891 x1456))
(assert (=> (> (+ 10000 1) x549) (= (x511 x549) (x582 x549))))
(assert (x751 x38))
(assert (x751 x1433))
(assert (x751 x1572))
...
(assert (=> (> (+ 10000 1) x400) (= (x511 x400) (x582 x400))))
(assert (x891 x931))
(assert (x891 x89))
(assert (x751 x1103))
