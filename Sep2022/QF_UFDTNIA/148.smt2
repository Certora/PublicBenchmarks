...
(declare-datatypes ((x950 0)) (((x1128 (x1273 Int)) (x1052 (x353 x950) (x1000 x950) (x758 Int)) (x885 (x423 x950) (x87 Int)))))
...
(define-fun x1170 ((x950 x950) (x1228 Int)) x950 (ite ((_ is x885) x950) (x885 (x423 x950) (+ (x87 x950) x1228)) (ite ((_ is x1052) x950) (x1052 (x353 x950) (x1000 x950) (+ x1228 (x758 x950))) (x1128 (+ (x1273 x950) x1228)))))
(define-fun x1436 ((x952 Int)) Int (ite (and (< x952 115792089237316195423570985008687907853269984665640564039457584007913129639936) (<= 0 x952)) x952 (- x952 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x949 ((x952 Int)) Int (ite (and (> 0 x952) (<= (- 115792089237316195423570985008687907853269984665640564039457584007913129639936) x952)) (+ 115792089237316195423570985008687907853269984665640564039457584007913129639936 x952) x952))
(define-fun x420 ((x803 Int)) Bool (and (< x803 115792089237316195423570985008687907853269984665640564039457584007913129639936) (>= x803 0)))
(define-fun x1317 ((x803 Int)) Bool (and (= (x818 x803 115792089237316195423570985008687907853269984665640564039457584007913129639935) x803) (= x803 (x818 115792089237316195423570985008687907853269984665640564039457584007913129639935 x803))))
(define-fun x1388 ((x803 Int)) Bool (and (= 0 (x818 x803 0)) (= 0 (x818 0 x803))))
(define-fun x214 ((x803 Int)) Bool (= x803 (x818 x803 x803)))
(define-fun x1016 ((x803 Int)) Bool (and (x1388 x803) (x214 x803) (x1317 x803)))
(define-fun x1352 ((x803 Int)) Bool (= (x818 1099511627775 (x818 1099511627775 x803)) (x818 1099511627775 x803)))
(define-fun x813 ((x803 Int)) Bool (=> (and (< x803 1099511627776) (<= 0 x803)) (= x803 (x818 1099511627775 x803))))
(define-fun x1516 ((x803 Int)) Bool (=> (= x803 (x818 1099511627775 x803)) (and (>= x803 0) (< x803 1099511627776))))
(define-fun x1527 ((x803 Int)) Bool (=> (and (< x803 2199023255552) (<= 1099511627776 x803)) (= (x818 1099511627775 x803) (- x803 1099511627776))))
(define-fun x1531 ((x803 Int) (x112 Int)) Bool (and (<= 0 x112) (= x803 (+ (x818 1099511627775 x803) (* x112 1099511627776)))))
(define-fun x694 ((x803 Int) (x1479 Int)) Bool (and (x1352 x803) (x1531 x803 x1479) (x813 x803) (x1527 x803) (x1516 x803)))
(define-fun x1048 ((x803 Int) (x112 Int)) Bool (= (x818 x803 x112) (x818 x112 x803)))
(define-fun x453 ((x803 Int) (x112 Int)) Bool (and (=> (>= x112 0) (>= x112 (x818 x803 x112))) (=> (>= x803 0) (<= (x818 x803 x112) x803)) (>= (x818 x803 x112) 0)))
(define-fun x1056 ((x803 Int) (x112 Int)) Bool (and (x453 x803 x112) (x1048 x803 x112)))
(define-fun x920 ((x803 Int) (x1479 Int)) Bool (and (x1056 x803 1099511627775) (x694 x803 x1479)))
(define-fun x52 ((x803 Int)) Bool (= (x818 20282409603651670423947251286015 (x818 20282409603651670423947251286015 x803)) (x818 20282409603651670423947251286015 x803)))
(define-fun x222 ((x803 Int)) Bool (=> (and (> 20282409603651670423947251286016 x803) (<= 0 x803)) (= (x818 20282409603651670423947251286015 x803) x803)))
(define-fun x1166 ((x803 Int)) Bool (=> (= x803 (x818 20282409603651670423947251286015 x803)) (and (>= x803 0) (< x803 20282409603651670423947251286016))))
(define-fun x1272 ((x803 Int)) Bool (=> (and (>= x803 20282409603651670423947251286016) (> 40564819207303340847894502572032 x803)) (= (- x803 20282409603651670423947251286016) (x818 20282409603651670423947251286015 x803))))
(define-fun x1305 ((x803 Int) (x112 Int)) Bool (and (= x803 (+ (x818 20282409603651670423947251286015 x803) (* 20282409603651670423947251286016 x112))) (>= x112 0)))
(define-fun x790 ((x803 Int) (x1479 Int)) Bool (and (x222 x803) (x52 x803) (x1272 x803) (x1305 x803 x1479) (x1166 x803)))
(define-fun x1082 ((x803 Int) (x1479 Int)) Bool (and (x1056 x803 20282409603651670423947251286015) (x790 x803 x1479)))
(define-fun x389 ((x803 Int)) Bool (= (x818 18446744073709551615 (x818 18446744073709551615 x803)) (x818 18446744073709551615 x803)))
(define-fun x1409 ((x803 Int)) Bool (=> (and (> 18446744073709551616 x803) (<= 0 x803)) (= (x818 18446744073709551615 x803) x803)))
(define-fun x789 ((x803 Int)) Bool (=> (= (x818 18446744073709551615 x803) x803) (and (> 18446744073709551616 x803) (>= x803 0))))
(define-fun x1282 ((x803 Int)) Bool (=> (and (>= x803 18446744073709551616) (< x803 36893488147419103232)) (= (x818 18446744073709551615 x803) (- x803 18446744073709551616))))
(define-fun x756 ((x803 Int) (x112 Int)) Bool (and (<= 0 x112) (= x803 (+ (* x112 18446744073709551616) (x818 18446744073709551615 x803)))))
(define-fun x1410 ((x803 Int) (x1479 Int)) Bool (and (x756 x803 x1479) (x389 x803) (x789 x803) (x1282 x803) (x1409 x803)))
(define-fun x908 ((x803 Int) (x1479 Int)) Bool (and (x1410 x803 x1479) (x1056 x803 18446744073709551615)))
(define-fun x718 ((x803 Int)) Bool (= (x763 x803) (ite (< (x818 x803 20282409603651670423947251286015) 10141204801825835211973625643008) (x818 x803 20282409603651670423947251286015) (+ 115792089237316195423570985008687907853269984645358154435805913583965878353920 (x818 x803 20282409603651670423947251286015)))))
(define-fun x1279 ((x803 Int)) Bool (= (x818 16 x803) (x818 16 (x818 16 x803))))
(define-fun x1094 ((x803 Int)) Bool (=> (and (> 16 x803) (>= x803 0)) (= (x818 16 x803) 0)))
(define-fun x1416 ((x803 Int) (x112 Int) (x100 Int) (x1152 Int)) Bool (and (<= 0 x100) (= (+ x112 (* x100 16) (* x1152 32)) x803) (<= 0 x112) (> 3618502788666131106986593281521497120414687020801267626233049500247285301248 x1152) (<= 0 x1152) (> 2 x100) (< x112 16) (= (* x100 16) (x818 16 x803))))
(define-fun x1519 ((x803 Int) (x312 Int) (x711 Int) (x202 Int)) Bool (and (x1416 x803 x312 x711 x202) (x1094 x803) (x1279 x803)))
(define-fun x446 ((x803 Int) (x312 Int) (x711 Int) (x202 Int)) Bool (and (x1519 x803 x312 x711 x202) (x1056 x803 16)))
(define-fun x46 ((x803 Int)) Bool (= (x818 1461501637330902918203684832716283019655932542975 (x818 1461501637330902918203684832716283019655932542975 x803)) (x818 1461501637330902918203684832716283019655932542975 x803)))
(define-fun x370 ((x803 Int)) Bool (=> (and (> 1461501637330902918203684832716283019655932542976 x803) (<= 0 x803)) (= x803 (x818 1461501637330902918203684832716283019655932542975 x803))))
(define-fun x1096 ((x803 Int)) Bool (=> (= (x818 1461501637330902918203684832716283019655932542975 x803) x803) (and (< x803 1461501637330902918203684832716283019655932542976) (<= 0 x803))))
(define-fun x1485 ((x803 Int)) Bool (=> (and (< x803 2923003274661805836407369665432566039311865085952) (>= x803 1461501637330902918203684832716283019655932542976)) (= (- x803 1461501637330902918203684832716283019655932542976) (x818 1461501637330902918203684832716283019655932542975 x803))))
(define-fun x750 ((x803 Int) (x112 Int)) Bool (and (= x803 (+ (x818 1461501637330902918203684832716283019655932542975 x803) (* 1461501637330902918203684832716283019655932542976 x112))) (<= 0 x112)))
(define-fun x337 ((x803 Int) (x1479 Int)) Bool (and (x1485 x803) (x46 x803) (x1096 x803) (x370 x803) (x750 x803 x1479)))
(define-fun x564 ((x803 Int) (x1479 Int)) Bool (and (x337 x803 x1479) (x1056 x803 1461501637330902918203684832716283019655932542975)))
(define-fun x1017 ((x803 Int)) Bool (= (x818 1 x803) (x818 1 (x818 1 x803))))
(define-fun x878 ((x803 Int)) Bool (=> (and (> 2 x803) (>= x803 0)) (= x803 (x818 1 x803))))
(define-fun x552 ((x803 Int)) Bool (=> (= x803 (x818 1 x803)) (and (< x803 2) (>= x803 0))))
(define-fun x1280 ((x803 Int)) Bool (=> (and (>= x803 2) (> 4 x803)) (= (- x803 2) (x818 1 x803))))
(define-fun x399 ((x803 Int) (x112 Int)) Bool (and (<= 0 x112) (= x803 (+ (x818 1 x803) (* 2 x112)))))
(define-fun x943 ((x803 Int) (x1479 Int)) Bool (and (x1017 x803) (x552 x803) (x399 x803 x1479) (x1280 x803) (x878 x803)))
(define-fun x1188 ((x803 Int) (x1479 Int)) Bool (and (x943 x803 x1479) (x1056 x803 1)))
(define-fun x407 ((x803 Int)) Bool (= (x818 255 x803) (x818 255 (x818 255 x803))))
(define-fun x296 ((x803 Int)) Bool (=> (and (< x803 256) (>= x803 0)) (= x803 (x818 255 x803))))
(define-fun x511 ((x803 Int)) Bool (=> (= x803 (x818 255 x803)) (and (< x803 256) (<= 0 x803))))
(define-fun x975 ((x803 Int)) Bool (=> (and (< x803 512) (>= x803 256)) (= (x818 255 x803) (- x803 256))))
(define-fun x792 ((x803 Int) (x112 Int)) Bool (and (= (+ (x818 255 x803) (* 256 x112)) x803) (>= x112 0)))
(define-fun x1385 ((x803 Int) (x1479 Int)) Bool (and (x407 x803) (x792 x803 x1479) (x296 x803) (x511 x803) (x975 x803)))
(define-fun x290 ((x803 Int) (x1479 Int)) Bool (and (x1056 x803 255) (x1385 x803 x1479)))
(define-fun x845 ((x803 Int)) Bool (= (x818 65535 (x818 65535 x803)) (x818 65535 x803)))
(define-fun x3 ((x803 Int)) Bool (=> (and (>= x803 0) (> 65536 x803)) (= x803 (x818 65535 x803))))
(define-fun x1025 ((x803 Int)) Bool (=> (= (x818 65535 x803) x803) (and (> 65536 x803) (>= x803 0))))
(define-fun x194 ((x803 Int)) Bool (=> (and (>= x803 65536) (< x803 131072)) (= (- x803 65536) (x818 65535 x803))))
(define-fun x1160 ((x803 Int) (x112 Int)) Bool (and (= x803 (+ (x818 65535 x803) (* 65536 x112))) (>= x112 0)))
(define-fun x1206 ((x803 Int) (x1479 Int)) Bool (and (x3 x803) (x194 x803) (x1160 x803 x1479) (x845 x803) (x1025 x803)))
(define-fun x788 ((x803 Int) (x1479 Int)) Bool (and (x1056 x803 65535) (x1206 x803 x1479)))
(define-fun x433 ((x803 Int)) Bool (and (= (x1049 115792089237316195423570985008687907853269984665640564039457584007913129639935 x803) 115792089237316195423570985008687907853269984665640564039457584007913129639935) (= 115792089237316195423570985008687907853269984665640564039457584007913129639935 (x1049 x803 115792089237316195423570985008687907853269984665640564039457584007913129639935))))
(define-fun x1442 ((x803 Int)) Bool (and (= x803 (x1049 x803 0)) (= x803 (x1049 0 x803))))
(define-fun x812 ((x803 Int)) Bool (= (x1049 x803 x803) x803))
(define-fun x1315 ((x803 Int)) Bool (and (x812 x803) (x1442 x803) (x433 x803)))
(define-fun x833 ((x803 Int) (x112 Int)) Bool (= (x1049 x803 x112) (x1049 x112 x803)))
(define-fun x445 ((x803 Int) (x112 Int)) Bool (and (=> (>= x803 0) (<= x803 (x1049 x803 x112))) (>= (+ x803 x112) (x1049 x803 x112)) (=> (<= 0 x112) (>= (x1049 x803 x112) x112))))
(define-fun x261 ((x803 Int) (x112 Int)) Bool (and (x833 x803 x112) (x445 x803 x112)))
(define-fun x1125 ((x803 Int)) Bool (= (x818 340282366920938463463374607431768211455 x803) (x818 340282366920938463463374607431768211455 (x818 340282366920938463463374607431768211455 x803))))
(define-fun x109 ((x803 Int)) Bool (=> (and (< x803 340282366920938463463374607431768211456) (>= x803 0)) (= (x818 340282366920938463463374607431768211455 x803) x803)))
(define-fun x1260 ((x803 Int)) Bool (=> (= x803 (x818 340282366920938463463374607431768211455 x803)) (and (<= 0 x803) (> 340282366920938463463374607431768211456 x803))))
(define-fun x211 ((x803 Int)) Bool (=> (and (<= 340282366920938463463374607431768211456 x803) (< x803 680564733841876926926749214863536422912)) (= (- x803 340282366920938463463374607431768211456) (x818 340282366920938463463374607431768211455 x803))))
(define-fun x1058 ((x803 Int) (x112 Int)) Bool (and (<= 0 x112) (= (+ (x818 340282366920938463463374607431768211455 x803) (* 340282366920938463463374607431768211456 x112)) x803)))
(define-fun x880 ((x803 Int) (x1479 Int)) Bool (and (x1260 x803) (x1125 x803) (x109 x803) (x211 x803) (x1058 x803 x1479)))
(define-fun x57 ((x803 Int) (x1479 Int)) Bool (and (x1056 x803 340282366920938463463374607431768211455) (x880 x803 x1479)))
(define-fun x413 ((x803 Int)) Bool (= (x1296 x803) (ite (< (x818 x803 340282366920938463463374607431768211455) 170141183460469231731687303715884105728) (x818 x803 340282366920938463463374607431768211455) (+ 115792089237316195423570985008687907852929702298719625575994209400481361428480 (x818 x803 340282366920938463463374607431768211455)))))
(define-fun x914 ((x803 Int)) Bool (= (x818 115792089237316195423570985008687907853269984665640564039457584007913129639904 x803) (x818 115792089237316195423570985008687907853269984665640564039457584007913129639904 (x818 115792089237316195423570985008687907853269984665640564039457584007913129639904 x803))))
(define-fun x699 ((x803 Int)) Bool (=> (and (<= 0 x803) (< x803 32)) (= 0 (x818 115792089237316195423570985008687907853269984665640564039457584007913129639904 x803))))
(define-fun x1217 ((x803 Int) (x112 Int) (x100 Int) (x1152 Int)) Bool (and (> 32 x112) (<= 0 x1152) (> 3618502788666131106986593281521497120414687020801267626233049500247285301248 x100) (= (x818 115792089237316195423570985008687907853269984665640564039457584007913129639904 x803) (* x100 32)) (<= 0 x100) (> 1 x1152) (= x803 (+ (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1152) (* x100 32) x112)) (>= x112 0)))
(define-fun x925 ((x803 Int) (x312 Int) (x711 Int) (x202 Int)) Bool (and (x1217 x803 x312 x711 x202) (x914 x803) (x699 x803)))
(define-fun x1165 ((x803 Int) (x312 Int) (x711 Int) (x202 Int)) Bool (and (x925 x803 x312 x711 x202) (x1056 x803 115792089237316195423570985008687907853269984665640564039457584007913129639904)))
(define-fun x1593 ((x1115 Int)) Int (ite (= 128 x1115) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x1310 x1115)))
(define-fun x592 ((x1115 Int)) Int (ite (= 0 x1115) x8 (x1497 x1115)))
(define-fun x572 ((x1115 Int)) Int (ite (= 128 x1115) x8 (x910 x1115)))
(define-fun x486 ((x1115 Int)) Int (ite (= x1115 128) x1402 (x910 x1115)))
(define-fun x1434 ((x1115 Int)) Int (ite (= 128 x1115) x799 (x910 x1115)))
(define-fun x295 ((x1115 Int)) Int (ite (= 128 x1115) x458 (x910 x1115)))
(define-fun x1014 ((x1115 Int)) Int (ite (and x1135 x349) (x572 x1115) (ite (and x293 x684) (x486 x1115) (ite (and x437 x1198) (x1434 x1115) (x295 x1115)))))
(define-fun x651 ((x1115 Int)) Int (ite (= x1560 x1115) 16156842317565293874272834530371880720966471053262404558597773956279093428224 (x1014 x1115)))
(define-fun x50 ((x1115 Int)) Int (ite (= x243 x1115) x603 (x651 x1115)))
(define-fun x1549 ((x1115 Int)) Int (ite (= x1115 x443) 274184521717934524641157099916833587211 (x50 x1115)))
(define-fun x1594 ((x1115 Int)) Int (ite (= x1560 x1115) 1 (x1588 x1115)))
(define-fun x249 ((x1115 Int)) Int (ite (= x1115 x1560) 1 (x1588 x1115)))
(define-fun x904 ((x1115 Int)) Int (ite (= x1115 x1560) 1 (x1588 x1115)))
(define-fun x380 ((x1115 Int)) Int (ite (and x1413 x902) (x1594 x1115) (ite (and x1244 x837) (x249 x1115) (x904 x1115))))
(define-fun x730 ((x1115 Int)) Int (ite (= x741 x1115) x1405 (x1241 x1115)))
(define-fun x92 ((x1115 Int)) Int (ite (= x1115 x973) x965 (x730 x1115)))
(define-fun x786 ((x1115 Int)) Int (ite (= x1115 x235) x1083 (x92 x1115)))
(define-fun x1535 ((x1115 Int)) Int (ite (= x355 x1115) x983 (x786 x1115)))
(define-fun x1412 ((x1115 Int)) Int (ite (= x1115 x820) x1346 (x1535 x1115)))
(define-fun x181 ((x1115 Int)) Int (ite (= x1115 x741) x1038 (x1241 x1115)))
(define-fun x489 ((x1115 Int)) Int (ite (= x1115 x565) x496 (x181 x1115)))
(define-fun x1307 ((x1115 Int)) Int (ite (= x1115 x1182) x1275 (x489 x1115)))
(define-fun x570 ((x1115 Int)) Int (ite (= x629 x1115) x1558 (x1307 x1115)))
(define-fun x808 ((x1115 Int)) Int (ite (= x1115 x266) x326 (x570 x1115)))
(define-fun x928 ((x1115 Int)) Int (ite (and x695 x797) (x1412 x1115) (x808 x1115)))
(define-fun x1379 ((x1115 Int)) Int (ite (= x1115 x1020) 115197700812830431890159100217698998050002284567939525164234024451216521560064 (x928 x1115)))
(define-fun x1068 ((x1115 Int)) Int (ite (= x1020 x1115) x447 (x1379 x1115)))
(define-fun x968 ((x1115 Int)) Int (ite (= x22 x1115) x195 (x1068 x1115)))
(define-fun x1149 ((x1115 Int)) Int (ite (= x1115 x1567) x324 (x968 x1115)))
(define-fun x1055 ((x1115 Int)) Int (ite (= x1115 x67) x839 (x1149 x1115)))
(define-fun x410 ((x1115 Int)) Int (ite (= x926 x1115) x1308 (x1055 x1115)))
(define-fun x862 ((x1115 Int)) Int (ite (= x1115 x322) 115197700812830431890159100217698998050002284567939525164234024451216521560064 (x410 x1115)))
(define-fun x273 ((x1115 Int)) Int (ite (= x322 x1115) x79 (x862 x1115)))
(define-fun x103 ((x1115 Int)) Int (ite (= x1208 x1115) x1022 (x273 x1115)))
(define-fun x300 ((x1115 Int)) Int (ite (= x1062 x1115) x549 (x103 x1115)))
(define-fun x435 ((x1115 Int)) Int (ite (= x1115 x1432) x831 (x300 x1115)))
(define-fun x167 ((x1115 Int)) Int (ite (= x344 x1115) x1403 (x234 x1115)))
(define-fun x1088 ((x1115 Int)) Int (ite (= x755 x1115) x1423 (x167 x1115)))
(define-fun x431 ((x1115 Int)) Int (ite (= x795 x1115) x1345 (x1088 x1115)))
(define-fun x580 ((x1115 Int)) Int (ite (= x245 x1115) x518 (x431 x1115)))
(define-fun x1287 ((x1115 Int)) Int (ite (= x1115 x1035) x1073 (x580 x1115)))
(define-fun x524 ((x1115 Int)) Int (ite (= x1115 x344) x1433 (x234 x1115)))
(define-fun x861 ((x1115 Int)) Int (ite (= x1115 x481) x971 (x524 x1115)))
(define-fun x1486 ((x1115 Int)) Int (ite (= x90 x1115) x538 (x861 x1115)))
(define-fun x1586 ((x1115 Int)) Int (ite (= x183 x1115) x427 (x1486 x1115)))
(define-fun x856 ((x1115 Int)) Int (ite (= x600 x1115) x997 (x1586 x1115)))
(define-fun x666 ((x1115 Int)) Int (ite (and x236 x1579) (x1287 x1115) (x856 x1115)))
(define-fun x5 ((x1115 Int)) Int (ite x342 (x666 x1115) (x1544 x1115)))
(define-fun x1051 ((x1115 Int)) Int (ite x731 (ite (and (not x849) x1438) (x1544 x1115) (x5 x1115)) (x1544 x1115)))
(define-fun x1426 ((x1115 Int)) Int (ite (= x1115 x732) 76450787359836037641860180984291677749980919077056822294353438043884394381312 (x1051 x1115)))
(define-fun x164 ((x1115 Int)) Int (ite (= x1115 x358) x480 (x1426 x1115)))
(define-fun x1358 ((x1115 x950)) Int (ite (= x1115 x59) x884 (x78 x1115)))
(define-fun x89 ((x1115 x950)) Int (ite (= x1085 x1115) x444 (x1358 x1115)))
(define-fun x648 ((x1115 x950)) Int (ite (and x902 x1413) (x89 x1115) (x78 x1115)))
(define-fun x1375 ((x1115 x950)) Int (ite (= x1115 x374) x1357 (x648 x1115)))
(define-fun x1191 ((x1115 Int)) Int (ite (= 0 x1115) 1 (x579 x1115)))
(define-fun x607 ((x1115 Int)) Int (ite (= x732 x1115) 1 (x1461 x1115)))
(define-fun x825 ((x1115 Int)) Int (ite (= x13 x1115) 0 (x284 x1115)))
(define-fun x117 ((x1115 Int)) Int (ite (= x207 x1115) x1095 (x1267 x1115)))
(define-fun x1306 ((x1115 Int)) Int (ite (= x357 x1115) x990 (x229 x1115)))
(define-fun x1171 ((x1115 Int)) Int (ite (= x448 x1115) x1066 (x1365 x1115)))
(define-fun x321 ((x1115 Int)) Int (ite (= x1115 x157) x38 (x1164 x1115)))
(define-fun x652 ((x1115 Int)) Int (ite (= x1089 x1115) x796 (x1457 x1115)))
(define-fun x994 ((x1115 Int)) Int (ite (= x1115 x392) x221 (x681 x1115)))
(define-fun x192 ((x1115 Int)) Int (ite (= x692 x1115) x1504 (x196 x1115)))
(define-fun x676 ((x1115 x950)) Int (ite (= x1115 x430) x419 (x1254 x1115)))
(define-fun x783 ((x1115 Int)) Int (ite (= 128 x1115) x213 (x513 x1115)))
(define-fun x151 ((x1115 Int)) Int (ite (= 160 x1115) x857 (x783 x1115)))
(define-fun x140 ((x1115 Int)) Int (ite (= x1115 192) x1473 (x151 x1115)))
(define-fun x1286 ((x1115 Int)) Int (ite (= x1115 224) x1480 (x140 x1115)))
(define-fun x770 ((x1115 Int)) Int (ite (= 256 x1115) x1019 (x1286 x1115)))
(define-fun x1261 ((x1115 Int)) Int (ite (= 0 x1115) x1037 (x744 x1115)))
(define-fun x641 ((x1115 Int)) Int (ite (= 32 x1115) x1169 (x1261 x1115)))
(define-fun x672 ((x1115 Int)) Int (ite (= 64 x1115) x436 (x641 x1115)))
(define-fun x404 ((x1115 Int)) Int (ite (= x1115 96) x923 (x672 x1115)))
(define-fun x338 ((x1115 Int)) Int (ite (= x1115 128) x1003 (x404 x1115)))
(define-fun x966 ((x1115 Int)) Int (ite (= x1115 x620) 0 (x132 x1115)))
(define-fun x667 ((x1115 Int)) Int (ite (= x824 x1115) x286 (x1047 x1115)))
(define-fun x1144 ((x1115 Int)) Int (ite (= x1115 x86) x19 (x1446 x1115)))
(define-fun x1377 ((x1115 Int)) Int (ite (= x1115 x72) x898 (x216 x1115)))
(define-fun x205 ((x1115 Int)) Int (ite (= x223 x1115) x327 (x461 x1115)))
(define-fun x313 ((x1115 Int)) Int (ite (= x631 x1115) x1196 (x729 x1115)))
(define-fun x127 ((x1115 Int)) Int (ite (= x941 x1115) x310 (x1523 x1115)))
(define-fun x39 ((x1115 Int)) Int (ite (= x765 x1115) x155 (x736 x1115)))
(define-fun x325 ((x1115 Int)) Int (ite (= 128 x1115) x213 (x24 x1115)))
(define-fun x710 ((x1115 Int)) Int (ite (= x1115 160) x144 (x325 x1115)))
(define-fun x1573 ((x1115 Int)) Int (ite (= x1115 192) x1473 (x710 x1115)))
(define-fun x1562 ((x1115 Int)) Int (ite (= x1115 224) x1480 (x1573 x1115)))
(define-fun x1550 ((x1115 Int)) Int (ite (= x1115 256) x1019 (x1562 x1115)))
(define-fun x1023 ((x1115 Int)) Int (ite (= 0 x1115) x1300 (x1555 x1115)))
(define-fun x1569 ((x1115 Int)) Int (ite (= 32 x1115) x1133 (x1023 x1115)))
(define-fun x233 ((x1115 Int)) Int (ite (= x1115 64) x911 (x1569 x1115)))
(define-fun x1468 ((x1115 Int)) Int (ite (= x1115 96) x546 (x233 x1115)))
(define-fun x170 ((x1115 Int)) Int (ite (= 128 x1115) x1582 (x1468 x1115)))
(define-fun x665 ((x1115 Int)) Int (ite (= x1115 0) x458 (x1497 x1115)))
(define-fun x859 ((x1115 Int)) Int (ite (= x1115 0) x799 (x1497 x1115)))
(define-fun x917 ((x1115 Int)) Int (ite (= 0 x1115) x1402 (x1497 x1115)))
(define-fun x1428 ((x1115 x950)) Int (ite (= x131 x1115) x944 (x31 x1115)))
(define-fun x1269 ((x1115 x950)) Int (ite (= x1115 x460) x810 (x1428 x1115)))
(define-fun x1007 ((x1115 Int)) Int (ite (= x1115 0) 1 (x421 x1115)))
(define-fun x1478 ((x1115 x950)) Int (ite (= x1115 x852) x768 (x985 x1115)))
(define-fun x593 ((x1115 x950)) Int (ite (= x1115 x1540) x514 (x1478 x1115)))
(define-fun x848 ((x1115 Int)) Int (ite (= x1115 0) 1 (x421 x1115)))
(define-fun x114 ((x1115 Int)) Int (ite (= 128 x1115) x1087 (x772 x1115)))
(define-fun x287 ((x1115 Int)) Int (ite (= x1115 160) x575 (x114 x1115)))
(define-fun x96 ((x1115 Int)) Int (ite (= 192 x1115) x1459 (x287 x1115)))
(define-fun x391 ((x1115 Int)) Int (ite (= x1115 224) x417 (x96 x1115)))
(define-fun x1205 ((x1115 Int)) Int (ite (= 256 x1115) x1243 (x391 x1115)))
(define-fun x969 ((x1115 Int)) Int (ite (= 0 x1115) x1547 (x1555 x1115)))
(define-fun x1103 ((x1115 Int)) Int (ite (= x1115 32) x492 (x969 x1115)))
(define-fun x55 ((x1115 Int)) Int (ite (= 64 x1115) x501 (x1103 x1115)))
(define-fun x159 ((x1115 Int)) Int (ite (= x1115 96) x468 (x55 x1115)))
(define-fun x958 ((x1115 Int)) Int (ite (= x1115 128) x1161 (x159 x1115)))
(define-fun x75 ((x1115 x950)) Int (ite (and x902 x1413) (x31 x1115) (ite (and x837 x1244) (x31 x1115) (x1269 x1115))))
(define-fun x455 ((x1115 x950)) Int (ite (= x1276 x1115) x1044 (x75 x1115)))
(define-fun x239 ((x1115 Int)) Int (ite (= 0 x1115) 1 (x579 x1115)))
(define-fun x913 ((x1115 Int)) Int (ite (= x732 x1115) 1 (x1461 x1115)))
(define-fun x1435 ((x1115 x950)) Int (ite (and x902 x1413) (x985 x1115) (ite (and x1244 x837) (x593 x1115) (x985 x1115))))
(define-fun x508 ((x1115 x950)) Int (ite (= x401 x1115) x1575 (x1435 x1115)))
(define-fun x269 ((x1115 Int)) Int (ite (= 0 x1115) 1 (x579 x1115)))
(define-fun x1431 ((x1115 Int)) Int (ite (= x732 x1115) 1 (x1461 x1115)))
(define-fun x1097 ((x1115 Int)) Int (ite (= 128 x1115) x1087 (x972 x1115)))
(define-fun x596 ((x1115 Int)) Int (ite (= x1115 160) x1013 (x1097 x1115)))
(define-fun x686 ((x1115 Int)) Int (ite (= 192 x1115) x1459 (x596 x1115)))
(define-fun x299 ((x1115 Int)) Int (ite (= 224 x1115) x417 (x686 x1115)))
(define-fun x860 ((x1115 Int)) Int (ite (= 256 x1115) x1243 (x299 x1115)))
(define-fun x1140 ((x1115 Int)) Int (ite (= 0 x1115) x1120 (x744 x1115)))
(define-fun x706 ((x1115 Int)) Int (ite (= 32 x1115) x274 (x1140 x1115)))
(define-fun x981 ((x1115 Int)) Int (ite (= 64 x1115) x493 (x706 x1115)))
(define-fun x199 ((x1115 Int)) Int (ite (= x1115 96) x263 (x981 x1115)))
(define-fun x35 ((x1115 Int)) Int (ite (= 128 x1115) x791 (x199 x1115)))
(define-fun x874 ((x1115 Int)) Int (ite (= 0 x1115) 1 (x421 x1115)))
(define-fun x1437 ((x1115 Int)) Int (ite (= x1115 128) x1087 (x659 x1115)))
(define-fun x974 ((x1115 Int)) Int (ite (= x1115 160) x1011 (x1437 x1115)))
(define-fun x587 ((x1115 Int)) Int (ite (= 192 x1115) x1459 (x974 x1115)))
(define-fun x378 ((x1115 Int)) Int (ite (= x1115 224) x417 (x587 x1115)))
(define-fun x472 ((x1115 Int)) Int (ite (= 256 x1115) x1243 (x378 x1115)))
(define-fun x689 ((x1115 Int)) Int (ite (= 0 x1115) x1338 (x156 x1115)))
(define-fun x1278 ((x1115 Int)) Int (ite (= 32 x1115) x303 (x689 x1115)))
(define-fun x1266 ((x1115 Int)) Int (ite (= 64 x1115) x650 (x1278 x1115)))
(define-fun x630 ((x1115 Int)) Int (ite (= 96 x1115) x402 (x1266 x1115)))
(define-fun x1319 ((x1115 Int)) Int (ite (= 128 x1115) x1380 (x630 x1115)))
(define-fun x406 ((x1115 Int)) Int (ite (= x573 x1115) 0 (x1091 x1115)))
(define-fun x1576 ((x1115 Int)) Int (ite (= x1224 x1115) x987 (x332 x1115)))
(define-fun x163 ((x1115 Int)) Int (ite (= x440 x1115) x488 (x530 x1115)))
(define-fun x1469 ((x1115 Int)) Int (ite (= x304 x1115) x637 (x185 x1115)))
(define-fun x1063 ((x1115 Int)) Int (ite (= x1115 x1235) x793 (x414 x1115)))
(define-fun x1451 ((x1115 Int)) Int (ite (= x1115 x452) x1322 (x193 x1115)))
(define-fun x240 ((x1115 Int)) Int (ite (= x394 x1115) x33 (x851 x1115)))
(define-fun x627 ((x1115 Int)) Int (ite (= x281 x1115) x776 (x60 x1115)))
(define-fun x41 ((x1115 x950)) Int (ite (= x1115 x628) x1285 (x939 x1115)))
(define-fun x752 ((x1115 x950)) Int (ite (= x494 x1115) x206 (x939 x1115)))
(define-fun x1002 ((x1115 x950)) Int (ite (and x738 (not x626)) (ite (and (not x935) x738 (not x626)) (x939 x1115) (x752 x1115)) (x41 x1115)))
(define-fun x595 ((x1115 Int)) Int (ite (= x1115 128) x1087 (x346 x1115)))
(define-fun x1542 ((x1115 Int)) Int (ite (= 160 x1115) x1439 (x595 x1115)))
(define-fun x1253 ((x1115 Int)) Int (ite (= 192 x1115) x1459 (x1542 x1115)))
(define-fun x992 ((x1115 Int)) Int (ite (= x1115 224) x417 (x1253 x1115)))
(define-fun x411 ((x1115 Int)) Int (ite (= x1115 256) x1243 (x992 x1115)))
(define-fun x1464 ((x1115 Int)) Int (ite (= 0 x1115) x1297 (x356 x1115)))
(define-fun x1071 ((x1115 Int)) Int (ite (= x1115 32) x1463 (x1464 x1115)))
(define-fun x408 ((x1115 Int)) Int (ite (= x1115 64) x359 (x1071 x1115)))
(define-fun x1505 ((x1115 Int)) Int (ite (= x1115 96) x557 (x408 x1115)))
(define-fun x84 ((x1115 Int)) Int (ite (= x1115 128) x1065 (x1505 x1115)))
(define-fun x1134 ((x1115 Int)) Int (ite (and x1179 x1513) (x607 x1115) (ite (and x271 x158) (x1431 x1115) (x913 x1115))))
(define-fun x778 ((x803 Int)) Bool (=> (and (not (= 4033150093 x803)) (not (= 3695885053 x803)) (not (= x803 20282409603651670423947251286015)) (not (= 117300739 x803)) (not (= x803 274184521717934524641157099916833587235)) (not (= 2799315671 x803)) (not (= 65536 x803)) (not (= x803 3119561463)) (not (= x803 404098525)) (not (= 4062139261 x803)) (not (= x803 274184521717934524641157099916833587227)) (not (= x803 3889878717)) (not (= 2661915226 x803)) (not (= x803 76450787359836037641860180984291677749980919077056822294353438043884394381312)) (not (= 57896044618658097711785492504343953926634992332820282019728792003956564819968 x803)) (not (= x803 274184521717934524641157099916833587211)) (not (= 3638949393 x803)) (not (= x803 18446744073709551616)) (not (= x803 826074471)) (not (= 18446744073709551615 x803)) (not (= 3257672857 x803)) (not (= x803 10141204801825835211973625643007)) (not (= 57896044618658097711785492504343953926634992332820282019728792003956564819967 x803)) (not (= 115792089237316195423570985008687907853269984655499359237631748795939503996928 x803)) (not (= 157198259 x803)) (not (= x803 274184521717934524641157099916833587223)) (not (= 3253611544 x803)) (not (= x803 50942633119752846454219349998365661925608737367104304655302372697894809501696)) (> x803 10000) (not (= x803 65535)) (not (= 20282409603651670423947251286016 x803)) (not (= 115792089237316195423570985008687907853269984665640564039457584007913129639935 x803)) (not (= 16156842317565293874272834530371880720966471053262404558597773956279093428224 x803)) (not (= x803 274184521717934524641157099916833587244)) (not (= x803 1889567281)) (not (= 170141183460469231731687303715884105727 x803)) (not (= 2835717307 x803)) (not (= x803 599290589)) (not (= 274184521717934524641157099916833587233 x803)) (not (= x803 3840337785)) (not (= 2362581449 x803)) (not (= 4272920204 x803)) (not (= 2068668150 x803)) (not (= x803 115792089237316195423570985008687907853269984665640564039457584007913129639904)) (not (= 3795249780 x803)) (not (= x803 1099511627775)) (not (= 1099511627776 x803)) (not (= x803 1461501637330902918203684832716283019655932542975)) (not (= x803 274184521717934524641157099916833587231)) (not (= 3833100637 x803)) (not (= 340282366920938463463374607431768211455 x803)) (not (= 2514000705 x803)) (not (= x803 340282366920938463463374607431768211456)) (not (= x803 1208925819614629174706175)) (not (= 1208925819614629174706176 x803)) (not (= 115197700812830431890159100217698998050002284567939525164234024451216521560064 x803))) (not ((_ is x1128) (x1418 x803)))))
...
(assert (= (div x476 6277101735386680763835789423207666416102355444464034512896) (x682 x476 192)))
...
(assert (= 0 (x229 x1355)))
(assert (x1016 x520))
(assert (=> (<= x515 10000) (= (x1418 x515) (x1128 x515))))
(assert (=> (<= x1018 10000) (= (x1418 x1018) (x1128 x1018))))
...
(assert (x420 x1427))
(assert (x420 x727))
(assert (=> (>= 10000 x661) (= (x1128 x661) (x1418 x661))))
(assert (x420 x1504))
(assert (x420 x237))
...
(assert (=> (<= x298 10000) (= (x1418 x298) (x1128 x298))))
(assert (x420 x782))
(assert (x778 x298))
...
(assert (=> (<= x1333 10000) (= (x1128 x1333) (x1418 x1333))))
(assert (x420 x548))
(assert (=> (>= 10000 x354) (= (x1418 x354) (x1128 x354))))
(assert (= (div x476 95780971304118053647396689196894323976171195136475136) (x682 x476 176)))
...
(assert (x420 x923))
(assert (x420 x480))
(assert (=> (<= x658 10000) (= (x1418 x658) (x1128 x658))))
(assert (x420 x1265))
(assert (x420 x1529))
(assert (x420 x176))
(assert (x420 x1348))
...
(assert (x420 x1536))
(assert (x420 x276))
(assert (= (mod (x1008 2 x422) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (x746 1 x422)))
(assert (x420 x1563))
...
(assert (x420 x900))
(assert (x1315 x835))
(assert (= (div x809 1461501637330902918203684832716283019655932542976) (x682 x809 160)))
...
(assert (x420 x616))
(assert (x420 x791))
(assert (=> (>= 10000 x1430) (= (x1418 x1430) (x1128 x1430))))
(assert (x420 x661))
(assert (x1016 x98))
(assert (x420 x1533))
(assert (x420 x625))
...
(assert (x420 x266))
(assert (x1016 x633))
(assert (= (div x476 1461501637330902918203684832716283019655932542976) (x682 x476 160)))
(assert (=> (>= 10000 x863) (= (x1128 x863) (x1418 x863))))
(assert (x420 x175))
(assert (x420 x283))
(assert (x420 x1239))
(assert (x420 x354))
...
(assert (x420 x714))
(assert (=> (<= x129 10000) (= (x1418 x129) (x1128 x129))))
(assert (x420 x834))
(assert (x420 x734))
...
(assert (x420 x1108))
(assert (x1016 x608))
(assert (=> (<= x145 10000) (= (x1418 x145) (x1128 x145))))
(assert (x420 x32))
...
(assert (x1016 x1108))
(assert (x420 x1323))
(assert (=> (>= 10000 x1349) (= (x1418 x1349) (x1128 x1349))))
(assert (x420 x387))
...
(assert (=> (<= x30 10000) (= (x1418 x30) (x1128 x30))))
(assert (x420 x912))
(assert (x420 x1021))
(assert (x1016 x77))
(assert (x1016 x537))
...
(assert (x420 x217))
(assert (= (mod (x1008 2 x238) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (x746 1 x238)))
...
(assert (=> (>= 10000 x1138) (= (x1128 x1138) (x1418 x1138))))
(assert (x420 x1564))
(assert (x420 x1430))
(assert (x420 x8))
...
(assert (x420 x77))
(assert (= x999 true))
(assert (=> (>= 10000 x12) (= (x1418 x12) (x1128 x12))))
(assert (x1016 x1580))
(assert (x420 x1371))
...
(assert (x420 x418))
(assert (= (x682 x809 168) (div x809 374144419156711147060143317175368453031918731001856)))
...
(assert (x420 x520))
(assert (x420 x1098))
(assert (=> (>= 10000 x875) (= (x1128 x875) (x1418 x875))))
(check-sat)
