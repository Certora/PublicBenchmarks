...
(declare-datatypes ((x2506 0)) (((x4651 (x405 x2506) (x2323 x2506) (x1045 Int)) (x715 (x1509 x2506) (x622 Int)) (x1228 (x3839 Int)))))
...
(define-fun x656 ((x2506 x2506) (x4412 Int)) x2506 (ite ((_ is x715) x2506) (x715 (x1509 x2506) (+ (x622 x2506) x4412)) (ite ((_ is x4651) x2506) (x4651 (x405 x2506) (x2323 x2506) (+ x4412 (x1045 x2506))) (x1228 (+ x4412 (x3839 x2506))))))
(define-fun x2483 ((x3933 Int)) Int (ite (and (>= x3933 0) (< x3933 115792089237316195423570985008687907853269984665640564039457584007913129639936)) x3933 (- x3933 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x4965 ((x3933 Int)) Int (ite (and (< x3933 0) (>= x3933 (- 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (+ x3933 115792089237316195423570985008687907853269984665640564039457584007913129639936) x3933))
(define-fun x3142 ((x4431 Int)) Bool (and (< x4431 115792089237316195423570985008687907853269984665640564039457584007913129639936) (>= x4431 0)))
(define-fun x3617 ((x4431 Int)) Bool (and (= (x1999 115792089237316195423570985008687907853269984665640564039457584007913129639935 x4431) x4431) (= x4431 (x1999 x4431 115792089237316195423570985008687907853269984665640564039457584007913129639935))))
(define-fun x2620 ((x4431 Int)) Bool (and (= 0 (x1999 0 x4431)) (= (x1999 x4431 0) 0)))
(define-fun x1451 ((x4431 Int)) Bool (= x4431 (x1999 x4431 x4431)))
(define-fun x1438 ((x4431 Int)) Bool (and (x1451 x4431) (x3617 x4431) (x2620 x4431)))
(define-fun x3383 ((x4431 Int)) Bool (= (x1999 1461501637330902918203684832716283019655932542975 x4431) (x1999 1461501637330902918203684832716283019655932542975 (x1999 1461501637330902918203684832716283019655932542975 x4431))))
(define-fun x455 ((x4431 Int)) Bool (=> (and (< x4431 1461501637330902918203684832716283019655932542976) (<= 0 x4431)) (= x4431 (x1999 1461501637330902918203684832716283019655932542975 x4431))))
(define-fun x3860 ((x4431 Int)) Bool (=> (= x4431 (x1999 1461501637330902918203684832716283019655932542975 x4431)) (and (<= 0 x4431) (> 1461501637330902918203684832716283019655932542976 x4431))))
(define-fun x1739 ((x4431 Int)) Bool (=> (and (<= 1461501637330902918203684832716283019655932542976 x4431) (> 2923003274661805836407369665432566039311865085952 x4431)) (= (x1999 1461501637330902918203684832716283019655932542975 x4431) (- x4431 1461501637330902918203684832716283019655932542976))))
(define-fun x3729 ((x4431 Int) (x3889 Int)) Bool (and (= x4431 (+ (* 1461501637330902918203684832716283019655932542976 x3889) (x1999 1461501637330902918203684832716283019655932542975 x4431))) (<= 0 x3889)))
(define-fun x1482 ((x4431 Int) (x1821 Int)) Bool (and (x1739 x4431) (x455 x4431) (x3860 x4431) (x3729 x4431 x1821) (x3383 x4431)))
(define-fun x1798 ((x4431 Int) (x3889 Int)) Bool (= (x1999 x3889 x4431) (x1999 x4431 x3889)))
(define-fun x1192 ((x4431 Int) (x3889 Int)) Bool (and (=> (<= 0 x4431) (>= x4431 (x1999 x4431 x3889))) (=> (>= x3889 0) (<= (x1999 x4431 x3889) x3889)) (>= (x1999 x4431 x3889) 0)))
(define-fun x4568 ((x4431 Int) (x3889 Int)) Bool (and (x1798 x4431 x3889) (x1192 x4431 x3889)))
(define-fun x22 ((x4431 Int) (x1821 Int)) Bool (and (x1482 x4431 x1821) (x4568 x4431 1461501637330902918203684832716283019655932542975)))
(define-fun x3449 ((x4431 Int)) Bool (= (x1999 255 (x1999 255 x4431)) (x1999 255 x4431)))
(define-fun x3667 ((x4431 Int)) Bool (=> (and (<= 0 x4431) (> 256 x4431)) (= (x1999 255 x4431) x4431)))
(define-fun x5099 ((x4431 Int)) Bool (=> (= (x1999 255 x4431) x4431) (and (<= 0 x4431) (> 256 x4431))))
(define-fun x3467 ((x4431 Int)) Bool (=> (and (> 512 x4431) (<= 256 x4431)) (= (x1999 255 x4431) (- x4431 256))))
(define-fun x2686 ((x4431 Int) (x3889 Int)) Bool (and (= x4431 (+ (x1999 255 x4431) (* 256 x3889))) (<= 0 x3889)))
(define-fun x4173 ((x4431 Int) (x1821 Int)) Bool (and (x3667 x4431) (x3449 x4431) (x5099 x4431) (x3467 x4431) (x2686 x4431 x1821)))
(define-fun x1047 ((x4431 Int) (x1821 Int)) Bool (and (x4568 x4431 255) (x4173 x4431 x1821)))
(define-fun x1306 ((x4431 Int)) Bool (= (x1999 340282366920938463463374607431768211455 x4431) (x1999 340282366920938463463374607431768211455 (x1999 340282366920938463463374607431768211455 x4431))))
(define-fun x2210 ((x4431 Int)) Bool (=> (and (< x4431 340282366920938463463374607431768211456) (<= 0 x4431)) (= x4431 (x1999 340282366920938463463374607431768211455 x4431))))
(define-fun x759 ((x4431 Int)) Bool (=> (= (x1999 340282366920938463463374607431768211455 x4431) x4431) (and (<= 0 x4431) (< x4431 340282366920938463463374607431768211456))))
(define-fun x801 ((x4431 Int)) Bool (=> (and (> 680564733841876926926749214863536422912 x4431) (>= x4431 340282366920938463463374607431768211456)) (= (x1999 340282366920938463463374607431768211455 x4431) (- x4431 340282366920938463463374607431768211456))))
(define-fun x4822 ((x4431 Int) (x3889 Int)) Bool (and (= x4431 (+ (x1999 340282366920938463463374607431768211455 x4431) (* 340282366920938463463374607431768211456 x3889))) (<= 0 x3889)))
(define-fun x4644 ((x4431 Int) (x1821 Int)) Bool (and (x2210 x4431) (x1306 x4431) (x4822 x4431 x1821) (x759 x4431) (x801 x4431)))
(define-fun x2550 ((x4431 Int) (x1821 Int)) Bool (and (x4568 x4431 340282366920938463463374607431768211455) (x4644 x4431 x1821)))
(define-fun x2043 ((x4431 Int)) Bool (= (x1999 20282409603651670423947251286015 (x1999 20282409603651670423947251286015 x4431)) (x1999 20282409603651670423947251286015 x4431)))
(define-fun x2232 ((x4431 Int)) Bool (=> (and (< x4431 20282409603651670423947251286016) (<= 0 x4431)) (= (x1999 20282409603651670423947251286015 x4431) x4431)))
(define-fun x4106 ((x4431 Int)) Bool (=> (= (x1999 20282409603651670423947251286015 x4431) x4431) (and (> 20282409603651670423947251286016 x4431) (<= 0 x4431))))
(define-fun x1330 ((x4431 Int)) Bool (=> (and (< x4431 40564819207303340847894502572032) (>= x4431 20282409603651670423947251286016)) (= (- x4431 20282409603651670423947251286016) (x1999 20282409603651670423947251286015 x4431))))
(define-fun x997 ((x4431 Int) (x3889 Int)) Bool (and (>= x3889 0) (= x4431 (+ (x1999 20282409603651670423947251286015 x4431) (* 20282409603651670423947251286016 x3889)))))
(define-fun x5114 ((x4431 Int) (x1821 Int)) Bool (and (x2232 x4431) (x997 x4431 x1821) (x1330 x4431) (x2043 x4431) (x4106 x4431)))
(define-fun x2786 ((x4431 Int) (x1821 Int)) Bool (and (x5114 x4431 x1821) (x4568 x4431 20282409603651670423947251286015)))
(define-fun x2487 ((x4431 Int)) Bool (= (ite (> 10141204801825835211973625643008 (x1999 x4431 20282409603651670423947251286015)) (x1999 x4431 20282409603651670423947251286015) (+ 115792089237316195423570985008687907853269984645358154435805913583965878353920 (x1999 x4431 20282409603651670423947251286015))) (x216 x4431)))
(define-fun x2766 ((x4431 Int)) Bool (= (x1999 18446744073709551615 x4431) (x1999 18446744073709551615 (x1999 18446744073709551615 x4431))))
(define-fun x490 ((x4431 Int)) Bool (=> (and (> 18446744073709551616 x4431) (<= 0 x4431)) (= (x1999 18446744073709551615 x4431) x4431)))
(define-fun x2855 ((x4431 Int)) Bool (=> (= x4431 (x1999 18446744073709551615 x4431)) (and (> 18446744073709551616 x4431) (>= x4431 0))))
(define-fun x1480 ((x4431 Int)) Bool (=> (and (> 36893488147419103232 x4431) (>= x4431 18446744073709551616)) (= (- x4431 18446744073709551616) (x1999 18446744073709551615 x4431))))
(define-fun x3437 ((x4431 Int) (x3889 Int)) Bool (and (<= 0 x3889) (= x4431 (+ (x1999 18446744073709551615 x4431) (* 18446744073709551616 x3889)))))
(define-fun x1903 ((x4431 Int) (x1821 Int)) Bool (and (x2855 x4431) (x2766 x4431) (x1480 x4431) (x490 x4431) (x3437 x4431 x1821)))
(define-fun x4136 ((x4431 Int) (x1821 Int)) Bool (and (x1903 x4431 x1821) (x4568 x4431 18446744073709551615)))
(define-fun x4497 ((x4431 Int)) Bool (= (x1999 65535 x4431) (x1999 65535 (x1999 65535 x4431))))
(define-fun x1983 ((x4431 Int)) Bool (=> (and (>= x4431 0) (> 65536 x4431)) (= x4431 (x1999 65535 x4431))))
(define-fun x5127 ((x4431 Int)) Bool (=> (= (x1999 65535 x4431) x4431) (and (<= 0 x4431) (< x4431 65536))))
(define-fun x3677 ((x4431 Int)) Bool (=> (and (< x4431 131072) (<= 65536 x4431)) (= (- x4431 65536) (x1999 65535 x4431))))
(define-fun x2566 ((x4431 Int) (x3889 Int)) Bool (and (<= 0 x3889) (= (+ (x1999 65535 x4431) (* 65536 x3889)) x4431)))
(define-fun x600 ((x4431 Int) (x1821 Int)) Bool (and (x5127 x4431) (x3677 x4431) (x2566 x4431 x1821) (x4497 x4431) (x1983 x4431)))
(define-fun x5234 ((x4431 Int) (x1821 Int)) Bool (and (x4568 x4431 65535) (x600 x4431 x1821)))
(define-fun x970 ((x4431 Int)) Bool (= (x1999 115792089237316195423570985008687907853269984665640564039457584007913129639904 x4431) (x1999 115792089237316195423570985008687907853269984665640564039457584007913129639904 (x1999 115792089237316195423570985008687907853269984665640564039457584007913129639904 x4431))))
(define-fun x1578 ((x4431 Int)) Bool (=> (and (> 32 x4431) (>= x4431 0)) (= (x1999 115792089237316195423570985008687907853269984665640564039457584007913129639904 x4431) 0)))
(define-fun x2335 ((x4431 Int) (x3889 Int) (x2404 Int) (x3312 Int)) Bool (and (>= x3312 0) (< x3312 1) (= (+ x3889 (* 32 x2404) (* x3312 115792089237316195423570985008687907853269984665640564039457584007913129639936)) x4431) (>= x3889 0) (<= 0 x2404) (< x2404 3618502788666131106986593281521497120414687020801267626233049500247285301248) (> 32 x3889) (= (x1999 115792089237316195423570985008687907853269984665640564039457584007913129639904 x4431) (* x2404 32))))
(define-fun x2449 ((x4431 Int) (x130 Int) (x1534 Int) (x3346 Int)) Bool (and (x1578 x4431) (x970 x4431) (x2335 x4431 x130 x1534 x3346)))
(define-fun x1936 ((x4431 Int) (x130 Int) (x1534 Int) (x3346 Int)) Bool (and (x4568 x4431 115792089237316195423570985008687907853269984665640564039457584007913129639904) (x2449 x4431 x130 x1534 x3346)))
(define-fun x3018 ((x4431 Int)) Bool (= (ite (> 170141183460469231731687303715884105728 (x1999 x4431 340282366920938463463374607431768211455)) (x1999 x4431 340282366920938463463374607431768211455) (+ (x1999 x4431 340282366920938463463374607431768211455) 115792089237316195423570985008687907852929702298719625575994209400481361428480)) (x14 x4431)))
(define-fun x3866 ((x4431 Int)) Bool (= (x1999 1208925819614629174706175 x4431) (x1999 1208925819614629174706175 (x1999 1208925819614629174706175 x4431))))
(define-fun x5046 ((x4431 Int)) Bool (=> (and (> 1208925819614629174706176 x4431) (>= x4431 0)) (= x4431 (x1999 1208925819614629174706175 x4431))))
(define-fun x4337 ((x4431 Int)) Bool (=> (= (x1999 1208925819614629174706175 x4431) x4431) (and (>= x4431 0) (> 1208925819614629174706176 x4431))))
(define-fun x4541 ((x4431 Int)) Bool (=> (and (< x4431 2417851639229258349412352) (<= 1208925819614629174706176 x4431)) (= (- x4431 1208925819614629174706176) (x1999 1208925819614629174706175 x4431))))
(define-fun x744 ((x4431 Int) (x3889 Int)) Bool (and (<= 0 x3889) (= x4431 (+ (x1999 1208925819614629174706175 x4431) (* 1208925819614629174706176 x3889)))))
(define-fun x1258 ((x4431 Int) (x1821 Int)) Bool (and (x5046 x4431) (x744 x4431 x1821) (x3866 x4431) (x4337 x4431) (x4541 x4431)))
(define-fun x3549 ((x4431 Int) (x1821 Int)) Bool (and (x1258 x4431 x1821) (x4568 x4431 1208925819614629174706175)))
(define-fun x4980 ((x1744 Int)) Int (ite (= x1744 288) x946 (x2096 x1744)))
(define-fun x3445 ((x1744 Int)) Int (ite (= 320 x1744) x4755 (x4980 x1744)))
(define-fun x4913 ((x1744 Int)) Int (ite (= x1744 352) x1705 (x3445 x1744)))
(define-fun x41 ((x1744 Int)) Int (ite (= 384 x1744) x1049 (x4913 x1744)))
(define-fun x304 ((x1744 Int)) Int (ite (= x1744 416) x3152 (x41 x1744)))
(define-fun x5173 ((x1744 Int)) Int (ite (= 288 x1744) x589 (x2096 x1744)))
(define-fun x3235 ((x1744 Int)) Int (ite (= x1744 320) x1850 (x5173 x1744)))
(define-fun x3320 ((x1744 Int)) Int (ite (= x1744 352) x2073 (x3235 x1744)))
(define-fun x1644 ((x1744 Int)) Int (ite (= 384 x1744) x2769 (x3320 x1744)))
(define-fun x361 ((x1744 Int)) Int (ite (= x1744 416) x2155 (x1644 x1744)))
(define-fun x3938 ((x1744 Int)) Int (ite (= x1029 x1744) x492 (x3953 x1744)))
(define-fun x1223 ((x1744 Int)) Int (ite (= x3355 x1744) x1933 (x3938 x1744)))
(define-fun x3903 ((x1744 Int)) Int (ite (= x1744 x4722) x2160 (x1223 x1744)))
(define-fun x2177 ((x1744 Int)) Int (ite (= x4564 x1744) x1087 (x3903 x1744)))
(define-fun x1167 ((x1744 Int)) Int (ite (= x1744 x3010) x9 (x2177 x1744)))
(define-fun x1147 ((x1744 Int)) Int (ite (= x1744 x1029) x917 (x3953 x1744)))
(define-fun x4898 ((x1744 Int)) Int (ite (= x3075 x1744) x5084 (x1147 x1744)))
(define-fun x4262 ((x1744 Int)) Int (ite (= x1744 x4909) x1725 (x4898 x1744)))
(define-fun x2509 ((x1744 Int)) Int (ite (= x1744 x132) x2680 (x4262 x1744)))
(define-fun x1491 ((x1744 Int)) Int (ite (= x3887 x1744) x3623 (x2509 x1744)))
(define-fun x4340 ((x1744 Int)) Int (ite (and x1639 x2182) (x1167 x1744) (x1491 x1744)))
(define-fun x2986 ((x1744 Int)) Int (ite (and (not x5049) x1778) (x874 x1744) (x2958 x1744)))
(define-fun x4858 ((x1744 Int)) Int (ite (= x1744 x1870) x1575 (x793 x1744)))
(define-fun x3843 ((x1744 Int)) Int (ite x2076 (x4858 x1744) (x793 x1744)))
(define-fun x2886 ((x1744 Int)) Int (ite (= x1744 x2477) x3838 (x3843 x1744)))
(define-fun x475 ((x1744 Int)) Int (ite (= x1744 x3529) x4994 (x5129 x1744)))
(define-fun x1634 ((x1744 Int)) Int (ite x2076 (x475 x1744) (x5129 x1744)))
(define-fun x2457 ((x1744 Int)) Int (ite (= x364 x1744) x5093 (x1634 x1744)))
(define-fun x1463 ((x1744 Int)) Int (ite (= x620 x1744) x1938 (x4182 x1744)))
(define-fun x707 ((x1744 Int)) Int (ite x2076 (x1463 x1744) (x4182 x1744)))
(define-fun x1790 ((x1744 Int)) Int (ite (= x1744 x3164) x3508 (x707 x1744)))
(define-fun x2978 ((x1744 Int)) Int (ite (= x1744 x3284) x1897 (x3849 x1744)))
(define-fun x1827 ((x1744 Int)) Int (ite x2076 (x2978 x1744) (x3849 x1744)))
(define-fun x3020 ((x1744 Int)) Int (ite (= x1744 x263) x4166 (x1827 x1744)))
(define-fun x4206 ((x1744 Int)) Int (ite (= x1744 x4745) x3816 (x1064 x1744)))
(define-fun x2678 ((x1744 Int)) Int (ite x2076 (x4206 x1744) (x1064 x1744)))
(define-fun x1689 ((x1744 Int)) Int (ite (= x1744 x2976) x1695 (x2678 x1744)))
(define-fun x1371 ((x1744 Int)) Int (ite (= x1744 x1861) x4177 (x190 x1744)))
(define-fun x1364 ((x1744 Int)) Int (ite x2076 (x1371 x1744) (x190 x1744)))
(define-fun x4238 ((x1744 Int)) Int (ite (= x1744 x2431) x4533 (x1364 x1744)))
(define-fun x2213 ((x1744 Int)) Int (ite (= x4580 x1744) x3959 (x1854 x1744)))
(define-fun x4830 ((x1744 Int)) Int (ite x2076 (x2213 x1744) (x1854 x1744)))
(define-fun x3315 ((x1744 Int)) Int (ite (= x1744 x925) x3302 (x4830 x1744)))
(define-fun x3784 ((x1744 Int)) Int (ite (= x1744 x5155) x2224 (x4316 x1744)))
(define-fun x952 ((x1744 Int)) Int (ite x2076 (x3784 x1744) (x4316 x1744)))
(define-fun x19 ((x1744 Int)) Int (ite (= x187 x1744) x549 (x952 x1744)))
(define-fun x3123 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x2870 x1744)))
(define-fun x3165 ((x1744 Int)) Int (ite (= 160 x1744) x4112 (x3123 x1744)))
(define-fun x3209 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x3165 x1744)))
(define-fun x2277 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x3209 x1744)))
(define-fun x958 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x2277 x1744)))
(define-fun x3604 ((x1744 Int)) Int (ite (= x356 x1744) x2693 (x4791 x1744)))
(define-fun x4135 ((x1744 Int)) Int (ite (= x1744 x3413) x1880 (x3604 x1744)))
(define-fun x4690 ((x1744 Int)) Int (ite (= x1744 x3676) x1706 (x4135 x1744)))
(define-fun x1483 ((x1744 Int)) Int (ite (= x4009 x1744) x2448 (x4690 x1744)))
(define-fun x1407 ((x1744 Int)) Int (ite (= x2149 x1744) x3227 (x1483 x1744)))
(define-fun x3513 ((x1744 Int)) Int (ite (= 0 x1744) x4721 (x259 x1744)))
(define-fun x1802 ((x1744 Int)) Int (ite (= 32 x1744) x3361 (x3513 x1744)))
(define-fun x1596 ((x1744 Int)) Int (ite (= x1744 64) x2365 (x1802 x1744)))
(define-fun x884 ((x1744 Int)) Int (ite (= x1744 96) x4281 (x1596 x1744)))
(define-fun x5227 ((x1744 Int)) Int (ite (= x1744 128) x2320 (x884 x1744)))
(define-fun x2221 ((x1744 Int)) Int (ite (= x3820 x1744) x5191 (x3266 x1744)))
(define-fun x733 ((x1744 Int)) Int (ite x3777 (x2221 x1744) (x3266 x1744)))
(define-fun x1082 ((x1744 Int)) Int (ite (= x1744 x4240) x1691 (x733 x1744)))
(define-fun x5059 ((x1744 Int)) Int (ite (= x16 x1744) x1587 (x4586 x1744)))
(define-fun x1260 ((x1744 Int)) Int (ite x3777 (x5059 x1744) (x4586 x1744)))
(define-fun x2734 ((x1744 Int)) Int (ite (= x2208 x1744) x2243 (x1260 x1744)))
(define-fun x1006 ((x1744 Int)) Int (ite (= x1744 x5214) x1229 (x3781 x1744)))
(define-fun x117 ((x1744 Int)) Int (ite x3777 (x1006 x1744) (x3781 x1744)))
(define-fun x1031 ((x1744 Int)) Int (ite (= x1744 x2098) x2389 (x117 x1744)))
(define-fun x8 ((x1744 Int)) Int (ite (= x1744 x158) x883 (x4627 x1744)))
(define-fun x3695 ((x1744 Int)) Int (ite x3777 (x8 x1744) (x4627 x1744)))
(define-fun x1878 ((x1744 Int)) Int (ite (= x1744 x1892) x4955 (x3695 x1744)))
(define-fun x3491 ((x1744 Int)) Int (ite (= x4104 x1744) x1759 (x247 x1744)))
(define-fun x1207 ((x1744 Int)) Int (ite x3777 (x3491 x1744) (x247 x1744)))
(define-fun x871 ((x1744 Int)) Int (ite (= x1744 x2321) x2375 (x1207 x1744)))
(define-fun x1159 ((x1744 Int)) Int (ite (= x231 x1744) x3087 (x2969 x1744)))
(define-fun x4885 ((x1744 Int)) Int (ite x3777 (x1159 x1744) (x2969 x1744)))
(define-fun x887 ((x1744 Int)) Int (ite (= x1744 x1431) x2257 (x4885 x1744)))
(define-fun x2374 ((x1744 Int)) Int (ite (= x1744 x3102) x2993 (x1074 x1744)))
(define-fun x5029 ((x1744 Int)) Int (ite x3777 (x2374 x1744) (x1074 x1744)))
(define-fun x2549 ((x1744 Int)) Int (ite (= x1744 x5119) x3629 (x5029 x1744)))
(define-fun x1296 ((x1744 Int)) Int (ite (= x1744 x1454) x3891 (x5211 x1744)))
(define-fun x2856 ((x1744 Int)) Int (ite x3777 (x1296 x1744) (x5211 x1744)))
(define-fun x4503 ((x1744 Int)) Int (ite (= x1744 x807) x2425 (x2856 x1744)))
(define-fun x3013 ((x1744 x2506)) Int (ite (= x2278 x1744) x1885 (x4399 x1744)))
(define-fun x2496 ((x1744 Int)) Int (ite (= 128 x1744) x572 (x2281 x1744)))
(define-fun x1 ((x1744 Int)) Int (ite (= 160 x1744) x771 (x2496 x1744)))
(define-fun x2523 ((x1744 Int)) Int (ite (= x1744 192) x5167 (x1 x1744)))
(define-fun x1212 ((x1744 Int)) Int (ite (= 224 x1744) x4611 (x2523 x1744)))
(define-fun x2186 ((x1744 Int)) Int (ite (= x1744 256) x533 (x1212 x1744)))
(define-fun x4902 ((x1744 Int)) Int (ite (= 128 x1744) x5040 (x2281 x1744)))
(define-fun x1710 ((x1744 Int)) Int (ite (= 160 x1744) x2369 (x4902 x1744)))
(define-fun x4213 ((x1744 Int)) Int (ite (= x1744 192) x28 (x1710 x1744)))
(define-fun x4871 ((x1744 Int)) Int (ite (= 224 x1744) x2044 (x4213 x1744)))
(define-fun x575 ((x1744 Int)) Int (ite (= x1744 256) x3350 (x4871 x1744)))
(define-fun x2902 ((x1744 Int)) Int (ite (= x1744 x1708) x3177 (x3301 x1744)))
(define-fun x4285 ((x1744 Int)) Int (ite (= x1183 x1744) x553 (x2902 x1744)))
(define-fun x3720 ((x1744 Int)) Int (ite (= x3393 x1744) x2975 (x4285 x1744)))
(define-fun x1163 ((x1744 Int)) Int (ite (= x4661 x1744) x4313 (x3720 x1744)))
(define-fun x1035 ((x1744 Int)) Int (ite (= x1744 x3951) x1605 (x1163 x1744)))
(define-fun x1920 ((x1744 Int)) Int (ite (= x1708 x1744) x3251 (x3301 x1744)))
(define-fun x2854 ((x1744 Int)) Int (ite (= x3160 x1744) x151 (x1920 x1744)))
(define-fun x3782 ((x1744 Int)) Int (ite (= x1744 x4995) x2174 (x2854 x1744)))
(define-fun x2694 ((x1744 Int)) Int (ite (= x3407 x1744) x2836 (x3782 x1744)))
(define-fun x3566 ((x1744 Int)) Int (ite (= x1744 x2801) x2910 (x2694 x1744)))
(define-fun x3313 ((x1744 Int)) Int (ite (and x1046 x795) (x1035 x1744) (x3566 x1744)))
(define-fun x2498 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x326 x1744)))
(define-fun x489 ((x1744 Int)) Int (ite (= 160 x1744) x974 (x2498 x1744)))
(define-fun x1016 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x489 x1744)))
(define-fun x2045 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x1016 x1744)))
(define-fun x1776 ((x1744 Int)) Int (ite (= x1744 256) x888 (x2045 x1744)))
(define-fun x3333 ((x1744 Int)) Int (ite (= x5107 x1744) x1319 (x990 x1744)))
(define-fun x2692 ((x1744 Int)) Int (ite (= x2244 x1744) x4605 (x3333 x1744)))
(define-fun x31 ((x1744 Int)) Int (ite (= x1744 x2735) x3221 (x2692 x1744)))
(define-fun x2555 ((x1744 Int)) Int (ite (= x1744 x3095) x488 (x31 x1744)))
(define-fun x4776 ((x1744 Int)) Int (ite (= x4071 x1744) x3504 (x2555 x1744)))
(define-fun x2357 ((x1744 Int)) Int (ite (= x1744 0) x821 (x240 x1744)))
(define-fun x2105 ((x1744 Int)) Int (ite (= 32 x1744) x1841 (x2357 x1744)))
(define-fun x1305 ((x1744 Int)) Int (ite (= 64 x1744) x836 (x2105 x1744)))
(define-fun x2832 ((x1744 Int)) Int (ite (= x1744 96) x1252 (x1305 x1744)))
(define-fun x1900 ((x1744 Int)) Int (ite (= 128 x1744) x395 (x2832 x1744)))
(define-fun x4485 ((x1744 Int)) Int (ite (= x1744 x356) x2731 (x4791 x1744)))
(define-fun x4555 ((x1744 Int)) Int (ite (= x1744 x3263) x5076 (x4485 x1744)))
(define-fun x3322 ((x1744 Int)) Int (ite (= x1744 x2159) x4464 (x4555 x1744)))
(define-fun x4452 ((x1744 Int)) Int (ite (= x1744 x3917) x4010 (x3322 x1744)))
(define-fun x2827 ((x1744 Int)) Int (ite (= x1744 x3761) x3033 (x4452 x1744)))
(define-fun x2077 ((x1744 Int)) Int (ite (and x3807 x1350) (x1407 x1744) (x2827 x1744)))
(define-fun x4256 ((x1744 Int)) Int (ite x1823 (x2077 x1744) (x874 x1744)))
(define-fun x2284 ((x1744 Int)) Int (ite (= x5107 x1744) x1728 (x990 x1744)))
(define-fun x4169 ((x1744 Int)) Int (ite (= x5024 x1744) x2656 (x2284 x1744)))
(define-fun x1538 ((x1744 Int)) Int (ite (= x1744 x4190) x3418 (x4169 x1744)))
(define-fun x1715 ((x1744 Int)) Int (ite (= x2216 x1744) x4975 (x1538 x1744)))
(define-fun x3632 ((x1744 Int)) Int (ite (= x4648 x1744) x5126 (x1715 x1744)))
(define-fun x2486 ((x1744 Int)) Int (ite (and x2622 x1376) (x4776 x1744) (x3632 x1744)))
(define-fun x734 ((x1744 Int)) Int (ite x127 (x2486 x1744) (x845 x1744)))
(define-fun x2332 ((x1744 Int)) Int (ite (and (not x545) x2590) (x874 x1744) (ite (and x3984 (not x1607)) (x2958 x1744) (x4256 x1744))))
(define-fun x353 ((x1744 Int)) Int (ite x4614 (ite (and (not x3732) x2188) (x845 x1744) (ite (and (not x3535) x1406) (x5247 x1744) (x734 x1744))) (ite (and x629 (not x2529)) (x845 x1744) (x5247 x1744))))
(define-fun x3219 ((x1744 Int)) Int (ite (= x3774 x1744) 76450787359836037641860180984291677749980919077056822294353438043884394381312 (x353 x1744)))
(define-fun x1979 ((x1744 Int)) Int (ite (= x1744 x3027) x4857 (x3219 x1744)))
(define-fun x4140 ((x1744 x2506)) Int (ite (= x3117 x1744) x4145 (x3181 x1744)))
(define-fun x1362 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x977 x1744)))
(define-fun x940 ((x1744 Int)) Int (ite (= x3774 x1744) 1 (x763 x1744)))
(define-fun x2504 ((x1744 x2506)) Int (ite (= x3408 x1744) x4993 (x4204 x1744)))
(define-fun x1000 ((x1744 Int)) Int (ite (= x1744 128) x3958 (x2042 x1744)))
(define-fun x1130 ((x1744 Int)) Int (ite (= x1744 224) x4820 (x2217 x1744)))
(define-fun x3631 ((x1744 Int)) Int (ite (= 256 x1744) x1918 (x1299 x1744)))
(define-fun x1027 ((x1744 Int)) Int (ite (= x1744 128) x2413 (x1000 x1744)))
(define-fun x10 ((x1744 Int)) Int (ite (= 192 x1744) x3652 (x4477 x1744)))
(define-fun x2255 ((x1744 Int)) Int (ite (= 192 x1744) x4860 (x4477 x1744)))
(define-fun x234 ((x1744 Int)) Int (ite (and x1176 x4109 x2676) (x2255 x1744) (x10 x1744)))
(define-fun x2161 ((x1744 Int)) Int (ite (= x1744 160) x1724 (x1427 x1744)))
(define-fun x1982 ((x1744 Int)) Int (ite (= 160 x1744) x2026 (x1427 x1744)))
(define-fun x1472 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x599 x1744)))
(define-fun x4873 ((x1744 Int)) Int (ite (= 160 x1744) x1940 (x1472 x1744)))
(define-fun x1313 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x4873 x1744)))
(define-fun x3460 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x1313 x1744)))
(define-fun x4070 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x3460 x1744)))
(define-fun x3390 ((x1744 Int)) Int (ite (= 0 x1744) x2342 (x4559 x1744)))
(define-fun x4414 ((x1744 Int)) Int (ite (= x1744 32) x3738 (x3390 x1744)))
(define-fun x5143 ((x1744 Int)) Int (ite (= 64 x1744) x912 (x4414 x1744)))
(define-fun x3168 ((x1744 Int)) Int (ite (= x1744 96) x3826 (x5143 x1744)))
(define-fun x4751 ((x1744 Int)) Int (ite (= x1744 128) x1847 (x3168 x1744)))
(define-fun x1879 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x2445 x1744)))
(define-fun x2833 ((x1744 Int)) Int (ite (= 160 x1744) x3637 (x1879 x1744)))
(define-fun x3515 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x2833 x1744)))
(define-fun x11 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x3515 x1744)))
(define-fun x1441 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x11 x1744)))
(define-fun x3916 ((x1744 Int)) Int (ite (= 0 x1744) x4054 (x4896 x1744)))
(define-fun x2080 ((x1744 Int)) Int (ite (= 32 x1744) x2806 (x3916 x1744)))
(define-fun x3770 ((x1744 Int)) Int (ite (= x1744 64) x3587 (x2080 x1744)))
(define-fun x5101 ((x1744 Int)) Int (ite (= 96 x1744) x3046 (x3770 x1744)))
(define-fun x2144 ((x1744 Int)) Int (ite (= 128 x1744) x167 (x5101 x1744)))
(define-fun x4237 ((x1744 Int)) Int (ite (= x1744 128) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x2295 x1744)))
(define-fun x4853 ((x1744 Int)) Int (ite (= x1744 132) 274184521717934524641157099916833587210 (x4237 x1744)))
(define-fun x3126 ((x1744 Int)) Int (ite (= x1744 0) x1676 (x1734 x1744)))
(define-fun x3452 ((x1744 Int)) Int (ite (= x1744 128) x1676 (x4853 x1744)))
(define-fun x4543 ((x1744 Int)) Int (ite (= x1744 160) 16156842317565293874272834530371880720966471053262404558597773956279093428224 (x3452 x1744)))
(define-fun x3509 ((x1744 Int)) Int (ite (= x1744 164) x4857 (x4543 x1744)))
(define-fun x4248 ((x1744 Int)) Int (ite (= x1744 196) 274184521717934524641157099916833587210 (x3509 x1744)))
(define-fun x2536 ((x1744 Int)) Int (ite (= x1744 228) x4326 (x4248 x1744)))
(define-fun x879 ((x1744 x2506)) Int (ite (= x1744 x4441) x5060 (x3181 x1744)))
(define-fun x4632 ((x1744 Int)) Int (ite (= x1744 0) 1 (x312 x1744)))
(define-fun x2 ((x1744 Int)) Int (ite (= 160 x1744) 1 (x2536 x1744)))
(define-fun x1067 ((x1744 Int)) Int (ite (and x5044 (not x4201)) (x1395 x1744) (ite x2150 (x2332 x1744) (x2986 x1744))))
(define-fun x2713 ((x1744 Int)) Int (ite (= x1744 x1869) 76450787359836037641860180984291677749980919077056822294353438043884394381312 (x1067 x1744)))
(define-fun x4833 ((x1744 Int)) Int (ite (= x1744 x2699) x4857 (x2713 x1744)))
(define-fun x3201 ((x1744 Int)) Int (ite (= x1744 x3714) x3706 (x4833 x1744)))
(define-fun x152 ((x1744 x2506)) Int (ite (= x683 x1744) x376 (x3181 x1744)))
(define-fun x2013 ((x1744 Int)) Int (ite (= x1744 0) 1 (x2016 x1744)))
(define-fun x5109 ((x1744 Int)) Int (ite (= x1869 x1744) 1 (x3201 x1744)))
(define-fun x3364 ((x1744 Int)) Int (ite (and x4500 x2676 x4109) (x1982 x1744) (x2161 x1744)))
(define-fun x2770 ((x1744 x2506)) Int (ite (= x4409 x1744) x1384 (x3703 x1744)))
(define-fun x2813 ((x1744 x2506)) Int (ite (= x4409 x1744) x4841 (x4204 x1744)))
(define-fun x4419 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x4331 x1744)))
(define-fun x3978 ((x1744 Int)) Int (ite (= 160 x1744) x182 (x4419 x1744)))
(define-fun x4802 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x3978 x1744)))
(define-fun x803 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x4802 x1744)))
(define-fun x473 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x803 x1744)))
(define-fun x4365 ((x1744 Int)) Int (ite (= 0 x1744) x2925 (x682 x1744)))
(define-fun x3895 ((x1744 Int)) Int (ite (= x1744 32) x159 (x4365 x1744)))
(define-fun x738 ((x1744 Int)) Int (ite (= 64 x1744) x3512 (x3895 x1744)))
(define-fun x1231 ((x1744 Int)) Int (ite (= 96 x1744) x1517 (x738 x1744)))
(define-fun x4255 ((x1744 Int)) Int (ite (= 128 x1744) x4462 (x1231 x1744)))
(define-fun x332 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x4581 x1744)))
(define-fun x4384 ((x1744 Int)) Int (ite (= x1744 160) x1646 (x332 x1744)))
(define-fun x2204 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x4384 x1744)))
(define-fun x1142 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x2204 x1744)))
(define-fun x1576 ((x1744 Int)) Int (ite (= x1744 256) x888 (x1142 x1744)))
(define-fun x4373 ((x1744 Int)) Int (ite (= 0 x1744) x864 (x5142 x1744)))
(define-fun x4361 ((x1744 Int)) Int (ite (= x1744 32) x2454 (x4373 x1744)))
(define-fun x1942 ((x1744 Int)) Int (ite (= 64 x1744) x3759 (x4361 x1744)))
(define-fun x177 ((x1744 Int)) Int (ite (= x1744 96) x4385 (x1942 x1744)))
(define-fun x1220 ((x1744 Int)) Int (ite (= 128 x1744) x1580 (x177 x1744)))
(define-fun x3304 ((x1744 Int)) Int (ite (= x3264 x1744) x3832 (x1949 x1744)))
(define-fun x1248 ((x1744 Int)) Int (ite x1809 (x3304 x1744) (x1949 x1744)))
(define-fun x823 ((x1744 Int)) Int (ite (= x4979 x1744) x4534 (x1248 x1744)))
(define-fun x3297 ((x1744 Int)) Int (ite (= x2962 x1744) x3590 (x2171 x1744)))
(define-fun x5212 ((x1744 Int)) Int (ite x1809 (x3297 x1744) (x2171 x1744)))
(define-fun x1601 ((x1744 Int)) Int (ite (= x903 x1744) x439 (x5212 x1744)))
(define-fun x4589 ((x1744 Int)) Int (ite (= x1744 x950) x657 (x3806 x1744)))
(define-fun x3444 ((x1744 Int)) Int (ite x1809 (x4589 x1744) (x3806 x1744)))
(define-fun x4093 ((x1744 Int)) Int (ite (= x1744 x781) x1768 (x3444 x1744)))
(define-fun x644 ((x1744 Int)) Int (ite (= x1744 x3848) x4693 (x85 x1744)))
(define-fun x1703 ((x1744 Int)) Int (ite x1809 (x644 x1744) (x85 x1744)))
(define-fun x3470 ((x1744 Int)) Int (ite (= x1744 x1280) x2218 (x1703 x1744)))
(define-fun x2166 ((x1744 Int)) Int (ite (= x1744 x2908) x4288 (x453 x1744)))
(define-fun x402 ((x1744 Int)) Int (ite x1809 (x2166 x1744) (x453 x1744)))
(define-fun x2462 ((x1744 Int)) Int (ite (= x1744 x3030) x4295 (x402 x1744)))
(define-fun x3270 ((x1744 Int)) Int (ite (= x1744 x2211) x625 (x2718 x1744)))
(define-fun x2655 ((x1744 Int)) Int (ite x1809 (x3270 x1744) (x2718 x1744)))
(define-fun x255 ((x1744 Int)) Int (ite (= x358 x1744) x2333 (x2655 x1744)))
(define-fun x2254 ((x1744 Int)) Int (ite (= x1744 x3656) x3907 (x4667 x1744)))
(define-fun x1664 ((x1744 Int)) Int (ite x1809 (x2254 x1744) (x4667 x1744)))
(define-fun x2228 ((x1744 Int)) Int (ite (= x1843 x1744) x2463 (x1664 x1744)))
(define-fun x985 ((x1744 Int)) Int (ite (= x1744 x3169) x286 (x4179 x1744)))
(define-fun x5092 ((x1744 Int)) Int (ite x1809 (x985 x1744) (x4179 x1744)))
(define-fun x3105 ((x1744 Int)) Int (ite (= x1479 x1744) x5077 (x5092 x1744)))
(define-fun x2104 ((x1744 x2506)) Int (ite (= x2097 x1744) x295 (x4399 x1744)))
(define-fun x366 ((x1744 Int)) Int (ite (= x1744 960) x2963 (x1361 x1744)))
(define-fun x196 ((x1744 Int)) Int (ite (= 992 x1744) x2798 (x366 x1744)))
(define-fun x2341 ((x1744 Int)) Int (ite (= x1744 1024) x3107 (x196 x1744)))
(define-fun x2428 ((x1744 Int)) Int (ite (= x1744 1056) x1304 (x2341 x1744)))
(define-fun x1214 ((x1744 Int)) Int (ite (= 1088 x1744) x5170 (x2428 x1744)))
(define-fun x4869 ((x1744 Int)) Int (ite (= 960 x1744) x4259 (x1361 x1744)))
(define-fun x4338 ((x1744 Int)) Int (ite (= x1744 992) x479 (x4869 x1744)))
(define-fun x3158 ((x1744 Int)) Int (ite (= 1024 x1744) x1423 (x4338 x1744)))
(define-fun x2398 ((x1744 Int)) Int (ite (= 1056 x1744) x2573 (x3158 x1744)))
(define-fun x2476 ((x1744 Int)) Int (ite (= x1744 1088) x4734 (x2398 x1744)))
(define-fun x2930 ((x1744 Int)) Int (ite (and x4472 x2948) (x1214 x1744) (x2476 x1744)))
(define-fun x2617 ((x1744 Int)) Int (ite (= x1744 x2576) x2128 (x1913 x1744)))
(define-fun x812 ((x1744 Int)) Int (ite (= x3345 x1744) x1927 (x2617 x1744)))
(define-fun x233 ((x1744 Int)) Int (ite (= x1744 x621) x4674 (x812 x1744)))
(define-fun x2897 ((x1744 Int)) Int (ite (= x872 x1744) x1737 (x233 x1744)))
(define-fun x2995 ((x1744 Int)) Int (ite (= x4920 x1744) x518 (x2897 x1744)))
(define-fun x392 ((x1744 Int)) Int (ite (= x2576 x1744) x4358 (x1913 x1744)))
(define-fun x2985 ((x1744 Int)) Int (ite (= x1744 x4610) x2239 (x392 x1744)))
(define-fun x4932 ((x1744 Int)) Int (ite (= x83 x1744) x4354 (x2985 x1744)))
(define-fun x5013 ((x1744 Int)) Int (ite (= x551 x1744) x3203 (x4932 x1744)))
(define-fun x2245 ((x1744 Int)) Int (ite (= x609 x1744) x1971 (x5013 x1744)))
(define-fun x251 ((x1744 Int)) Int (ite (and x2741 x3058) (x2995 x1744) (x2245 x1744)))
(define-fun x544 ((x1744 Int)) Int (ite (= x1835 x1744) x1693 (x5028 x1744)))
(define-fun x4539 ((x1744 Int)) Int (ite (= x1744 x4421) x4856 (x544 x1744)))
(define-fun x3884 ((x1744 Int)) Int (ite (= x166 x1744) x4482 (x4539 x1744)))
(define-fun x1080 ((x1744 Int)) Int (ite (= x4379 x1744) x4276 (x3884 x1744)))
(define-fun x2994 ((x1744 Int)) Int (ite (= x4490 x1744) x5125 (x1080 x1744)))
(define-fun x1091 ((x1744 Int)) Int (ite (= x1835 x1744) x4740 (x5028 x1744)))
(define-fun x4594 ((x1744 Int)) Int (ite (= x1744 x3290) x87 (x1091 x1744)))
(define-fun x4536 ((x1744 Int)) Int (ite (= x1744 x3635) x1625 (x4594 x1744)))
(define-fun x3495 ((x1744 Int)) Int (ite (= x1443 x1744) x824 (x4536 x1744)))
(define-fun x224 ((x1744 Int)) Int (ite (= x1744 x2817) x3308 (x3495 x1744)))
(define-fun x4200 ((x1744 Int)) Int (ite (= x1744 x1178) x2494 (x2679 x1744)))
(define-fun x2815 ((x1744 Int)) Int (ite (= x1744 x4699) x4793 (x4200 x1744)))
(define-fun x1783 ((x1744 Int)) Int (ite (= x1744 x2157) x5174 (x2815 x1744)))
(define-fun x2673 ((x1744 Int)) Int (ite (= x3647 x1744) x3363 (x1783 x1744)))
(define-fun x5259 ((x1744 Int)) Int (ite (= x2114 x1744) x2785 (x2673 x1744)))
(define-fun x5225 ((x1744 Int)) Int (ite (= x1178 x1744) x4415 (x2679 x1744)))
(define-fun x4195 ((x1744 Int)) Int (ite (= x3997 x1744) x3899 (x5225 x1744)))
(define-fun x630 ((x1744 Int)) Int (ite (= x566 x1744) x673 (x4195 x1744)))
(define-fun x420 ((x1744 Int)) Int (ite (= x1744 x3436) x3737 (x630 x1744)))
(define-fun x2030 ((x1744 Int)) Int (ite (= x1744 x1276) x2219 (x420 x1744)))
(define-fun x5208 ((x1744 Int)) Int (ite (and x3534 x791) (x5259 x1744) (x2030 x1744)))
(define-fun x1439 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x1209 x1744)))
(define-fun x753 ((x1744 Int)) Int (ite (= x1744 160) x5146 (x1439 x1744)))
(define-fun x4767 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x753 x1744)))
(define-fun x4845 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x4767 x1744)))
(define-fun x1128 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x4845 x1744)))
(define-fun x4161 ((x1744 Int)) Int (ite (= x1744 x1160) x5164 (x3929 x1744)))
(define-fun x1723 ((x1744 Int)) Int (ite (= x1744 x219) x4148 (x4161 x1744)))
(define-fun x1102 ((x1744 Int)) Int (ite (= x4507 x1744) x2202 (x1723 x1744)))
(define-fun x218 ((x1744 Int)) Int (ite (= x1744 x4609) x4098 (x1102 x1744)))
(define-fun x1420 ((x1744 Int)) Int (ite (= x3748 x1744) x3968 (x218 x1744)))
(define-fun x1932 ((x1744 Int)) Int (ite (= x1744 0) x2397 (x5158 x1744)))
(define-fun x3809 ((x1744 Int)) Int (ite (= x1744 32) x2331 (x1932 x1744)))
(define-fun x3167 ((x1744 Int)) Int (ite (= 64 x1744) x649 (x3809 x1744)))
(define-fun x1257 ((x1744 Int)) Int (ite (= x1744 96) x3735 (x3167 x1744)))
(define-fun x512 ((x1744 Int)) Int (ite (= 128 x1744) x3817 (x1257 x1744)))
(define-fun x2574 ((x1744 Int)) Int (ite (= x1744 x1160) x3226 (x3929 x1744)))
(define-fun x2436 ((x1744 Int)) Int (ite (= x4370 x1744) x4479 (x2574 x1744)))
(define-fun x651 ((x1744 Int)) Int (ite (= x2376 x1744) x3204 (x2436 x1744)))
(define-fun x70 ((x1744 Int)) Int (ite (= x1744 x5012) x3230 (x651 x1744)))
(define-fun x4388 ((x1744 Int)) Int (ite (= x207 x1744) x1458 (x70 x1744)))
(define-fun x2845 ((x1744 Int)) Int (ite (and x853 x180) (x1420 x1744) (x4388 x1744)))
(define-fun x1494 ((x1744 Int)) Int (ite x3447 (x2845 x1744) (x2276 x1744)))
(define-fun x427 ((x1744 Int)) Int (ite x511 (ite (and x372 (not x4981)) (x2276 x1744) (ite (and x3054 (not x790)) (x4944 x1744) (x1494 x1744))) (ite (and x374 (not x3908)) (x2276 x1744) (x4944 x1744))))
(define-fun x2001 ((x1744 Int)) Int (ite (= x5081 x1744) 76450787359836037641860180984291677749980919077056822294353438043884394381312 (x427 x1744)))
(define-fun x1893 ((x1744 Int)) Int (ite (= x1744 x1669) x3088 (x2001 x1744)))
(define-fun x959 ((x1744 x2506)) Int (ite (= x3481 x1744) x3571 (x2774 x1744)))
(define-fun x3063 ((x1744 x2506)) Int (ite (= x1744 x4950) x4884 (x959 x1744)))
(define-fun x3086 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x3768 x1744)))
(define-fun x5154 ((x1744 Int)) Int (ite (= x1744 x5081) 1 (x2518 x1744)))
(define-fun x4056 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x3833 x1744)))
(define-fun x3365 ((x1744 Int)) Int (ite (= x1744 160) x846 (x4056 x1744)))
(define-fun x3856 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x3365 x1744)))
(define-fun x4073 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x3856 x1744)))
(define-fun x3592 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x4073 x1744)))
(define-fun x337 ((x1744 Int)) Int (ite (= x1744 0) x3795 (x1481 x1744)))
(define-fun x2691 ((x1744 Int)) Int (ite (= 32 x1744) x4044 (x337 x1744)))
(define-fun x4381 ((x1744 Int)) Int (ite (= 64 x1744) x1385 (x2691 x1744)))
(define-fun x189 ((x1744 Int)) Int (ite (= 96 x1744) x1154 (x4381 x1744)))
(define-fun x1833 ((x1744 Int)) Int (ite (= x1744 128) x3326 (x189 x1744)))
(define-fun x2997 ((x1744 Int)) Int (ite (= x1744 704) x2230 (x3343 x1744)))
(define-fun x1513 ((x1744 Int)) Int (ite (= x1744 736) x1105 (x3137 x1744)))
(define-fun x2980 ((x1744 Int)) Int (ite (= 768 x1744) x4458 (x1782 x1744)))
(define-fun x1208 ((x1744 Int)) Int (ite (= x1744 800) x2175 (x4866 x1744)))
(define-fun x3798 ((x1744 Int)) Int (ite (= 832 x1744) x4343 (x2613 x1744)))
(define-fun x3074 ((x1744 Int)) Int (ite (= x1744 864) x3787 (x2852 x1744)))
(define-fun x4174 ((x1744 Int)) Int (ite (= x1744 896) x50 (x4659 x1744)))
(define-fun x2767 ((x1744 Int)) Int (ite (= 928 x1744) x2782 (x2020 x1744)))
(define-fun x1354 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x1456 x1744)))
(define-fun x815 ((x1744 Int)) Int (ite (= x1744 160) x4396 (x1354 x1744)))
(define-fun x4854 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x815 x1744)))
(define-fun x677 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x4854 x1744)))
(define-fun x749 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x677 x1744)))
(define-fun x2192 ((x1744 Int)) Int (ite (= x1744 0) x5218 (x1508 x1744)))
(define-fun x768 ((x1744 Int)) Int (ite (= x1744 32) x3810 (x2192 x1744)))
(define-fun x191 ((x1744 Int)) Int (ite (= 64 x1744) x5110 (x768 x1744)))
(define-fun x3599 ((x1744 Int)) Int (ite (= 96 x1744) x1585 (x191 x1744)))
(define-fun x816 ((x1744 Int)) Int (ite (= 128 x1744) x522 (x3599 x1744)))
(define-fun x2433 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x1379 x1744)))
(define-fun x3671 ((x1744 Int)) Int (ite (= x1744 160) x4403 (x2433 x1744)))
(define-fun x1591 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x3671 x1744)))
(define-fun x2903 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x1591 x1744)))
(define-fun x4264 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x2903 x1744)))
(define-fun x3919 ((x1744 Int)) Int (ite (= 0 x1744) x1309 (x531 x1744)))
(define-fun x4128 ((x1744 Int)) Int (ite (= 32 x1744) x1895 (x3919 x1744)))
(define-fun x4558 ((x1744 Int)) Int (ite (= x1744 64) x192 (x4128 x1744)))
(define-fun x1227 ((x1744 Int)) Int (ite (= x1744 96) x444 (x4558 x1744)))
(define-fun x509 ((x1744 Int)) Int (ite (= x1744 128) x421 (x1227 x1744)))
(define-fun x4545 ((x1744 Int)) Int (ite (= 288 x1744) x5008 (x1448 x1744)))
(define-fun x279 ((x1744 Int)) Int (ite (= 320 x1744) x2688 (x4545 x1744)))
(define-fun x2640 ((x1744 Int)) Int (ite (= x1744 352) x718 (x279 x1744)))
(define-fun x1090 ((x1744 Int)) Int (ite (= x1744 384) x4727 (x2640 x1744)))
(define-fun x2900 ((x1744 Int)) Int (ite (= 416 x1744) x3649 (x1090 x1744)))
(define-fun x5202 ((x1744 Int)) Int (ite (= x1744 288) x3234 (x1448 x1744)))
(define-fun x2570 ((x1744 Int)) Int (ite (= x1744 320) x365 (x5202 x1744)))
(define-fun x2279 ((x1744 Int)) Int (ite (= x1744 352) x147 (x2570 x1744)))
(define-fun x1359 ((x1744 Int)) Int (ite (= 384 x1744) x2972 (x2279 x1744)))
(define-fun x4342 ((x1744 Int)) Int (ite (= 416 x1744) x1828 (x1359 x1744)))
(define-fun x2440 ((x1744 Int)) Int (ite (= x5089 x1744) x4297 (x2828 x1744)))
(define-fun x3597 ((x1744 Int)) Int (ite (= x4570 x1744) x4114 (x2440 x1744)))
(define-fun x3454 ((x1744 Int)) Int (ite (= x1744 x1545) x5017 (x3597 x1744)))
(define-fun x2039 ((x1744 Int)) Int (ite (= x1744 x4153) x325 (x3454 x1744)))
(define-fun x3753 ((x1744 Int)) Int (ite (= x1246 x1744) x973 (x2039 x1744)))
(define-fun x2066 ((x1744 Int)) Int (ite (= x1744 x5089) x145 (x2828 x1744)))
(define-fun x1339 ((x1744 Int)) Int (ite (= x1744 x2698) x905 (x2066 x1744)))
(define-fun x1765 ((x1744 Int)) Int (ite (= x515 x1744) x1184 (x1339 x1744)))
(define-fun x3964 ((x1744 Int)) Int (ite (= x1744 x437) x384 (x1765 x1744)))
(define-fun x4705 ((x1744 Int)) Int (ite (= x2888 x1744) x4406 (x3964 x1744)))
(define-fun x2306 ((x1744 Int)) Int (ite (and x4001 x4657) (x3753 x1744) (x4705 x1744)))
(define-fun x5113 ((x1744 Int)) Int (ite (and (not x5223) x1268) (x204 x1744) (x1249 x1744)))
(define-fun x4717 ((x1744 Int)) Int (ite (= x1744 x3773) x1320 (x1512 x1744)))
(define-fun x4989 ((x1744 Int)) Int (ite (and x1914 x2329) (x4717 x1744) (x1512 x1744)))
(define-fun x832 ((x1744 Int)) Int (ite (= x1744 x1075) x1860 (x4989 x1744)))
(define-fun x5219 ((x1744 Int)) Int (ite (= x849 x1744) x4807 (x38 x1744)))
(define-fun x2387 ((x1744 Int)) Int (ite (and x2329 x1914) (x5219 x1744) (x38 x1744)))
(define-fun x3213 ((x1744 Int)) Int (ite (= x33 x1744) x465 (x2387 x1744)))
(define-fun x105 ((x1744 Int)) Int (ite (= x1744 x1222) x457 (x3556 x1744)))
(define-fun x1242 ((x1744 Int)) Int (ite (and x1914 x2329) (x105 x1744) (x3556 x1744)))
(define-fun x449 ((x1744 Int)) Int (ite (= x1118 x1744) x2533 (x1242 x1744)))
(define-fun x1283 ((x1744 Int)) Int (ite (= x1744 x4552) x643 (x3550 x1744)))
(define-fun x3067 ((x1744 Int)) Int (ite (and x2329 x1914) (x1283 x1744) (x3550 x1744)))
(define-fun x4664 ((x1744 Int)) Int (ite (= x1166 x1744) x5252 (x3067 x1744)))
(define-fun x4079 ((x1744 Int)) Int (ite (= x910 x1744) x3783 (x4436 x1744)))
(define-fun x4603 ((x1744 Int)) Int (ite (and x1914 x2329) (x4079 x1744) (x4436 x1744)))
(define-fun x4511 ((x1744 Int)) Int (ite (= x1744 x2409) x2023 (x4603 x1744)))
(define-fun x3948 ((x1744 Int)) Int (ite (= x1744 x3271) x4901 (x1830 x1744)))
(define-fun x4941 ((x1744 Int)) Int (ite (and x1914 x2329) (x3948 x1744) (x1830 x1744)))
(define-fun x2082 ((x1744 Int)) Int (ite (= x1744 x307) x4595 (x4941 x1744)))
(define-fun x1461 ((x1744 Int)) Int (ite (= x188 x1744) x1186 (x416 x1744)))
(define-fun x1638 ((x1744 Int)) Int (ite (and x2329 x1914) (x1461 x1744) (x416 x1744)))
(define-fun x1822 ((x1744 Int)) Int (ite (= x955 x1744) x2301 (x1638 x1744)))
(define-fun x1731 ((x1744 Int)) Int (ite (= x3527 x1744) x1470 (x3003 x1744)))
(define-fun x964 ((x1744 Int)) Int (ite (and x1914 x2329) (x1731 x1744) (x3003 x1744)))
(define-fun x2280 ((x1744 Int)) Int (ite (= x1744 x3867) x2340 (x964 x1744)))
(define-fun x1572 ((x1744 Int)) Int (ite (= x5118 x1744) x223 (x3104 x1744)))
(define-fun x3476 ((x1744 Int)) Int (ite (and x214 x3245) (x1572 x1744) (x3104 x1744)))
(define-fun x4606 ((x1744 Int)) Int (ite (= x1744 x382) x20 (x3476 x1744)))
(define-fun x1595 ((x1744 Int)) Int (ite (= x1744 x945) x786 (x2631 x1744)))
(define-fun x2417 ((x1744 Int)) Int (ite (and x214 x3245) (x1595 x1744) (x2631 x1744)))
(define-fun x2841 ((x1744 Int)) Int (ite (= x1744 x2906) x1098 (x2417 x1744)))
(define-fun x503 ((x1744 Int)) Int (ite (= x1744 x2345) x1754 (x58 x1744)))
(define-fun x1909 ((x1744 Int)) Int (ite (and x3245 x214) (x503 x1744) (x58 x1744)))
(define-fun x4496 ((x1744 Int)) Int (ite (= x2275 x1744) x696 (x1909 x1744)))
(define-fun x4501 ((x1744 Int)) Int (ite (= x1881 x1744) x2895 (x4322 x1744)))
(define-fun x3378 ((x1744 Int)) Int (ite (and x3245 x214) (x4501 x1744) (x4322 x1744)))
(define-fun x4959 ((x1744 Int)) Int (ite (= x1692 x1744) x4187 (x3378 x1744)))
(define-fun x333 ((x1744 Int)) Int (ite (= x1744 x3766) x284 (x999 x1744)))
(define-fun x406 ((x1744 Int)) Int (ite (and x214 x3245) (x333 x1744) (x999 x1744)))
(define-fun x4612 ((x1744 Int)) Int (ite (= x1744 x4090) x4014 (x406 x1744)))
(define-fun x4917 ((x1744 Int)) Int (ite (= x1744 x3918) x889 (x1917 x1744)))
(define-fun x1169 ((x1744 Int)) Int (ite (and x214 x3245) (x4917 x1744) (x1917 x1744)))
(define-fun x628 ((x1744 Int)) Int (ite (= x2819 x1744) x3954 (x1169 x1744)))
(define-fun x3035 ((x1744 Int)) Int (ite (= x1744 x4915) x3038 (x2283 x1744)))
(define-fun x4258 ((x1744 Int)) Int (ite (and x3245 x214) (x3035 x1744) (x2283 x1744)))
(define-fun x2022 ((x1744 Int)) Int (ite (= x5189 x1744) x4973 (x4258 x1744)))
(define-fun x2750 ((x1744 Int)) Int (ite (= x1744 x3619) x4775 (x1533 x1744)))
(define-fun x1701 ((x1744 Int)) Int (ite (and x3245 x214) (x2750 x1744) (x1533 x1744)))
(define-fun x4051 ((x1744 Int)) Int (ite (= x1744 x3352) x5082 (x1701 x1744)))
(define-fun x2923 ((x1744 Int)) Int (ite (= x2420 x1744) x3721 (x4540 x1744)))
(define-fun x2515 ((x1744 Int)) Int (ite (= x1744 x1477) x2423 (x2923 x1744)))
(define-fun x4027 ((x1744 Int)) Int (ite (= x1744 x3200) x1978 (x2515 x1744)))
(define-fun x172 ((x1744 Int)) Int (ite (= x3406 x1744) x3357 (x4027 x1744)))
(define-fun x2638 ((x1744 Int)) Int (ite (= x1744 x1259) x1452 (x172 x1744)))
(define-fun x3463 ((x1744 Int)) Int (ite (= x2420 x1744) x1052 (x4540 x1744)))
(define-fun x4144 ((x1744 Int)) Int (ite (= x1108 x1744) x1440 (x3463 x1744)))
(define-fun x4809 ((x1744 Int)) Int (ite (= x1744 x863) x1657 (x4144 x1744)))
(define-fun x4599 ((x1744 Int)) Int (ite (= x1744 x2427) x3952 (x4809 x1744)))
(define-fun x5255 ((x1744 Int)) Int (ite (= x1744 x2360) x2547 (x4599 x1744)))
(define-fun x1826 ((x1744 Int)) Int (ite (and x2094 x61) (x2638 x1744) (x5255 x1744)))
(define-fun x1994 ((x1744 Int)) Int (ite (and x4466 x1532) (x204 x1744) (x1826 x1744)))
(define-fun x3269 ((x1744 Int)) Int (ite (= x1744 128) x123 (x4420 x1744)))
(define-fun x694 ((x1744 Int)) Int (ite (= 160 x1744) x1808 (x3269 x1744)))
(define-fun x1308 ((x1744 Int)) Int (ite (= x1744 192) x2775 (x694 x1744)))
(define-fun x163 ((x1744 Int)) Int (ite (= x1744 224) x2697 (x1308 x1744)))
(define-fun x3442 ((x1744 Int)) Int (ite (= 256 x1744) x1762 (x163 x1744)))
(define-fun x3740 ((x1744 Int)) Int (ite (= x1744 128) x582 (x4420 x1744)))
(define-fun x3397 ((x1744 Int)) Int (ite (= 160 x1744) x590 (x3740 x1744)))
(define-fun x2470 ((x1744 Int)) Int (ite (= 192 x1744) x3012 (x3397 x1744)))
(define-fun x1955 ((x1744 Int)) Int (ite (= x1744 224) x4597 (x2470 x1744)))
(define-fun x4676 ((x1744 Int)) Int (ite (= 256 x1744) x4925 (x1955 x1744)))
(define-fun x4320 ((x1744 Int)) Int (ite (= x1421 x1744) x2938 (x2876 x1744)))
(define-fun x4266 ((x1744 Int)) Int (ite (= x1744 x835) x645 (x4320 x1744)))
(define-fun x2421 ((x1744 Int)) Int (ite (= x1744 x1769) x4502 (x4266 x1744)))
(define-fun x2313 ((x1744 Int)) Int (ite (= x1744 x2859) x106 (x2421 x1744)))
(define-fun x464 ((x1744 Int)) Int (ite (= x1744 x1474) x4242 (x2313 x1744)))
(define-fun x1193 ((x1744 Int)) Int (ite (= x1744 x1421) x2067 (x2876 x1744)))
(define-fun x4990 ((x1744 Int)) Int (ite (= x2351 x1744) x1241 (x1193 x1744)))
(define-fun x594 ((x1744 Int)) Int (ite (= x1744 x3053) x639 (x4990 x1744)))
(define-fun x1787 ((x1744 Int)) Int (ite (= x1744 x3650) x7 (x594 x1744)))
(define-fun x2803 ((x1744 Int)) Int (ite (= x953 x1744) x4219 (x1787 x1744)))
(define-fun x4207 ((x1744 Int)) Int (ite (and x3582 x1622) (x464 x1744) (x2803 x1744)))
(define-fun x939 ((x1744 Int)) Int (ite (= x4087 x1744) x3664 (x5231 x1744)))
(define-fun x2707 ((x1744 Int)) Int (ite (= x1744 x4573) x4028 (x939 x1744)))
(define-fun x1720 ((x1744 Int)) Int (ite (= x909 x1744) x3141 (x2707 x1744)))
(define-fun x1546 ((x1744 Int)) Int (ite (= x4924 x1744) x2129 (x1720 x1744)))
(define-fun x3327 ((x1744 Int)) Int (ite (= x1744 x2378) x3032 (x1546 x1744)))
(define-fun x4764 ((x1744 Int)) Int (ite (= x1744 x4087) x3702 (x5231 x1744)))
(define-fun x334 ((x1744 Int)) Int (ite (= x3863 x1744) x4134 (x4764 x1744)))
(define-fun x2355 ((x1744 Int)) Int (ite (= x1744 x579) x4768 (x334 x1744)))
(define-fun x885 ((x1744 Int)) Int (ite (= x5072 x1744) x1398 (x2355 x1744)))
(define-fun x2667 ((x1744 Int)) Int (ite (= x2838 x1744) x4514 (x885 x1744)))
(define-fun x2805 ((x1744 Int)) Int (ite (and x4710 x1112) (x3327 x1744) (x2667 x1744)))
(define-fun x895 ((x1744 Int)) Int (ite (and x2541 x2069) (x1197 x1744) (x2805 x1744)))
(define-fun x3902 ((x1744 Int)) Int (ite (and x54 (not x1915)) (x204 x1744) (ite (and x3642 (not x4222)) (x1249 x1744) (x1994 x1744))))
(define-fun x3699 ((x1744 Int)) Int (ite x3071 (ite (and (not x2064) x4329) (x1197 x1744) (ite (and x4100 (not x4880)) (x3143 x1744) (x895 x1744))) (ite (and x2593 (not x574)) (x1197 x1744) (x3143 x1744))))
(define-fun x5171 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x1072 x1744)))
(define-fun x3644 ((x1744 Int)) Int (ite (= 160 x1744) x2352 (x5171 x1744)))
(define-fun x3249 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x3644 x1744)))
(define-fun x3335 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x3249 x1744)))
(define-fun x4489 ((x1744 Int)) Int (ite (= x1744 256) x888 (x3335 x1744)))
(define-fun x1698 ((x1744 Int)) Int (ite (= 0 x1744) x438 (x179 x1744)))
(define-fun x4827 ((x1744 Int)) Int (ite (= 32 x1744) x1380 (x1698 x1744)))
(define-fun x3131 ((x1744 Int)) Int (ite (= x1744 64) x1433 (x4827 x1744)))
(define-fun x4997 ((x1744 Int)) Int (ite (= x1744 96) x1928 (x3131 x1744)))
(define-fun x2458 ((x1744 Int)) Int (ite (= 128 x1744) x2562 (x4997 x1744)))
(define-fun x1124 ((x1744 x2506)) Int (ite (= x820 x1744) x2935 (x2104 x1744)))
(define-fun x971 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x3579 x1744)))
(define-fun x3561 ((x1744 Int)) Int (ite (= x1744 160) x3589 (x971 x1744)))
(define-fun x1894 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x3561 x1744)))
(define-fun x3482 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x1894 x1744)))
(define-fun x3348 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x3482 x1744)))
(define-fun x1496 ((x1744 Int)) Int (ite (= 0 x1744) x1865 (x565 x1744)))
(define-fun x319 ((x1744 Int)) Int (ite (= 32 x1744) x3191 (x1496 x1744)))
(define-fun x4283 ((x1744 Int)) Int (ite (= x1744 64) x1668 (x319 x1744)))
(define-fun x2931 ((x1744 Int)) Int (ite (= x1744 96) x5185 (x4283 x1744)))
(define-fun x555 ((x1744 Int)) Int (ite (= 128 x1744) x5075 (x2931 x1744)))
(define-fun x3940 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x4081 x1744)))
(define-fun x4505 ((x1744 Int)) Int (ite (= 160 x1744) x3066 (x3940 x1744)))
(define-fun x916 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x4505 x1744)))
(define-fun x2508 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x916 x1744)))
(define-fun x1177 ((x1744 Int)) Int (ite (= x1744 256) x888 (x2508 x1744)))
(define-fun x2599 ((x1744 Int)) Int (ite (= x1744 0) x288 (x3580 x1744)))
(define-fun x926 ((x1744 Int)) Int (ite (= x1744 32) x5074 (x2599 x1744)))
(define-fun x3389 ((x1744 Int)) Int (ite (= x1744 64) x26 (x926 x1744)))
(define-fun x2359 ((x1744 Int)) Int (ite (= x1744 96) x3078 (x3389 x1744)))
(define-fun x3151 ((x1744 Int)) Int (ite (= x1744 128) x4113 (x2359 x1744)))
(define-fun x2706 ((x1744 Int)) Int (ite (= 128 x1744) x4350 (x4443 x1744)))
(define-fun x306 ((x1744 Int)) Int (ite (= 160 x1744) x4191 (x2706 x1744)))
(define-fun x4562 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x306 x1744)))
(define-fun x2309 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x4562 x1744)))
(define-fun x1522 ((x1744 Int)) Int (ite (= x1744 256) x888 (x2309 x1744)))
(define-fun x678 ((x1744 Int)) Int (ite (= 0 x1744) x1962 (x2385 x1744)))
(define-fun x2407 ((x1744 Int)) Int (ite (= x1744 32) x2242 (x678 x1744)))
(define-fun x1145 ((x1744 Int)) Int (ite (= x1744 64) x5157 (x2407 x1744)))
(define-fun x150 ((x1744 Int)) Int (ite (= x1744 96) x1015 (x1145 x1744)))
(define-fun x4218 ((x1744 Int)) Int (ite (= 128 x1744) x1659 (x150 x1744)))
(define-fun x1360 ((x1744 Int)) Int (ite (= 128 x1744) x2628 (x3189 x1744)))
(define-fun x4819 ((x1744 Int)) Int (ite (= 128 x1744) x3778 (x1360 x1744)))
(define-fun x80 ((x1744 Int)) Int (ite (= x1179 x1744) 76450787359836037641860180984291677749980919077056822294353438043884394381312 (x3699 x1744)))
(define-fun x4588 ((x1744 Int)) Int (ite (= x4868 x1744) x4857 (x80 x1744)))
(define-fun x2488 ((x1744 x2506)) Int (ite (= x3606 x1744) x1345 (x3255 x1744)))
(define-fun x1225 ((x1744 x2506)) Int (ite (= x1744 x4348) x1059 (x3255 x1744)))
(define-fun x2514 ((x1744 x2506)) Int (ite (= x4348 x1744) x5078 (x3703 x1744)))
(define-fun x1690 ((x1744 Int)) Int (ite (and (not x5018) x1346) (x4949 x1744) (ite x3069 (x3902 x1744) (x5113 x1744))))
(define-fun x4210 ((x1744 Int)) Int (ite (= x2912 x1744) 76450787359836037641860180984291677749980919077056822294353438043884394381312 (x1690 x1744)))
(define-fun x3897 ((x1744 Int)) Int (ite (= x1641 x1744) x4857 (x4210 x1744)))
(define-fun x2112 ((x1744 Int)) Int (ite (= x1744 192) x810 (x2790 x1744)))
(define-fun x769 ((x1744 Int)) Int (ite (= 192 x1744) x967 (x2790 x1744)))
(define-fun x5147 ((x1744 Int)) Int (ite (and x3751 (not x4305)) (x2112 x1744) (x769 x1744)))
(define-fun x1204 ((x1744 Int)) Int (ite (= 160 x1744) x1724 (x2571 x1744)))
(define-fun x543 ((x1744 Int)) Int (ite (= x1744 160) x2026 (x2571 x1744)))
(define-fun x1018 ((x1744 Int)) Int (ite (and x1460 x5130) (x543 x1744) (x1204 x1744)))
(define-fun x2740 ((x1744 Int)) Int (ite (= x1744 224) x1121 (x4703 x1744)))
(define-fun x3503 ((x1744 Int)) Int (ite (= 256 x1744) x339 (x944 x1744)))
(define-fun x2881 ((x1744 x2506)) Int (ite (= x1744 x2942) x1468 (x308 x1744)))
(define-fun x813 ((x1744 Int)) Int (ite (= x1744 x2912) 1 (x3286 x1744)))
(define-fun x627 ((x1744 Int)) Int (ite x3853 (x3286 x1744) (ite (and (not x5014) (not x2582) x520) (x813 x1744) (x3286 x1744))))
(define-fun x2262 ((x1744 Int)) Int (ite (= x1744 x1179) 1 (x1066 x1744)))
(define-fun x2858 ((x1744 Int)) Int (ite (= x1744 x1179) 1 (x1066 x1744)))
(define-fun x808 ((x1744 Int)) Int (ite (= x1744 x1179) 1 (x1066 x1744)))
(define-fun x3426 ((x1744 Int)) Int (ite x4488 (ite x2937 (x1066 x1744) (x2262 x1744)) (ite x4197 (ite x43 (x1066 x1744) (x2858 x1744)) (ite x4542 (x1066 x1744) (x808 x1744)))))
(define-fun x3847 ((x1744 x2506)) Int (ite (= x4315 x1744) x1730 (x886 x1744)))
(define-fun x3171 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x4939 x1744)))
(define-fun x4865 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x245 x1744)))
(define-fun x5172 ((x1744 Int)) Int (ite (= 160 x1744) x1606 (x4865 x1744)))
(define-fun x4424 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x5172 x1744)))
(define-fun x510 ((x1744 Int)) Int (ite (= 224 x1744) x1834 (x4424 x1744)))
(define-fun x5087 ((x1744 Int)) Int (ite (= 256 x1744) x888 (x510 x1744)))
(define-fun x1566 ((x1744 Int)) Int (ite (= x1744 0) x271 (x3873 x1744)))
(define-fun x422 ((x1744 Int)) Int (ite (= 32 x1744) x692 (x1566 x1744)))
(define-fun x5256 ((x1744 Int)) Int (ite (= 64 x1744) x3041 (x422 x1744)))
(define-fun x5058 ((x1744 Int)) Int (ite (= 96 x1744) x2635 (x5256 x1744)))
(define-fun x1073 ((x1744 Int)) Int (ite (= 128 x1744) x115 (x5058 x1744)))
(define-fun x2605 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x754 x1744)))
(define-fun x811 ((x1744 Int)) Int (ite (= x1744 160) x3888 (x2605 x1744)))
(define-fun x2979 ((x1744 Int)) Int (ite (= 192 x1744) x2353 (x811 x1744)))
(define-fun x354 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x2979 x1744)))
(define-fun x3059 ((x1744 Int)) Int (ite (= x1744 256) x888 (x354 x1744)))
(define-fun x4929 ((x1744 Int)) Int (ite (= x1744 0) x2904 (x659 x1744)))
(define-fun x954 ((x1744 Int)) Int (ite (= 32 x1744) x3195 (x4929 x1744)))
(define-fun x2952 ((x1744 Int)) Int (ite (= x1744 64) x495 (x954 x1744)))
(define-fun x2818 ((x1744 Int)) Int (ite (= 96 x1744) x3805 (x2952 x1744)))
(define-fun x612 ((x1744 Int)) Int (ite (= 128 x1744) x1038 (x2818 x1744)))
(define-fun x3288 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x4660 x1744)))
(define-fun x4556 ((x1744 Int)) Int (ite (= 160 x1744) x2148 (x3288 x1744)))
(define-fun x412 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x4556 x1744)))
(define-fun x2034 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x412 x1744)))
(define-fun x3129 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x2034 x1744)))
(define-fun x82 ((x1744 Int)) Int (ite (= x1744 0) x1616 (x259 x1744)))
(define-fun x2438 ((x1744 Int)) Int (ite (= 32 x1744) x4459 (x82 x1744)))
(define-fun x2405 ((x1744 Int)) Int (ite (= 64 x1744) x1766 (x2438 x1744)))
(define-fun x4461 ((x1744 Int)) Int (ite (= x1744 96) x5187 (x2405 x1744)))
(define-fun x642 ((x1744 Int)) Int (ite (= 128 x1744) x3845 (x4461 x1744)))
(define-fun x1136 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x1473 x1744)))
(define-fun x1583 ((x1744 Int)) Int (ite (= x1744 160) x1224 (x1136 x1744)))
(define-fun x4628 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x1583 x1744)))
(define-fun x1017 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x4628 x1744)))
(define-fun x2988 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x1017 x1744)))
(define-fun x866 ((x1744 Int)) Int (ite (= 0 x1744) x2554 (x240 x1744)))
(define-fun x5104 ((x1744 Int)) Int (ite (= 32 x1744) x666 (x866 x1744)))
(define-fun x154 ((x1744 Int)) Int (ite (= 64 x1744) x370 (x5104 x1744)))
(define-fun x745 ((x1744 Int)) Int (ite (= 96 x1744) x4303 (x154 x1744)))
(define-fun x4015 ((x1744 Int)) Int (ite (= x1744 128) x3024 (x745 x1744)))
(define-fun x1794 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x3687 x1744)))
(define-fun x3265 ((x1744 Int)) Int (ite (= 160 x1744) x635 (x1794 x1744)))
(define-fun x2220 ((x1744 Int)) Int (ite (= x1744 192) x1863 (x3265 x1744)))
(define-fun x2580 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x2220 x1744)))
(define-fun x1713 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x2580 x1744)))
(define-fun x268 ((x1744 Int)) Int (ite (= x1744 0) x5121 (x4559 x1744)))
(define-fun x3620 ((x1744 Int)) Int (ite (= x1744 32) x280 (x268 x1744)))
(define-fun x5085 ((x1744 Int)) Int (ite (= x1744 64) x882 (x3620 x1744)))
(define-fun x4418 ((x1744 Int)) Int (ite (= x1744 96) x1446 (x5085 x1744)))
(define-fun x4294 ((x1744 Int)) Int (ite (= 128 x1744) x2739 (x4418 x1744)))
(define-fun x161 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x4753 x1744)))
(define-fun x2235 ((x1744 Int)) Int (ite (= x1744 160) x2054 (x161 x1744)))
(define-fun x1161 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x2235 x1744)))
(define-fun x2187 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x1161 x1744)))
(define-fun x4099 ((x1744 Int)) Int (ite (= x1744 256) x443 (x2187 x1744)))
(define-fun x4508 ((x1744 Int)) Int (ite (= x1744 0) x784 (x4896 x1744)))
(define-fun x1386 ((x1744 Int)) Int (ite (= 32 x1744) x4780 (x4508 x1744)))
(define-fun x1293 ((x1744 Int)) Int (ite (= x1744 64) x2027 (x1386 x1744)))
(define-fun x3182 ((x1744 Int)) Int (ite (= 96 x1744) x2860 (x1293 x1744)))
(define-fun x5062 ((x1744 Int)) Int (ite (= x1744 128) x1780 (x3182 x1744)))
(define-fun x4882 ((x1744 x2506)) Int (ite (= x1303 x1744) x3065 (x4495 x1744)))
(define-fun x4095 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x977 x1744)))
(define-fun x198 ((x1744 Int)) Int (ite (= x3774 x1744) 1 (x763 x1744)))
(define-fun x2795 ((x1744 x2506)) Int (ite (= x4522 x1744) x4167 (x507 x1744)))
(define-fun x4243 ((x1744 Int)) Int (ite (= x1744 0) 1 (x977 x1744)))
(define-fun x2282 ((x1744 Int)) Int (ite (= x3774 x1744) 1 (x763 x1744)))
(define-fun x3811 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x1187 x1744)))
(define-fun x2005 ((x1744 Int)) Int (ite (= 160 x1744) x2083 (x3811 x1744)))
(define-fun x3822 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x2005 x1744)))
(define-fun x71 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x3822 x1744)))
(define-fun x516 ((x1744 Int)) Int (ite (= x1744 256) x443 (x71 x1744)))
(define-fun x4105 ((x1744 Int)) Int (ite (= 0 x1744) x3256 (x682 x1744)))
(define-fun x487 ((x1744 Int)) Int (ite (= 32 x1744) x3841 (x4105 x1744)))
(define-fun x906 ((x1744 Int)) Int (ite (= x1744 64) x4948 (x487 x1744)))
(define-fun x2534 ((x1744 Int)) Int (ite (= x1744 96) x3936 (x906 x1744)))
(define-fun x3909 ((x1744 Int)) Int (ite (= 128 x1744) x3329 (x2534 x1744)))
(define-fun x693 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x3166 x1744)))
(define-fun x4978 ((x1744 Int)) Int (ite (= x1744 160) x418 (x693 x1744)))
(define-fun x2736 ((x1744 Int)) Int (ite (= x1744 192) x1863 (x4978 x1744)))
(define-fun x1297 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x2736 x1744)))
(define-fun x5071 ((x1744 Int)) Int (ite (= x1744 256) x443 (x1297 x1744)))
(define-fun x2037 ((x1744 Int)) Int (ite (= 0 x1744) x4585 (x5142 x1744)))
(define-fun x3443 ((x1744 Int)) Int (ite (= x1744 32) x3338 (x2037 x1744)))
(define-fun x470 ((x1744 Int)) Int (ite (= 64 x1744) x5068 (x3443 x1744)))
(define-fun x2443 ((x1744 Int)) Int (ite (= x1744 96) x1623 (x470 x1744)))
(define-fun x1148 ((x1744 Int)) Int (ite (= 128 x1744) x51 (x2443 x1744)))
(define-fun x466 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x1173 x1744)))
(define-fun x2158 ((x1744 Int)) Int (ite (= x1744 160) x2303 (x466 x1744)))
(define-fun x3405 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x2158 x1744)))
(define-fun x3947 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x3405 x1744)))
(define-fun x5053 ((x1744 Int)) Int (ite (= x1744 256) x443 (x3947 x1744)))
(define-fun x2302 ((x1744 Int)) Int (ite (= x1744 0) x757 (x397 x1744)))
(define-fun x494 ((x1744 Int)) Int (ite (= 32 x1744) x4121 (x2302 x1744)))
(define-fun x699 ((x1744 Int)) Int (ite (= x1744 64) x2442 (x494 x1744)))
(define-fun x1110 ((x1744 Int)) Int (ite (= 96 x1744) x2263 (x699 x1744)))
(define-fun x135 ((x1744 Int)) Int (ite (= 128 x1744) x3983 (x1110 x1744)))
(define-fun x4685 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x5025 x1744)))
(define-fun x2929 ((x1744 Int)) Int (ite (= x1744 160) x2434 (x4685 x1744)))
(define-fun x960 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x2929 x1744)))
(define-fun x2011 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x960 x1744)))
(define-fun x1717 ((x1744 Int)) Int (ite (= x1744 256) x443 (x2011 x1744)))
(define-fun x767 ((x1744 Int)) Int (ite (= 0 x1744) x2393 (x5158 x1744)))
(define-fun x993 ((x1744 Int)) Int (ite (= x1744 32) x3254 (x767 x1744)))
(define-fun x4041 ((x1744 Int)) Int (ite (= x1744 64) x1774 (x993 x1744)))
(define-fun x1081 ((x1744 Int)) Int (ite (= 96 x1744) x1772 (x4041 x1744)))
(define-fun x3668 ((x1744 Int)) Int (ite (= x1744 128) x2565 (x1081 x1744)))
(define-fun x1328 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x3281 x1744)))
(define-fun x4278 ((x1744 Int)) Int (ite (= 160 x1744) x3382 (x1328 x1744)))
(define-fun x3097 ((x1744 Int)) Int (ite (= x1744 192) x1863 (x4278 x1744)))
(define-fun x4762 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x3097 x1744)))
(define-fun x1408 ((x1744 Int)) Int (ite (= x1744 256) x443 (x4762 x1744)))
(define-fun x1995 ((x1744 Int)) Int (ite (= x1744 0) x1043 (x1508 x1744)))
(define-fun x3575 ((x1744 Int)) Int (ite (= x1744 32) x5196 (x1995 x1744)))
(define-fun x2461 ((x1744 Int)) Int (ite (= 64 x1744) x1817 (x3575 x1744)))
(define-fun x327 ((x1744 Int)) Int (ite (= x1744 96) x2696 (x2461 x1744)))
(define-fun x2484 ((x1744 Int)) Int (ite (= 128 x1744) x4567 (x327 x1744)))
(define-fun x1526 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x2660 x1744)))
(define-fun x4653 ((x1744 Int)) Int (ite (= 160 x1744) x3247 (x1526 x1744)))
(define-fun x3005 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x4653 x1744)))
(define-fun x2489 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x3005 x1744)))
(define-fun x2825 ((x1744 Int)) Int (ite (= x1744 256) x443 (x2489 x1744)))
(define-fun x679 ((x1744 Int)) Int (ite (= 0 x1744) x3502 (x1481 x1744)))
(define-fun x3119 ((x1744 Int)) Int (ite (= x1744 32) x1321 (x679 x1744)))
(define-fun x4785 ((x1744 Int)) Int (ite (= 64 x1744) x205 (x3119 x1744)))
(define-fun x3391 ((x1744 Int)) Int (ite (= 96 x1744) x4682 (x4785 x1744)))
(define-fun x1428 ((x1744 Int)) Int (ite (= x1744 128) x352 (x3391 x1744)))
(define-fun x4265 ((x1744 x2506)) Int (ite (= x228 x1744) x2875 (x4495 x1744)))
(define-fun x987 ((x1744 x2506)) Int (ite (= x1744 x3786) x1632 (x4265 x1744)))
(define-fun x201 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x3768 x1744)))
(define-fun x2453 ((x1744 Int)) Int (ite (= x5081 x1744) 1 (x2518 x1744)))
(define-fun x4038 ((x1744 x2506)) Int (ite (= x431 x1744) x3578 (x507 x1744)))
(define-fun x660 ((x1744 x2506)) Int (ite (= x1744 x2887) x802 (x4038 x1744)))
(define-fun x3113 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x3768 x1744)))
(define-fun x4604 ((x1744 Int)) Int (ite (= x5081 x1744) 1 (x2518 x1744)))
(define-fun x1375 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x1735 x1744)))
(define-fun x4945 ((x1744 Int)) Int (ite (= x1744 160) x426 (x1375 x1744)))
(define-fun x918 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x4945 x1744)))
(define-fun x2017 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x918 x1744)))
(define-fun x521 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x2017 x1744)))
(define-fun x4728 ((x1744 Int)) Int (ite (= x1744 0) x1945 (x531 x1744)))
(define-fun x4289 ((x1744 Int)) Int (ite (= 32 x1744) x1972 (x4728 x1744)))
(define-fun x5246 ((x1744 Int)) Int (ite (= x1744 64) x4801 (x4289 x1744)))
(define-fun x772 ((x1744 Int)) Int (ite (= x1744 96) x4346 (x5246 x1744)))
(define-fun x2274 ((x1744 Int)) Int (ite (= 128 x1744) x3076 (x772 x1744)))
(define-fun x1122 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x1377 x1744)))
(define-fun x4437 ((x1744 Int)) Int (ite (= 160 x1744) x3173 (x1122 x1744)))
(define-fun x1449 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x4437 x1744)))
(define-fun x1560 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x1449 x1744)))
(define-fun x3680 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x1560 x1744)))
(define-fun x57 ((x1744 Int)) Int (ite (= 0 x1744) x293 (x179 x1744)))
(define-fun x1464 ((x1744 Int)) Int (ite (= x1744 32) x602 (x57 x1744)))
(define-fun x298 ((x1744 Int)) Int (ite (= x1744 64) x3187 (x1464 x1744)))
(define-fun x217 ((x1744 Int)) Int (ite (= x1744 96) x1901 (x298 x1744)))
(define-fun x5041 ((x1744 Int)) Int (ite (= 128 x1744) x1937 (x217 x1744)))
(define-fun x1562 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x2298 x1744)))
(define-fun x4812 ((x1744 Int)) Int (ite (= x1744 160) x3876 (x1562 x1744)))
(define-fun x2406 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x4812 x1744)))
(define-fun x128 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x2406 x1744)))
(define-fun x1943 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x128 x1744)))
(define-fun x2327 ((x1744 Int)) Int (ite (= x1744 0) x3973 (x565 x1744)))
(define-fun x3615 ((x1744 Int)) Int (ite (= 32 x1744) x3420 (x2327 x1744)))
(define-fun x2134 ((x1744 Int)) Int (ite (= 64 x1744) x856 (x3615 x1744)))
(define-fun x2197 ((x1744 Int)) Int (ite (= 96 x1744) x3567 (x2134 x1744)))
(define-fun x1925 ((x1744 Int)) Int (ite (= 128 x1744) x1687 (x2197 x1744)))
(define-fun x597 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x1485 x1744)))
(define-fun x5216 ((x1744 Int)) Int (ite (= 160 x1744) x3618 (x597 x1744)))
(define-fun x4823 ((x1744 Int)) Int (ite (= 192 x1744) x1863 (x5216 x1744)))
(define-fun x2432 ((x1744 Int)) Int (ite (= x1744 224) x2402 (x4823 x1744)))
(define-fun x4876 ((x1744 Int)) Int (ite (= x1744 256) x443 (x2432 x1744)))
(define-fun x1001 ((x1744 Int)) Int (ite (= x1744 0) x3914 (x3580 x1744)))
(define-fun x3643 ((x1744 Int)) Int (ite (= x1744 32) x750 (x1001 x1744)))
(define-fun x3194 ((x1744 Int)) Int (ite (= 64 x1744) x4321 (x3643 x1744)))
(define-fun x3493 ((x1744 Int)) Int (ite (= x1744 96) x2677 (x3194 x1744)))
(define-fun x4229 ((x1744 Int)) Int (ite (= 128 x1744) x4107 (x3493 x1744)))
(define-fun x4891 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x4130 x1744)))
(define-fun x95 ((x1744 Int)) Int (ite (= 160 x1744) x2031 (x4891 x1744)))
(define-fun x3451 ((x1744 Int)) Int (ite (= x1744 192) x1863 (x95 x1744)))
(define-fun x4126 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x3451 x1744)))
(define-fun x3935 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x4126 x1744)))
(define-fun x3278 ((x1744 Int)) Int (ite (= 0 x1744) x3433 (x2385 x1744)))
(define-fun x4510 ((x1744 Int)) Int (ite (= 32 x1744) x4771 (x3278 x1744)))
(define-fun x3330 ((x1744 Int)) Int (ite (= 64 x1744) x4842 (x4510 x1744)))
(define-fun x2646 ((x1744 Int)) Int (ite (= x1744 96) x4746 (x3330 x1744)))
(define-fun x4455 ((x1744 Int)) Int (ite (= 128 x1744) x5134 (x2646 x1744)))
(define-fun x5193 ((x1744 Int)) Int (ite (= x1744 128) x5009 (x4655 x1744)))
(define-fun x1373 ((x1744 Int)) Int (ite (= x1744 160) x3905 (x5193 x1744)))
(define-fun x3337 ((x1744 Int)) Int (ite (= x1744 192) x1863 (x1373 x1744)))
(define-fun x2372 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x3337 x1744)))
(define-fun x1757 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x2372 x1744)))
(define-fun x5215 ((x1744 Int)) Int (ite (= x1744 0) x3083 (x3873 x1744)))
(define-fun x3560 ((x1744 Int)) Int (ite (= x1744 32) x1170 (x5215 x1744)))
(define-fun x4788 ((x1744 Int)) Int (ite (= x1744 64) x2367 (x3560 x1744)))
(define-fun x3621 ((x1744 Int)) Int (ite (= 96 x1744) x1929 (x4788 x1744)))
(define-fun x4451 ((x1744 Int)) Int (ite (= x1744 128) x1675 (x3621 x1744)))
(define-fun x2844 ((x1744 Int)) Int (ite (= 128 x1744) x5009 (x4019 x1744)))
(define-fun x69 ((x1744 Int)) Int (ite (= 160 x1744) x4647 (x2844 x1744)))
(define-fun x3448 ((x1744 Int)) Int (ite (= x1744 192) x1863 (x69 x1744)))
(define-fun x3754 ((x1744 Int)) Int (ite (= 224 x1744) x2402 (x3448 x1744)))
(define-fun x4287 ((x1744 Int)) Int (ite (= 256 x1744) x443 (x3754 x1744)))
(define-fun x236 ((x1744 Int)) Int (ite (= x1744 0) x847 (x659 x1744)))
(define-fun x4069 ((x1744 Int)) Int (ite (= 32 x1744) x3934 (x236 x1744)))
(define-fun x2293 ((x1744 Int)) Int (ite (= x1744 64) x3824 (x4069 x1744)))
(define-fun x5180 ((x1744 Int)) Int (ite (= 96 x1744) x4998 (x2293 x1744)))
(define-fun x4942 ((x1744 Int)) Int (ite (= x1744 128) x4345 (x5180 x1744)))
(define-fun x3545 ((x1744 x2506)) Int (ite (and x2184 x3850) (x4495 x1744) (ite (and x221 x39) (x4495 x1744) (x987 x1744))))
(define-fun x2748 ((x1744 x2506)) Int (ite (= x1744 x3543) x169 (x3545 x1744)))
(define-fun x2670 ((x1744 Int)) Int (ite (= x1744 0) 1 (x3686 x1744)))
(define-fun x4763 ((x1744 x2506)) Int (ite (and x3850 x2184) (x507 x1744) (ite (and x39 x221) (x660 x1744) (x507 x1744))))
(define-fun x1113 ((x1744 x2506)) Int (ite (= x1487 x1744) x4186 (x4763 x1744)))
(define-fun x2229 ((x1744 Int)) Int (ite (= x1744 0) 1 (x3686 x1744)))
(define-fun x3325 ((x1744 x2506)) Int (ite (= x1744 x893) x2253 (x886 x1744)))
(define-fun x1149 ((x1744 Int)) Int (ite (= 0 x1744) 1 (x3686 x1744)))
(define-fun x2473 ((x1744 Int)) Int (ite (and x1272 x5031) (x940 x1744) (ite (and x1804 x1679) (x2282 x1744) (x198 x1744))))
(define-fun x962 ((x1744 Int)) Int (ite (= x1744 128) x4350 (x1254 x1744)))
(define-fun x2319 ((x1744 Int)) Int (ite (= 160 x1744) x244 (x962 x1744)))
(define-fun x1884 ((x1744 Int)) Int (ite (= x1744 192) x2353 (x2319 x1744)))
(define-fun x1856 ((x1744 Int)) Int (ite (= x1744 224) x1834 (x1884 x1744)))
(define-fun x215 ((x1744 Int)) Int (ite (= x1744 256) x888 (x1856 x1744)))
(define-fun x983 ((x1744 Int)) Int (ite (= x1744 0) x369 (x397 x1744)))
(define-fun x3673 ((x1744 Int)) Int (ite (= 32 x1744) x1234 (x983 x1744)))
(define-fun x4246 ((x1744 Int)) Int (ite (= x1744 64) x1685 (x3673 x1744)))
(define-fun x1486 ((x1744 Int)) Int (ite (= 96 x1744) x3111 (x4246 x1744)))
(define-fun x1387 ((x1744 Int)) Int (ite (= x1744 128) x4016 (x1486 x1744)))
(define-fun x4432 ((x1744 Int)) Int (ite (and x3850 x2184) (x5154 x1744) (ite (and x221 x39) (x4604 x1744) (x2453 x1744))))
(define-fun x493 ((x4431 Int)) Bool (=> (and (not (= x4431 4072298103)) (not (= x4431 115792089237316195423570985008687907853269984655499359237631748795939503996928)) (not (= 4033150093 x4431)) (not (= 16156842317565293874272834530371880720966471053262404558597773956279093428224 x4431)) (not (= 2362581449 x4431)) (not (= 157198259 x4431)) (not (= x4431 4062139261)) (not (= x4431 115792089237316195423570985008687907853269984665640564039457584007913129639904)) (not (= 170141183460469231731687303715884105727 x4431)) (not (= 20282409603651670423947251286015 x4431)) (not (= 3283311230 x4431)) (not (= 18446744073709551615 x4431)) (not (= 115197700812830431890159100217698998050002284567939525164234024451216521560064 x4431)) (not (= 1099511627775 x4431)) (not (= x4431 10141204801825835211973625643007)) (not (= 274184521717934524641157099916833587244 x4431)) (not (= 274184521717934524641157099916833587223 x4431)) (not (= 274184521717934524641157099916833587227 x4431)) (not (= 3454435393 x4431)) (not (= 76450787359836037641860180984291677749980919077056822294353438043884394381312 x4431)) (not (= 1208925819614629174706175 x4431)) (not (= 2514000705 x4431)) (not (= 340282366920938463463374607431768211456 x4431)) (not (= 117300739 x4431)) (not (= x4431 340282366920938463463374607431768211455)) (not (= x4431 18446744073709551616)) (not (= 404098525 x4431)) (not (= 3840337785 x4431)) (not (= 3257672857 x4431)) (not (= x4431 3798450084)) (not (= x4431 599290589)) (not (= 50942633119752846454219349998365661925608737367104304655302372697894809501696 x4431)) (not (= x4431 3368549995)) (not (= x4431 65536)) (not (= x4431 274184521717934524641157099916833587210)) (not (= x4431 3833100637)) (not (= 3950285521 x4431)) (not (= x4431 4072275384)) (not (= 20282409603651670423947251286016 x4431)) (not (= x4431 57896044618658097711785492504343953926634992332820282019728792003956564819967)) (not (= x4431 4093572003)) (not (= 1461501637330902918203684832716283019655932542976 x4431)) (not (= x4431 2059964113)) (< 10000 x4431) (not (= 65535 x4431)) (not (= x4431 115792089237316195423570985008687907853269984665640564039457584007913129639935)) (not (= 274184521717934524641157099916833587235 x4431)) (not (= 1889567281 x4431)) (not (= 3695885053 x4431)) (not (= 1461501637330902918203684832716283019655932542975 x4431)) (not (= x4431 826074471)) (not (= 57896044618658097711785492504343953926634992332820282019728792003956564819968 x4431)) (not (= x4431 274184521717934524641157099916833587233)) (not (= 2835717307 x4431)) (not (= 4272920204 x4431)) (not (= x4431 1208925819614629174706176)) (not (= x4431 274184521717934524641157099916833587231)) (not (= x4431 3795249780))) (not ((_ is x1228) (x3424 x4431)))))
...
(assert (x3142 x3817))
(assert (x3142 x2608))
(assert (=> (<= x4131 10000) (= (x1228 x4131) (x3424 x4131))))
...
(assert (x3142 x2250))
(assert (x3142 x4523))
(assert (=> (>= 10000 x2920) (= (x1228 x2920) (x3424 x2920))))
...
(assert (x3142 x364))
(assert (x3142 x2533))
(assert (=> (<= x1888 10000) (= (x3424 x1888) (x1228 x1888))))
(assert (x3142 x3040))
...
(assert (x3142 x79))
(assert (x3142 x1972))
(assert (=> (<= x2961 10000) (= (x3424 x2961) (x1228 x2961))))
(assert (x3142 x3682))
...
(assert (= x2959 (=> (and (= x1036 (> x4814 57896044618658097711785492504343953926634992332820282019728792003956564819967)) (= (mod (* x3612 x596) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x4814)) (and (=> (not x1036) x2173) (=> x1036 x2526)))))
...
(assert (x1438 x2546))
(assert (x3142 x4647))
(assert (= x3756 (=> (and (= (x1999 20282409603651670423947251286015 x878) x3982) (= (> x3982 10141204801825835211973625643007) x3898) (= (div x2227 x1040) x878)) (and (=> (not x3898) x702) (=> x3898 x941)))))
(assert (x3142 x2632))
(assert (x3142 x2083))
(assert (x493 x4217))
...
(assert (x493 x3771))
(assert (x3142 x4498))
(assert (=> (<= x4284 10000) (= (x3424 x4284) (x1228 x4284))))
(assert (x3142 x1314))
(assert (x3142 x376))
(assert (x1438 x3029))
...
(assert (=> (>= 10000 x3924) (= (x1228 x3924) (x3424 x3924))))
...
(assert (x3142 x3375))
(assert (x3142 x2366))
(assert (=> (>= 10000 x1334) (= (x3424 x1334) (x1228 x1334))))
(assert (x3142 x2128))
...
(assert (=> (>= 10000 x2264) (= (x3424 x2264) (x1228 x2264))))
(assert (x3142 x3563))
(assert (x2487 x2672))
(assert (x3142 x5187))
(assert (x3142 x2933))
...
(assert (x3142 x4042))
(assert (x3142 x2537))
(assert (= (=> (and (= x2884 (= x1647 0)) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1647) x4209) (= x1120 (= x4656 0)) (= (x1999 x4590 x4239) x4656) (= (ite (not x2884) 1 0) x4590) (= (ite (< x4209 x5067) 1 0) x4239) (= x1647 (x1999 20282409603651670423947251286015 x1851))) (and (=> (not x1120) x796) (=> x1120 x3372))) x4124))
(assert (x3142 x632))
...
(assert (=> (>= 10000 x4217) (= (x1228 x4217) (x3424 x4217))))
(assert (x3142 x2742))
(assert (x493 x3001))
(assert (x3142 x4350))
...
(assert (=> (>= 10000 x3395) (= (x1228 x3395) (x3424 x3395))))
...
(assert (=> (<= x809 10000) (= (x1228 x809) (x3424 x809))))
(assert (x3142 x4580))
(assert (= (=> (and (= (ite (not x2957) 1 0) x4390) (= x2563 (x1283 x2878)) (= (x1999 x4390 x5054) x1747) (= (x2483 (+ x4456 64)) x4730) (= x3612 (mod (* x2712 x452) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (ite (< x2214 x596) 1 0) x5054) (= x2878 (x2483 (+ x499 64))) (= (x1999 340282366920938463463374607431768211455 x4577) x452) (= (x1999 18446744073709551615 x1702) x596) (= x1702 (x4079 x4730)) (= x2527 (= 0 x1747)) (= x2214 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x3612)) (= (= x3612 0) x2957)) (and (=> (not x2527) x4829) (=> x2527 x2959))) x2088))
(assert (x3142 x4919))
(assert (x3142 x4306))
(assert (x3142 x4808))
...
(assert (x3142 x4570))
(assert (x3142 x418))
(assert (= x998 (=> (and (= (= 0 x2145) x1291) (= x4450 (x1999 340282366920938463463374607431768211455 x2400)) (= x3790 (ite (not x3723) 1 0)) (= x1864 (x4959 x2411)) (= (x2483 (+ 64 x646)) x468) (= (mod (* x4450 x1525) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x615) (= (x2483 (+ x4669 64)) x2411) (= (ite (< x2823 x3871) 1 0) x2330) (= (= 0 x615) x3723) (= x3871 (x1999 18446744073709551615 x3036)) (= x2823 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x615)) (= x3036 (x4612 x468)) (= x2145 (x1999 x3790 x2330))) (and (=> x1291 x2850) (=> (not x1291) x3362)))))
(assert (x3142 x395))
(assert (x3142 x3951))
(assert (x1438 x1931))
(assert (x3142 x1537))
...
(assert (=> (>= 10000 x3356) (= (x3424 x3356) (x1228 x3356))))
...
(assert (x3142 x1697))
(assert (x3142 x1608))
(assert (=> (>= 10000 x2822) (= (x1228 x2822) (x3424 x2822))))
(assert (x493 x701))
(assert (x3142 x3502))
(assert (x3142 x3352))
(assert (x3142 x5036))
...
(assert (x1438 x1643))
(assert (= (x5129 x72) 0))
(assert (= x4972 (=> (and (= x761 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1758)) (= (= 0 x1758) x2648) (= x907 (= 0 x1216)) (= (ite (not x2648) 1 0) x5245) (= (x1999 x5245 x3029) x1216) (= x1758 (x1999 20282409603651670423947251286015 x4160)) (= x3029 (ite (< x761 x1040) 1 0))) (and (=> x907 x4818) (=> (not x907) x796)))))
...
(assert (x3142 x1053))
(assert (x1438 x3869))
(assert (=> (<= x4512 10000) (= (x3424 x4512) (x1228 x4512))))
...
(assert (= x387 (=> (and (= x4678 x2007) (<= 0 x3830) (= (ite (> x1040 x2674) 1 0) x344) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x3830) x2674) (<= x3830 20282409603651670423947251286015) (= x4988 (= 0 x3830)) (< x3830 20282409603651670423947251286016) (= (* x4484 x5067) x4678) (<= 0 x1040) (= (= x4116 0) x64) (<= x1040 18446744073709551615) (= x3731 (ite (not x4988) 1 0)) (= (x1999 x3731 x344) x4116) (< x1040 18446744073709551616)) (and (=> (not x64) x796) (=> x64 x2113)))))
...
(assert (x3142 x49))
(assert (x3142 x2910))
(assert (=> (>= 10000 x2339) (= (x3424 x2339) (x1228 x2339))))
(assert (x3142 x4167))
(assert (x3142 x2794))
(assert (x3142 x3876))
(assert (x3142 x2448))
...
(assert (=> (<= x701 10000) (= (x3424 x701) (x1228 x701))))
(assert (= x282 x941))
...
(assert (x3142 x1222))
(assert (x3142 x411))
(assert (= (=> (and (= (x4965 (- 18446744073709551615 x1171)) x2441) (= x4305 (< x2441 x4319)) (= (mod (* x1194 x2604) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1270) (= (x2790 192) x1058) (= (x1999 18446744073709551615 x1058) x4319) (= x1171 (x1999 18446744073709551615 x1270))) (and (=> (and (not x4305) (= (x1999 18446744073709551615 x2810) x810) (= (x2483 (+ x1171 x4319)) x2810)) x564) (=> x4305 x796))) x315))
(assert (x1438 x5065))
(assert (x3142 x2156))
...
(assert (x3142 x1098))
(assert (x1438 x3474))
(assert (=> (<= x923 10000) (= (x1228 x923) (x3424 x923))))
(assert (x3142 x2072))
(assert (x3142 x865))
...
(assert (x1438 x4707))
(assert (x1438 x3007))
(assert (= x1230 (=> (and (= x3750 (mod (* x4261 x4714) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x2199 (> x3750 57896044618658097711785492504343953926634992332820282019728792003956564819967))) (and (=> x2199 x2526) (=> (not x2199) x5011)))))
(assert (x3142 x2044))
(assert (x3142 x3761))
(assert (x3142 x3456))
(assert (x3142 x3504))
...
(assert (x1438 x2169))
(assert (x3142 x3056))
(assert (= x4649 (=> (and (= x1582 (= 0 x2746)) (= (ite (not x2837) 1 0) x209) (= x3192 (x1999 20282409603651670423947251286015 x3140)) (= (ite (< x4175 x5067) 1 0) x1741) (= (= x3192 0) x2837) (= (x1999 x209 x1741) x2746) (= x4175 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x3192))) (and (=> (not x1582) x796) (=> x1582 x3017)))))
...
(assert (= 0 (x2295 x828)))
(assert (x3142 x4967))
(assert (=> (>= 10000 x3085) (= (x3424 x3085) (x1228 x3085))))
(assert (x3142 x2352))
(assert (x3142 x878))
(assert (x3142 x1767))
...
(assert (x1438 x4633))
(assert (x3142 x3232))
(assert (= x1414 (=> (and (= (x1999 x2607 x4068) x32) (= (x1999 20282409603651670423947251286015 x2829) x5112) (= (x4965 (- x1724 x141)) x4796) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x5112) x3776) (= x4068 (ite (> x3880 x3776) 1 0)) (= x2607 (ite (not x3568) 1 0)) (= (= x5112 0) x3568) (= x3880 (x1999 18446744073709551615 x4796)) (= (= x32 0) x140)) (and (=> x140 x1652) (=> (not x140) x796)))))
(assert (x1438 x1315))
(assert (x3142 x2892))
(assert (x3142 x16))
(assert (x3142 x4908))
...
(assert (x3142 x5159))
(assert (x3142 x4841))
(assert (= (=> (and (= (x1999 20282409603651670423947251286015 x4696) x4292) (= x2661 (> x4292 10141204801825835211973625643007)) (= (mod (* x5067 x1647) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x4696)) (and (=> x2661 x941) (=> (and (not x2661) (= x194 x4696)) x4572))) x3372))
(assert (x3142 x1940))
(assert (x3142 x3214))
(assert (x1438 x2800))
...
(assert (x3142 x1488))
(assert (x493 x2909))
(assert (=> (<= x2086 10000) (= (x3424 x2086) (x1228 x2086))))
(assert (x3142 x3790))
(assert (x3142 x2657))
...
(assert (= x4400 (=> (and (= x2657 (div x5052 x1040)) (= x3396 (x1999 20282409603651670423947251286015 x2657)) (= (or (< 57896044618658097711785492504343953926634992332820282019728792003956564819967 (x216 x2800)) (and (> 0 (x216 x2800)) (= true (>= 57896044618658097711785492504343953926634992332820282019728792003956564819967 (x216 x2800))))) x3540)) (and (=> x3540 x2847) (=> (not x3540) x3190)))))
(assert (x2786 x2808 x129))
(assert (=> (<= x4857 10000) (= (x3424 x4857) (x1228 x4857))))
...
(assert (=> (>= 10000 x4985) (= (x1228 x4985) (x3424 x4985))))
(assert (x3142 x836))
...
(assert (x3142 x3815))
(assert (= (=> (and (= x3912 (ite (not x4344) 1 0)) (<= 0 x2842) (= x2568 (ite (< x2252 x5067) 1 0)) (= (= 0 x2842) x3519) (<= 0 x4484) (>= 255 x2842) (> 20282409603651670423947251286016 x4484) (= (= 0 x2207) x3461) (= (x1999 x3480 x2568) x2207) (>= x5067 0) (>= 20282409603651670423947251286015 x4484) (= x2252 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x4484)) (= x3480 (ite (not x2683) 1 0)) (> 256 x2842) (= x2683 (= x4484 0)) (> 18446744073709551616 x5067) (<= x5067 18446744073709551615) (= x4344 (not x3519))) (and (=> (not x3461) x796) (=> x3461 x387))) x3351))
(assert (x3142 x222))
(assert (x22 x385 x73))
(assert (x3142 x3247))
(assert (x3142 x72))
...
(assert (x3142 x4745))
(assert (=> (>= 10000 x1345) (= (x3424 x1345) (x1228 x1345))))
...
(assert (x3142 x5124))
(assert (x3142 x3499))
(assert (=> (>= 10000 x4752) (= (x1228 x4752) (x3424 x4752))))
...
(assert (x3142 x2905))
(assert (x3142 x736))
(assert (=> (<= x4811 10000) (= (x1228 x4811) (x3424 x4811))))
...
(assert (x3142 x3924))
(assert (=> (>= 10000 x1611) (= (x1228 x1611) (x3424 x1611))))
(assert (x3142 x1002))
(assert (x3142 x3477))
...
(assert (x3142 x989))
(assert (x3142 x3084))
(assert (= x269 (=> (and (= (x1999 255 x4120) x4976) (= 0 x3610) (= (< 0 x4976) x4880) (= (x1999 340282366920938463463374607431768211455 x301) x4080) (= x4962 (mod (* x4080 (x14 x3450)) 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (and (=> x4880 x4473) (=> (and (not x4880) (= x1662 x1697) (= x4962 x1002)) x1815)))))
(assert (x3142 x4793))
(assert (x3142 x4180))
(assert (x3142 x5197))
(assert (x3142 x3204))
...
(assert (x3142 x1061))
(assert (x3142 x4211))
(assert (=> (>= 10000 x804) (= (x1228 x804) (x3424 x804))))
(assert (x3142 x3420))
(assert (x3142 x426))
(assert (=> (<= x4650 10000) (= (x1228 x4650) (x3424 x4650))))
(assert (x3142 x2162))
(assert (x3142 x1179))
(assert (= (=> (and (= x318 (mod (* x5080 x1040) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (x1999 20282409603651670423947251286015 x318) x2846) (= x4772 (> x2846 10141204801825835211973625643007))) (and (=> x4772 x941) (=> (not x4772) x4198))) x2238))
...
(assert (x3142 x4221))
(assert (x1438 x3025))
(assert (=> (<= x4744 10000) (= (x1228 x4744) (x3424 x4744))))
...
(assert (x3142 x3887))
(assert (=> (>= 10000 x3051) (= (x1228 x3051) (x3424 x3051))))
(assert (x3142 x4831))
...
(assert (x3142 x4150))
(assert (x3142 x4006))
(assert (=> (>= 10000 x2559) (= (x1228 x2559) (x3424 x2559))))
(assert (x3142 x2400))
(assert (x3142 x2202))
(assert (x3142 x2273))
(assert (x3142 x4123))
...
(assert (x1438 x4160))
(assert (x3142 x4948))
(assert (= x92 (=> (and (= x4633 (ite (< x991 x1040) 1 0)) (= (= x2633 0) x1238) (= x5080 (x1999 20282409603651670423947251286015 x4549)) (= x472 (= 0 x5080)) (= x2633 (x1999 x1358 x4633)) (= x1358 (ite (not x472) 1 0)) (= x991 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x5080))) (and (=> x1238 x2238) (=> (not x1238) x796)))))
(assert (x3142 x2031))
(assert (x3142 x1182))
(assert (x3142 x4597))
(assert (x3142 x1216))
...
(assert (x1438 x4286))
(assert (x3142 x4252))
(assert (=> (>= 10000 x1649) (= (x3424 x1649) (x1228 x1649))))
(assert (x3142 x1635))
(assert (x3142 x2002))
(assert (x3142 x1611))
(assert (x3142 x2427))
...
(assert (x1438 x2730))
(assert (x3142 x4474))
(assert (=> (<= x860 10000) (= (x3424 x860) (x1228 x860))))
(assert (x493 x3900))
(assert (x3142 x1722))
(assert (x3142 x1615))
(assert (x3142 x922))
...
(assert (= x4033 x2948))
(assert (x3142 x4976))
(assert (=> (<= x3725 10000) (= (x1228 x3725) (x3424 x3725))))
...
(assert (x3142 x2936))
(assert (=> (<= x4919 10000) (= (x1228 x4919) (x3424 x4919))))
(assert (x3142 x3912))
(assert (x3142 x5096))
...
(assert (x3142 x3656))
(assert (=> (>= 10000 x2909) (= (x3424 x2909) (x1228 x2909))))
(assert (x3142 x1702))
(assert (x3142 x4958))
...
(assert (x3142 x5178))
(assert (x1438 x1419))
(assert (=> (>= 10000 x3815) (= (x1228 x3815) (x3424 x3815))))
(assert (x1438 x2537))
(assert (x3142 x3164))
(assert (x2786 x3140 x3831))
(assert (= (and x4683 x1921) x1622))
(assert (= 0 (x3556 x4456)))
(assert (=> (<= x3043 10000) (= (x1228 x3043) (x3424 x3043))))
(assert (x3142 x3583))
(assert (x3142 x4317))
...
(assert (x3142 x2949))
(assert (x3142 x4386))
(assert (=> (<= x3882 10000) (= (x1228 x3882) (x3424 x3882))))
(assert (x3142 x328))
(assert (x3142 x2172))
...
(assert (= (=> (and (= (> x3885 10141204801825835211973625643007) x1484) (= x91 (div x2038 x5067)) (= x3885 (x1999 20282409603651670423947251286015 x91))) (and (=> (and (= x1011 x91) (not x1484)) x1719) (=> x1484 x941))) x5230))
(assert (x493 x4512))
...
(assert (=> (<= x2612 10000) (= (x3424 x2612) (x1228 x2612))))
...
(assert (x3142 x4187))
(assert (=> (>= 10000 x3771) (= (x1228 x3771) (x3424 x3771))))
...
(assert (=> (<= x4935 10000) (= (x3424 x4935) (x1228 x4935))))
(assert (x2487 x3115))
(assert (x3142 x1325))
(assert (x3142 x3439))
(assert (=> (>= 10000 x3728) (= (x3424 x3728) (x1228 x3728))))
(assert (x3142 x2201))
(assert (x3142 x2542))
(assert (= x796 x4991))
(assert (x3142 x424))
...
(assert (x3142 x1606))
(assert (x3142 x4393))
(assert (= x3425 (=> (and (= (ite (not x4196) 1 0) x1801) (= (x1999 x1801 x398) x3607) (= x4196 (= 0 x2604)) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x2604) x2338) (= (ite (< x2338 x1194) 1 0) x398) (= (x1999 20282409603651670423947251286015 x4736) x2604) (= x4736 (x4965 (- 0 x3198))) (= x1852 (= x3607 0))) (and (=> (not x1852) x796) (=> x1852 x315)))))
...
(assert (x3142 x912))
(assert (x3142 x2442))
(assert (=> (<= x2101 10000) (= (x1228 x2101) (x3424 x2101))))
...
(assert (x3142 x348))
(assert (x3142 x579))
(assert (=> (<= x4416 10000) (= (x1228 x4416) (x3424 x4416))))
(assert (x3142 x917))
(assert (x3142 x5169))
(assert (x3142 x205))
(assert (x3142 x1315))
...
(assert (x3142 x3719))
(assert (x3142 x1043))
(assert (=> (<= x3212 10000) (= (x1228 x3212) (x3424 x3212))))
...
(assert (x3142 x2560))
(assert (= x2507 (=> (and (= (= x2745 0) x4368) (= (ite (not x777) 1 0) x2868) (= x2685 (ite (> x5067 x3937) 1 0)) (= (x1999 x2868 x2685) x2745) (= (x1999 20282409603651670423947251286015 x3763) x2180) (= x777 (= x2180 0)) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x2180) x3937)) (and (=> x4368 x1232) (=> (not x4368) x796)))))
(assert (x3142 x1516))
(assert (x3142 x3075))
...
(assert (=> (<= x4738 10000) (= (x3424 x4738) (x1228 x4738))))
(assert (x3142 x4249))
(assert (x1438 x4838))
(assert (x3142 x3192))
(assert (x3142 x2091))
...
(assert (x3142 x296))
(assert (=> (<= x2046 10000) (= (x3424 x2046) (x1228 x2046))))
...
(assert (x3142 x3309))
(assert (=> (>= 10000 x606) (= (x3424 x606) (x1228 x606))))
(assert (x1438 x2882))
(assert (x3142 x547))
(assert (x3142 x1671))
...
(assert (x3142 x377))
(assert (x3142 x2006))
(assert (= x1673 (=> (and (= (= 0 x4714) x2377) (= (x4664 x891) x2802) (= x1825 (ite (not x2377) 1 0)) (= x3636 (x2483 (+ 64 x3423))) (= (x1999 18446744073709551615 x4214) x4261) (= (mod (* x2178 x4357) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x4714) (= (x4511 x3636) x4214) (= x1775 (ite (> x4261 x2834) 1 0)) (= x2834 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x4714)) (= (x1999 340282366920938463463374607431768211455 x3869) x2178) (= (x2483 (+ x5258 64)) x891) (= (= x3926 0) x567) (= x3926 (x1999 x1825 x1775))) (and (=> (not x567) x4829) (=> x567 x1230)))))
(assert (x3142 x2413))
(assert (= x2226 (or (and x1556 x4183) (and x4883 x3127))))
(assert (= x4615 (and x4834 (not x4332))))
(assert (=> (>= 10000 x1602) (= (x1228 x1602) (x3424 x1602))))
(assert (x3142 x3531))
(assert (= x1245 x743))
(assert (x3142 x3824))
(assert (x3142 x5128))
...
(assert (x3142 x4661))
(assert (=> (>= 10000 x1251) (= (x1228 x1251) (x3424 x1251))))
(assert (x3142 x113))
(assert (= x4205 true))
(assert (x3142 x3012))
(assert (x3142 x1736))
...
(assert (x3142 x1575))
(assert (x3142 x4894))
(assert (= x4818 (=> (and (= (x1999 20282409603651670423947251286015 x1748) x727) (= x1748 (mod (* x1758 x1040) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (> x727 10141204801825835211973625643007) x2467)) (and (=> (not x2467) x722) (=> x2467 x941)))))
(assert (x3142 x4686))
...
(assert (x3142 x491))
(assert (=> (>= 10000 x3375) (= (x1228 x3375) (x3424 x3375))))
(assert (x1438 x199))
(assert (x3142 x3766))
...
(assert (= (=> (and (= x1127 (x1999 20282409603651670423947251286015 x4691)) (= (ite (not x3023) 1 0) x5050) (= (= x1127 0) x3023) (= x1401 (= 0 x2176)) (= (ite (> x1040 x1558) 1 0) x2671) (= (x1999 x5050 x2671) x2176) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1127) x1558)) (and (=> x1401 x3317) (=> (not x1401) x796))) x2561))
...
(assert (=> (>= 10000 x550) (= (x1228 x550) (x3424 x550))))
(assert (x3142 x3792))
(assert (x3142 x4722))
(assert (=> (>= 10000 x2430) (= (x3424 x2430) (x1228 x2430))))
...
(assert (= x4662 (=> (and (= 0 x5106) (= (mod (* (x14 x2399) x3857) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x3877) (= (x1999 340282366920938463463374607431768211455 x1939) x3857) (= (> x1462 0) x4222) (= x1462 (x1999 255 x4120))) (and (=> x4222 x2368) (=> (and (not x4222) (= x3762 x2085) (= x3877 x5198)) x1117)))))
(assert (x3142 x3762))
(assert (= (and x211 (not x792)) x1200))
(assert (x3142 x3607))
(assert (x1438 x226))
(assert (= (=> (and (= x3376 (mod (* x3192 x5067) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x3577 (< 10141204801825835211973625643007 x4544)) (= x4544 (x1999 20282409603651670423947251286015 x3376))) (and (=> (and (= x3376 x1908) (not x3577)) x3890) (=> x3577 x941))) x3017))
(assert (x3142 x500))
...
(assert (=> (<= x4356 10000) (= (x3424 x4356) (x1228 x4356))))
...
(assert (=> (>= 10000 x3098) (= (x1228 x3098) (x3424 x3098))))
(assert (x3142 x3712))
...
(assert (= x2850 (=> (and (= (mod (* x615 x3871) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x2361) (= x3199 (< 57896044618658097711785492504343953926634992332820282019728792003956564819967 x2361))) (and (=> (not x3199) x1906) (=> x3199 x2522)))))
(assert (x3142 x3261))
(assert (x3142 x230))
(assert (=> (<= x1013 10000) (= (x1228 x1013) (x3424 x1013))))
(assert (x3142 x3905))
(assert (x3142 x2058))
...
(assert (x3142 x3410))
(assert (= (=> (and (= x3595 (> x3289 10141204801825835211973625643007)) (= (x1999 20282409603651670423947251286015 x1022) x3289) (= (mod (* x1040 x1127) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1022)) (and (=> (not x3595) x2924) (=> x3595 x941))) x3317))
(assert (x3142 x5245))
(assert (x3142 x4212))
(assert (x3142 x1172))
(assert (x3142 x3894))
(assert (=> (>= 10000 x1889) (= (x3424 x1889) (x1228 x1889))))
(assert (x3142 x2842))
(assert (x3142 x158))
(assert (x493 x4738))
(assert (x3142 x684))
...
(assert (=> (>= 10000 x1609) (= (x3424 x1609) (x1228 x1609))))
(assert (x3142 x4290))
(assert (= x36 (and (not x2715) x3267)))
(assert (x3142 x5017))
(assert (=> (>= 10000 x1946) (= (x3424 x1946) (x1228 x1946))))
(assert (=> (>= 10000 x3900) (= (x1228 x3900) (x3424 x3900))))
(assert (x3142 x1759))
...
(assert (x3142 x4706))
(assert (x493 x2430))
(assert (=> (>= 10000 x1020) (= (x3424 x1020) (x1228 x1020))))
(assert (x3142 x2883))
(assert (x3142 x1054))
...
(assert (= x1232 (=> (and (= (x1999 20282409603651670423947251286015 x157) x936) (= (mod (* x2180 x5067) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x157) (= x2690 (> x936 10141204801825835211973625643007))) (and (=> (and (= x157 x2209) (not x2690)) x5003) (=> x2690 x941)))))
(assert (= x4217 (x88 (x3424 x4217))))
(assert (x3142 x1166))
(assert (=> (<= x4993 10000) (= (x1228 x4993) (x3424 x4993))))
(assert (x3142 x4926))
...
(assert (x3142 x5170))
(assert (=> (<= x3961 10000) (= (x1228 x3961) (x3424 x3961))))
(assert (x3142 x417))
(assert (x3142 x1651))
(assert (x3142 x4682))
...
(assert (x3142 x881))
(assert (=> (>= 10000 x1902) (= (x1228 x1902) (x3424 x1902))))
...
(assert (x3142 x4856))
(assert (x3142 x4297))
(assert (= x1652 (=> (and (= (x2790 192) x908) (= (> x3707 x4769) x3974) (= x5065 (mod (* x3880 x5112) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x4769 (x4965 (- 18446744073709551615 x799))) (= (x1999 18446744073709551615 x908) x3707) (= (x1999 18446744073709551615 x5065) x799)) (and (=> x3974 x796) (=> (and (= (x1999 18446744073709551615 x1819) x967) (not x3974) (= (x2483 (+ x3707 x799)) x1819)) x564)))))
(assert (= 274184521717934524641157099916833587233 (x88 (x1228 274184521717934524641157099916833587233))))
(assert (= (=> (and (= x261 (x1999 18446744073709551615 x4596)) (= x5150 (x2483 (+ 64 x4836))) (= x2266 (= 0 x5036)) (= x2586 (x4501 x138)) (= (= 0 x1816) x1700) (= (mod (* x5006 x1426) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x5036) (= x1816 (x1999 x711 x1620)) (= x711 (ite (not x2266) 1 0)) (= x1620 (ite (< x1039 x261) 1 0)) (= x1039 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x5036)) (= (x2483 (+ x2203 64)) x138) (= (x1999 340282366920938463463374607431768211455 x4042) x1426) (= (x333 x5150) x4596)) (and (=> (not x1700) x3362) (=> x1700 x2726))) x3294))
(assert (= x4829 x796))
(assert (x3142 x766))
(assert (x3142 x3562))
(assert (x3142 x2559))
...
(assert (= (=> (and (= x4043 (> x1040 0)) (= x153 (div x1984 x5067)) (= x5052 (x1999 20282409603651670423947251286015 x2755)) (>= x1040 0) (= x3132 (x1999 20282409603651670423947251286015 x153)) (>= 18446744073709551615 x1040) (< x1040 18446744073709551616)) (and (=> (not x4043) x963) (=> x4043 x4400))) x2464))
...
(assert (x3142 x4848))
(assert (= 0 (x85 x4475)))
(assert (=> (>= 10000 x4066) (= (x1228 x4066) (x3424 x4066))))
