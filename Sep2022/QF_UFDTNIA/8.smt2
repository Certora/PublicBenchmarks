...
(declare-datatypes ((x2327 0)) (((x1886 (x2677 x2327) (x2253 Int)) (x4101 (x1285 x2327) (x3487 x2327) (x51 Int)) (x4822 (x2112 Int)))))
...
(declare-fun x956 (x2327) Int)
(declare-fun x3993 () Bool)
(declare-fun x2 () Int)
(declare-fun x28 (Int) Int)
(declare-fun x1532 (x2327) Int)
...
(declare-fun x4595 (x2327) Int)
(declare-fun x4268 (x2327) Int)
(declare-fun x4304 (x2327) Int)
...
(declare-fun x15 (x2327) Int)
(declare-fun x4659 () Bool)
(declare-fun x4045 () Int)
(declare-fun x615 (x2327) Int)
...
(declare-fun x916 (x2327) Int)
(declare-fun x4977 () Bool)
(declare-fun x3723 () Int)
(declare-fun x374 () Bool)
(declare-fun x3618 (x2327) Int)
...
(declare-fun x1703 (x2327) Int)
(declare-fun x1398 () Int)
(declare-fun x694 () x2327)
(declare-fun x529 (x2327) Int)
...
(declare-fun x3446 (x2327) Int)
(declare-fun x4739 () Int)
(declare-fun x1227 (x2327) Int)
...
(declare-fun x3569 (Int) Int)
(declare-fun x74 () Int)
(declare-fun x2718 () Bool)
(declare-fun x3159 () Bool)
(declare-fun x1267 (x2327) Int)
...
(declare-fun x2153 (x2327) Int)
(declare-fun x509 () Bool)
(declare-fun x2012 () Int)
(declare-fun x4828 (x2327) Int)
...
(declare-fun x3622 (x2327) Int)
(declare-fun x761 (x2327) Int)
...
(declare-fun x1199 (x2327) Int)
(declare-fun x3226 () Int)
(declare-fun x1734 () Int)
(declare-fun x1633 (x2327) Int)
(declare-fun x10 () Int)
...
(declare-fun x2093 (x2327) Int)
(declare-fun x641 () Bool)
(declare-fun x279 () Bool)
(declare-fun x3573 () Int)
(declare-fun x3635 () Int)
(declare-fun x3815 (x2327) Int)
...
(declare-fun x4306 (x2327) Int)
(declare-fun x1399 () Int)
(declare-fun x4747 (Int) Int)
...
(declare-fun x4506 (x2327) Int)
(declare-fun x2572 () Int)
(declare-fun x2300 () Int)
(declare-fun x1081 () Int)
(declare-fun x709 (x2327) Int)
...
(declare-fun x99 (x2327) Int)
(declare-fun x4279 () Bool)
(declare-fun x4830 () Int)
(declare-fun x698 () Int)
(declare-fun x199 () Bool)
(declare-fun x4592 (x2327) Int)
...
(declare-fun x2185 (x2327) Int)
(declare-fun x3651 () Int)
(declare-fun x2721 () Int)
(declare-fun x3989 (x2327) Int)
...
(declare-fun x572 (x2327) Int)
(declare-fun x1647 () Int)
(declare-fun x208 (x2327) Int)
...
(declare-fun x4898 (Int) Int)
(declare-fun x4920 () Int)
(declare-fun x14 () Int)
(declare-fun x675 (x2327) Int)
...
(declare-fun x30 (x2327) Int)
(declare-fun x4613 () x2327)
(declare-fun x2696 (x2327) Int)
...
(declare-fun x2269 (x2327) Int)
(declare-fun x4792 () Int)
(declare-fun x1325 (x2327) Int)
...
(declare-fun x1102 (x2327) Int)
(declare-fun x4186 (x2327) Int)
...
(define-fun x2808 ((x2327 x2327) (x1056 Int)) x2327 (ite ((_ is x1886) x2327) (x1886 (x2677 x2327) (+ x1056 (x2253 x2327))) (ite ((_ is x4101) x2327) (x4101 (x1285 x2327) (x3487 x2327) (+ x1056 (x51 x2327))) (x4822 (+ (x2112 x2327) x1056)))))
(define-fun x1229 ((x4531 Int)) Int (ite (and (>= x4531 0) (< x4531 115792089237316195423570985008687907853269984665640564039457584007913129639936)) x4531 (- x4531 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x4575 ((x4531 Int)) Int (ite (and (>= x4531 (- 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (> 0 x4531)) (+ 115792089237316195423570985008687907853269984665640564039457584007913129639936 x4531) x4531))
(define-fun x1513 ((x1067 Int)) Bool (and (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 x1067) (>= x1067 0)))
(define-fun x66 ((x1067 Int)) Bool (and (= x1067 (x1319 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1067)) (= (x1319 x1067 115792089237316195423570985008687907853269984665640564039457584007913129639935) x1067)))
(define-fun x1263 ((x1067 Int)) Bool (and (= 0 (x1319 x1067 0)) (= 0 (x1319 0 x1067))))
(define-fun x3872 ((x1067 Int)) Bool (= x1067 (x1319 x1067 x1067)))
(define-fun x3166 ((x1067 Int)) Bool (and (x3872 x1067) (x1263 x1067) (x66 x1067)))
(define-fun x445 ((x1067 Int)) Bool (= (x1319 255 (x1319 255 x1067)) (x1319 255 x1067)))
(define-fun x3028 ((x1067 Int)) Bool (=> (and (<= 0 x1067) (> 256 x1067)) (= x1067 (x1319 255 x1067))))
(define-fun x3575 ((x1067 Int)) Bool (=> (= x1067 (x1319 255 x1067)) (and (> 256 x1067) (<= 0 x1067))))
(define-fun x1670 ((x1067 Int)) Bool (=> (and (> 512 x1067) (<= 256 x1067)) (= (- x1067 256) (x1319 255 x1067))))
(define-fun x3557 ((x1067 Int) (x3092 Int)) Bool (and (<= 0 x3092) (= (+ (x1319 255 x1067) (* x3092 256)) x1067)))
(define-fun x3945 ((x1067 Int) (x2346 Int)) Bool (and (x445 x1067) (x1670 x1067) (x3557 x1067 x2346) (x3575 x1067) (x3028 x1067)))
(define-fun x2146 ((x1067 Int) (x3092 Int)) Bool (= (x1319 x3092 x1067) (x1319 x1067 x3092)))
(define-fun x3364 ((x1067 Int) (x3092 Int)) Bool (and (=> (<= 0 x3092) (>= x3092 (x1319 x1067 x3092))) (=> (<= 0 x1067) (>= x1067 (x1319 x1067 x3092))) (>= (x1319 x1067 x3092) 0)))
(define-fun x2143 ((x1067 Int) (x3092 Int)) Bool (and (x2146 x1067 x3092) (x3364 x1067 x3092)))
(define-fun x1564 ((x1067 Int) (x2346 Int)) Bool (and (x3945 x1067 x2346) (x2143 x1067 255)))
(define-fun x2194 ((x1067 Int)) Bool (= (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x1067)) (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x1067)))
(define-fun x4196 ((x1067 Int)) Bool (=> (and (>= x1067 0) (> 1461501637330902918203684832716283019655932542976 x1067)) (= x1067 (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x1067))))
(define-fun x836 ((x1067 Int) (x3092 Int) (x4459 Int) (x4982 Int)) Bool (and (<= 0 x4459) (> 309485009821345068724781056 x4982) (= (+ (* 374144419156711147060143317175368453031918731001856 x4982) x3092 (* 1461501637330902918203684832716283019655932542976 x4459)) x1067) (>= x3092 0) (> 1461501637330902918203684832716283019655932542976 x3092) (>= x4982 0) (< x4459 256) (= (+ (* 374144419156711147060143317175368453031918731001856 x4982) x3092) (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x1067))))
(define-fun x703 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x836 x1067 x4820 x2870 x4469) (x2194 x1067) (x4196 x1067)))
(define-fun x305 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x2143 x1067 115792089237316195423570984636004990333889740523700931696805413995650331181055) (x703 x1067 x4820 x2870 x4469)))
(define-fun x2619 ((x1067 Int)) Bool (= (x1319 372682917519380244141939632342652170012262798458880 x1067) (x1319 372682917519380244141939632342652170012262798458880 (x1319 372682917519380244141939632342652170012262798458880 x1067))))
(define-fun x4270 ((x1067 Int)) Bool (=> (and (< x1067 1461501637330902918203684832716283019655932542976) (<= 0 x1067)) (= 0 (x1319 372682917519380244141939632342652170012262798458880 x1067))))
(define-fun x104 ((x1067 Int) (x3092 Int) (x4459 Int) (x4982 Int)) Bool (and (= x1067 (+ x3092 (* x4459 1461501637330902918203684832716283019655932542976) (* x4982 374144419156711147060143317175368453031918731001856))) (< x4982 309485009821345068724781056) (> 256 x4459) (= (* 1461501637330902918203684832716283019655932542976 x4459) (x1319 372682917519380244141939632342652170012262798458880 x1067)) (>= x4982 0) (>= x4459 0) (< x3092 1461501637330902918203684832716283019655932542976) (>= x3092 0)))
(define-fun x4377 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x2619 x1067) (x104 x1067 x4820 x2870 x4469) (x4270 x1067)))
(define-fun x4263 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x4377 x1067 x4820 x2870 x4469) (x2143 x1067 372682917519380244141939632342652170012262798458880)))
(define-fun x1841 ((x1067 Int)) Bool (= (x1319 18446744073709551615 x1067) (x1319 18446744073709551615 (x1319 18446744073709551615 x1067))))
(define-fun x247 ((x1067 Int)) Bool (=> (and (< x1067 18446744073709551616) (>= x1067 0)) (= x1067 (x1319 18446744073709551615 x1067))))
(define-fun x3586 ((x1067 Int)) Bool (=> (= x1067 (x1319 18446744073709551615 x1067)) (and (< x1067 18446744073709551616) (<= 0 x1067))))
(define-fun x3442 ((x1067 Int)) Bool (=> (and (<= 18446744073709551616 x1067) (< x1067 36893488147419103232)) (= (x1319 18446744073709551615 x1067) (- x1067 18446744073709551616))))
(define-fun x4726 ((x1067 Int) (x3092 Int)) Bool (and (= (+ (* x3092 18446744073709551616) (x1319 18446744073709551615 x1067)) x1067) (<= 0 x3092)))
(define-fun x2440 ((x1067 Int) (x2346 Int)) Bool (and (x3586 x1067) (x3442 x1067) (x247 x1067) (x4726 x1067 x2346) (x1841 x1067)))
(define-fun x4187 ((x1067 Int) (x2346 Int)) Bool (and (x2143 x1067 18446744073709551615) (x2440 x1067 x2346)))
(define-fun x1804 ((x1067 Int)) Bool (= (x1319 1461501637330902918203684832716283019655932542975 x1067) (x1319 1461501637330902918203684832716283019655932542975 (x1319 1461501637330902918203684832716283019655932542975 x1067))))
(define-fun x759 ((x1067 Int)) Bool (=> (and (<= 0 x1067) (> 1461501637330902918203684832716283019655932542976 x1067)) (= (x1319 1461501637330902918203684832716283019655932542975 x1067) x1067)))
(define-fun x2133 ((x1067 Int)) Bool (=> (= x1067 (x1319 1461501637330902918203684832716283019655932542975 x1067)) (and (< x1067 1461501637330902918203684832716283019655932542976) (<= 0 x1067))))
(define-fun x2788 ((x1067 Int)) Bool (=> (and (< x1067 2923003274661805836407369665432566039311865085952) (>= x1067 1461501637330902918203684832716283019655932542976)) (= (x1319 1461501637330902918203684832716283019655932542975 x1067) (- x1067 1461501637330902918203684832716283019655932542976))))
(define-fun x3874 ((x1067 Int) (x3092 Int)) Bool (and (= (+ (x1319 1461501637330902918203684832716283019655932542975 x1067) (* 1461501637330902918203684832716283019655932542976 x3092)) x1067) (<= 0 x3092)))
(define-fun x3073 ((x1067 Int) (x2346 Int)) Bool (and (x1804 x1067) (x2788 x1067) (x759 x1067) (x2133 x1067) (x3874 x1067 x2346)))
(define-fun x2349 ((x1067 Int) (x2346 Int)) Bool (and (x3073 x1067 x2346) (x2143 x1067 1461501637330902918203684832716283019655932542975)))
(define-fun x3198 ((x1067 Int)) Bool (= (x1319 4294967295 (x1319 4294967295 x1067)) (x1319 4294967295 x1067)))
(define-fun x1160 ((x1067 Int)) Bool (=> (and (> 4294967296 x1067) (>= x1067 0)) (= x1067 (x1319 4294967295 x1067))))
(define-fun x3606 ((x1067 Int)) Bool (=> (= (x1319 4294967295 x1067) x1067) (and (<= 0 x1067) (> 4294967296 x1067))))
(define-fun x2097 ((x1067 Int)) Bool (=> (and (<= 4294967296 x1067) (> 8589934592 x1067)) (= (x1319 4294967295 x1067) (- x1067 4294967296))))
(define-fun x1621 ((x1067 Int) (x3092 Int)) Bool (and (= (+ (x1319 4294967295 x1067) (* 4294967296 x3092)) x1067) (<= 0 x3092)))
(define-fun x754 ((x1067 Int) (x2346 Int)) Bool (and (x3198 x1067) (x1621 x1067 x2346) (x2097 x1067) (x1160 x1067) (x3606 x1067)))
(define-fun x2072 ((x1067 Int) (x2346 Int)) Bool (and (x2143 x1067 4294967295) (x754 x1067 x2346)))
(define-fun x965 ((x1067 Int)) Bool (= (x1319 65535 (x1319 65535 x1067)) (x1319 65535 x1067)))
(define-fun x4442 ((x1067 Int)) Bool (=> (and (>= x1067 0) (> 65536 x1067)) (= x1067 (x1319 65535 x1067))))
(define-fun x289 ((x1067 Int)) Bool (=> (= (x1319 65535 x1067) x1067) (and (>= x1067 0) (< x1067 65536))))
(define-fun x4539 ((x1067 Int)) Bool (=> (and (<= 65536 x1067) (< x1067 131072)) (= (x1319 65535 x1067) (- x1067 65536))))
(define-fun x4713 ((x1067 Int) (x3092 Int)) Bool (and (>= x3092 0) (= (+ (* x3092 65536) (x1319 65535 x1067)) x1067)))
(define-fun x36 ((x1067 Int) (x2346 Int)) Bool (and (x289 x1067) (x965 x1067) (x4539 x1067) (x4713 x1067 x2346) (x4442 x1067)))
(define-fun x1498 ((x1067 Int) (x2346 Int)) Bool (and (x36 x1067 x2346) (x2143 x1067 65535)))
(define-fun x2520 ((x1067 Int)) Bool (= (x1319 115792089237316195423570985007226406215939081747436879206741300988257197096960 (x1319 115792089237316195423570985007226406215939081747436879206741300988257197096960 x1067)) (x1319 115792089237316195423570985007226406215939081747436879206741300988257197096960 x1067)))
(define-fun x555 ((x1067 Int)) Bool (=> (and (> 1461501637330902918203684832716283019655932542976 x1067) (<= 0 x1067)) (= (x1319 115792089237316195423570985007226406215939081747436879206741300988257197096960 x1067) 0)))
(define-fun x3937 ((x1067 Int) (x3092 Int) (x4459 Int) (x4982 Int)) Bool (and (<= 0 x4982) (= x1067 (+ (* x4982 115792089237316195423570985008687907853269984665640564039457584007913129639936) x3092 (* 1461501637330902918203684832716283019655932542976 x4459))) (< x3092 1461501637330902918203684832716283019655932542976) (= (* 1461501637330902918203684832716283019655932542976 x4459) (x1319 115792089237316195423570985007226406215939081747436879206741300988257197096960 x1067)) (<= 0 x4459) (> 1 x4982) (> 79228162514264337593543950336 x4459) (<= 0 x3092)))
(define-fun x1412 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x555 x1067) (x3937 x1067 x4820 x2870 x4469) (x2520 x1067)))
(define-fun x778 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x1412 x1067 x4820 x2870 x4469) (x2143 x1067 115792089237316195423570985007226406215939081747436879206741300988257197096960)))
(define-fun x431 ((x1067 Int)) Bool (= (x1319 26959946667150639794667015087019630673637144422540572481103610249215 x1067) (x1319 26959946667150639794667015087019630673637144422540572481103610249215 (x1319 26959946667150639794667015087019630673637144422540572481103610249215 x1067))))
(define-fun x3305 ((x1067 Int)) Bool (=> (and (< x1067 26959946667150639794667015087019630673637144422540572481103610249216) (>= x1067 0)) (= x1067 (x1319 26959946667150639794667015087019630673637144422540572481103610249215 x1067))))
(define-fun x3205 ((x1067 Int)) Bool (=> (= x1067 (x1319 26959946667150639794667015087019630673637144422540572481103610249215 x1067)) (and (<= 0 x1067) (> 26959946667150639794667015087019630673637144422540572481103610249216 x1067))))
(define-fun x3212 ((x1067 Int)) Bool (=> (and (>= x1067 26959946667150639794667015087019630673637144422540572481103610249216) (< x1067 53919893334301279589334030174039261347274288845081144962207220498432)) (= (- x1067 26959946667150639794667015087019630673637144422540572481103610249216) (x1319 26959946667150639794667015087019630673637144422540572481103610249215 x1067))))
(define-fun x803 ((x1067 Int) (x3092 Int)) Bool (and (= x1067 (+ (x1319 26959946667150639794667015087019630673637144422540572481103610249215 x1067) (* x3092 26959946667150639794667015087019630673637144422540572481103610249216))) (<= 0 x3092)))
(define-fun x3437 ((x1067 Int) (x2346 Int)) Bool (and (x3205 x1067) (x803 x1067 x2346) (x3305 x1067) (x431 x1067) (x3212 x1067)))
(define-fun x934 ((x1067 Int) (x2346 Int)) Bool (and (x2143 x1067 26959946667150639794667015087019630673637144422540572481103610249215) (x3437 x1067 x2346)))
(define-fun x2960 ((x1067 Int)) Bool (= (x1319 115792089237316195423570985008687907853269984665640564039457584007913129639904 (x1319 115792089237316195423570985008687907853269984665640564039457584007913129639904 x1067)) (x1319 115792089237316195423570985008687907853269984665640564039457584007913129639904 x1067)))
(define-fun x3336 ((x1067 Int)) Bool (=> (and (>= x1067 0) (> 32 x1067)) (= 0 (x1319 115792089237316195423570985008687907853269984665640564039457584007913129639904 x1067))))
(define-fun x1188 ((x1067 Int) (x3092 Int) (x4459 Int) (x4982 Int)) Bool (and (> 1 x4982) (= (+ (* 115792089237316195423570985008687907853269984665640564039457584007913129639936 x4982) x3092 (* 32 x4459)) x1067) (<= 0 x3092) (> 3618502788666131106986593281521497120414687020801267626233049500247285301248 x4459) (> 32 x3092) (<= 0 x4459) (= (* x4459 32) (x1319 115792089237316195423570985008687907853269984665640564039457584007913129639904 x1067)) (<= 0 x4982)))
(define-fun x2550 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x1188 x1067 x4820 x2870 x4469) (x3336 x1067) (x2960 x1067)))
(define-fun x4612 ((x1067 Int) (x4820 Int) (x2870 Int) (x4469 Int)) Bool (and (x2143 x1067 115792089237316195423570985008687907853269984665640564039457584007913129639904) (x2550 x1067 x4820 x2870 x4469)))
(define-fun x2557 ((x1213 x2327)) Int (ite (= (x1894 x2008) x1213) x2653 (x1031 x1213)))
(define-fun x874 ((x1213 x2327)) Int (ite (= (x1894 x2747) x1213) x1112 (x1031 x1213)))
(define-fun x324 ((x1213 x2327)) Int (ite (= x3420 x1213) x3801 (x1939 x1213)))
(define-fun x4197 ((x1213 x2327)) Int (ite (= x1213 x2192) x2084 (x324 x1213)))
(define-fun x4554 ((x1213 x2327)) Int (ite (= x1213 x1082) x552 (x4197 x1213)))
(define-fun x1982 ((x1213 x2327)) Int (ite (= x1213 x3822) x2711 (x4554 x1213)))
(define-fun x2602 ((x1213 x2327)) Int (ite (and x3982 x3236) (x1982 x1213) (x1939 x1213)))
(define-fun x1147 ((x1213 x2327)) Int (ite (= x1213 x3403) x4833 (x1983 x1213)))
(define-fun x2817 ((x1213 x2327)) Int (ite (= x2111 x1213) x1452 (x1147 x1213)))
(define-fun x1900 ((x1213 x2327)) Int (ite (= x2941 x1213) x1675 (x2817 x1213)))
(define-fun x3934 ((x1213 x2327)) Int (ite (= x4208 x1213) x2790 (x1900 x1213)))
(define-fun x1504 ((x1213 x2327)) Int (ite x674 (ite (and x4346 x4128) (x3934 x1213) (x1983 x1213)) (x1983 x1213)))
(define-fun x888 ((x1213 x2327)) Int (ite (= x1213 x634) x3229 (x1504 x1213)))
(define-fun x1815 ((x1213 x2327)) Int (ite (= x1213 x216) x89 (x888 x1213)))
(define-fun x3640 ((x1213 x2327)) Int (ite (= x1213 x1632) x178 (x1815 x1213)))
(define-fun x1852 ((x1213 x2327)) Int (ite x4941 (x3640 x1213) (x1377 x1213)))
(define-fun x2295 ((x1213 x2327)) Int (ite (= x281 x1213) x1612 (x1625 x1213)))
(define-fun x4509 ((x1213 x2327)) Int (ite (= x1213 x882) x2828 (x2295 x1213)))
(define-fun x3726 ((x1213 x2327)) Int (ite (and x3236 x3982) (x1625 x1213) (ite (and x2552 x576) (x4509 x1213) (x1625 x1213))))
(define-fun x4435 ((x1213 x2327)) Int (ite (and x877 x570) (x1633 x1213) (x1625 x1213)))
(define-fun x4425 ((x1213 x2327)) Int (ite (= x1213 x2749) x4926 (x130 x1213)))
(define-fun x4548 ((x1213 x2327)) Int (ite (= x4517 x1213) x3888 (x4425 x1213)))
(define-fun x196 ((x1213 x2327)) Int (ite (and x2519 x3967 x1313 (not x2648)) (x2362 x1213) (x130 x1213)))
(define-fun x3791 ((x1213 x2327)) Int (ite (= x764 x1213) x1964 (x4568 x1213)))
(define-fun x4090 ((x1213 x2327)) Int (ite (= x1397 x1213) x4262 (x3791 x1213)))
(define-fun x4086 ((x1213 x2327)) Int (ite (= x1213 x2816) x4721 (x3846 x1213)))
(define-fun x24 ((x1213 x2327)) Int (ite (= x1213 x223) x415 (x4086 x1213)))
(define-fun x64 ((x1213 x2327)) Int (ite (and x865 (not x3527) x4586 x1980) (x3636 x1213) (x3846 x1213)))
(define-fun x4155 ((x1213 x2327)) Int (ite (and x2275 x4941 x1191) (x2777 x1213) (x208 x1213)))
(define-fun x3890 ((x1213 x2327)) Int (ite (= x1213 x3864) x1342 (x3126 x1213)))
(define-fun x3281 ((x1213 x2327)) Int (ite (= x4373 x1213) x4058 (x3890 x1213)))
(define-fun x3244 ((x1213 x2327)) Int (ite (and x3982 x3236) (x3126 x1213) (ite (and x576 x2552) (x3126 x1213) (x3281 x1213))))
(define-fun x3171 ((x1213 x2327)) Int (ite (and x570 x877) (x123 x1213) (x3126 x1213)))
(define-fun x4743 ((x1213 x2327)) Int (ite (= x1934 x1213) x4569 (x102 x1213)))
(define-fun x4644 ((x1213 x2327)) Int (ite (= x1874 x1213) x493 (x4743 x1213)))
(define-fun x4924 ((x1213 x2327)) Int (ite (and x1313 (not x2648) x3967 x2519) (x3989 x1213) (x102 x1213)))
(define-fun x2701 ((x1213 x2327)) Int (ite (= x1213 x3630) x4804 (x572 x1213)))
(define-fun x291 ((x1213 x2327)) Int (ite (= x2379 x1213) x1921 (x2701 x1213)))
(define-fun x4282 ((x1213 x2327)) Int (ite (= x1946 x1213) x139 (x4306 x1213)))
(define-fun x3486 ((x1213 x2327)) Int (ite (= x1213 x3360) x52 (x4282 x1213)))
(define-fun x3587 ((x1213 x2327)) Int (ite (and x865 (not x3527) x1980 x4586) (x3498 x1213) (x4306 x1213)))
(define-fun x539 ((x1213 x2327)) Int (ite (and x4941 x1191 x2275) (x4595 x1213) (x1003 x1213)))
(define-fun x4463 ((x1213 x2327)) Int (ite (= x567 x1213) x1978 (x4506 x1213)))
(define-fun x1861 ((x1213 x2327)) Int (ite (and x3982 x3236) (x4506 x1213) (ite (and x2552 x576) (x4463 x1213) (x4506 x1213))))
(define-fun x2080 ((x1213 x2327)) Int (ite (and x3967 x1313 x2519 (not x2648)) (x4530 x1213) (x1414 x1213)))
(define-fun x3841 ((x1213 x2327)) Int (ite (= x1213 x3376) x3522 (x99 x1213)))
(define-fun x3049 ((x1213 x2327)) Int (ite (and x4586 x865 (not x3527) x1980) (x4837 x1213) (x3389 x1213)))
(define-fun x1769 ((x1213 x2327)) Int (ite (and x1191 x2275 x4941) (x2512 x1213) (x2005 x1213)))
(define-fun x1470 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x1 (x1083 x1213)))
(define-fun x3308 ((x1213 x2327)) Int (ite (= (x1894 x1081) x1213) x1278 (x1470 x1213)))
(define-fun x2923 ((x1213 x2327)) Int (ite (= x1213 (x1894 x1081)) x2131 (x3308 x1213)))
(define-fun x1898 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x1553 (x2923 x1213)))
(define-fun x47 ((x1213 x2327)) Int (ite (and x877 x570) (x4798 x1213) (x1083 x1213)))
(define-fun x3075 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x3178 (x1451 x1213)))
(define-fun x3362 ((x1213 x2327)) Int (ite (= (x1894 x1092) x1213) x3317 (x3075 x1213)))
(define-fun x2688 ((x1213 x2327)) Int (ite (= (x1894 x1092) x1213) x1766 (x3362 x1213)))
(define-fun x2198 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x3928 (x2688 x1213)))
(define-fun x3158 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x558 (x1451 x1213)))
(define-fun x4110 ((x1213 x2327)) Int (ite (= x1213 (x1894 x850)) x686 (x3158 x1213)))
(define-fun x468 ((x1213 x2327)) Int (ite (and x1313 x3967 x2519 (not x2648)) (x2696 x1213) (x4110 x1213)))
(define-fun x1627 ((x1213 x2327)) Int (ite (= (x1894 x850) x1213) x985 (x468 x1213)))
(define-fun x1117 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x2969 (x1627 x1213)))
(define-fun x3670 ((x1213 x2327)) Int (ite x4806 (x2198 x1213) (ite (and x2519 x1313 (not x2648)) (x1117 x1213) (x1451 x1213))))
(define-fun x3541 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x719 (x1720 x1213)))
(define-fun x48 ((x1213 x2327)) Int (ite (= (x1894 x4676) x1213) x4447 (x3541 x1213)))
(define-fun x2452 ((x1213 x2327)) Int (ite (= x1213 (x1894 x4676)) x1037 (x48 x1213)))
(define-fun x1436 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x4680 (x2452 x1213)))
(define-fun x3766 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x2361 (x1720 x1213)))
(define-fun x2406 ((x1213 x2327)) Int (ite (= x1213 (x1894 x2482)) x2341 (x3766 x1213)))
(define-fun x2622 ((x1213 x2327)) Int (ite (and x1980 x865 x4586 (not x3527)) (x1798 x1213) (x2406 x1213)))
(define-fun x2539 ((x1213 x2327)) Int (ite (= (x1894 x2482) x1213) x4896 (x2622 x1213)))
(define-fun x2316 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x2953 (x2539 x1213)))
(define-fun x4192 ((x1213 x2327)) Int (ite (and x2275 x4941 x1191) (x2528 x1213) (x2476 x1213)))
(define-fun x659 ((x1213 x2327)) Int (ite x4941 (ite (and (not x2275) x4941) (x2476 x1213) (x4192 x1213)) (x1031 x1213)))
(define-fun x3318 ((x1213 x2327)) Int (ite (= x1213 x369) x1544 (x3248 x1213)))
(define-fun x4761 ((x1213 x2327)) Int (ite (and x3982 x3236) (x3248 x1213) (ite (and x2552 x576) (x3248 x1213) (x3318 x1213))))
(define-fun x2505 ((x1213 x2327)) Int (ite (and (not x2648) x3967 x1313 x2519) (x2153 x1213) (x4828 x1213)))
(define-fun x2948 ((x1213 x2327)) Int (ite (= x1213 x1895) x740 (x4784 x1213)))
(define-fun x381 ((x1213 x2327)) Int (ite (and x865 (not x3527) x1980 x4586) (x1703 x1213) (x3824 x1213)))
(define-fun x1709 ((x1213 x2327)) Int (ite (and x1191 x4941 x2275) (x548 x1213) (x2502 x1213)))
(define-fun x1912 ((x1213 x2327)) Int (ite (= (x1894 x2008) x1213) x651 (x659 x1213)))
(define-fun x1185 ((x1213 Int)) Int (ite (= x1213 420) x3380 (x4604 x1213)))
(define-fun x343 ((x1213 Int)) Int (ite (= x4079 x1213) 0 (x705 x1213)))
(define-fun x4803 ((x1213 Int)) Int (ite (= x1213 324) x1761 (x2564 x1213)))
(define-fun x1520 ((x1213 Int)) Int (ite (= 324 x1213) x1310 (x2564 x1213)))
(define-fun x2853 ((x1213 Int)) Int (ite (and x1969 x4454) (x2564 x1213) (ite (and x1825 x2984) (x4803 x1213) (x1520 x1213))))
(define-fun x1130 ((x1213 Int)) Int (ite (= 128 x1213) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x1699 x1213)))
(define-fun x3952 ((x1213 Int)) Int (ite (= 128 x1213) x2522 (x2237 x1213)))
(define-fun x1381 ((x1213 Int)) Int (ite (= x1213 128) x3524 (x2237 x1213)))
(define-fun x547 ((x1213 Int)) Int (ite (= x1213 128) x1115 (x2237 x1213)))
(define-fun x4654 ((x1213 Int)) Int (ite (and x1858 x4203) (x3952 x1213) (ite (and x3507 x1228) (x1381 x1213) (x547 x1213))))
(define-fun x4487 ((x1213 Int)) Int (ite x1002 (x4654 x1213) (x1699 x1213)))
(define-fun x4787 ((x1213 Int)) Int (ite (= x4145 x1213) 34167655436598589418538772692774877509225721125679165766806516059628562808832 (x4487 x1213)))
(define-fun x2413 ((x1213 Int)) Int (ite (= x1534 x1213) x2419 (x4787 x1213)))
(define-fun x793 ((x1213 Int)) Int (ite (and (> (+ x4145 0) x1213) (>= x1213 x4145)) (x3680 (+ (- x1213 x4145) 0)) (x2007 x1213)))
(define-fun x1345 ((x1213 Int)) Int (ite (= x4145 x1213) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x3163 x1213)))
(define-fun x1995 ((x1213 Int)) Int (ite (= x4145 x1213) x3459 (x1786 x1213)))
(define-fun x3374 ((x1213 Int)) Int (ite (= x1213 x4145) x439 (x1786 x1213)))
(define-fun x1355 ((x1213 Int)) Int (ite (= x1213 x4145) x1990 (x1786 x1213)))
(define-fun x3206 ((x1213 Int)) Int (ite (and x1706 x2436) (x1995 x1213) (ite (and x1349 x3939) (x3374 x1213) (x1355 x1213))))
(define-fun x1880 ((x1213 Int)) Int (ite (= x2905 x1213) x414 (x3154 x1213)))
(define-fun x3747 ((x1213 Int)) Int (ite (= x1213 x1244) 0 (x2981 x1213)))
(define-fun x1389 ((x1213 Int)) Int (ite (= x4205 x1213) x2063 (x1530 x1213)))
(define-fun x1373 ((x1213 Int)) Int (ite (= x4205 x1213) x4566 (x1530 x1213)))
(define-fun x3033 ((x1213 Int)) Int (ite (and (< x1213 (+ x2628 0)) (>= x1213 x2628)) (x3803 (+ (- x1213 x2628) 0)) (x1192 x1213)))
(define-fun x4046 ((x1213 Int)) Int (ite (and (not x4964) x4755 x906 x2645) (x3033 x1213) (x1192 x1213)))
(define-fun x3135 ((x1213 Int)) Int (ite x3426 (ite (and x1308 x4516) (x1389 x1213) (x1373 x1213)) (ite (and x2645 x906 (not x4964)) (x4046 x1213) (x1192 x1213))))
(define-fun x2320 ((x1213 Int)) Int (ite (= x1213 x4633) 904250603428552709895185118199468575982109441609966099573332780532423983104 (x3135 x1213)))
(define-fun x4550 ((x1213 Int)) Int (ite (and (<= x4633 x1213) (> (+ x4633 32) x1213)) (x1326 (+ 0 (- x1213 x4633))) (x3393 x1213)))
(define-fun x1166 ((x1213 Int)) Int (ite (= x1213 x2626) 16156842317565293874272834530371880720966471053262404558597773956279093428224 (x1836 x1213)))
(define-fun x3518 ((x1213 Int)) Int (ite (= x1213 x2666) 274184521717934524641157099916833587240 (x1166 x1213)))
(define-fun x3040 ((x1213 Int)) Int (ite (= x3703 x1213) x2378 (x3518 x1213)))
(define-fun x1051 ((x1213 x2327)) Int (ite (= x379 x1213) x3048 (x201 x1213)))
(define-fun x4254 ((x1213 x2327)) Int (ite (= x1678 x1213) x4244 (x1051 x1213)))
(define-fun x2313 ((x1213 x2327)) Int (ite (= x3234 x1213) x3979 (x4254 x1213)))
(define-fun x3684 ((x1213 x2327)) Int (ite (= x4411 x1213) x4579 (x2313 x1213)))
(define-fun x534 ((x1213 x2327)) Int (ite (and x1969 x4454) (x3684 x1213) (x201 x1213)))
(define-fun x4162 ((x1213 x2327)) Int (ite (= x1213 x298) x2281 (x1199 x1213)))
(define-fun x1641 ((x1213 x2327)) Int (ite (= x1213 x3052) x676 (x4162 x1213)))
(define-fun x234 ((x1213 x2327)) Int (ite (= x1213 x2746) x3836 (x1641 x1213)))
(define-fun x3233 ((x1213 x2327)) Int (ite (= x2639 x1213) x3654 (x234 x1213)))
(define-fun x3525 ((x1213 x2327)) Int (ite (= x211 x1213) x3781 (x3126 x1213)))
(define-fun x3363 ((x1213 x2327)) Int (ite (= x1586 x1213) x4210 (x3525 x1213)))
(define-fun x119 ((x1213 x2327)) Int (ite (and x4454 x1969) (x3126 x1213) (ite (and x1825 x2984) (x3126 x1213) (x3363 x1213))))
(define-fun x3583 ((x1213 x2327)) Int (ite (and x4678 x1970) (x3432 x1213) (x3126 x1213)))
(define-fun x2655 ((x1213 x2327)) Int (ite (= x1213 x2071) x27 (x1507 x1213)))
(define-fun x4091 ((x1213 x2327)) Int (ite (= x4072 x1213) x4790 (x2655 x1213)))
(define-fun x4518 ((x1213 x2327)) Int (ite (and x906 x2645 x4755 (not x4964)) (x4707 x1213) (x1507 x1213)))
(define-fun x2694 ((x1213 x2327)) Int (ite (= x1213 x3081) x2390 (x4552 x1213)))
(define-fun x3359 ((x1213 x2327)) Int (ite (= x1213 x943) x2464 (x2694 x1213)))
(define-fun x4278 ((x1213 x2327)) Int (ite x3848 (ite (and x2404 x4549) (x4552 x1213) (ite (and x3094 x4935) (x4552 x1213) (x3359 x1213))) (ite (and x2934 x2196 (not x3110)) (x2269 x1213) (x4552 x1213))))
(define-fun x1782 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x2364 (x853 x1213)))
(define-fun x3283 ((x1213 x2327)) Int (ite (= (x1894 x2419) x1213) x96 (x1782 x1213)))
(define-fun x4710 ((x1213 x2327)) Int (ite (= x1213 (x1894 x2419)) x966 (x3283 x1213)))
(define-fun x1727 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x4022 (x4710 x1213)))
(define-fun x1807 ((x1213 x2327)) Int (ite (and x4678 x1970) (x4186 x1213) (x853 x1213)))
(define-fun x811 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x1321 (x3519 x1213)))
(define-fun x131 ((x1213 x2327)) Int (ite (= x1213 (x1894 x1299)) x1869 (x811 x1213)))
(define-fun x3592 ((x1213 x2327)) Int (ite (= x1213 (x1894 x1299)) x314 (x131 x1213)))
(define-fun x3693 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x478 (x3592 x1213)))
(define-fun x752 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x4374 (x3519 x1213)))
(define-fun x2544 ((x1213 x2327)) Int (ite (= x1213 (x1894 x1662)) x4267 (x752 x1213)))
(define-fun x2872 ((x1213 x2327)) Int (ite (and x2645 x906 x4755 (not x4964)) (x1532 x1213) (x2544 x1213)))
(define-fun x581 ((x1213 x2327)) Int (ite (= (x1894 x1662) x1213) x3717 (x2872 x1213)))
(define-fun x3263 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x1408 (x581 x1213)))
(define-fun x4230 ((x1213 x2327)) Int (ite x3426 (x3693 x1213) (ite (and x906 (not x4964) x2645) (x3263 x1213) (x3519 x1213))))
(define-fun x2588 ((x1213 x2327)) Int (ite (= x1213 x488) x3515 (x1625 x1213)))
(define-fun x2804 ((x1213 x2327)) Int (ite (= x1085 x1213) x3772 (x2588 x1213)))
(define-fun x4985 ((x1213 x2327)) Int (ite (and x4454 x1969) (x1625 x1213) (ite (and x2984 x1825) (x2804 x1213) (x1625 x1213))))
(define-fun x1095 ((x1213 x2327)) Int (ite (and x4678 x1970) (x956 x1213) (x1625 x1213)))
(define-fun x4168 ((x1213 x2327)) Int (ite (= x1213 x2297) x4329 (x3661 x1213)))
(define-fun x386 ((x1213 x2327)) Int (ite (= x706 x1213) x270 (x4168 x1213)))
(define-fun x4150 ((x1213 x2327)) Int (ite (and x2645 x4755 x906 (not x4964)) (x3223 x1213) (x3661 x1213)))
(define-fun x1552 ((x1213 x2327)) Int (ite (= x4245 x1213) x2219 (x3031 x1213)))
(define-fun x3497 ((x1213 x2327)) Int (ite (= x1213 x4504) x1918 (x1552 x1213)))
(define-fun x856 ((x1213 x2327)) Int (ite x3848 (ite (and x4549 x2404) (x3031 x1213) (ite (and x4935 x3094) (x3497 x1213) (x3031 x1213))) (ite (and x2196 x2934 (not x3110)) (x2093 x1213) (x3031 x1213))))
(define-fun x4214 ((x1213 Int)) Int (ite (= x1213 x2626) x585 (x1679 x1213)))
(define-fun x3960 ((x1213 Int)) Int (ite (= x2626 x1213) x777 (x1679 x1213)))
(define-fun x1838 ((x1213 Int)) Int (ite (= x1213 x2626) 109576784812748834340197573905731726730118698833493337707389013487240318287872 (x1836 x1213)))
(define-fun x2114 ((x1213 Int)) Int (ite (= x1213 x4258) 274184521717934524641157099916833587240 (x1838 x1213)))
(define-fun x3348 ((x1213 Int)) Int (ite (= x1213 x3797) x807 (x2114 x1213)))
(define-fun x292 ((x1213 Int)) Int (ite (= x2337 x1213) x2771 (x3348 x1213)))
(define-fun x816 ((x1213 Int)) Int (ite (= x1213 x1833) x2892 (x292 x1213)))
(define-fun x858 ((x1213 Int)) Int (ite (= x579 x1213) 160 (x816 x1213)))
(define-fun x2569 ((x1213 Int)) Int (ite (and (> (+ 0 x2626) x1213) (<= x2626 x1213)) (x1268 (+ 0 (- x1213 x2626))) (x1153 x1213)))
(define-fun x4732 ((x1213 x2327)) Int (ite x3848 (ite (and x4549 x2404) (x3233 x1213) (x1199 x1213)) (x1199 x1213)))
(define-fun x912 ((x1213 x2327)) Int (ite (= x1213 x2508) x2968 (x4732 x1213)))
(define-fun x2887 ((x1213 x2327)) Int (ite (= x1213 x1145) x4320 (x912 x1213)))
(define-fun x1433 ((x1213 x2327)) Int (ite (= x1213 x4607) x2062 (x2887 x1213)))
(define-fun x3017 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x1167 (x761 x1213)))
(define-fun x4319 ((x1213 x2327)) Int (ite (= (x1894 x4789) x1213) x3695 (x3017 x1213)))
(define-fun x2593 ((x1213 x2327)) Int (ite (and (not x1785) x422 x1366 x1178) (x1309 x1213) (x4319 x1213)))
(define-fun x4296 ((x1213 x2327)) Int (ite (= (x1894 x4789) x1213) x1917 (x2593 x1213)))
(define-fun x633 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x892 (x4296 x1213)))
(define-fun x3594 ((x1213 Int)) Int (ite (= x1529 x1213) x4789 (x3535 x1213)))
(define-fun x2245 ((x1213 Int)) Int (ite (= x774 x1213) x2402 (x3594 x1213)))
(define-fun x2986 ((x1213 Int)) Int (ite (= x1213 x2626) x3894 (x1138 x1213)))
(define-fun x1714 ((x1213 Int)) Int (ite (= x2917 x1213) x2949 (x2245 x1213)))
(define-fun x1163 ((x1213 Int)) Int (ite (= x981 x1213) x3137 (x4747 x1213)))
(define-fun x2637 ((x1213 Int)) Int (ite (= x2779 x1213) 0 (x4299 x1213)))
(define-fun x4067 ((x1213 Int)) Int (ite (= x1213 0) x2522 (x2961 x1213)))
(define-fun x1050 ((x1213 Int)) Int (ite (= 0 x1213) x3459 (x4869 x1213)))
(define-fun x2599 ((x1213 Int)) Int (ite (= 164 x1213) x1873 (x3572 x1213)))
(define-fun x2319 ((x1213 Int)) Int (ite (= 196 x1213) 274184521717934524641157099916833587240 (x2599 x1213)))
(define-fun x46 ((x1213 Int)) Int (ite (= x1213 228) x4403 (x2319 x1213)))
(define-fun x3829 ((x1213 Int)) Int (ite (= x1213 128) 100 (x2415 x1213)))
(define-fun x337 ((x1213 Int)) Int (ite (= x1213 160) x4102 (x46 x1213)))
(define-fun x4758 ((x1213 Int)) Int (ite (= 324 x1213) x3517 (x4740 x1213)))
(define-fun x3910 ((x1213 Int)) Int (ite (and x4600 x1330) (x4740 x1213) (x4758 x1213)))
(define-fun x1232 ((x1213 x2327)) Int (ite (= x1685 x1213) x1579 (x4506 x1213)))
(define-fun x477 ((x1213 x2327)) Int (ite (and x4454 x1969) (x4506 x1213) (ite (and x1825 x2984) (x1232 x1213) (x4506 x1213))))
(define-fun x990 ((x1213 x2327)) Int (ite (= x1213 x2397) x4261 (x3248 x1213)))
(define-fun x311 ((x1213 x2327)) Int (ite (and x1969 x4454) (x3248 x1213) (ite (and x1825 x2984) (x3248 x1213) (x990 x1213))))
(define-fun x4785 ((x1213 x2327)) Int (ite (and x4755 (not x4964) x2645 x906) (x1227 x1213) (x2185 x1213)))
(define-fun x4767 ((x1213 x2327)) Int (ite (and x906 x4755 (not x4964) x2645) (x3622 x1213) (x4342 x1213)))
(define-fun x3849 ((x1213 Int)) Int (ite (= x115 x1213) x1662 (x4563 x1213)))
(define-fun x3423 ((x1213 Int)) Int (ite (= x483 x1213) x4615 (x3849 x1213)))
(define-fun x2947 ((x1213 Int)) Int (ite (= x2628 x1213) x766 (x1843 x1213)))
(define-fun x3130 ((x1213 Int)) Int (ite (= x1213 x1803) x1341 (x3423 x1213)))
(define-fun x2781 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x1454 (x761 x1213)))
(define-fun x1555 ((x1213 x2327)) Int (ite (= (x1894 x1030) x1213) x418 (x2781 x1213)))
(define-fun x4157 ((x1213 x2327)) Int (ite (= (x1894 x1030) x1213) x3673 (x1555 x1213)))
(define-fun x3782 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x173 (x4157 x1213)))
(define-fun x4041 ((x1213 x2327)) Int (ite x433 (x3782 x1213) (ite (and x1366 x1178 (not x1785)) (x633 x1213) (x761 x1213))))
(define-fun x3994 ((x1213 x2327)) Int (ite x3426 (x2185 x1213) (ite (and x906 (not x4964) x2645) (x4785 x1213) (x2185 x1213))))
(define-fun x2416 ((x1213 x2327)) Int (ite x3426 (x4342 x1213) (ite (and x906 x2645 (not x4964)) (x4767 x1213) (x4342 x1213))))
(define-fun x864 ((x1213 Int)) Int (ite (= x1213 x4205) x3246 (x354 x1213)))
(define-fun x812 ((x1213 Int)) Int (ite (and x2469 x3426) (x354 x1213) (x864 x1213)))
(define-fun x891 ((x1213 Int)) Int (ite (and (not x3508) x1785 x1366) (x4299 x1213) (x2637 x1213)))
(define-fun x871 ((x1213 x2327)) Int (ite (= x1213 x1257) x1338 (x856 x1213)))
(define-fun x3129 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x730 x1213)))
(define-fun x1537 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x1106 x1213)))
(define-fun x2234 ((x1213 Int)) Int (ite (= 420 x1213) x3826 (x3117 x1213)))
(define-fun x4797 ((x1213 Int)) Int (ite (= x1213 x3217) 0 (x207 x1213)))
(define-fun x1216 ((x1213 Int)) Int (ite (= 324 x1213) x1146 (x2076 x1213)))
(define-fun x2141 ((x1213 Int)) Int (ite (= x1213 324) x1264 (x2076 x1213)))
(define-fun x648 ((x1213 Int)) Int (ite (and x3236 x3982) (x2076 x1213) (ite (and x2552 x576) (x1216 x1213) (x2141 x1213))))
(define-fun x140 ((x1213 Int)) Int (ite (= x1213 128) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x2266 x1213)))
(define-fun x4750 ((x1213 Int)) Int (ite (= x1213 128) x204 (x3341 x1213)))
(define-fun x237 ((x1213 Int)) Int (ite (= x1213 128) x2264 (x3341 x1213)))
(define-fun x3082 ((x1213 Int)) Int (ite (= x1213 128) x1114 (x3341 x1213)))
(define-fun x2831 ((x1213 Int)) Int (ite (and x4944 x4722) (x4750 x1213) (ite (and x721 x3095) (x237 x1213) (x3082 x1213))))
(define-fun x4961 ((x1213 Int)) Int (ite x448 (x2831 x1213) (x2266 x1213)))
(define-fun x4501 ((x1213 Int)) Int (ite (= x1213 x2491) 34167655436598589418538772692774877509225721125679165766806516059628562808832 (x4961 x1213)))
(define-fun x4132 ((x1213 Int)) Int (ite (= x610 x1213) x1081 (x4501 x1213)))
(define-fun x2029 ((x1213 Int)) Int (ite (and (< x1213 (+ 0 x2491)) (>= x1213 x2491)) (x3301 (+ (- x1213 x2491) 0)) (x4799 x1213)))
(define-fun x2342 ((x1213 Int)) Int (ite (= x2491 x1213) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x4273 x1213)))
(define-fun x959 ((x1213 Int)) Int (ite (= x1213 x2491) x2003 (x1512 x1213)))
(define-fun x1271 ((x1213 Int)) Int (ite (= x1213 x2491) x2814 (x1512 x1213)))
(define-fun x2090 ((x1213 Int)) Int (ite (= x2491 x1213) x1600 (x1512 x1213)))
(define-fun x972 ((x1213 Int)) Int (ite (and x3142 x4116) (x959 x1213) (ite (and x565 x1175) (x1271 x1213) (x2090 x1213))))
(define-fun x2260 ((x1213 Int)) Int (ite (= x1213 x2441) x3765 (x3886 x1213)))
(define-fun x1212 ((x1213 Int)) Int (ite (= x4123 x1213) 0 (x1233 x1213)))
(define-fun x255 ((x1213 Int)) Int (ite (= x2784 x1213) x1400 (x3863 x1213)))
(define-fun x3676 ((x1213 Int)) Int (ite (= x1213 x2784) x2927 (x3863 x1213)))
(define-fun x1248 ((x1213 Int)) Int (ite (and (>= x1213 x3289) (< x1213 (+ x3289 0))) (x2798 (+ (- x1213 x3289) 0)) (x1669 x1213)))
(define-fun x105 ((x1213 Int)) Int (ite (and (not x2648) x2519 x1313 x3967) (x1248 x1213) (x1669 x1213)))
(define-fun x4011 ((x1213 Int)) Int (ite x4806 (ite (and x641 x238) (x255 x1213) (x3676 x1213)) (ite (and (not x2648) x2519 x1313) (x105 x1213) (x1669 x1213))))
(define-fun x469 ((x1213 Int)) Int (ite (= x3823 x1213) 904250603428552709895185118199468575982109441609966099573332780532423983104 (x4011 x1213)))
(define-fun x4628 ((x1213 Int)) Int (ite (and (> (+ x3823 32) x1213) (>= x1213 x3823)) (x546 (+ (- x1213 x3823) 0)) (x4638 x1213)))
(define-fun x3185 ((x1213 Int)) Int (ite (= x2810 x1213) 16156842317565293874272834530371880720966471053262404558597773956279093428224 (x4349 x1213)))
(define-fun x1394 ((x1213 Int)) Int (ite (= x1213 x3664) 274184521717934524641157099916833587240 (x3185 x1213)))
(define-fun x4169 ((x1213 Int)) Int (ite (= x4965 x1213) x3635 (x1394 x1213)))
(define-fun x1266 ((x1213 Int)) Int (ite (= x1213 x2810) x4919 (x1382 x1213)))
(define-fun x2395 ((x1213 Int)) Int (ite (= x1213 x2810) x1222 (x1382 x1213)))
(define-fun x1231 ((x1213 Int)) Int (ite (= x1213 x2810) 109576784812748834340197573905731726730118698833493337707389013487240318287872 (x4349 x1213)))
(define-fun x1561 ((x1213 Int)) Int (ite (= x1213 x88) 274184521717934524641157099916833587240 (x1231 x1213)))
(define-fun x786 ((x1213 Int)) Int (ite (= x845 x1213) x696 (x1561 x1213)))
(define-fun x3428 ((x1213 Int)) Int (ite (= x1224 x1213) x3343 (x786 x1213)))
(define-fun x3775 ((x1213 Int)) Int (ite (= x1903 x1213) x1350 (x3428 x1213)))
(define-fun x2566 ((x1213 Int)) Int (ite (= x1213 x3737) 160 (x3775 x1213)))
(define-fun x516 ((x1213 Int)) Int (ite (and (<= x2810 x1213) (< x1213 (+ 0 x2810))) (x2037 (+ (- x1213 x2810) 0)) (x2451 x1213)))
(define-fun x3387 ((x1213 Int)) Int (ite (= x1213 x1460) x2482 (x3091 x1213)))
(define-fun x2780 ((x1213 Int)) Int (ite (= x3750 x1213) x429 (x3387 x1213)))
(define-fun x2763 ((x1213 Int)) Int (ite (= x1213 x2810) x612 (x1375 x1213)))
(define-fun x29 ((x1213 Int)) Int (ite (= x1213 x3966) x4608 (x2780 x1213)))
(define-fun x1416 ((x1213 Int)) Int (ite (= x1336 x1213) x1368 (x4061 x1213)))
(define-fun x2182 ((x1213 Int)) Int (ite (= x4561 x1213) 0 (x2121 x1213)))
(define-fun x2021 ((x1213 Int)) Int (ite (= 0 x1213) x204 (x3534 x1213)))
(define-fun x1617 ((x1213 Int)) Int (ite (= x1213 0) x2003 (x1207 x1213)))
(define-fun x1618 ((x1213 Int)) Int (ite (= x1213 164) x1770 (x4453 x1213)))
(define-fun x1644 ((x1213 Int)) Int (ite (= x1213 196) 274184521717934524641157099916833587240 (x1618 x1213)))
(define-fun x2800 ((x1213 Int)) Int (ite (= x1213 228) x250 (x1644 x1213)))
(define-fun x1510 ((x1213 Int)) Int (ite (= x1213 128) 100 (x2312 x1213)))
(define-fun x3677 ((x1213 Int)) Int (ite (= x1213 160) x1261 (x2800 x1213)))
(define-fun x1427 ((x1213 Int)) Int (ite (= x1213 324) x4878 (x1844 x1213)))
(define-fun x357 ((x1213 Int)) Int (ite (and x279 x1906) (x1844 x1213) (x1427 x1213)))
(define-fun x4675 ((x1213 Int)) Int (ite (= x1956 x1213) x850 (x975 x1213)))
(define-fun x1690 ((x1213 Int)) Int (ite (= x3238 x1213) x3349 (x4675 x1213)))
(define-fun x1899 ((x1213 Int)) Int (ite (= x3289 x1213) x3464 (x4898 x1213)))
(define-fun x3908 ((x1213 Int)) Int (ite (= x819 x1213) x3553 (x1690 x1213)))
(define-fun x3448 ((x1213 Int)) Int (ite (= x1213 x2784) x1344 (x4626 x1213)))
(define-fun x4931 ((x1213 Int)) Int (ite (and x4806 x1134) (x4626 x1213) (x3448 x1213)))
(define-fun x1022 ((x1213 Int)) Int (ite (and x865 x3527 (not x3009)) (x2121 x1213) (x2182 x1213)))
(define-fun x884 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x4305 x1213)))
(define-fun x3411 ((x1213 Int)) Int (ite (= x1213 0) 1 (x1794 x1213)))
(define-fun x3276 ((x1213 x2327)) Int (ite (and (not x941) x3980 x542) (x2259 x1213) (x1582 x1213)))
(define-fun x1539 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x4480 (x1582 x1213)))
(define-fun x590 ((x1213 x2327)) Int (ite (= x1213 (x1894 x3907)) x1868 (x1539 x1213)))
(define-fun x4967 ((x1213 x2327)) Int (ite (= (x1894 x3907) x1213) x2614 (x590 x1213)))
(define-fun x977 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x862 (x4967 x1213)))
(define-fun x737 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x3462 (x269 x1213)))
(define-fun x409 ((x1213 x2327)) Int (ite (= x1213 (x1894 x847)) x1620 (x737 x1213)))
(define-fun x1372 ((x1213 x2327)) Int (ite (= x1213 (x1894 x847)) x4089 (x409 x1213)))
(define-fun x2193 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x1910 (x1372 x1213)))
(define-fun x842 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x2754 (x269 x1213)))
(define-fun x4749 ((x1213 x2327)) Int (ite (= (x1894 x4959) x1213) x1518 (x842 x1213)))
(define-fun x3004 ((x1213 x2327)) Int (ite (and x1423 x287 x4286 (not x2427)) (x1480 x1213) (x4749 x1213)))
(define-fun x2387 ((x1213 x2327)) Int (ite (= x1213 (x1894 x4959)) x3323 (x3004 x1213)))
(define-fun x3699 ((x1213 x2327)) Int (ite (= (x1894 274184521717934524641157099916833587240) x1213) x701 (x2387 x1213)))
(define-fun x2865 ((x1213 x2327)) Int (ite x94 (ite x3368 (x2193 x1213) (x269 x1213)) (ite (and x287 (not x2427) x1423) (x3699 x1213) (x269 x1213))))
(define-fun x3390 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x3152 (x2098 x1213)))
(define-fun x3727 ((x1213 x2327)) Int (ite (= (x1894 x3392) x1213) x1590 (x3390 x1213)))
(define-fun x1991 ((x1213 x2327)) Int (ite (= (x1894 x3392) x1213) x2605 (x3727 x1213)))
(define-fun x3484 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x189 (x1991 x1213)))
(define-fun x4316 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x1514 (x2098 x1213)))
(define-fun x2126 ((x1213 x2327)) Int (ite (= x1213 (x1894 x335)) x2175 (x4316 x1213)))
(define-fun x82 ((x1213 x2327)) Int (ite (and (not x4287) x1370 x2668 x2203) (x3446 x1213) (x2126 x1213)))
(define-fun x4473 ((x1213 x2327)) Int (ite (= (x1894 x335) x1213) x4597 (x82 x1213)))
(define-fun x3232 ((x1213 x2327)) Int (ite (= x1213 (x1894 274184521717934524641157099916833587240)) x988 (x4473 x1213)))
(define-fun x672 ((x1213 x2327)) Int (ite x4097 (ite x1565 (x3484 x1213) (x2098 x1213)) (ite (and (not x4287) x1370 x2203) (x3232 x1213) (x2098 x1213))))
(define-fun x4719 ((x1213 x2327)) Int (ite (and x4829 (not x4980)) (x3604 x1213) (ite (and x1775 x3427) (x3604 x1213) (ite (and x3159 x4690) (x1267 x1213) (ite (and x963 x2223) (x15 x1213) (ite (and (not x1186) x2258) (x3604 x1213) (ite (and (not x1757) x1629) (x3604 x1213) (ite (and x1279 x4888) (x3604 x1213) (ite (and x1919 x1695) (x3604 x1213) (ite (and x40 x3951) (x1267 x1213) (x3604 x1213)))))))))))
(define-fun x4541 ((x1213 x2327)) Int (ite (= x1213 x2535) x4151 (x15 x1213)))
(define-fun x2357 ((x1213 x2327)) Int (ite (= x1213 x694) x4183 (x4541 x1213)))
(define-fun x3169 ((x1213 x2327)) Int (ite x4577 (x4719 x1213) (x2357 x1213)))
(define-fun x1570 ((x1213 x2327)) Int (ite x3146 (x3169 x1213) (x3604 x1213)))
(define-fun x4812 ((x1213 x2327)) Int (ite (and x667 (not x536)) (x3566 x1213) (ite (and x1357 x2559) (x3566 x1213) (ite (and x268 x649) (x4952 x1213) (ite (and x1974 x3998) (x1908 x1213) (ite (and x2043 x4917) (x3566 x1213) (ite (and x2709 (not x3739)) (x3566 x1213) (ite (and (not x1596) x1363) (x3566 x1213) (ite (and x3015 x3899) (x3566 x1213) (ite (and x2376 x2713) (x3566 x1213) (ite (and x1218 x2208) (x4952 x1213) (x3566 x1213))))))))))))
(define-fun x1902 ((x1213 x2327)) Int (ite (= x3562 x1213) x1262 (x1908 x1213)))
(define-fun x134 ((x1213 x2327)) Int (ite (= x1213 x3965) x3711 (x1902 x1213)))
(define-fun x3501 ((x1213 x2327)) Int (ite x438 (x4812 x1213) (x134 x1213)))
(define-fun x3915 ((x1213 x2327)) Int (ite (and x4019 (not x4397)) (ite x3306 (x3501 x1213) (x3566 x1213)) (x3566 x1213)))
(define-fun x3105 ((x1213 x2327)) Int (ite (= x3495 x1213) x3746 (x3915 x1213)))
(define-fun x3227 ((x1213 Int)) Int (ite (= 128 x1213) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x2885 x1213)))
(define-fun x1013 ((x1213 Int)) Int (ite (= 128 x1213) x4547 (x2548 x1213)))
(define-fun x3687 ((x1213 Int)) Int (ite (= x1213 128) x3827 (x2548 x1213)))
(define-fun x2509 ((x1213 Int)) Int (ite (= x1213 128) x2551 (x2548 x1213)))
(define-fun x135 ((x1213 Int)) Int (ite (and (not x2716) x2718 x1536) (x1013 x1213) (ite (and x2718 x1536 x2716) (x2548 x1213) (ite (and x1358 x2723 (not x2081)) (x3687 x1213) (ite (and x2723 x1358 x2081) (x2548 x1213) (ite (and x3584 x605 (not x2006)) (x2509 x1213) (x2548 x1213)))))))
(define-fun x4088 ((x1213 Int)) Int (ite (and (not x592) x383) (x135 x1213) (x2885 x1213)))
(define-fun x4983 ((x1213 Int)) Int (ite (= x1213 x2975) 34167655436598589418538772692774877509225721125679165766806516059628562808832 (x4088 x1213)))
(define-fun x4943 ((x1213 Int)) Int (ite (= x3307 x1213) x3907 (x4983 x1213)))
(define-fun x1997 ((x1213 Int)) Int (ite (and (>= x1213 x2975) (> (+ 0 x2975) x1213)) (x1197 (+ 0 (- x1213 x2975))) (x4441 x1213)))
(define-fun x1444 ((x1213 Int)) Int (ite (= x1213 x2975) 50942633119752846454219349998365661925608737367104304655302372697894809501696 (x2477 x1213)))
(define-fun x2805 ((x1213 Int)) Int (ite (= x2975 x1213) x838 (x4773 x1213)))
(define-fun x3540 ((x1213 Int)) Int (ite (= x1213 x2975) x700 (x4773 x1213)))
(define-fun x424 ((x1213 Int)) Int (ite (= x1213 x2975) x4824 (x4773 x1213)))
(define-fun x1488 ((x1213 Int)) Int (ite (and (not x2195) x4757 x549) (x2805 x1213) (ite (and x2195 x4757 x549) (x4773 x1213) (ite (and x2435 x1066 (not x889)) (x3540 x1213) (ite (and x1066 x2435 x889) (x4773 x1213) (ite (and x2991 (not x4400) x2728) (x424 x1213) (x4773 x1213)))))))
(define-fun x4028 ((x1213 Int)) Int (ite (= 420 x1213) x2882 (x2053 x1213)))
(define-fun x2248 ((x1213 Int)) Int (ite (= x1213 x3579) 0 (x522 x1213)))
(define-fun x3876 ((x1213 Int)) Int (ite (= 324 x1213) x2748 (x3382 x1213)))
(define-fun x1992 ((x1213 Int)) Int (ite x4887 (x3382 x1213) (x3876 x1213)))
(define-fun x408 ((x1213 Int)) Int (ite (= 324 x1213) x243 (x3382 x1213)))
(define-fun x3394 ((x1213 Int)) Int (ite x527 (x3382 x1213) (x408 x1213)))
(define-fun x4179 ((x1213 Int)) Int (ite x3146 (x3382 x1213) (ite x2339 (x1992 x1213) (x3394 x1213))))
(define-fun x1859 ((x1213 Int)) Int (ite (= x1213 x3153) x923 (x322 x1213)))
(define-fun x2988 ((x1213 Int)) Int (ite (= x1213 x717) 0 (x3098 x1213)))
(define-fun x183 ((x1213 Int)) Int (ite (= x4899 x1213) x2902 (x53 x1213)))
(define-fun x1334 ((x1213 Int)) Int (ite x4948 (x53 x1213) (x183 x1213)))
(define-fun x2147 ((x1213 Int)) Int (ite (= x1213 x4899) x4037 (x53 x1213)))
(define-fun x3709 ((x1213 Int)) Int (ite x3188 (x53 x1213) (x2147 x1213)))
(define-fun x726 ((x1213 Int)) Int (ite x2344 (x1334 x1213) (x3709 x1213)))
(define-fun x530 ((x1213 Int)) Int (ite (and (<= x4226 x1213) (> (+ x4226 0) x1213)) (x3614 (+ (- x1213 x4226) 0)) (x828 x1213)))
(define-fun x184 ((x1213 Int)) Int (ite (and x4286 x1423 (not x2427) x287) (x530 x1213) (x828 x1213)))
(define-fun x4599 ((x1213 Int)) Int (ite x94 (ite x3368 (x726 x1213) (x53 x1213)) (ite (and (not x2427) x287 x1423) (x184 x1213) (x828 x1213))))
(define-fun x3543 ((x1213 Int)) Int (ite (= x1213 x2660) 904250603428552709895185118199468575982109441609966099573332780532423983104 (x4599 x1213)))
(define-fun x394 ((x1213 Int)) Int (ite (and (>= x1213 x2660) (> (+ 32 x2660) x1213)) (x3569 (+ (- x1213 x2660) 0)) (x4215 x1213)))
(define-fun x3844 ((x1213 Int)) Int (ite (= x1950 x1213) 109576784812748834340197573905731726730118698833493337707389013487240318287872 (x4474 x1213)))
(define-fun x767 ((x1213 Int)) Int (ite (= x1213 x37) 274184521717934524641157099916833587240 (x3844 x1213)))
(define-fun x1724 ((x1213 Int)) Int (ite (= x1213 x3274) x2288 (x767 x1213)))
(define-fun x2567 ((x1213 Int)) Int (ite (= x188 x1213) x3451 (x1724 x1213)))
(define-fun x849 ((x1213 Int)) Int (ite (= x1213 x83) x3311 (x2567 x1213)))
(define-fun x2068 ((x1213 Int)) Int (ite (= x1213 x4836) 160 (x849 x1213)))
(define-fun x154 ((x1213 Int)) Int (ite (and (> (+ 0 x1950) x1213) (<= x1950 x1213)) (x2672 (+ 0 (- x1213 x1950))) (x4218 x1213)))
(define-fun x4170 ((x1213 Int)) Int (ite (= x1950 x1213) 16156842317565293874272834530371880720966471053262404558597773956279093428224 (x4474 x1213)))
(define-fun x4817 ((x1213 Int)) Int (ite (= x4564 x1213) 274184521717934524641157099916833587240 (x4170 x1213)))
(define-fun x4444 ((x1213 Int)) Int (ite (= x525 x1213) x219 (x4817 x1213)))
(define-fun x3564 ((x1213 Int)) Int (ite (= x1213 0) x4547 (x868 x1213)))
(define-fun x4616 ((x1213 Int)) Int (ite (= x1213 0) x838 (x685 x1213)))
(define-fun x3330 ((x1213 Int)) Int (ite (= x1213 164) x4341 (x3155 x1213)))
(define-fun x1656 ((x1213 Int)) Int (ite (= x1213 196) 274184521717934524641157099916833587240 (x3330 x1213)))
(define-fun x4149 ((x1213 Int)) Int (ite (= x1213 228) x1849 (x1656 x1213)))
(define-fun x4456 ((x1213 Int)) Int (ite (= x1213 128) 100 (x4788 x1213)))
(define-fun x1671 ((x1213 Int)) Int (ite (= 160 x1213) x4443 (x4149 x1213)))
(define-fun x787 ((x1213 Int)) Int (ite (= x1213 x2910) x335 (x136 x1213)))
(define-fun x1516 ((x1213 Int)) Int (ite (= x3631 x1213) x3774 (x787 x1213)))
(define-fun x2624 ((x1213 Int)) Int (ite (= x1950 x1213) x824 (x2127 x1213)))
(define-fun x907 ((x1213 Int)) Int (ite (= x1213 x4655) x697 (x1516 x1213)))
(define-fun x1863 ((x1213 Int)) Int (ite (= x1950 x1213) x3999 (x2110 x1213)))
(define-fun x1252 ((x1213 Int)) Int (ite x3740 (x2110 x1213) (x1863 x1213)))
(define-fun x1708 ((x1213 Int)) Int (ite (= x1213 x1950) x1390 (x2110 x1213)))
(define-fun x3297 ((x1213 Int)) Int (ite x3076 (x2110 x1213) (x1708 x1213)))
(define-fun x4364 ((x1213 Int)) Int (ite (= x680 x1213) x2591 (x3538 x1213)))
(define-fun x2884 ((x1213 Int)) Int (ite (= x2558 x1213) 0 (x3224 x1213)))
(define-fun x1525 ((x1213 Int)) Int (ite (= x1213 x3361) x4959 (x2615 x1213)))
(define-fun x271 ((x1213 Int)) Int (ite (= x2365 x1213) x968 (x1525 x1213)))
(define-fun x2432 ((x1213 Int)) Int (ite (= x4226 x1213) x2359 (x1113 x1213)))
(define-fun x2916 ((x1213 Int)) Int (ite (= x137 x1213) x4361 (x271 x1213)))
(define-fun x3282 ((x1213 x2327)) Int (ite (and x542 (not x941) x3980) (x30 x1213) (x2471 x1213)))
(define-fun x802 ((x1213 x2327)) Int (ite (and x1009 x2102) (x1953 x1213) (ite (and x2056 x4495) (x675 x1213) (ite (and x141 x3659) (x2471 x1213) (ite (and x3408 (not x4449)) (x2471 x1213) (ite (and x2052 x4572) (x2471 x1213) (ite (and x2900 x4892) (x1953 x1213) (ite (and x1523 x2795) (x2471 x1213) (x675 x1213)))))))))
(define-fun x3554 ((x1213 x2327)) Int (ite x527 (x802 x1213) (x1953 x1213)))
(define-fun x2735 ((x1213 x2327)) Int (ite x3146 (x2471 x1213) (ite x2339 (x2471 x1213) (x3554 x1213))))
(define-fun x3010 ((x1213 x2327)) Int (ite (and x287 (not x2427) x4286 x1423) (x4972 x1213) (x2293 x1213)))
(define-fun x4542 ((x1213 x2327)) Int (ite (= x1213 x3958) x1791 (x640 x1213)))
(define-fun x3531 ((x1213 x2327)) Int (ite x4887 (x640 x1213) (x4542 x1213)))
(define-fun x1614 ((x1213 x2327)) Int (ite x3146 (x640 x1213) (ite x2339 (x3531 x1213) (x640 x1213))))
(define-fun x2033 ((x1213 x2327)) Int (ite (and (not x2427) x287 x1423 x4286) (x2913 x1213) (x1471 x1213)))
(define-fun x500 ((x1213 x2327)) Int (ite (and x3980 (not x941) x542) (x4592 x1213) (x709 x1213)))
(define-fun x2064 ((x1213 x2327)) Int (ite (and x5 x4663) (x2541 x1213) (ite (and x1194 x138) (x76 x1213) (ite (and x668 x1989) (x709 x1213) (ite (and x4308 (not x1672)) (x709 x1213) (ite (and x4018 x4458) (x709 x1213) (ite (and x614 x4706) (x2541 x1213) (ite (and x374 x3567) (x709 x1213) (x76 x1213)))))))))
(define-fun x1975 ((x1213 x2327)) Int (ite x4887 (x2064 x1213) (x2541 x1213)))
(define-fun x4870 ((x1213 x2327)) Int (ite x3146 (x709 x1213) (ite x2339 (x1975 x1213) (x709 x1213))))
(define-fun x3511 ((x1213 x2327)) Int (ite (and x287 x4286 (not x2427) x1423) (x1879 x1213) (x2174 x1213)))
(define-fun x2486 ((x1213 x2327)) Int (ite (= x4674 x1213) x2681 (x3618 x1213)))
(define-fun x2534 ((x1213 x2327)) Int (ite x527 (x3618 x1213) (x2486 x1213)))
(define-fun x1034 ((x1213 x2327)) Int (ite x3146 (x3618 x1213) (ite x2339 (x3618 x1213) (x2534 x1213))))
(define-fun x796 ((x1213 x2327)) Int (ite (and (not x2427) x1423 x4286 x287) (x12 x1213) (x4662 x1213)))
(define-fun x1322 ((x1213 x2327)) Int (ite (and x108 x2089) (x2523 x1213) (ite (and x3414 x4872) (x2293 x1213) (ite (and x4477 (not x249)) (x2293 x1213) (ite (and x1140 x2167) (x2293 x1213) (ite (and x1352 x2306) (x2293 x1213) (x2523 x1213)))))))
(define-fun x1602 ((x1213 x2327)) Int (ite (= x1213 x1776) x4015 (x2523 x1213)))
(define-fun x2309 ((x1213 x2327)) Int (ite x3188 (x1322 x1213) (x1602 x1213)))
(define-fun x4553 ((x1213 x2327)) Int (ite x2344 (x2293 x1213) (x2309 x1213)))
(define-fun x753 ((x1213 x2327)) Int (ite (and x4640 x3537) (x4246 x1213) (ite (and x3993 x1024) (x2174 x1213) (ite (and x4684 (not x3261)) (x2174 x1213) (ite (and x2134 x3250) (x2174 x1213) (ite (and x2283 x1155) (x2174 x1213) (x4246 x1213)))))))
(define-fun x1573 ((x1213 x2327)) Int (ite (= x4613 x1213) x1755 (x4246 x1213)))
(define-fun x3678 ((x1213 x2327)) Int (ite x4948 (x753 x1213) (x1573 x1213)))
(define-fun x3884 ((x1213 x2327)) Int (ite x2344 (x3678 x1213) (x2174 x1213)))
(define-fun x484 ((x1213 x2327)) Int (ite x94 (x4662 x1213) (ite (and (not x2427) x287 x1423) (x796 x1213) (x4662 x1213))))
(define-fun x1993 ((x1213 x2327)) Int (ite x94 (x1471 x1213) (ite (and x287 x1423 (not x2427)) (x2033 x1213) (x1471 x1213))))
(define-fun x2809 ((x1213 Int)) Int (ite (= 324 x1213) x346 (x1566 x1213)))
(define-fun x822 ((x1213 Int)) Int (ite (and x2220 x3571) (x1566 x1213) (x2809 x1213)))
(define-fun x4507 ((x1213 Int)) Int (ite (= x4899 x1213) x34 (x2088 x1213)))
(define-fun x84 ((x1213 Int)) Int (ite (and x11 x1012) (x2088 x1213) (x4507 x1213)))
(define-fun x3840 ((x1213 Int)) Int (ite (= x636 x1213) x2368 (x1962 x1213)))
(define-fun x157 ((x1213 Int)) Int (ite (and x2866 x4415) (x1962 x1213) (x3840 x1213)))
(define-fun x3875 ((x1213 Int)) Int (ite (= x1213 0) 1 (x4622 x1213)))
(define-fun x4418 ((x1213 Int)) Int (ite x4887 (x4622 x1213) (x3875 x1213)))
(define-fun x2347 ((x1213 Int)) Int (ite (= x1213 0) 1 (x4622 x1213)))
(define-fun x544 ((x1213 Int)) Int (ite x527 (x4622 x1213) (x2347 x1213)))
(define-fun x3809 ((x1213 Int)) Int (ite x938 (ite x3146 (x4622 x1213) (ite x2339 (x4418 x1213) (x544 x1213))) (x953 x1213)))
(define-fun x1562 ((x1213 Int)) Int (ite (and (<= 356 x1213) (> (+ 356 x346) x1213)) (x3809 (+ (- x1213 356) 0)) (x2861 x1213)))
(define-fun x1682 ((x1213 Int)) Int (ite (= x1213 0) 1 (x3667 x1213)))
(define-fun x4808 ((x1213 Int)) Int (ite x4881 (x3667 x1213) (x1682 x1213)))
(define-fun x3384 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x3667 x1213)))
(define-fun x784 ((x1213 Int)) Int (ite x4211 (x3667 x1213) (x3384 x1213)))
(define-fun x4252 ((x1213 Int)) Int (ite x1565 (ite x2124 (x4808 x1213) (x784 x1213)) (x1522 x1213)))
(define-fun x3037 ((x1213 Int)) Int (ite (and (< x1213 (+ x3490 x2368)) (<= x3490 x1213)) (x4252 (+ (- x1213 x3490) 0)) (x751 x1213)))
(define-fun x1038 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x4871 x1213)))
(define-fun x4339 ((x1213 Int)) Int (ite x4948 (x4871 x1213) (x1038 x1213)))
(define-fun x681 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x4871 x1213)))
(define-fun x376 ((x1213 Int)) Int (ite x3188 (x4871 x1213) (x681 x1213)))
(define-fun x3825 ((x1213 Int)) Int (ite x3368 (ite x2344 (x4339 x1213) (x376 x1213)) (x2046 x1213)))
(define-fun x1598 ((x1213 Int)) Int (ite (and (<= x3656 x1213) (< x1213 (+ x34 x3656))) (x3825 (+ (- x1213 x3656) 0)) (x380 x1213)))
(define-fun x342 ((x1213 Int)) Int (ite (and x3571 x2220) (x2861 x1213) (x1562 x1213)))
(define-fun x1832 ((x1213 Int)) Int (ite (and x2866 x4415) (x751 x1213) (x3037 x1213)))
(define-fun x4405 ((x1213 Int)) Int (ite (and x11 x1012) (x380 x1213) (x1598 x1213)))
(define-fun x683 ((x1213 x2327)) Int (ite (= x1213 x2700) x4900 (x3105 x1213)))
(define-fun x2324 ((x1213 x2327)) Int (ite (= x168 x1213) x925 (x683 x1213)))
(define-fun x3935 ((x1213 Int)) Int (ite (and x1124 (not x3955) x4933) (x3224 x1213) (x2884 x1213)))
(define-fun x1648 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x2793 x1213)))
(define-fun x1713 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x2793 x1213)))
(define-fun x4271 ((x1213 Int)) Int (ite (= x1213 0) x1115 (x2961 x1213)))
(define-fun x2826 ((x1213 Int)) Int (ite (= 0 x1213) x3524 (x2961 x1213)))
(define-fun x3991 ((x1213 Int)) Int (ite (= x1213 0) x1990 (x4869 x1213)))
(define-fun x4010 ((x1213 Int)) Int (ite (= x1213 0) x439 (x4869 x1213)))
(define-fun x4938 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x4524 x1213)))
(define-fun x1297 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x4524 x1213)))
(define-fun x1235 ((x1213 x2327)) Int (ite (= x1213 x4198) x3355 (x4278 x1213)))
(define-fun x3977 ((x1213 Int)) Int (ite (= x1213 0) 1 (x730 x1213)))
(define-fun x198 ((x1213 Int)) Int (ite (= x1213 0) 1 (x1106 x1213)))
(define-fun x2004 ((x1213 Int)) Int (ite (= x1213 0) 1 (x2272 x1213)))
(define-fun x1984 ((x1213 Int)) Int (ite (= x1213 0) 1 (x2272 x1213)))
(define-fun x578 ((x1213 Int)) Int (ite (= x1213 0) x1114 (x3534 x1213)))
(define-fun x4827 ((x1213 Int)) Int (ite (= x1213 0) x2264 (x3534 x1213)))
(define-fun x4112 ((x1213 Int)) Int (ite (= x1213 0) x1600 (x1207 x1213)))
(define-fun x3452 ((x1213 Int)) Int (ite (= 0 x1213) x2814 (x1207 x1213)))
(define-fun x2717 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x2978 x1213)))
(define-fun x2152 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x2978 x1213)))
(define-fun x481 ((x1213 Int)) Int (ite (= x1213 0) 1 (x4305 x1213)))
(define-fun x4525 ((x1213 Int)) Int (ite (= 0 x1213) 1 (x1794 x1213)))
(define-fun x4330 ((x1213 Int)) Int (ite (= x1213 0) x2551 (x868 x1213)))
(define-fun x3050 ((x1213 Int)) Int (ite (= x1213 0) x3827 (x868 x1213)))
(define-fun x365 ((x1213 Int)) Int (ite (= x1213 0) x4824 (x685 x1213)))
(define-fun x1360 ((x1213 Int)) Int (ite (= 0 x1213) x700 (x685 x1213)))
(define-fun x3756 ((x1213 Int)) Int (ite (= x1213 0) 1 (x695 x1213)))
(define-fun x2650 ((x1213 x2327)) Int (ite (and x399 x3879) (x4934 x1213) (ite (and x3047 x2943) (x4763 x1213) (ite (and x1787 x419) (x4505 x1213) (ite (and (not x2118) x1168) (x4505 x1213) (ite (and x1925 x931) (x4505 x1213) (ite (and x3005 x1062) (x4934 x1213) (ite (and x4672 x3696) (x4505 x1213) (x4763 x1213)))))))))
(define-fun x1324 ((x1213 x2327)) Int (ite x3076 (x2650 x1213) (x4934 x1213)))
(define-fun x1587 ((x1213 Int)) Int (ite (= x1213 0) 1 (x695 x1213)))
(define-fun x1951 ((x1213 x2327)) Int (ite (and x4930 x1046) (x1325 x1213) (ite (and x1944 x637) (x2657 x1213) (ite (and x2895 x4496) (x520 x1213) (ite (and x3830 (not x2018)) (x520 x1213) (ite (and x350 x3245) (x520 x1213) (ite (and x4544 x1771) (x1325 x1213) (ite (and x4476 x3079) (x520 x1213) (x2657 x1213)))))))))
(define-fun x3492 ((x1213 x2327)) Int (ite x3740 (x1951 x1213) (x1325 x1213)))
(define-fun x2752 ((x1213 x2327)) Int (ite (and x4019 (not x4397)) (ite x3306 (x4505 x1213) (ite x4451 (x4505 x1213) (x1324 x1213))) (ite (and x2992 x1121 (not x3093)) (x1102 x1213) (x4505 x1213))))
(define-fun x2952 ((x1213 x2327)) Int (ite (= x1213 x1796) x4410 (x2752 x1213)))
(define-fun x2976 ((x1213 x2327)) Int (ite (and x4019 (not x4397)) (ite x3306 (x520 x1213) (ite x4451 (x3492 x1213) (x520 x1213))) (ite (and x1121 (not x3093) x2992) (x1148 x1213) (x520 x1213))))
(define-fun x161 ((x1213 x2327)) Int (ite (= x2584 x1213) x155 (x2976 x1213)))
(define-fun x3331 ((x1213 Int)) Int (ite (and x4454 x1969) (x4524 x1213) (ite (and x1825 x2984) (x1297 x1213) (x4938 x1213))))
(define-fun x4648 ((x1213 Int)) Int (ite (and (<= 356 x1213) (> (+ 356 x3517) x1213)) (x3331 (+ (- x1213 356) 0)) (x280 x1213)))
(define-fun x870 ((x1213 Int)) Int (ite (and x4600 x1330) (x280 x1213) (x4648 x1213)))
(define-fun x908 ((x1213 Int)) Int (ite (and x1100 x2736) (x3129 x1213) (x3977 x1213)))
(define-fun x1320 ((x1213 Int)) Int (ite (= x2190 x1213) x1578 (x664 x1213)))
(define-fun x1237 ((x1213 Int)) Int (ite (and (>= x1213 x1440) (> (+ x1578 x1440) x1213)) (x908 (+ (- x1213 x1440) 0)) (x665 x1213)))
(define-fun x3927 ((x1213 Int)) Int (ite (and x433 x236) (x665 x1213) (x1237 x1213)))
(define-fun x2946 ((x1213 Int)) Int (ite (and x433 x236) (x664 x1213) (x1320 x1213)))
(define-fun x4863 ((x1213 Int)) Int (ite (and x4516 x1308) (x1537 x1213) (x198 x1213)))
(define-fun x2113 ((x1213 Int)) Int (ite (and (>= x1213 x1780) (< x1213 (+ x1780 x3246))) (x4863 (+ 0 (- x1213 x1780))) (x1560 x1213)))
(define-fun x2226 ((x1213 Int)) Int (ite (and x2469 x3426) (x1560 x1213) (x2113 x1213)))
(define-fun x167 ((x1213 Int)) Int (ite (and x3236 x3982) (x2978 x1213) (ite (and x2552 x576) (x2152 x1213) (x2717 x1213))))
(define-fun x3189 ((x1213 Int)) Int (ite (and (> (+ 356 x4878) x1213) (>= x1213 356)) (x167 (+ (- x1213 356) 0)) (x489 x1213)))
(define-fun x4228 ((x1213 Int)) Int (ite (and x1906 x279) (x489 x1213) (x3189 x1213)))
(define-fun x4461 ((x1213 Int)) Int (ite (and x4337 x526) (x884 x1213) (x481 x1213)))
(define-fun x1253 ((x1213 Int)) Int (ite (= x1213 x2806) x2703 (x4096 x1213)))
(define-fun x2761 ((x1213 Int)) Int (ite (and (>= x1213 x1172) (> (+ x1172 x2703) x1213)) (x4461 (+ (- x1213 x1172) 0)) (x349 x1213)))
(define-fun x3042 ((x1213 Int)) Int (ite (and x2139 x436) (x349 x1213) (x2761 x1213)))
(define-fun x482 ((x1213 Int)) Int (ite (and x436 x2139) (x4096 x1213) (x1253 x1213)))
(define-fun x1657 ((x1213 Int)) Int (ite (and x238 x641) (x3411 x1213) (x4525 x1213)))
(define-fun x4398 ((x1213 Int)) Int (ite (and (> (+ x523 x1344) x1213) (<= x523 x1213)) (x1657 (+ (- x1213 x523) 0)) (x1016 x1213)))
(define-fun x2078 ((x1213 Int)) Int (ite (and x4806 x1134) (x1016 x1213) (x4398 x1213)))
(define-fun x2417 ((x1067 Int)) Bool (=> (and (not (= x1067 50942633119752846454219349998365661925608737367104304655302372697894809501696)) (not (= x1067 98474297345890754025501882143967591664980152141971839855651084132735363579904)) (not (= x1067 1461501637330902918203684832716283019655932542976)) (not (= x1067 157198259)) (not (= 1166402363 x1067)) (< 10000 x1067) (not (= 274184521717934524641157099916833587206 x1067)) (not (= x1067 826074471)) (not (= 274184521717934524641157099916833587202 x1067)) (not (= 79228162514264337593543950336 x1067)) (not (= 115792089237316195423570985007226406215939081747436879206741300988257197096960 x1067)) (not (= x1067 76450787359836037641860180984291677749980919077056822294353438043884394381312)) (not (= x1067 16156842317565293874272834530371880720966471053262404558597773956279093428224)) (not (= 1858285468 x1067)) (not (= 1889567281 x1067)) (not (= 26959946667150639794667015087019630673637144422540572481103610249215 x1067)) (not (= 1845821197 x1067)) (not (= x1067 109576784812748834340197573905731726730118698833493337707389013487240318287872)) (not (= 404098525 x1067)) (not (= 2514000705 x1067)) (not (= 2311529814 x1067)) (not (= x1067 34167655436598589418538772692774877509225721125679165766806516059628562808832)) (not (= 117300739 x1067)) (not (= 115792089237316195423570985008687907853269984665640564039457584007913129639904 x1067)) (not (= x1067 1461501637330902918203684832716283019655932542975)) (not (= 115792089237316195423570985008687907853269984665640564039457584007913129639934 x1067)) (not (= 26959946667150639794667015087019630673637144422540572481103610249216 x1067)) (not (= 4294967296 x1067)) (not (= x1067 115792089237316195423570985008687907853269984665640564039457584007913129639935)) (not (= 904250603428552709895185118199468575982109441609966099573332780532423983104 x1067)) (not (= 31536000 x1067)) (not (= x1067 511946350)) (not (= 599290589 x1067)) (not (= 274184521717934524641157099916833587240 x1067)) (not (= 65535 x1067)) (not (= x1067 18446744073709551615)) (not (= x1067 455944412)) (not (= 2835717307 x1067)) (not (= x1067 4294967295)) (not (= x1067 115792089237316195423570984636004990333889740523700931696805413995650331181055)) (not (= 924834022 x1067)) (not (= 1722255204 x1067))) (not ((_ is x4822) (x1894 x1067)))))
...
(assert (x1513 x1548))
(assert (x1513 x2041))
(assert (= (=> (and (= x2154 x2299) (= x346 x4297) (= x2614 (- (x590 (x1894 x3907)) x2132)) (= 0 x2132) (= (x1229 (+ x2132 (mod (x4967 (x1894 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936))) x862) (= x3097 (< (+ x2132 (x4967 (x1894 274184521717934524641157099916833587240))) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) x3097) x3544) x262))
(assert (x1513 x2202))
(assert (x1513 x3468))
(assert (x2417 x2213))
...
(assert (x1513 x3317))
(assert (=> (<= x867 10000) (= (x4822 x867) (x1894 x867))))
(assert (x1513 x3616))
(assert (x1513 x3590))
(assert (x1513 x2810))
...
(assert (=> (>= 10000 x1260) (= (x1894 x1260) (x4822 x1260))))
(assert (x1513 x642))
(assert (x1513 x3526))
...
(assert (x3166 x4559))
(assert (x1513 x502))
(assert (=> (<= x235 10000) (= (x4822 x235) (x1894 x235))))
(assert (x1513 x377))
(assert (x1513 x2331))
(assert (x1513 x596))
...
(assert (x1513 x2636))
(assert (x1513 x2490))
(assert (=> (<= x3201 10000) (= (x1894 x3201) (x4822 x3201))))
(assert (x1513 x3797))
(assert (x1513 x4838))
(assert (x1513 x1941))
...
(assert (x1513 x1265))
(assert (x1513 x4911))
(assert (=> (>= 10000 x4609) (= (x4822 x4609) (x1894 x4609))))
...
(assert (x3166 x1887))
(assert (x1513 x1467))
(assert (=> (<= x1662 10000) (= (x1894 x1662) (x4822 x1662))))
...
(assert (x1513 x3440))
(assert (= x3743 (=> (and (= x3377 (x1319 4294967295 x4445)) (= x4735 (x3604 x4478)) (= (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x404) x3320) (= x4445 (div x4735 26959946667150639794667015087019630673637144422540572481103610249216)) (= x4040 (= x4298 0)) (= x4298 (x1319 x1781 x4963)) (= x4963 (ite (< x3320 x3377) 1 0)) (= x3194 (x4575 (- x2689 x3181))) (= (ite (not x3477) 1 0) x1781) (= x3477 (= x404 0))) (and (=> (not x4040) x2460) (=> x4040 x1584)))))
(assert (x1513 x2176))
...
(assert (=> (<= x524 10000) (= (x4822 x524) (x1894 x524))))
...
(assert (x1513 x1978))
(assert (x1513 x2779))
(assert (=> (<= x2979 10000) (= (x1894 x2979) (x4822 x2979))))
...
(assert (x1513 x2201))
(assert (x1513 x552))
(assert (=> (>= 10000 x2922) (= (x1894 x2922) (x4822 x2922))))
...
(assert (=> (>= 10000 x2484) (= (x1894 x2484) (x4822 x2484))))
(assert (= x4458 (and x3850 x2325)))
(assert (=> (>= 10000 x2332) (= (x1894 x2332) (x4822 x2332))))
(assert (x1513 x1529))
(assert (x1513 x3008))
(assert (x1513 x1387))
(assert (x2417 x2202))
...
(assert (x1513 x4779))
(assert (x1513 x1721))
(assert (= x4194 (=> (and (= x4705 (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (+ (x1991 (x1894 274184521717934524641157099916833587240)) x1784))) (= x189 (x1229 (+ (mod (x1991 (x1894 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1784))) (= x2605 (- (x3727 (x1894 x3392)) x1784)) (= x2368 x4407) x4705 (= 0 x1784) (= x2031 x3602)) x1867)))
...
(assert (x1513 x4523))
(assert (x1513 x2951))
(assert (= x1584 (=> (and (= x902 (= 0 x4428)) (= (ite (not x902) 1 0) x3633) (= (x1319 x3633 x2041) x1457) (= (mod (* x3377 x404) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x4428) (= x2041 (ite (> x3194 x1118) 1 0)) (= x1118 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x4428)) (= (= x1457 0) x1422)) (and (=> (not x1422) x2460) (=> x1422 x254)))))
(assert (x1513 x3291))
(assert (= x4947 (x2856 (x1894 x4947))))
(assert (= x850 (x2856 (x1894 x850))))
(assert (=> (>= 10000 x1635) (= (x1894 x1635) (x4822 x1635))))
...
(assert (x1513 x3289))
(assert (=> (>= 10000 x335) (= (x1894 x335) (x4822 x335))))
...
(assert (x1513 x83))
(assert (x1513 x34))
(assert (=> (<= x4959 10000) (= (x4822 x4959) (x1894 x4959))))
(assert (x1513 x3491))
(assert (x1513 x2495))
...
(assert (x1513 x2818))
(assert (=> (>= 10000 x4289) (= (x4822 x4289) (x1894 x4289))))
...
(assert (x1513 x1481))
(assert (x3166 x2753))
(assert (=> (>= 10000 x3339) (= (x4822 x3339) (x1894 x3339))))
...
(assert (= (=> (and (= x4470 (x3604 x551)) (= x984 (x4575 (- 115792089237316195423570985008687907853269984665640564039457584007913129639935 x4470))) (= (div x4001 10000) x968) (= (> x2318 x984) x4204) (= x4001 (mod (* x2318 x1884) 115792089237316195423570985008687907853269984665640564039457584007913129639936))) (and (=> x4204 x2460) (=> (not x4204) x306))) x2722))
(assert (x1513 x4963))
(assert (= (x2523 x127) (ite (= x1136 x127) x4240 (x2293 x127))))
(assert (x1513 x88))
(assert (=> (>= 10000 x2482) (= (x4822 x2482) (x1894 x2482))))
...
(assert (x1513 x964))
(assert (=> (<= x465 10000) (= (x4822 x465) (x1894 x465))))
(assert (x1513 x2581))
...
(assert (=> (>= 10000 x2008) (= (x1894 x2008) (x4822 x2008))))
...
(assert (x1513 x402))
(assert (x1513 x4981))
(assert (=> (<= x4676 10000) (= (x1894 x4676) (x4822 x4676))))
...
(assert (x1513 x2755))
(assert (x1513 x3911))
(assert (=> (<= x3964 10000) (= (x1894 x3964) (x4822 x3964))))
...
(assert (=> (<= x3067 10000) (= (x1894 x3067) (x4822 x3067))))
(assert (=> (>= 10000 x6) (= (x4822 x6) (x1894 x6))))
(assert (x1513 x978))
(assert (x1513 x3605))
(assert (x3166 x3122))
(assert (x1513 x845))
...
(assert (=> (>= 10000 x4236) (= (x4822 x4236) (x1894 x4236))))
(assert (x1513 x701))
...
(assert (x1513 x139))
(assert (x1513 x2466))
(assert (=> (>= 10000 x2244) (= (x4822 x2244) (x1894 x2244))))
(assert (x1513 x3962))
...
(assert (x3166 x2308))
(assert (=> (>= 10000 x519) (= (x4822 x519) (x1894 x519))))
(assert (= (ite (= x1348 x2241) x844 (x1852 x1348)) (x3604 x1348)))
(assert (= x3507 (and (not x1858) x4203)))
(assert (x1513 x2010))
(assert (x3166 x915))
(assert (=> (<= x2419 10000) (= (x4822 x2419) (x1894 x2419))))
(assert (x1513 x3235))
(assert (x2417 x335))
(assert (x1513 x1445))
(assert (x1513 x3121))
(assert (x1513 x967))
(assert (=> (>= 10000 x3200) (= (x1894 x3200) (x4822 x3200))))
...
(assert (=> (<= x2213 10000) (= (x1894 x2213) (x4822 x2213))))
(assert (x1513 x4443))
(assert (x1513 x1244))
...
(assert (x1513 x1055))
(assert (=> (<= x3392 10000) (= (x1894 x3392) (x4822 x3392))))
(assert (x1513 x4379))
(assert (x1513 x780))
(assert (x1513 x3706))
(assert (x1513 x1158))
...
(assert (=> (<= x3907 10000) (= (x1894 x3907) (x4822 x3907))))
(assert (x1513 x3683))
...
(assert (=> (>= 10000 x896) (= (x1894 x896) (x4822 x896))))
...
(assert (x1513 x3546))
(assert (=> (<= x3675 10000) (= (x4822 x3675) (x1894 x3675))))
(assert (x1513 x3979))
(assert (x1513 x77))
...
(assert (=> (<= x1748 10000) (= (x1894 x1748) (x4822 x1748))))
...
(assert (x1513 x1310))
(assert (x1513 x1337))
(assert (=> (>= 10000 x2755) (= (x4822 x2755) (x1894 x2755))))
...
(assert (x1513 x3217))
(assert (x1513 x1779))
(assert (=> (>= 10000 x3800) (= (x1894 x3800) (x4822 x3800))))
...
(assert (=> (>= 10000 x2620) (= (x4822 x2620) (x1894 x2620))))
(assert (x1513 x2518))
...
(assert (= x11 x2377))
(assert (= x2915 (=> (and (= x3671 (> x1181 x2689)) (= x1181 (x1319 18446744073709551615 x4585)) (= (x1852 x2241) x4427) (= x4478 (x2808 x4255 5)) (= x844 (x1229 (+ x4409 (mod (ite x510 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))) (= x4585 (div x3787 1461501637330902918203684832716283019655932542976)) (= (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x4427) x4409) (= x3787 (x3604 x4478)) (= false x510)) (and (=> (not x3671) x2460) (=> x3671 x795)))))
...
(assert (x1513 x3184))
(assert (x1513 x896))
(assert (=> (<= x2287 10000) (= (x1894 x2287) (x4822 x2287))))
(assert (x1513 x297))
(assert (x1513 x4297))
...
(assert (=> (<= x3022 10000) (= (x1894 x3022) (x4822 x3022))))
...
(assert (x1513 x285))
(assert (x1513 x4570))
(assert (=> (<= x1236 10000) (= (x4822 x1236) (x1894 x1236))))
...
(assert (x3166 x3413))
(assert (=> (>= 10000 x1545) (= (x1894 x1545) (x4822 x1545))))
...
(assert (x1513 x1855))
(assert (=> (>= 10000 x4789) (= (x4822 x4789) (x1894 x4789))))
...
(assert (=> (<= x1914 10000) (= (x1894 x1914) (x4822 x1914))))
(assert (x1513 x2491))
(assert (x3166 1461501637330902918203684832716283019655932542975))
(assert (=> (>= 10000 x1365) (= (x1894 x1365) (x4822 x1365))))
(assert (x1513 x1680))
(assert (=> (>= 10000 x2034) (= (x4822 x2034) (x1894 x2034))))
(assert (x1513 x4434))
...
(assert (x3166 x338))
(assert (= x3296 (=> (and x2149 (= (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (+ (x4157 (x1894 274184521717934524641157099916833587240)) x13)) x2149) (= (x2946 x402) x756) (or (and (> x4074 0) (= (x3927 x939) x4074) (= x3926 (ite x1811 1 0)) (= x2155 (= 0 x4074)) (= x1601 (x2946 x402)) x4992 (= x3926 x4074) (= (not x2155) x1811) (= (x1229 (+ 32 x402)) x939) (not (or (< 57896044618658097711785492504343953926634992332820282019728792003956564819967 x1601) (and (< x1601 32) (= (<= x1601 57896044618658097711785492504343953926634992332820282019728792003956564819967) true))))) (not x4992)) (= x236 (= x1578 0)) (= 0 x13) (or (and (= x2190 x402) (not x236) (= (x1229 (+ 96 x4002)) x1440)) (and x236 (= 96 x402))) (= x3673 (- (x1555 (x1894 x1030)) x13)) (not (= 0 x1636)) (= (x1229 (+ (mod (x4157 (x1894 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x13)) x173) (= x4992 (> x756 0))) x3089)))
...
(assert (x1513 x3920))
(assert (=> (>= 10000 x4133) (= (x1894 x4133) (x4822 x4133))))
...
(assert (=> (<= x995 10000) (= (x4822 x995) (x1894 x995))))
...
(assert (=> (<= x3303 10000) (= (x1894 x3303) (x4822 x3303))))
...
(assert (=> (<= x1006 10000) (= (x4822 x1006) (x1894 x1006))))
...
(assert (x1513 x2487))
(assert (x1513 x294))
(assert (=> (<= x3475 10000) (= (x1894 x3475) (x4822 x3475))))
(assert (x1513 x3436))
(assert (x1513 x1735))
(assert (x1513 x358))
(assert (x1513 x3573))
...
(assert (x1513 x1460))
(assert (x1513 x460))
(assert (= x3404 (=> (and (= x2740 0) (= x3963 x34) (= (- (x409 (x1894 x847)) x2740) x4089) (= (< (+ x2740 (x1372 (x1894 274184521717934524641157099916833587240))) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1762) x1762 (= x4793 x1011) (= (x1229 (+ x2740 (mod (x1372 (x1894 274184521717934524641157099916833587240)) 115792089237316195423570985008687907853269984665640564039457584007913129639936))) x1910)) x4714)))
(assert (x1513 x4925))
...
(assert (=> (<= x505 10000) (= (x1894 x505) (x4822 x505))))
...
(assert (x1513 x2300))
(assert (=> (<= x847 10000) (= (x1894 x847) (x4822 x847))))
...
(assert (x1513 x3490))
(assert (=> (>= 10000 x4947) (= (x4822 x4947) (x1894 x4947))))
(assert (x1513 x3853))
(assert (x1513 x2954))
(assert (x1513 x3591))
(assert (x1513 x3975))
...
(assert (x1513 x3976))
(assert (x1513 x1954))
(assert (=> (<= x3718 10000) (= (x4822 x3718) (x1894 x3718))))
(assert (x1513 x3433))
(assert (x1513 x1876))
(assert (x1513 x3190))
...
(assert (x1513 x2161))
(assert (=> (<= x4195 10000) (= (x4822 x4195) (x1894 x4195))))
(assert (x1513 x2789))
(assert (x1513 x4403))
...
(assert (x1513 x3196))
(assert (x1513 x2308))
(assert (=> (<= x3473 10000) (= (x1894 x3473) (x4822 x3473))))
(assert (x2417 x3201))
(assert (x1513 x3701))
(assert (x3166 x2261))
...
(assert (x1513 x1226))
(assert (=> (>= 10000 x1092) (= (x1894 x1092) (x4822 x1092))))
(assert (x1513 x3530))
...
(assert (x1513 x1380))
(assert (x1513 x3631))
(assert (=> (<= x368 10000) (= (x4822 x368) (x1894 x368))))
(assert (x1513 x3383))
...
(assert (x1513 x4452))
(assert (=> (>= 10000 x2600) (= (x4822 x2600) (x1894 x2600))))
(assert (x1513 x3069))
...
(assert (=> (>= 10000 x3972) (= (x4822 x3972) (x1894 x3972))))
...
(assert (= x817 (=> (and (= (x201 x491) x2372) (= x2303 x2381) (= x395 (* x914 x3240)) (< (* x3240 x914) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (not (= 599290589 x4720)) (= x2233 (div x3706 10000)) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (* x2233 x400)) (= (x1377 (x4822 106)) x1817) (= x613 (x1319 18446744073709551615 x1805)) (= x100 (x1377 x2218)) (= x785 x1698) (= x3526 (x201 x4489)) (= (x2328 (x1894 x3303)) x3889) (= (x4575 (- x2689 x4939)) x3383) (= 924834022 x4720) (= x4322 (x1229 (+ x4693 (mod (ite x749 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936)))) (= x2233 x3796) (= (x1319 255 x1817) x596) (not (< x3366 4)) (< 0 x2369) (= (x1319 1461501637330902918203684832716283019655932542975 x2394) x2381) (= x4615 (div x4334 10000)) (not (= 455944412 x4720)) (= x3984 (x1319 255 x1399)) (< (* x3383 x1686) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (> x3984 0) (not (< x2233 x4615)) (= x4093 (x4575 (- x3366 4))) (= (x2808 x116 4) x1346) (= (x2808 x116 3) x4068) (= x4431 (x201 (x4822 1))) (= (x4575 (- 115792089237316195423570985008687907853269984665640564039457584007913129639935 x1698)) x218) (= (< 0 x3889) x3447) (< (+ x1698 x2233) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (= x2303 (x1319 1461501637330902918203684832716283019655932542975 x2008)) (= x491 (x2808 x116 5)) (= (x2808 x116 2) x4489) (= x2411 (div x2356 26959946667150639794667015087019630673637144422540572481103610249216)) (= x2419 (x1319 1461501637330902918203684832716283019655932542975 x712)) (= (div x4431 79228162514264337593543950336) x545) (= x1750 x3526) (not (< x924 x4939)) (= (div x315 1461501637330902918203684832716283019655932542976) x1399) (= x3303 (x1319 1461501637330902918203684832716283019655932542975 x2008)) (= x4334 (* x2233 x400)) (= x2369 (x2328 (x1894 274184521717934524641157099916833587240))) (= x315 (x1377 x2218)) (= x4957 (div x2083 1461501637330902918203684832716283019655932542976)) (= (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x100) x4693) (= x712 (x201 x1346)) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (+ x3526 x2982)) (= (x201 x1346) x2083) (= (x1319 4294967295 x2411) x3240) (= x2982 x4874) (= (x201 x4068) x1698) (= (x1319 65535 x545) x400) (not (or (> x4093 57896044618658097711785492504343953926634992332820282019728792003956564819967) (and (> 32 x4093) (= true (>= 57896044618658097711785492504343953926634992332820282019728792003956564819967 x4093))))) (= (* x3383 x1686) x3021) (not (< x4720 455944412)) (= x4939 (x1319 18446744073709551615 x4957)) (= (x2808 x116 6) x2218) (= x395 x1686) (= (+ x1750 x4874) x2402) (= (x201 x2218) x2394) (< x924 x613) (= (div x3021 31536000) x3706) (= (div x2372 1461501637330902918203684832716283019655932542976) x1805) (= x914 (x201 x4068)) (= (+ x3796 x785) x4403) (= x749 false) (< x4720 1166402363) (= x2982 (x4575 (- x2233 x4615))) (= 0 x596) (not (= x4720 511946350)) (< x4720 2311529814) (= (x4101 (x1894 x2484) (x4822 2) 0) x116) (= x2484 x3402) (= (x201 x491) x2356)) (and (=> (not x3447) x1294) (=> x3447 x2767)))))
(assert (x1513 x3025))
(assert (x1513 x2023))
(assert (x1513 x715))
(assert (x1513 x1079))
...
(assert (=> (>= 10000 x1165) (= (x4822 x1165) (x1894 x1165))))
(assert (= 0 (x4453 160)))
...
(assert (x1513 x3481))
(assert (=> (<= x2962 10000) (= (x1894 x2962) (x4822 x2962))))
(assert (x1513 x3823))
(assert (x1513 x3000))
(assert (x1513 x3720))
(assert (x1513 x4224))
...
(assert (x1513 x1544))
(assert (= (=> (and (= (x2808 x3417 6) x4679) (= x4009 (x1939 x4679)) (= x4851 (x1319 4294967295 x2430)) (not (= 511946350 x1842)) (= x442 (< 0 x1099)) (= (x1319 1461501637330902918203684832716283019655932542975 x4009) x779) (= (x1319 65535 x4047) x4078) (= x4777 (* x2256 x2401)) (= x3405 (x1319 18446744073709551615 x3111)) (= x779 x2751) (< (+ x1226 x1654) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (< (* x3265 x4078) 115792089237316195423570985008687907853269984665640564039457584007913129639936) (= x4802 (x1939 x2363)) (= (div x515 79228162514264337593543950336) x4047) (= (x1939 x4620) x4915) (= x3956 (div x3069 1461501637330902918203684832716283019655932542976)) (not (< x3265 x3349)) (= x2430 (div x4904 26959946667150639794667015087019630673637144422540572481103610249216)) (= (* x4078 x3265) x326) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (* x2401 x2256)) (= x260 x2979) (= (x1229 (+ x886 (mod (ite x1302 1461501637330902918203684832716283019655932542976 0) 115792089237316195423570985008687907853269984665640564039457584007913129639936))) x1441) (= x3111 (div x4372 1461501637330902918203684832716283019655932542976)) (not (= x1842 599290589)) (= x3349 (div x326 10000)) (not (> 4 x2262)) (= x775 x3702) (not (or (and (< x118 32) (= true (>= 57896044618658097711785492504343953926634992332820282019728792003956564819967 x118))) (> x118 57896044618658097711785492504343953926634992332820282019728792003956564819967))) (= (x2808 x3417 5) x1041) (= x4620 (x2808 x3417 4)) (= x4904 (x1939 x1041)) (= x1226 (x4575 (- x3265 x3349))) (= x3499 0) (not (= x1842 455944412)) (= (div x4567 1461501637330902918203684832716283019655932542976) x1204) (= x250 (+ x904 x3702)) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (* x4851 x4802)) (< x1842 1166402363) (= (x2808 x3417 3) x2363) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 (+ x3265 x775)) (< 0 x3466) (= x1654 x2039) (> x4039 0) (= (x1319 1461501637330902918203684832716283019655932542975 x2747) x2244) (= (+ x4032 x2039) x429) (= x3069 (x1939 x4620)) (= x886 (x1319 115792089237316195423570984636004990333889740523700931696805413995650331181055 x2038)) (= x3466 (x2328 (x1894 274184521717934524641157099916833587240))) (= x4567 (x1377 x4679)) (= x1654 (x1939 x4771)) (= false x1302) (= (x1377 x4679) x2038) (= x4877 (* x4851 x4802)) (= x2256 x4877) (= (x1319 255 x1204) x4039) (= (x1319 1461501637330902918203684832716283019655932542975 x4915) x1081) (= x515 (x1939 (x4822 1))) (> x3405 x1904) (= x1099 (x2328 (x1894 x2244))) (= x3504 (div x4777 31536000)) (= x775 (x1939 x2363)) (= (x4575 (- 115792089237316195423570985008687907853269984665640564039457584007913129639935 x775)) x4448) (= x1226 x4032) (= (x4575 (- x1927 x3558)) x2401) (= (x1319 1461501637330902918203684832716283019655932542975 x2747) x2751) (not (> x3558 x1904)) (= x1842 924834022) (= x4372 (x1939 x1041)) (= x3558 (x1319 18446744073709551615 x3956)) (= (x1377 (x4822 106)) x3720) (= x4771 (x2808 x3417 2)) (= (div x3504 10000) x3265) (= (x1319 255 x3720) x3499) (= (x4101 (x1894 x2979) (x4822 2) 0) x3417) (= x904 x3265) (= x118 (x4575 (- x2262 4))) (not (< x1842 455944412)) (< x1842 2311529814)) (and (=> x442 x2025) (=> (not x442) x4987))) x4908))
(assert (x1513 x736))
(assert (x1513 x657))
(assert (x1513 x2446))
...
(assert (=> (<= x621 10000) (= (x4822 x621) (x1894 x621))))
(assert (x1513 x189))
(assert (x1513 x839))
...
(assert (= x254 (=> (and (= x1764 (= 0 x2318)) (= (= 0 x2963) x1045) (= x1091 (ite (> x1884 x3367) 1 0)) (= x2525 (div x1461 31536000)) (= (div x4100 79228162514264337593543950336) x2450) (= x2963 (x1319 x2418 x1091)) (= x3367 (div 115792089237316195423570985008687907853269984665640564039457584007913129639935 x2318)) (= (div x2525 10000) x2318) (= x1461 (mod (* x3194 x4428) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (x1319 65535 x2450) x1884) (= x2418 (ite (not x1764) 1 0)) (= x4100 (x3604 (x4822 1)))) (and (=> x1045 x2722) (=> (not x1045) x2460)))))
(assert (x1513 x1362))
(assert (x1513 x774))
(assert (x1513 x1341))
(assert (x3166 x1123))
...
(assert (x1513 x3963))
(assert (=> (<= x1081 10000) (= (x1894 x1081) (x4822 x1081))))
(assert (x1513 x3473))
(assert (x1513 x854))
(assert (= 0 (x751 x1696)))
(assert (x1513 x2578))
...
(assert (= (=> (and (= (x2808 x4255 3) x551) (= x4796 (x3604 x2392)) (= x4404 (> x3181 x2689)) (= x1042 (div x4796 1461501637330902918203684832716283019655932542976)) (= x2392 (x2808 x4255 4)) (= x3181 (x1319 18446744073709551615 x1042)) (= (x3604 x551) x404)) (and (=> (not x4404) x3743) (=> x4404 x2460))) x1198))
...
(assert (=> (<= x1030 10000) (= (x4822 x1030) (x1894 x1030))))
...
(assert (x1513 x4764))
(assert (x1513 x2806))
(assert (=> (>= 10000 x1735) (= (x1894 x1735) (x4822 x1735))))
(assert (x1513 x1927))
...
(assert (x1513 x3280))
(assert (x1513 x3663))
(assert (=> (>= 10000 x2202) (= (x1894 x2202) (x4822 x2202))))
...
(assert (x1513 x4393))
(assert (=> (<= x410 10000) (= (x1894 x410) (x4822 x410))))
(assert (x1513 x1181))
...
(assert (x1513 x4624))
(assert (= (=> (and (= (x4101 (x1894 x3022) (x4822 2) 0) x4255) (= (x1319 255 x4988) x4) (= (x2808 x4255 6) x2241) (= x4988 (div x4143 1461501637330902918203684832716283019655932542976)) (= x1291 (< 0 x4)) (= x4143 (x1852 x2241))) (and (=> x1291 x2915) (=> (not x1291) x2460))) x4602))
(assert (x1513 x818))
(assert (x1513 x4918))
(assert (x1513 x1385))
(assert (x1513 x3888))
...
(assert (x1513 x798))
(assert (=> (>= 10000 x2747) (= (x4822 x2747) (x1894 x2747))))
(assert (x1513 x2579))
(assert (x3166 x1385))
(assert (x1513 x1399))
...
(assert (=> (>= 10000 x850) (= (x4822 x850) (x1894 x850))))
