...
(declare-datatypes ((x986 0)) (((x264 (x228 x986) (x1458 Int)) (x1478 (x515 Int)) (x570 (x214 x986) (x362 x986) (x1482 Int)))))
...
(declare-fun x672 (x986) Int)
(declare-fun x1143 (Int) Int)
(declare-fun x276 () Int)
(declare-fun x509 (x986) Int)
...
(declare-fun x27 () Int)
(define-fun x378 ((x986 x986) (x1450 Int)) x986 (ite ((_ is x264) x986) (x264 (x228 x986) (+ (x1458 x986) x1450)) (ite ((_ is x570) x986) (x570 (x214 x986) (x362 x986) (+ x1450 (x1482 x986))) (x1478 (+ x1450 (x515 x986))))))
(define-fun x856 ((x35 Int)) Int (ite (and (>= x35 0) (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 x35)) x35 (- x35 115792089237316195423570985008687907853269984665640564039457584007913129639936)))
(define-fun x1147 ((x35 Int)) Int (ite (and (>= x35 (- 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (< x35 0)) (+ x35 115792089237316195423570985008687907853269984665640564039457584007913129639936) x35))
(define-fun x533 ((x420 Int)) Bool (and (> 115792089237316195423570985008687907853269984665640564039457584007913129639936 x420) (>= x420 0)))
(define-fun x795 ((x1058 Int)) Int (x122 x1058))
(define-fun x1215 ((x1058 Int)) Int (ite (and (<= 28 x1058) (> (+ 4 28) x1058)) (x122 (+ (- x1058 28) 0)) (x1197 x1058)))
(define-fun x1096 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x1215 x1058)))
(define-fun x1185 ((x1058 Int)) Int (ite (= 800 x1058) 1854955031 (x1217 x1058)))
(define-fun x273 ((x1058 Int)) Int (ite (and (< x1058 (+ 800 32)) (>= x1058 800)) (x184 (+ (- x1058 800) 0)) (x172 x1058)))
(define-fun x1324 ((x1058 Int)) Int (ite (= 800 x1058) x1431 (x11 x1058)))
(define-fun x904 ((x1058 Int)) Int (ite (= 832 x1058) 60465744 (x1324 x1058)))
(define-fun x650 ((x1058 Int)) Int (ite (and (<= 0 x1058) (< x1058 (+ 0 0))) (x447 (+ (- x1058 0) 0)) (x22 x1058)))
(define-fun x626 ((x1058 Int)) Int (ite (= x1058 864) x1431 (x11 x1058)))
(define-fun x190 ((x1058 Int)) Int (ite (= 160 x1058) x597 (x199 x1058)))
(define-fun x429 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x190 x1058)))
(define-fun x1166 ((x1058 Int)) Int (ite (= 928 x1058) x1446 (x429 x1058)))
(define-fun x637 ((x1058 Int)) Int (ite (= x1058 160) x354 (x199 x1058)))
(define-fun x1151 ((x1058 Int)) Int (ite (= x1058 128) 16 (x637 x1058)))
(define-fun x389 ((x1058 Int)) Int (ite (= 224 x1058) 1889567281 (x1151 x1058)))
(define-fun x852 ((x1058 Int)) Int (ite (and (>= x1058 224) (< x1058 (+ 224 32))) (x430 (+ (- x1058 224) 0)) (x308 x1058)))
(define-fun x1160 ((x1058 Int)) Int (ite (and x608 x69 x1043) (x852 x1058) (x308 x1058)))
(define-fun x716 ((x1058 Int)) Int (ite (= 352 x1058) x1074 (x1160 x1058)))
(define-fun x748 ((x1058 Int)) Int (ite (= x1058 320) x252 (x716 x1058)))
(define-fun x1272 ((x1058 Int)) Int (ite (= x1058 160) x1389 (x748 x1058)))
(define-fun x669 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1272 x1058)))
(define-fun x359 ((x1058 Int)) Int (ite (= x1058 928) x1328 (x194 x1058)))
(define-fun x1142 ((x1058 Int)) Int (ite (= x1058 928) 0 (x194 x1058)))
(define-fun x845 ((x1058 Int)) Int (ite (= x1058 928) x86 (x194 x1058)))
(define-fun x351 ((x1058 Int)) Int (ite (and x1061 x902) (x359 x1058) (ite (and x723 (not x1300)) (x1142 x1058) (ite (and (not x297) x1280) (x845 x1058) (x1166 x1058)))))
(define-fun x428 ((x1058 Int)) Int (ite (= x1058 896) x145 (x351 x1058)))
(define-fun x78 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x428 x1058)))
(define-fun x996 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x78 x1058)))
(define-fun x417 ((x1058 Int)) Int (ite (= x1058 928) x402 (x996 x1058)))
(define-fun x1194 ((x1058 Int)) Int (ite (= 960 x1058) 113225476 (x417 x1058)))
(define-fun x1316 ((x1058 Int)) Int (ite (= x1058 992) x1192 (x1194 x1058)))
(define-fun x1322 ((x1058 Int)) Int (ite (and (>= x1058 1024) (> (+ 1024 96) x1058)) (x122 (+ 4 (- x1058 1024))) (x1316 x1058)))
(define-fun x1318 ((x1058 Int)) Int (ite (= 1120 x1058) x140 (x1322 x1058)))
(define-fun x93 ((x1058 Int)) Int (ite (and (< x1058 (+ 32 960)) (<= 960 x1058)) (x224 (+ 0 (- x1058 960))) (x1154 x1058)))
(define-fun x1480 ((x1058 Int)) Int (ite (and x715 x1467) (x93 x1058) (x1154 x1058)))
(define-fun x1156 ((x1058 x986)) Int (ite (and (not x220) x906) (x1063 x1058) (ite (and x1233 x877) (ite (and x588 x1483 (not x894)) (x764 x1058) (x1063 x1058)) (x1063 x1058))))
(define-fun x707 ((x1058 Int)) Int (ite (and (not x220) x906) (x1480 x1058) (ite (and x877 x1233) (ite (and x1483 (not x894) x588) (x650 x1058) (x22 x1058)) (x1217 x1058))))
(define-fun x1179 ((x1058 Int)) Int (ite (= 800 x1058) 1889567281 (x707 x1058)))
(define-fun x552 ((x1058 Int)) Int (ite (and (< x1058 (+ 32 800)) (<= 800 x1058)) (x531 (+ (- x1058 800) 0)) (x957 x1058)))
(define-fun x305 ((x1058 Int)) Int (ite (= 224 x1058) x1431 (x712 x1058)))
(define-fun x1028 ((x1058 Int)) Int (ite (= x1058 256) x806 (x305 x1058)))
(define-fun x287 ((x1058 Int)) Int (ite (= x1058 160) x1108 (x1028 x1058)))
(define-fun x304 ((x1058 Int)) Int (ite (= x1058 128) 16 (x287 x1058)))
(define-fun x471 ((x1058 Int)) Int (ite (= 160 x1058) x1332 (x88 x1058)))
(define-fun x929 ((x1058 Int)) Int (ite (= x1058 128) 16 (x471 x1058)))
(define-fun x726 ((x1058 Int)) Int (ite (= 160 x1058) x688 (x161 x1058)))
(define-fun x1414 ((x1058 Int)) Int (ite (= x1058 128) 16 (x726 x1058)))
(define-fun x1432 ((x1058 Int)) Int (ite (and x323 x1054) (x161 x1058) (ite (and x94 x1264) (x88 x1058) (x1414 x1058))))
(define-fun x1397 ((x1058 Int)) Int (ite (= 160 x1058) x157 (x1432 x1058)))
(define-fun x1442 ((x1058 Int)) Int (ite (= x1058 128) 16 (x1397 x1058)))
(define-fun x1013 ((x1058 Int)) Int (ite (= x1058 160) x893 (x1442 x1058)))
(define-fun x1250 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1013 x1058)))
(define-fun x931 ((x1058 Int)) Int (ite (and x235 (not x1041)) (x712 x1058) (x1250 x1058)))
(define-fun x614 ((x1058 x986)) Int (ite (= x1412 x1058) x1186 (x941 x1058)))
(define-fun x279 ((x1058 x986)) Int (ite (= x1058 (x1478 39)) x556 (x614 x1058)))
(define-fun x1090 ((x1058 x986)) Int (ite (and x323 x1054) (x941 x1058) (ite (and x1264 x94) (x941 x1058) (x279 x1058))))
(define-fun x1452 ((x1058 x986)) Int (ite (= x15 x1058) x1251 (x1090 x1058)))
(define-fun x1475 ((x1058 x986)) Int (ite (= x1058 x792) x979 (x1452 x1058)))
(define-fun x460 ((x1058 x986)) Int (ite (= (x1478 40) x1058) x660 (x1475 x1058)))
(define-fun x880 ((x1058 Int)) Int (ite (= 512 x1058) x1431 (x931 x1058)))
(define-fun x31 ((x1058 Int)) Int (ite (= x1058 544) x818 (x880 x1058)))
(define-fun x1089 ((x1058 Int)) Int (ite (= 160 x1058) x1365 (x31 x1058)))
(define-fun x654 ((x1058 Int)) Int (ite (= 832 x1058) 0 (x1143 x1058)))
(define-fun x1209 ((x1058 x986)) Int (ite (= x1058 (x1478 9)) x431 (x756 x1058)))
(define-fun x465 ((x1058 x986)) Int (ite (= x1058 x1484) x928 (x605 x1058)))
(define-fun x839 ((x1058 x986)) Int (ite (= x1058 x280) x1348 (x465 x1058)))
(define-fun x1436 ((x1058 x986)) Int (ite (= x1232 x1058) x349 (x582 x1058)))
(define-fun x1426 ((x1058 x986)) Int (ite (= x1058 x639) x1146 (x1436 x1058)))
(define-fun x638 ((x1058 x986)) Int (ite x239 (ite (and (not x70) x59) (x582 x1058) (ite (and (not x311) x642) (x756 x1058) (x1426 x1058))) (x756 x1058)))
(define-fun x1173 ((x1058 Int)) Int (ite (= x1058 160) x923 (x1143 x1058)))
(define-fun x480 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1173 x1058)))
(define-fun x486 ((x1058 Int)) Int (ite (= 160 x1058) x1066 (x189 x1058)))
(define-fun x1091 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x486 x1058)))
(define-fun x208 ((x1058 Int)) Int (ite (and (< x1058 (+ 640 32)) (<= 640 x1058)) (x1472 (+ 0 (- x1058 640))) (x106 x1058)))
(define-fun x477 ((x1058 Int)) Int (ite (and x262 x1095 x1254) (x208 x1058) (x106 x1058)))
(define-fun x791 ((x1058 Int)) Int (ite (= x1058 608) x662 (x477 x1058)))
(define-fun x651 ((x1058 Int)) Int (ite (= x1058 160) x462 (x791 x1058)))
(define-fun x1370 ((x1058 Int)) Int (ite (= x1058 128) 16 (x651 x1058)))
(define-fun x1459 ((x1058 Int)) Int (ite (= 640 x1058) x527 (x1370 x1058)))
(define-fun x984 ((x1058 Int)) Int (ite (= 672 x1058) x333 (x1459 x1058)))
(define-fun x1386 ((x1058 Int)) Int (ite (= x1058 704) x814 (x871 x1058)))
(define-fun x1205 ((x1058 Int)) Int (ite (= x1058 352) 274184521717934524641157099916833587200 (x23 x1058)))
(define-fun x326 ((x1058 Int)) Int (ite (= x1058 384) x960 (x1205 x1058)))
(define-fun x103 ((x1058 Int)) Int (ite (= 416 x1058) 0 (x326 x1058)))
(define-fun x1440 ((x1058 Int)) Int (ite (= x1058 224) 1889567281 (x30 x1058)))
(define-fun x1144 ((x1058 Int)) Int (ite (and (>= x1058 224) (> (+ 224 32) x1058)) (x222 (+ 0 (- x1058 224))) (x1082 x1058)))
(define-fun x560 ((x1058 Int)) Int (ite (and (not x916) x47 x773) (x1144 x1058) (x1082 x1058)))
(define-fun x201 ((x1058 Int)) Int (ite (= 288 x1058) x1180 (x560 x1058)))
(define-fun x1469 ((x1058 Int)) Int (ite (= x1058 256) x850 (x73 x1058)))
(define-fun x62 ((x1058 Int)) Int (ite (= 320 x1058) x891 (x1469 x1058)))
(define-fun x202 ((x1058 Int)) Int (ite (= 320 x1058) 0 (x73 x1058)))
(define-fun x629 ((x1058 Int)) Int (ite (and x657 (not x538)) (x62 x1058) (x202 x1058)))
(define-fun x523 ((x1058 Int)) Int (ite (= 480 x1058) x360 (x629 x1058)))
(define-fun x529 ((x1058 Int)) Int (ite (= x1058 416) x1477 (x523 x1058)))
(define-fun x599 ((x1058 Int)) Int (ite (= 416 x1058) x1411 (x30 x1058)))
(define-fun x315 ((x1058 Int)) Int (ite (and (not x394) x585) (x529 x1058) (x599 x1058)))
(define-fun x81 ((x1058 Int)) Int (ite (= 160 x1058) x820 (x315 x1058)))
(define-fun x628 ((x1058 Int)) Int (ite (= x1058 128) 7 (x81 x1058)))
(define-fun x435 ((x1058 Int)) Int (ite (= x1058 480) x345 (x628 x1058)))
(define-fun x165 ((x1058 Int)) Int (ite (= 768 x1058) x1361 (x435 x1058)))
(define-fun x542 ((x1058 Int)) Int (ite (= x1058 768) x870 (x433 x1058)))
(define-fun x352 ((x1058 Int)) Int (ite (= 224 x1058) 274184521717934524641157099916833587200 (x542 x1058)))
(define-fun x210 ((x1058 Int)) Int (ite (= 256 x1058) x371 (x352 x1058)))
(define-fun x1347 ((x1058 Int)) Int (ite (= 288 x1058) x293 (x210 x1058)))
(define-fun x1265 ((x1058 Int)) Int (ite (= 352 x1058) 274184521717934524641157099916833587200 (x1347 x1058)))
(define-fun x1168 ((x1058 Int)) Int (ite (= 384 x1058) 0 (x1265 x1058)))
(define-fun x483 ((x1058 Int)) Int (ite (= x1058 320) 0 (x1168 x1058)))
(define-fun x724 ((x1058 Int)) Int (ite (and x1204 x238) (x1101 x1058) (x754 x1058)))
(define-fun x358 ((x1058 Int)) Int (ite (= 320 x1058) 1 (x724 x1058)))
(define-fun x1384 ((x1058 Int)) Int (ite (and x203 x185) (x754 x1058) (x358 x1058)))
(define-fun x1087 ((x1058 Int)) Int (ite (= x1058 160) x900 (x1384 x1058)))
(define-fun x388 ((x1058 Int)) Int (ite (= 128 x1058) 7 (x1087 x1058)))
(define-fun x45 ((x1058 Int)) Int (ite (= x1058 160) x6 (x388 x1058)))
(define-fun x1298 ((x1058 Int)) Int (ite (= x1058 128) 7 (x45 x1058)))
(define-fun x65 ((x1058 Int)) Int (ite (= 320 x1058) x824 (x1298 x1058)))
(define-fun x584 ((x1058 Int)) Int (ite (and x1004 (not x1421)) (x433 x1058) (x65 x1058)))
(define-fun x16 ((x1058 Int)) Int (ite (= 160 x1058) 274184521717934524641157099916833587200 (x584 x1058)))
(define-fun x115 ((x1058 Int)) Int (ite (= x1058 224) 274184521717934524641157099916833587200 (x1221 x1058)))
(define-fun x1118 ((x1058 Int)) Int (ite (= x1058 256) x899 (x115 x1058)))
(define-fun x840 ((x1058 Int)) Int (ite (= 160 x1058) 274184521717934524641157099916833587200 (x1118 x1058)))
(define-fun x861 ((x1058 Int)) Int (ite (= 128 x1058) 7 (x840 x1058)))
(define-fun x968 ((x1058 Int)) Int (ite (= x1058 288) x329 (x861 x1058)))
(define-fun x321 ((x1058 Int)) Int (ite (= x1058 352) 274184521717934524641157099916833587200 (x968 x1058)))
(define-fun x997 ((x1058 Int)) Int (ite (= 384 x1058) 0 (x321 x1058)))
(define-fun x1 ((x1058 Int)) Int (ite (= x1058 320) 0 (x997 x1058)))
(define-fun x690 ((x1058 Int)) Int (ite (and x1163 x1387) (x1083 x1058) (x206 x1058)))
(define-fun x868 ((x1058 Int)) Int (ite (= 320 x1058) 1 (x690 x1058)))
(define-fun x1277 ((x1058 Int)) Int (ite (and x658 x1360) (x206 x1058) (x868 x1058)))
(define-fun x335 ((x1058 Int)) Int (ite (= x1058 160) x20 (x1277 x1058)))
(define-fun x962 ((x1058 Int)) Int (ite (= x1058 128) 7 (x335 x1058)))
(define-fun x661 ((x1058 Int)) Int (ite (= x1058 160) x1422 (x962 x1058)))
(define-fun x882 ((x1058 Int)) Int (ite (= x1058 128) 7 (x661 x1058)))
(define-fun x1195 ((x1058 Int)) Int (ite (= x1058 320) x226 (x882 x1058)))
(define-fun x107 ((x1058 Int)) Int (ite (and x59 (not x70)) (x1221 x1058) (ite (and x642 (not x311)) (x23 x1058) (x1195 x1058))))
(define-fun x970 ((x1058 Int)) Int (ite (= x1058 832) x408 (x107 x1058)))
(define-fun x559 ((x1058 Int)) Int (ite (= x1058 832) 0 (x189 x1058)))
(define-fun x156 ((x1058 Int)) Int (ite x239 (x970 x1058) (ite (and x1095 (not x1254)) (x559 x1058) (x654 x1058))))
(define-fun x1343 ((x1058 Int)) Int (ite (= 800 x1058) x613 (x156 x1058)))
(define-fun x770 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x1343 x1058)))
(define-fun x152 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x770 x1058)))
(define-fun x160 ((x1058 Int)) Int (ite (= 864 x1058) 0 (x1024 x1058)))
(define-fun x909 ((x1058 Int)) Int (ite (= x1058 224) 1889567281 (x1024 x1058)))
(define-fun x954 ((x1058 Int)) Int (ite (and (>= x1058 224) (> (+ 224 32) x1058)) (x2 (+ (- x1058 224) 0)) (x706 x1058)))
(define-fun x1016 ((x1058 Int)) Int (ite (and x309 x495 x307) (x954 x1058) (x706 x1058)))
(define-fun x1073 ((x1058 Int)) Int (ite (= x1058 352) x725 (x1016 x1058)))
(define-fun x851 ((x1058 Int)) Int (ite (= x1058 320) x1164 (x1073 x1058)))
(define-fun x91 ((x1058 Int)) Int (ite (= x1058 352) x567 (x851 x1058)))
(define-fun x946 ((x1058 Int)) Int (ite (= 384 x1058) x1353 (x91 x1058)))
(define-fun x572 ((x1058 Int)) Int (ite (= 160 x1058) x1235 (x946 x1058)))
(define-fun x383 ((x1058 Int)) Int (ite (= x1058 128) 16 (x572 x1058)))
(define-fun x722 ((x1058 Int)) Int (ite (= 416 x1058) x1157 (x383 x1058)))
(define-fun x288 ((x1058 Int)) Int (ite (= 160 x1058) x837 (x722 x1058)))
(define-fun x695 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x288 x1058)))
(define-fun x691 ((x1058 Int)) Int (ite (= x1058 448) x855 (x695 x1058)))
(define-fun x1161 ((x1058 Int)) Int (ite (= x1058 160) x301 (x691 x1058)))
(define-fun x1094 ((x1058 Int)) Int (ite (= x1058 128) 16 (x1161 x1058)))
(define-fun x295 ((x1058 Int)) Int (ite (= x1058 480) x245 (x1094 x1058)))
(define-fun x1106 ((x1058 Int)) Int (ite (= x1058 160) x170 (x295 x1058)))
(define-fun x810 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1106 x1058)))
(define-fun x1461 ((x1058 Int)) Int (ite (= 544 x1058) x153 (x286 x1058)))
(define-fun x1257 ((x1058 Int)) Int (ite (= x1058 544) x755 (x1461 x1058)))
(define-fun x191 ((x1058 Int)) Int (ite (= x1058 576) 1889567281 (x1257 x1058)))
(define-fun x177 ((x1058 Int)) Int (ite (and (< x1058 (+ 576 32)) (>= x1058 576)) (x33 (+ (- x1058 576) 0)) (x925 x1058)))
(define-fun x801 ((x1058 Int)) Int (ite (and x862 (not x1429) x958) (x177 x1058) (x925 x1058)))
(define-fun x802 ((x1058 Int)) Int (ite (= x1058 864) 0 (x591 x1058)))
(define-fun x742 ((x1058 Int)) Int (ite (= x1058 864) x1155 (x591 x1058)))
(define-fun x278 ((x1058 Int)) Int (ite (= 864 x1058) 0 (x286 x1058)))
(define-fun x682 ((x1058 Int)) Int (ite (and x872 x1010 x546) (x802 x1058) (ite (and (not x872) x1010 x546) (x742 x1058) (ite (and (not x786) x751) (x278 x1058) (x160 x1058)))))
(define-fun x29 ((x1058 Int)) Int (ite (= 832 x1058) x832 (x682 x1058)))
(define-fun x1231 ((x1058 Int)) Int (ite (= x1058 160) x1042 (x14 x1058)))
(define-fun x1465 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1231 x1058)))
(define-fun x1406 ((x1058 Int)) Int (ite (= 224 x1058) 1889567281 (x1465 x1058)))
(define-fun x211 ((x1058 Int)) Int (ite (and (> (+ 32 224) x1058) (<= 224 x1058)) (x545 (+ 0 (- x1058 224))) (x196 x1058)))
(define-fun x1413 ((x1058 Int)) Int (ite (and x859 x867 x1423) (x211 x1058) (x196 x1058)))
(define-fun x819 ((x1058 Int)) Int (ite (= 352 x1058) x994 (x1413 x1058)))
(define-fun x90 ((x1058 Int)) Int (ite (= 320 x1058) x714 (x819 x1058)))
(define-fun x230 ((x1058 Int)) Int (ite (= 160 x1058) x1394 (x90 x1058)))
(define-fun x1026 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x230 x1058)))
(define-fun x105 ((x1058 Int)) Int (ite (= x1058 896) x310 (x836 x1058)))
(define-fun x347 ((x1058 Int)) Int (ite (= 896 x1058) 0 (x836 x1058)))
(define-fun x534 ((x1058 Int)) Int (ite (= x1058 896) x1268 (x836 x1058)))
(define-fun x1130 ((x1058 Int)) Int (ite (= 160 x1058) x1158 (x14 x1058)))
(define-fun x144 ((x1058 Int)) Int (ite (= x1058 128) 16 (x1130 x1058)))
(define-fun x632 ((x1058 Int)) Int (ite (= 896 x1058) x1171 (x144 x1058)))
(define-fun x1245 ((x1058 Int)) Int (ite (and x98 x607) (x105 x1058) (ite (and (not x400) x1388) (x347 x1058) (ite (and x776 (not x805)) (x534 x1058) (x632 x1058)))))
(define-fun x869 ((x1058 Int)) Int (ite (= 864 x1058) x374 (x1245 x1058)))
(define-fun x1393 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x959 x1058)))
(define-fun x150 ((x1058 Int)) Int (ite (= x1058 128) 16 (x1393 x1058)))
(define-fun x525 ((x1058 x986)) Int (ite (= x1489 x1058) x686 (x149 x1058)))
(define-fun x50 ((x1058 x986)) Int (ite (= (x1478 40) x1058) x8 (x525 x1058)))
(define-fun x721 ((x1058 Int)) Int (ite (= 864 x1058) x260 (x150 x1058)))
(define-fun x799 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x875 x1058)))
(define-fun x9 ((x1058 Int)) Int (ite (= x1058 128) 16 (x799 x1058)))
(define-fun x63 ((x1058 x986)) Int (ite (= x1058 x1148) x7 (x509 x1058)))
(define-fun x1114 ((x1058 x986)) Int (ite (= (x1478 40) x1058) x519 (x63 x1058)))
(define-fun x38 ((x1058 Int)) Int (ite (and (not x788) x558) (x875 x1058) (x9 x1058)))
(define-fun x92 ((x1058 Int)) Int (ite (= 224 x1058) x1034 (x1286 x1058)))
(define-fun x618 ((x1058 Int)) Int (ite (= 256 x1058) x1431 (x92 x1058)))
(define-fun x1385 ((x1058 Int)) Int (ite (= x1058 288) 274184521717934524641157099916833587200 (x618 x1058)))
(define-fun x1344 ((x1058 Int)) Int (ite (= x1058 320) x574 (x1385 x1058)))
(define-fun x516 ((x1058 Int)) Int (ite (= 416 x1058) 4 (x1344 x1058)))
(define-fun x1327 ((x1058 Int)) Int (ite (and (>= x1058 512) (< x1058 (+ 4 512))) (x1447 (+ (- x1058 512) 0)) (x1059 x1058)))
(define-fun x942 ((x1058 Int)) Int (ite (and x1117 x1227 (not x1419)) (x1327 x1058) (x1059 x1058)))
(define-fun x472 ((x1058 Int)) Int (ite (= x1153 x1058) x148 (x942 x1058)))
(define-fun x1135 ((x1058 Int)) Int (ite (= x1058 x399) x1352 (x472 x1058)))
(define-fun x1303 ((x1058 Int)) Int (ite (= x1058 x951) x587 (x1135 x1058)))
(define-fun x131 ((x1058 Int)) Int (ite (and (>= x1058 672) (< x1058 (+ 672 32))) (x229 (+ (- x1058 672) 0)) (x987 x1058)))
(define-fun x1029 ((x1058 Int)) Int (ite (= 224 x1058) x816 (x1286 x1058)))
(define-fun x512 ((x1058 Int)) Int (ite (= 256 x1058) x1431 (x1029 x1058)))
(define-fun x541 ((x1058 Int)) Int (ite (= x1058 288) x1253 (x512 x1058)))
(define-fun x1182 ((x1058 Int)) Int (ite (= 384 x1058) 4 (x541 x1058)))
(define-fun x1145 ((x1058 Int)) Int (ite (and (>= x1058 480) (> (+ 480 4) x1058)) (x37 (+ (- x1058 480) 0)) (x317 x1058)))
(define-fun x1167 ((x1058 Int)) Int (ite (and (not x66) x1451 x332) (x1145 x1058) (x317 x1058)))
(define-fun x204 ((x1058 Int)) Int (ite (= x1058 x1125) x1240 (x1167 x1058)))
(define-fun x768 ((x1058 Int)) Int (ite (= x732 x1058) x873 (x204 x1058)))
(define-fun x450 ((x1058 Int)) Int (ite (and (> (+ 32 608) x1058) (>= x1058 608)) (x277 (+ 0 (- x1058 608))) (x924 x1058)))
(define-fun x736 ((x1058 Int)) Int (ite (and (not x1419) x1227 x34) (x131 x1058) (x987 x1058)))
(define-fun x785 ((x1058 Int)) Int (ite (and (< x1058 (+ x1310 352)) (>= x1058 352)) (x566 (+ (- x1058 352) 0)) (x796 x1058)))
(define-fun x41 ((x1058 Int)) Int (ite (and x521 x741 x1403) (x785 x1058) (x796 x1058)))
(define-fun x1485 ((x1058 Int)) Int (ite (and x1181 x332 (not x66)) (x450 x1058) (x924 x1058)))
(define-fun x683 ((x1058 Int)) Int (ite (and (>= x1058 320) (> (+ 320 x1097) x1058)) (x933 (+ 0 (- x1058 320))) (x1104 x1058)))
(define-fun x1112 ((x1058 Int)) Int (ite (and x980 x147 x834) (x683 x1058) (x1104 x1058)))
(define-fun x745 ((x1058 Int)) Int (ite (and x87 (not x1398)) (x1286 x1058) (ite x1466 (x41 x1058) (x1112 x1058))))
(define-fun x1408 ((x1058 Int)) Int (ite (= x1058 256) x478 (x936 x1058)))
(define-fun x505 ((x1058 Int)) Int (ite (= x1058 992) x547 (x1408 x1058)))
(define-fun x808 ((x1058 Int)) Int (ite (= 992 x1058) 0 (x936 x1058)))
(define-fun x1246 ((x1058 Int)) Int (ite (and x1056 (not x938)) (x505 x1058) (x808 x1058)))
(define-fun x1169 ((x1058 Int)) Int (ite (= x1058 960) x461 (x1246 x1058)))
(define-fun x537 ((x1058 x986)) Int (ite (= (x1478 43) x1058) 0 (x672 x1058)))
(define-fun x1293 ((x1058 x986)) Int (ite (= x1058 (x1478 43)) x903 (x672 x1058)))
(define-fun x427 ((x1058 x986)) Int (ite (and x171 (not x413)) (x1293 x1058) (x537 x1058)))
(define-fun x281 ((x1058 Int)) Int (ite (= 160 x1058) x1431 (x1169 x1058)))
(define-fun x762 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x281 x1058)))
(define-fun x176 ((x1058 x986)) Int (ite (= x1058 x782) x1301 (x427 x1058)))
(define-fun x207 ((x1058 x986)) Int (ite (= x1058 (x1478 41)) x1301 (x176 x1058)))
(define-fun x1375 ((x1058 Int)) Int (ite (and (<= 992 x1058) (> (+ 64 992) x1058)) (x122 (+ (- x1058 992) 4)) (x762 x1058)))
(define-fun x619 ((x1058 Int)) Int (ite (= x1058 1056) x248 (x1375 x1058)))
(define-fun x1306 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x619 x1058)))
(define-fun x1260 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1306 x1058)))
(define-fun x530 ((x1058 Int)) Int (ite (= x1058 1088) x1055 (x1260 x1058)))
(define-fun x58 ((x1058 Int)) Int (ite (= 160 x1058) x1431 (x530 x1058)))
(define-fun x1078 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x58 x1058)))
(define-fun x826 ((x1058 Int)) Int (ite (= x1058 1120) x659 (x1078 x1058)))
(define-fun x935 ((x1058 Int)) Int (ite (= 160 x1058) x1431 (x826 x1058)))
(define-fun x761 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x935 x1058)))
(define-fun x1364 ((x1058 Int)) Int (ite (= 1152 x1058) x955 (x761 x1058)))
(define-fun x1366 ((x1058 Int)) Int (ite (= 1184 x1058) x257 (x1364 x1058)))
(define-fun x1030 ((x1058 Int)) Int (ite (= 160 x1058) x1431 (x1366 x1058)))
(define-fun x306 ((x1058 Int)) Int (ite (= 128 x1058) 16 (x1030 x1058)))
(define-fun x1007 ((x1058 Int)) Int (ite (= 1216 x1058) x1291 (x306 x1058)))
(define-fun x1258 ((x1058 Int)) Int (ite (= x1058 160) x1431 (x1007 x1058)))
(define-fun x1133 ((x1058 Int)) Int (ite (= x1058 128) 16 (x1258 x1058)))
(define-fun x1309 ((x420 Int)) Bool (=> (and (not (= x420 3862337480)) (not (= x420 1020253707)) (not (= x420 2572356358)) (not (= 2388873442 x420)) (not (= 773487949 x420)) (not (= 1851080549 x420)) (not (= 2835717307 x420)) (not (= 961581905 x420)) (not (= x420 31556952)) (not (= x420 1196925270)) (not (= 2316151882 x420)) (not (= x420 60465744)) (not (= 4267106866 x420)) (not (= x420 31576340)) (not (= 3544214205 x420)) (not (= x420 1461501637330902918203684832716283019655932542975)) (not (= x420 3065339685)) (not (= 1889567281 x420)) (not (= 3963136098 x420)) (not (= x420 2869116585)) (not (= x420 274184521717934524641157099916833587200)) (not (= 2087341860 x420)) (not (= x420 1888058147)) (not (= x420 1854955031)) (not (= 157198259 x420)) (not (= 2052391781 x420)) (not (= 2988718581 x420)) (not (= 2715400956 x420)) (not (= x420 861432679)) (not (= 3877814014 x420)) (not (= x420 288104347)) (not (= 4294967296 x420)) (not (= x420 4151200938)) (not (= x420 2209625481)) (not (= 2681579215 x420)) (not (= 3491319510 x420)) (not (= 3504541104 x420)) (not (= x420 113225476)) (not (= 1257916802 x420)) (not (= 3208075701 x420)) (not (= x420 3296657447)) (not (= x420 596573372)) (not (= 348537858 x420)) (not (= x420 599290589)) (not (= x420 3184006219)) (not (= x420 464926286)) (not (= x420 1000000000000000000)) (not (= x420 1401663147)) (not (= 3613687827 x420)) (not (= 347398766 x420)) (not (= x420 16156842317565293874272834530371880720966471053262404558597773956279093428224)) (not (= x420 16192718)) (not (= 2484372501 x420)) (not (= 3567397854 x420)) (not (= x420 629314576)) (not (= x420 3339924076)) (< 10000 x420) (not (= x420 3184473787)) (not (= 76450787359836037641860180984291677749980919077056822294353438043884394381312 x420)) (not (= 297566789 x420)) (not (= x420 3147386184)) (not (= x420 2757214935)) (not (= x420 2699341722)) (not (= x420 1977493762)) (not (= x420 1823829273)) (not (= 3092021830 x420)) (not (= 356263876 x420)) (not (= x420 2780307423))) (not ((_ is x1478) (x1441 x420)))))
(assert (x533 x1230))
(assert (x533 x434))
...
(assert (=> (>= 10000 (x628 128)) (= (x1478 (x628 128)) (x1441 (x628 128)))))
...
(assert (x533 x1157))
(assert (x533 x622))
(assert (=> (>= 10000 (x628 160)) (= (x1478 (x628 160)) (x1441 (x628 160)))))
...
(assert (= (x1221 128) 7))
(assert (x533 x233))
(assert (=> (>= 10000 (x1465 128)) (= (x1478 (x1465 128)) (x1441 (x1465 128)))))
(assert (x533 x943))
(assert (x533 x617))
...
(assert (x533 x668))
(assert (x533 x681))
(assert (=> (<= (x1217 128) 10000) (= (x1441 (x1217 128)) (x1478 (x1217 128)))))
(assert true)
...
(assert (= (=> (and (= (div x697 x536) x870) (= x99 (x1101 256)) (= x641 (x856 (+ 352 x879))) (= x195 (x1101 x641)) (= x1138 (x1101 192)) (= (mod (* x1138 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x879) (= x238 (= x99 x195)) (= x371 (x352 512)) (= (x210 768) x293)) (and (=> (not x238) x442) (=> x238 x330))) x1281))
(assert (x533 x71))
(assert (x1309 (x882 160)))
(assert (= (ite (= x425 (x1478 44)) x434 (x638 (x1478 44))) (x149 (x1478 44))))
(assert (x1309 (x1217 128)))
(assert (= (=> (and (= (x672 (x1478 44)) x881) (= (div x1052 x636) x1288) (= (mod (* x636 x881) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1052) (= x621 (or x1123 x499)) (= (= x1288 x881) x1123) (= x499 (= 0 x636)) (= x1437 (= 0 (ite x621 1 0))) (= x636 (x1147 (- x1301 x255)))) (and (=> x1437 x52) (=> (not x1437) x19))) x918))
...
(assert (x533 x1134))
(assert (x533 x500))
(assert (= x738 (=> (and (= (= 0 x689) x633) (= (mod (* x1454 x689) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1159) (= (x1147 (- x967 x1085)) x689) (= x357 (= x1454 x151)) (= x1454 (x477 576)) (= (div x1159 x689) x151) (= (= (ite x1350 1 0) 0) x692) (= (or x633 x357) x1350)) (and (=> x692 x52) (=> (not x692) x1341)))))
(assert (x533 x1352))
(assert (=> (>= 10000 (x1250 160)) (= (x1441 (x1250 160)) (x1478 (x1250 160)))))
...
(assert (=> (<= (x1091 160) 10000) (= (x1441 (x1091 160)) (x1478 (x1091 160)))))
(assert (= (and (not x939) x620) x1305))
(assert (= (=> (and (= (x1408 256) x511) (= x1320 (= (ite x178 1 0) 0)) (= (= x124 0) x300) (= (= x511 x1006) x129) (= x478 (x672 (x1478 43))) (= x178 (or x300 x129)) (= (x1408 256) x1176) (= x1006 (div x1415 x124)) (= x1415 (mod (* x511 x124) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x124 (x1408 224))) (and (=> x1320 x52) (=> (not x1320) x1427))) x576))
...
(assert (= (=> (and (= x398 (x984 672)) (= (div x1402 10000) x333) (= x423 (x984 640)) (= x1274 (> x398 x489)) (= (x856 (+ x398 x423)) x489)) (and (=> x1274 x52) (=> (not x1274) x919))) x514))
...
(assert (=> (<= (x996 160) 10000) (= (x1441 (x996 160)) (x1478 (x996 160)))))
...
(assert (=> (<= (x996 128) 10000) (= (x1441 (x996 128)) (x1478 (x996 128)))))
(assert (x533 x519))
(assert (= (x38 384) (x1286 384)))
(assert (= (x975 (x378 x603 6)) (+ 6 (x975 x603))))
(assert (= (x669 128) (x975 (x1441 (x669 128)))))
(assert (x533 x739))
(assert (= (=> (and (= x866 (x523 480)) (= x360 (x1147 (- x520 x205))) (= x394 (= 0 x866))) (and (=> (and (= x1477 (div x1266 x866)) (not x394)) x1473) (=> x394 x52))) x84))
...
(assert (=> (>= 10000 (x1250 128)) (= (x1478 (x1250 128)) (x1441 (x1250 128)))))
(assert (x533 x1155))
...
(assert (= (x83 x449 x1269) (div x449 (x1425 2 x1269))))
(assert (x533 x20))
...
(assert (=> (>= 10000 (x762 160)) (= (x1441 (x762 160)) (x1478 (x762 160)))))
(assert (= x535 x817))
(assert (x533 x757))
(assert (= (x801 512) (x591 512)))
(assert (= x532 (=> (= (> x438 0) x1362) (and (=> x1362 x1434) (=> (not x1362) x52)))))
(assert (x533 x1377))
(assert (=> (<= (x1442 128) 10000) (= (x1441 (x1442 128)) (x1478 (x1442 128)))))
...
(assert (= x200 (=> (and (= (= x270 x998) x488) (= x1048 (x30 384)) (= x1266 (mod (* x270 x1048) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (or x1128 x488) x457) (= (div x1266 x1048) x998) (= x1128 (= x1048 0)) (= (x30 448) x270) (= (= (ite x457 1 0) 0) x916)) (and (=> (and (not x916) (or (and (= x1236 x373) (not x773)) (and (> 4294967296 x1302) x773 (= x1236 1))) (= x773 (> x373 0))) x705) (=> x916 x52)))))
(assert (x533 x225))
...
(assert (=> (>= 10000 (x383 128)) (= (x1478 (x383 128)) (x1441 (x383 128)))))
(assert (= (x194 352) x1222))
(assert (=> (<= (x1091 128) 10000) (= (x1441 (x1091 128)) (x1478 (x1091 128)))))
(assert (= 16 (x1217 128)))
(assert (x533 x1296))
(assert (= (x1406 832) (x196 832)))
(assert (= (x16 704) (x1221 704)))
(assert (= (x975 (x1441 (x388 160))) (x388 160)))
(assert (=> (>= 10000 (x1260 160)) (= (x1478 (x1260 160)) (x1441 (x1260 160)))))
(assert (x533 x1097))
(assert (x1309 (x861 128)))
(assert (x533 x331))
(assert (= (x1024 288) x1431))
(assert (= (=> (= (> x1296 31) x1336) (and (=> x1336 x1462) (=> (not x1336) x52))) x364))
(assert (=> (<= (x150 128) 10000) (= (x1441 (x150 128)) (x1478 (x150 128)))))
(assert (=> (<= (x1298 128) 10000) (= (x1478 (x1298 128)) (x1441 (x1298 128)))))
(assert (x533 x1136))
(assert (x533 x282))
...
(assert (= (=> (and (= (x206 256) x42) (= (x206 192) x401) (= (x206 x437) x892) (= x437 (x856 (+ x127 352))) (= (= x42 x892) x667) (= (mod (* x401 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x127)) (and x817 x667)) x247))
...
(assert (x533 x547))
(assert (x533 x101))
(assert (=> (>= 10000 (x861 128)) (= (x1478 (x861 128)) (x1441 (x861 128)))))
...
(assert (=> (<= (x882 160) 10000) (= (x1478 (x882 160)) (x1441 (x882 160)))))
(assert (= x679 (=> (and (= x701 (x756 (x1478 44))) (= (= x687 x701) x1420) (= x865 (or x976 x1420)) (= (x1147 (- x1301 x911)) x874) (= (mod (* x874 x701) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x926) (= (= 0 (ite x865 1 0)) x1248) (= x976 (= 0 x874)) (= (div x926 x874) x687)) (and (=> (not x1248) x168) (=> x1248 x52)))))
...
(assert (=> (>= 10000 (x762 128)) (= (x1441 (x762 128)) (x1478 (x762 128)))))
(assert (= x1020 (=> (and (= x1256 (= x934 x804)) (= x934 (x754 256)) (= (x754 x57) x804) (= x366 (x754 192)) (= x57 (x856 (+ 352 x1092))) (= (mod (* x366 32) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1092)) (and x1256 x330))))
...
(assert (=> (>= 10000 (x1094 160)) (= (x1478 (x1094 160)) (x1441 (x1094 160)))))
(assert (=> (<= (x388 160) 10000) (= (x1441 (x388 160)) (x1478 (x388 160)))))
...
(assert (=> (>= 10000 (x761 160)) (= (x1441 (x761 160)) (x1478 (x761 160)))))
(assert (=> (>= 10000 (x1414 160)) (= (x1441 (x1414 160)) (x1478 (x1414 160)))))
...
(assert (x533 x339))
(assert (= (div x361 (x1425 2 x807)) (x83 x361 x807)))
...
(assert (=> (>= 10000 (x1217 160)) (= (x1441 (x1217 160)) (x1478 (x1217 160)))))
...
(assert (=> (>= 10000 x668) (= (x1478 x668) (x1441 x668))))
...
(assert (x533 x820))
(assert (= (=> (and (= x1017 (x570 (x1441 (x929 128)) (x1441 (x929 160)) 0)) (= (x378 x1017 2) x649) (= (x88 224) x1332) (= x746 (ite (> x1428 x1349) x1349 x1428)) (= x1349 (x941 x649)) (= (x161 320) x1379) (= (div x159 x595) x1428) (= x323 (= 0 x1379))) (and (=> (not x323) x1438) (=> x323 x506))) x673))
...
(assert (= x1427 (=> (and (= x938 (< x1176 x1278)) (= (div x1415 1000000000000000000) x1278)) (and (=> x938 x52) (=> (and (= (x1147 (- x1176 x1278)) x547) (not x938)) x406)))))
(assert (x533 x823))
...
(assert (x533 x110))
(assert (=> (>= 10000 (x304 128)) (= (x1478 (x304 128)) (x1441 (x304 128)))))
(assert (= x348 (=> (and (= x697 (mod (* x696 x1018) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x616 (= x696 x676)) (= x696 (x433 736)) (= (div x697 x1018) x676) (= (= 0 x1018) x487) (= x1018 (x433 640)) (= x393 (or x616 x487)) (= x1200 (= (ite x393 1 0) 0))) (and (=> (not x1200) x1271) (=> x1200 x52)))))
...
(assert (= (=> (and (= (x1073 352) x1164) (= x518 (= x1178 x292)) (= x725 (x856 (+ x956 x283))) (= x678 (x149 (x1478 39))) (= (or x518 x271) x272) (= (= x678 0) x271) (= x36 (mod (* x292 x678) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x482 (= 0 (ite x272 1 0))) (= x292 (x851 320)) (= x1178 (div x36 x678))) (and (=> x482 x52) (=> (not x482) x767))) x1046))
...
(assert (=> (<= (x1078 160) 10000) (= (x1441 (x1078 160)) (x1478 (x1078 160)))))
...
(assert (=> (<= (x962 128) 10000) (= (x1441 (x962 128)) (x1478 (x962 128)))))
...
(assert (=> (<= (x9 160) 10000) (= (x1478 (x9 160)) (x1441 (x9 160)))))
...
(assert (= (=> (and (= x1269 (mod (* 8 x104) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (x41 384) x449) (= (x1147 (- 32 x1304)) x104) (= (x41 352) x1304) (= x432 (> (x83 x449 x1269) 0))) (and (=> (not x432) x52) (=> x432 x821))) x1285))
...
(assert (=> (>= 10000 (x1026 128)) (= (x1478 (x1026 128)) (x1441 (x1026 128)))))
...
(assert (=> (<= (x1414 128) 10000) (= (x1441 (x1414 128)) (x1478 (x1414 128)))))
...
(assert (=> (>= 10000 (x1143 128)) (= (x1478 (x1143 128)) (x1441 (x1143 128)))))
(assert (=> (>= 10000 (x669 128)) (= (x1441 (x669 128)) (x1478 (x669 128)))))
(assert (= x392 (and (not x169) x113)))
(assert (=> (>= 10000 (x1260 128)) (= (x1478 (x1260 128)) (x1441 (x1260 128)))))
(assert (=> (<= x833 10000) (= (x1441 x833) (x1478 x833))))
(assert (x533 x1307))
(assert (=> (>= 10000 (x144 160)) (= (x1478 (x144 160)) (x1441 (x144 160)))))
(assert (x533 x1032))
...
(assert (=> (>= 10000 (x144 128)) (= (x1478 (x144 128)) (x1441 (x144 128)))))
...
(assert (=> (<= (x1133 128) 10000) (= (x1478 (x1133 128)) (x1441 (x1133 128)))))
(assert (=> (>= 10000 (x152 160)) (= (x1478 (x152 160)) (x1441 (x152 160)))))
...
(assert (= (=> (and (= x325 (= x418 0)) (= (x1469 256) x827) (= x718 (mod (* x827 x418) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x850 (x756 (x1478 43))) (= x459 (div x718 x418)) (= (= (ite x1401 1 0) 0) x838) (= (= x459 x827) x146) (= (x1469 224) x418) (= (or x325 x146) x1401) (= x110 (x1469 256))) (and (=> x838 x52) (=> (not x838) x298))) x1249))
...
(assert (x533 x1132))
(assert (x533 x408))
(assert (=> (>= 10000 (x1442 160)) (= (x1478 (x1442 160)) (x1441 (x1442 160)))))
...
(assert (=> (>= 10000 (x1133 160)) (= (x1441 (x1133 160)) (x1478 (x1133 160)))))
...
(assert (=> (>= 10000 (x306 128)) (= (x1478 (x306 128)) (x1441 (x306 128)))))
(assert (= (ite (and x1333 (not x377)) (x959 352) (x721 352)) (x875 352)))
(assert (=> (>= 10000 (x383 160)) (= (x1478 (x383 160)) (x1441 (x383 160)))))
(assert (x533 x1039))
...
(assert (x533 x173))
(assert (=> (>= 10000 (x9 128)) (= (x1478 (x9 128)) (x1441 (x9 128)))))
(assert (= x410 (=> (and (= x769 (= x498 0)) (= x76 (or x769 x375)) (= x375 (= x1105 x302)) (= x1105 (div x1402 x498)) (= (x1459 544) x498) (= x302 (x756 (x1478 47))) (= x527 (div x829 10000)) (= (mod (* x498 x302) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1402) (= (= (ite x76 1 0) 0) x544)) (and (=> (not x544) x514) (=> x544 x52)))))
...
(assert (x533 x294))
(assert (=> (>= 10000 (x810 128)) (= (x1478 (x810 128)) (x1441 (x810 128)))))
(assert (=> (<= x557 10000) (= (x1441 x557) (x1478 x557))))
...
(assert (=> (<= (x1151 128) 10000) (= (x1441 (x1151 128)) (x1478 (x1151 128)))))
(assert (= 0 (x1197 352)))
(assert (x533 x892))
(assert (x533 x923))
...
(assert (=> (>= 10000 (x669 160)) (= (x1441 (x669 160)) (x1478 (x669 160)))))
...
(assert (x533 x120))
(assert (=> (>= 10000 (x861 160)) (= (x1478 (x861 160)) (x1441 (x861 160)))))
(assert (x533 x1019))
...
(assert (= x1060 (=> (and (= x1067 (= x1457 0)) (= (x856 (+ x783 x456)) x1074) (= x949 (div x1299 x1457)) (= (x716 352) x72) (= x1299 (mod (* x72 x1457) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= (= x949 x72) x1407) (= x1317 (or x1067 x1407)) (= x1470 (= 0 (ite x1317 1 0)))) (and (=> x1470 x52) (=> (not x1470) x1107)))))
...
(assert (=> (<= (x929 128) 10000) (= (x1478 (x929 128)) (x1441 (x929 128)))))
(assert (x533 x574))
...
(assert (x533 x240))
(assert (x533 x907))
(assert (=> (>= 10000 (x150 160)) (= (x1441 (x150 160)) (x1478 (x150 160)))))
...
(assert (= x1025 (=> (and (= (or x444 x1051) x753) (= x444 (= 0 x1132)) (= (x941 (x1478 39)) x249) (= (= (ite x753 1 0) 0) x355) (= x1051 (= x249 x1335)) (= (x88 256) x1132) (= x1335 (div x159 x1132)) (= (mod (* x249 x1132) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x159)) (and (=> (not x355) x1444) (=> x355 x52)))))
...
(assert (=> (>= 10000 (x1298 160)) (= (x1478 (x1298 160)) (x1441 (x1298 160)))))
...
(assert (= (x1197 x57) 0))
(assert (= x583 (=> (and (= (> (x83 x361 x807) 0) x586) (= (x1112 352) x361) (= (mod (* x1234 8) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x807) (= x1234 (x1147 (- 32 x655))) (= x655 (x1112 320))) (and (=> (not x586) x52) (=> x586 x1023)))))
...
(assert (x533 x395))
(assert (= x316 x1244))
(assert (=> (>= 10000 (x1151 160)) (= (x1478 (x1151 160)) (x1441 (x1151 160)))))
...
(assert (x533 x1282))
(assert (=> (<= (x1143 160) 10000) (= (x1441 (x1143 160)) (x1478 (x1143 160)))))
...
(assert (x533 x1382))
(assert (=> (>= 10000 (x695 128)) (= (x1478 (x695 128)) (x1441 (x695 128)))))
...
(assert (x1309 x833))
(assert (=> (>= 10000 x385) (= (x1478 x385) (x1441 x385))))
...
(assert (=> (>= 10000 (x761 128)) (= (x1478 (x761 128)) (x1441 (x761 128)))))
...
(assert (=> (<= (x882 128) 10000) (= (x1478 (x882 128)) (x1441 (x882 128)))))
(assert (x533 x1365))
...
(assert (=> (<= (x1221 128) 10000) (= (x1441 (x1221 128)) (x1478 (x1221 128)))))
...
(assert (=> (>= 10000 (x480 160)) (= (x1441 (x480 160)) (x1478 (x480 160)))))
...
(assert (=> (>= 10000 (x929 160)) (= (x1478 (x929 160)) (x1441 (x929 160)))))
(assert (= (x582 (x1478 37)) (ite (and x1004 (not x1421)) (x605 (x1478 37)) (x839 (x1478 37)))))
(assert (=> (<= (x1465 160) 10000) (= (x1478 (x1465 160)) (x1441 (x1465 160)))))
...
(assert (=> (>= 10000 (x1221 160)) (= (x1478 (x1221 160)) (x1441 (x1221 160)))))
...
(assert (=> (>= 10000 (x1078 128)) (= (x1478 (x1078 128)) (x1441 (x1078 128)))))
...
(assert (=> (>= 10000 (x388 128)) (= (x1441 (x388 128)) (x1478 (x388 128)))))
...
(assert (= x940 (=> (and (= (= 0 x243) x95) (= (x791 544) x243) (= (x791 512) x462) (= (= 0 (ite x1369 1 0)) x1224) (= (div x1218 10000) x120) (= (or x95 x656) x1369) (= x1170 (div x829 x243)) (= x922 (x570 (x1441 (x1370 128)) (x1441 (x1370 160)) 0)) (= x662 (div x120 31556952)) (= (x756 x922) x950) (= (mod (* x243 x950) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x829) (= (= x1170 x950) x656)) (and (=> x1224 x52) (=> (not x1224) x410)))))
...
(assert (=> (<= (x429 128) 10000) (= (x1478 (x429 128)) (x1441 (x429 128)))))
...
(assert (=> (<= (x306 160) 10000) (= (x1441 (x306 160)) (x1478 (x306 160)))))
(assert (x533 x1159))
...
(assert (=> (<= (x304 160) 10000) (= (x1478 (x304 160)) (x1441 (x304 160)))))
...
(assert (=> (>= 10000 (x962 160)) (= (x1478 (x962 160)) (x1441 (x962 160)))))
...
(assert (= (=> (and (= (x90 288) x1394) (= (x378 x784 6) x698) (= x714 (div x382 10000)) (= (< 0 x1261) x607) (= (x149 x698) x790) (= x784 (x570 (x1441 (x1026 128)) (x1441 (x1026 160)) 0)) (= (x149 (x1478 37)) x1261)) (and (=> (not x607) x961) (=> (and x607 (= x310 (x836 352))) x844))) x1464))
...
(assert (=> (<= (x1370 160) 10000) (= (x1441 (x1370 160)) (x1478 (x1370 160)))))
(assert (x533 x461))
(assert (= (=> (= (> x592 0) x1077) (and (=> (not x1077) x52) (=> x1077 x179))) x1430))
(assert (=> (>= 10000 (x1370 128)) (= (x1478 (x1370 128)) (x1441 (x1370 128)))))
(assert (= (x672 (x1478 43)) (ite (and x558 (not x788)) (x509 (x1478 43)) (x1114 (x1478 43)))))
(assert (=> (>= 10000 (x810 160)) (= (x1478 (x810 160)) (x1441 (x810 160)))))
...
(assert (=> (>= 10000 (x480 128)) (= (x1478 (x480 128)) (x1441 (x480 128)))))
(assert (x533 x655))
(assert (= x298 (=> (and (= x538 (< x110 x1001)) (= x1001 (div x718 1000000000000000000))) (and (=> (and (not x538) (= x891 (x1147 (- x110 x1001)))) x1079) (=> x538 x52)))))
...
(assert (x533 x1400))
(assert (=> (<= (x695 160) 10000) (= (x1441 (x695 160)) (x1478 (x695 160)))))
(assert (x533 x205))
...
(assert (= x1341 (=> (and (= (= (ite x126 1 0) 0) x627) (= (x756 (x1478 46)) x1435) (= x612 (= x1159 0)) (= x126 (or x1191 x612)) (= (div x1218 x1159) x1152) (= (mod (* x1435 x1159) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x1218) (= x1191 (= x1152 x1435))) (and (=> (not x627) x940) (=> x627 x52)))))
(assert (x533 x974))
...
(assert (= x1390 (=> (and (= x989 (mod (* 32 x615) 115792089237316195423570985008687907853269984665640564039457584007913129639936)) (= x899 (x582 (x1478 45))) (= x329 (x582 x319)) (= (x1083 x328) x1131) (= (= x1131 x5) x1387) (= (x856 (+ x989 352)) x328) (= (x570 (x1441 (x861 128)) (x1441 (x861 160)) 0) x319) (= (x1083 256) x5) (= x615 (x1083 192))) (and (=> x1387 x817) (=> (not x1387) x634)))))
(assert (= (x975 (x1441 (x1260 160))) (x1260 160)))
(assert (x533 x687))
(assert (=> (<= (x1094 128) 10000) (= (x1478 (x1094 128)) (x1441 (x1094 128)))))
...
(assert (= (=> (and (= x763 (or x1188 x1355)) (= x945 (x819 352)) (= x994 (x856 (+ x1307 x863))) (= x1188 (= x282 x945)) (= x416 (= (ite x763 1 0) 0)) (= (= 0 x289) x1355) (= x282 (div x382 x289)) (= (mod (* x945 x289) 115792089237316195423570985008687907853269984665640564039457584007913129639936) x382)) (and (=> (not x416) x1464) (=> x416 x52))) x630))
...
(assert (= (=> (and (= x1389 (x748 288)) (= (x941 x82) x1222) (= (< 0 x681) x1061) (= (x941 (x1478 37)) x681) (= x252 (div x1299 10000)) (= (x570 (x1441 (x669 128)) (x1441 (x669 160)) 0) x481) (= x82 (x378 x481 6))) (and (=> (not x1061) x1319) (=> (and x1061 (= (x194 352) x1328)) x1011))) x1107))
...
(assert (=> (>= 10000 (x152 128)) (= (x1478 (x152 128)) (x1441 (x152 128)))))
(assert (x533 x299))
(assert (x533 x718))
